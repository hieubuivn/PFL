...
export const cvData = {
    poba: {
        ...
        cvAvatarURL: `${(import.meta.env && import.meta.env.BASE_URL) || './'}textures/cv-poba-nobg.webp?v=${ASSET_VERSION}`,
    ...
    dev: {
        ...
        cvAvatarURL: `${(import.meta.env && import.meta.env.BASE_URL) || './'}textures/cv-dev-nobg.webp?v=${ASSET_VERSION}`,
