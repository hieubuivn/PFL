...
`+e.fragmentShader,Pr(e,`fragment`,`
    ...
    `),e.fragmentShader=e.fragmentShader.replace(/UV\s*=\s*vUv/g,`UV = vWarpedUv`).replace(/texture2D\(\s*map\s*,\s*vMapUv\s*\)/g,`texture2D( map, vWarpedUv )`).replace(/texture2D\(\s*roughnessMap\s*,\s*vMapUv\s*\)/g,`texture2D( roughnessMap, vWarpedUv )`).replace(/texture2D\(\s*metalnessMap\s*,\s*vMapUv\s*\)/g,`texture2D( metalnessMap, vWarpedUv )`).replace(/texture2D\(\s*bumpMap\s*,\s*vMapUv\s*\)/g,`texture2D( bumpMap, vWarpedUv )`).replace(/texture2D\(\s*iChannel([0-9X])\s*,\s*(vUv|uv)\s*\)/g,`texture2D( iChannel$1, vWarpedUv )`).replace(/textureLod\(\s*iChannelX\s*,\s*UV\+n\s*,\s*focus\s*\)/g,`textureLod( iChannelX, vWarpedUv+n, focus )`).replace(/texture2D\(\s*fireFliesTexture\s*,\s*uv\s*\)/g,`texture2D( fireFliesTexture, vWarpedUv )`),e.fragmentShader.includes(`#include <normal_fragment_begin>`)&&(e.fragmentShader=e.fragmentShader.replace(`#include <normal_fragment_begin>`,`
            ...
            `))}function Ar(e,t={}){if(Fr(e,t,`grid`),Nr(e,`vertex`,`vPatchedUv`,`vec2`),Nr(e,`vertex`,`vWorldPos`,`vec3`),Pr(e,`vertex`,`vPatchedUv = uv;`),Pr(e,`vertex`,`vWorldPos = (modelMatrix * vec4(position, 1.0)).xyz;`),e.fragmentShader.includes(`Holographic Grid Overlay`))return;let n=`
        ${e.fragmentShader.includes(`uniform float iTime;`)?``:`uniform float iTime;`}
...
}`}}function jr(e,t={}){if(Fr(e,t,`welcome`),Nr(e,`vertex`,`vPatchedUv`,`vec2`),Pr(e,`vertex`,`vPatchedUv = uv;`),e.fragmentShader.includes(`Welcome Text Header`))return;let n=e.fragmentShader.includes(`uniform float iTime;`),r=e.fragmentShader.includes(`uniform vec2 iResolution;`),i=`
        // --- Welcome Text Header ---
...
}`}}var Mr,Nr,Pr,Fr,Ir=O((()=>{Mt(),Mr={core:{iTime:0,iResolution:new e.Vector2(1024,1024)},water:Dt,grid:{...Ot,uObjectStagger:0},dotaLogo:kt,welcome:At},Nr=(e,t,n,r=`vec2`)=>{let i=`varying ${r} ${n};`;e.vertexShader&&!e.vertexShader.includes(n+`;`)&&(e.vertexShader=e.vertexShader.replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${i}\n${e}`)),e.fragmentShader&&!e.fragmentShader.includes(n+`;`)&&(e.fragmentShader.includes(`#include <common>`)?e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>\n${i}`):e.fragmentShader=`${i}\n${e.fragmentShader}`)},Pr=(e,t,n)=>{let r=t===`vertex`?`vertexShader`:`fragmentShader`;e[r]&&!e[r].includes(n.trim())&&(e[r]=e[r].replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${e}\n    ${n}`))},Fr=(e,t,n)=>{let r=Mr[n];if(r){n!==`core`&&Fr(e,t,`core`);for(let[n,i]of Object.entries(r))e.uniforms[n]||(e.uniforms[n]=t[n]||{value:i})}}})),Lr,Rr=O((()=>{Lr=`
    uniform vec2 iResolution;
    uniform float iTime;
    uniform float uBSODState; // 0.0 = Normal, 1.0 = BSOD
...
`}));async function zr(){return new Promise(e=>requestAnimationFrame(e))}var Br=O((()=>{}));function Vr(t,n,r={}){let{transparent:i=!1,blending:a=e.AdditiveBlending,side:o=e.FrontSide,derivatives:s=!1,uniforms:c={},vs:l=Kt}=r,u=t.globalUniformsHub?t.globalUniformsHub.core:{};return new e.ShaderMaterial({vertexShader:l,fragmentShader:n,uniforms:{...u,...c},blending:a,side:o,transparent:i,extensions:{derivatives:s}})}async function Hr(t,n){n&&(n.innerText=R(`SYS_CONFIG_MATERIALS`));let r=t.globalUniformsHub,i=r?r.uniforms:{};Kr=Vr(t,Jt,{transparent:!0,uniforms:{uFireHeightOverride:i.uFireHeightOverride||{value:0},uSmoothedMouse:{value:new e.Vector2(0,0)}}}),qr=Vr(t,$t),U=Vr(t,Lr,{blending:e.NormalBlending,uniforms:{uBSODState:i.uPCBSODState||{value:0},uIsPoba:i.uIsPoba||{value:0},uHoverPos:{value:new e.Vector2(0,0)},uTargetHoverPos:{value:new e.Vector2(0,0)},uHoverActive:{value:0},uClickPos:{value:new e.Vector2(.5,.5)},uClickTime:{value:-99},uBootState:{value:0},uChannelAvatars:i.uChannelAvatars||{value:null},uHasAvatarTexture:{value:1},uSpecialPos1:{value:new e.Vector2(0,1)},uSpecialPos2:{value:new e.Vector2(2,0)}}}),Jr=Vr(t,Xt,{blending:e.NormalBlending}),Yr=Vr(t,Qt,{blending:e.NormalBlending}),Xr=Vr(t,Zt,{blending:e.NormalBlending,derivatives:!0,uniforms:{uBSODState:i.uLaptopBSODState||{value:0},uNetflixStartTime:i.uNetflixStartTime||{value:0}}}),W=Vr(t,Zt,{blending:e.NormalBlending,derivatives:!0,uniforms:{uBSODState:i.uPCBSODState||{value:0},uNetflixStartTime:i.uNetflixStartTime||{value:0}}}),Zr=Vr(t,mn,{depthWrite:!1,depthTest:!1,transparent:!0,uniforms:{uEyeActive:{value:!1},uOffsetY:{value:-.017},uEyeOpenness:{value:0},uEyeAngle:{value:-.36},uEyeScale:{value:.5},uEyeFlameOffset:{value:new e.Vector2(0,.52)},uFlameScale:{value:new e.Vector2(.5,.5)},uEyeScreenPosition:{value:new e.Vector2(.6,0)},uFireHeightOverride:i.uFireHeightOverride||{value:0},uSmoothedMouse:{value:new e.Vector2(0,0)}}}),G=Vr(t,hn,{transparent:!0,uniforms:{...t.globalUniformsHub.core,uSelectedSlot:{value:new e.Vector2(3,1)},uGlowIntensity:{value:.05},uBorderThickness:{value:.02},uCurrentSpeed:{value:5},uIconScale:{value:.75},uDarkness:{value:.74},uAspect:{value:1.77}}}),Qr=Vr(t,gn,{blending:e.NormalBlending,uniforms:{uBSODState:i.uPCBSODState||{value:0},uAspect:{value:1.77}}}),ei=[qr,Jr,Yr,Xr,G,Qr],ti=[U,W,G,Qr];let a=async n=>{let r=[{name:[`screenDisplay001_1`],envMapIntensity:10,metalness:.1,roughness:.5,envMapRotation:new e.Euler(0,.5,.5)},{name:[`verticalMonitorBody`],envMapIntensity:10,metalness:0,roughness:.15,envMapRotation:new e.Euler(0,1.97,.39),toneMapped:!1},{name:`Object_0003_3`,envMapIntensity:1,metalness:0,roughness:.32,envMapRotation:new e.Euler(0,Math.PI/2,0)},{name:`shelf`,envMapIntensity:2.65,metalness:0,roughness:1,envMapRotation:new e.Euler(1.2,.1,.2),side:e.BackSide,toneMapped:!0},{name:`mjolnir_low_mjolnir_hammer_0`,envMapIntensity:5,metalness:1,roughness:1},{name:`Object_15`,envMapIntensity:20,metalness:.15,roughness:.5},{name:`Object_15001`,envMapIntensity:2,metalness:.15,roughness:.2,envMapRotation:new e.Euler(Math.PI,-Math.PI/2,-1)},{name:`book001`,envMapIntensity:20,metalness:0,roughness:1,envMapRotation:new e.Euler(Math.PI/2,Math.PI/2,0)},{name:`blackCat`,envMapIntensity:.75,envMapRotation:new e.Euler(0,1,0),toneMapped:!1},{name:`Object_108`,envMapIntensity:1},{name:`leftWallFoot001`,envMapIntensity:.5},{name:`Object_17`,envMapIntensity:.5},{name:`Ch23_Body`,envMapIntensity:8,metalness:0,roughness:1,envMapRotation:new e.Euler(-2.17,-2.83,.73)},{name:`PokeBall__0002`},{name:`PokeBall__0002_1`},{name:`PokeBall__0002_2`},{name:`Model_0001`},{name:`pictureLion`,map:B.avatarsCelShaded,envMapIntensity:1.5,metalness:0,roughness:1},{name:`PokeBall__0003`},{name:`PokeBall__0003_1`},{name:`PokeBall__0003_2`},{name:`pillow-small-2`,envMapIntensity:.3},{name:`pillow-small-1`,envMapIntensity:.3},{name:`Sphere001_0`,toneMapped:!1},{name:`stool1`},{name:`stool2`},{name:`stool_seat`,envMapIntensity:5,envMapRotation:new e.Euler(0,-.4,.2)},{name:`Object_8001`},{name:`aegis`,envMapIntensity:5},{name:`questionCube`,envMapIntensity:5,metalness:0,roughness:0},{name:`Object_34001`,envMapIntensity:10,metalness:0,roughness:.7,side:e.BackSide},{name:`Object_32`,envMapIntensity:2.5},{name:`Object_31`,envMapIntensity:5,envMapRotation:new e.Euler(Math.PI,0,0)},{name:`Object_33`,envMapIntensity:2,envMapRotation:new e.Euler(Math.PI,0,0),roughness:0},{name:`Object_42001`,envMapIntensity:6},{name:`Object_40001`,envMapIntensity:15,roughness:0},{name:`bedMain`,envMapIntensity:.15,roughness:1,envMapRotation:new e.Euler(Math.PI,Math.PI,Math.PI)},{name:`bedStand`,envMapIntensity:.9,roughness:1},{name:`Object_0007`,toneMapped:!1,envMapIntensity:.4},{name:`Lathe_S_Blackhole_01_0`,toneMapped:!1,emissiveIntensity:.7},{name:`Circle_0`,envMapIntensity:3.5,roughness:.1},{name:`Cube_1`,envMapIntensity:1.5,roughness:.1},{name:`Circle002_0`,envMapIntensity:6,roughness:.1}],i=new Map;for(let e of r){let t=Array.isArray(e.name)?e.name:[e.name];for(let n of t)i.set(n,e)}let a=performance.now(),o=0,s=[t];for(;s.length>0;){let e=s.pop();if(e.name&&i.has(e.name)){let{name:t,...r}=i.get(e.name);e.traverse(e=>{e.isMesh&&e.material&&(e.material.envMap=n,Object.assign(e.material,r))})}if(e.children)for(let t=e.children.length-1;t>=0;t--)s.push(e.children[t]);if(o++,o%50==0&&performance.now()-a>8){await zr(),a=performance.now();let e=.2+Math.min(o/600,1)*.6;updateTaskProgress(`model-assembly`,e)}}t.isAdjusted=!0};B.environmentMap?await a(B.environmentMap):t.environment&&await a(t.environment);let o=t.getObjectByName(`Object_34001`);o&&(o.material=qr),o.material.side=e.BackSide;let s=t.getObjectByName(`screenDisplay002`);if(s){s.material=U,s.userData.originalMaterial=U;let t=s.geometry.attributes.position.count;s.geometry.setAttribute(`aLayoutMode`,new e.BufferAttribute(new Float32Array(t).fill(2),1))}let c=t.getObjectByName(`screenDisplay001`);if(c){c.material=U,c.userData.originalMaterial=U,c.onBeforeRender=()=>{if(!U.uniforms.uHoverPos||!U.uniforms.uTargetHoverPos)return;let e=U.uniforms.uTargetHoverPos.value,t=U.uniforms.uHoverPos.value,n=.12;if(t.x+=(e.x-t.x)*n,t.y+=(e.y-t.y)*n,t.distanceTo(e)<.001&&t.copy(e),U.uniforms.uIsPoba.value>.5){let e=performance.now();if(c.userData.lastShuffleTime||(c.userData.lastShuffleTime=e),e-c.userData.lastShuffleTime>5e3){c.userData.lastShuffleTime=e;let t=e=>{let t=(Math.round(e.y*3+e.x)+1)%6;e.x=t%3,e.y=Math.floor(t/3)};t(U.uniforms.uSpecialPos1.value),t(U.uniforms.uSpecialPos2.value)}}};let t=c.geometry.attributes.position.count;c.geometry.setAttribute(`aLayoutMode`,new e.BufferAttribute(new Float32Array(t).fill(0),1))}let l=t.getObjectByName(`verticalMonitorDisplay`);if(l){l.material=U,l.userData.originalMaterial=U;let t=l.geometry.attributes.position.count;l.geometry.setAttribute(`aLayoutMode`,new e.BufferAttribute(new Float32Array(t).fill(1),1))}let u=t.getObjectByName(`wallArea`);if(u){u.material=Zr,u.onBeforeRender=()=>{let e=Zr.uniforms.uMouse.value,t=Zr.uniforms.uSmoothedMouse.value,n=.06;t.x+=(e.x-t.x)*n,t.y+=(e.y-t.y)*n};let e=u.scale.x/u.scale.y;Zr.uniforms.uDragonEyeAspect={value:e}}Zr.visible=!1;let d=t.getObjectByName(`caseCoverArea`);d&&(d.material=Kr,d.onBeforeRender=()=>{let e=Kr.uniforms.uMouse.value,t=Kr.uniforms.uSmoothedMouse.value,n=.22;t.x+=(e.x-t.x)*n,t.y+=(e.y-t.y)*n});let f=t.getObjectByName(`chairBack`);f&&(f.material=G),K=Pt(`#FBC189`,1,.05),K.side=e.DoubleSide,$r=Nt(`#FBC189`,1.5,.01,6.5,e.FrontSide);let p=t.getObjectByName(`cFanBulbAura`);p&&(p.material=$r);let m=t.getObjectByName(`cFanBulb`);m&&(m.material=K)}async function Ur(t){if(!t.physicBodies||!t.globalUniformsHub)return;let n=t.globalUniformsHub.uniforms,r=I.ELECTRIC_CYAN,i=I.ACCENT_GOLD;t.cyanPulseActive||={value:0};let a={...n,uWorldGridActive:n.uWorldGridActive,uGroupGridActive:t.cyanPulseActive,uBorderColor:{value:r},uObjectStagger:{value:.5}},o={...n,uWorldGridActive:n.uWorldGridActive,uGroupGridActive:{value:0},uBorderColor:{value:i},uObjectStagger:{value:.5}},s=0,c=0,l=0,u=new Map,d=t=>{if(!t.geometry)return!1;t.geometry.boundingBox||t.geometry.computeBoundingBox();let n=new e.Vector3;return t.geometry.boundingBox.getSize(n),n.x*n.y*n.z<1e-4},f=t=>{if(t.isShaderMaterial||t.type===`ShaderMaterial`)return`shader|${t.fragmentShader.length}|${t.vertexShader.length}|${t.name||`unnamed`}`;let n=t.color?t.color.getHex():0,r=t.emissive?t.emissive.getHex():0,i=t.emissiveIntensity??0,a=t.map?t.map.uuid:`n1`,o=t.alphaMap?t.alphaMap.uuid:`n2`,s=t.normalMap?t.normalMap.uuid:`n3`,c=t.aoMap?t.aoMap.uuid:`n4`,l=t.emissiveMap?t.emissiveMap.uuid:`n5`,u=t.metalness??0,d=t.roughness??1,f=t.opacity??1,p=t.transparent?1:0,m=t.envMapIntensity??1,h=t.side??e.FrontSide,g=t.toneMapped?1:0,_=t.envMapRotation?`${t.envMapRotation.x.toFixed(2)}|${t.envMapRotation.y.toFixed(2)}|${t.envMapRotation.z.toFixed(2)}`:`0`;return`std|${t.name||`unnamed`}|${n}|${r}|${i}|${a}|${o}|${s}|${c}|${l}|${u}|${d}|${f}|${p}|${m}|${h}|${g}|${_}`},p=(e,t)=>{if(!e.material||e.material.isGridPatched)return;if(d(e)){l++;return}s++;let n=f(e.material),r=u.get(n);r||(r=new Map,u.set(n,r));let i=r.get(t);if(i){e.material=i;return}c++;let a=e.material.clone();a.uniforms=t,a.onBeforeCompile=Gr,a.isGridPatched=!0,r.set(t,a),e.material=a},m=0,h=performance.now();for(let e of t.physicBodies){let s=e.threeObject;if(!s)continue;m++,(m%5==0||performance.now()-h>2)&&(await zr(),h=performance.now());let c=s.name,l=null;c===`stool`||c===`stool_bound`?(t.stoolGridUniforms||={...n,uWorldGridActive:{value:0},uWorldGridProgress:{value:0},uGroupGridActive:n.uWorldGridActive,uGroupGridProgress:n.uWorldGridProgress,uBorderColor:{value:i},uObjectStagger:{value:0}},l=t.stoolGridUniforms):[`Object_0003`,`Object_108`,`GLTF_created_0001`,`pokeball`,`pokeball2`].includes(c)||c.includes(`pokeball`)?(t.pokeballGridUniforms||={...n,uWorldGridActive:{value:0},uGroupGridActive:n.uWorldGridActive,uWorldGridProgress:{value:0},uGroupGridProgress:n.uWorldGridProgress,uBorderColor:{value:r},uObjectStagger:{value:0}},l=t.pokeballGridUniforms):l=e.bodyType()===0?a:o,s.traverse(e=>{e.isMesh&&p(e,l)})}U&&U.uniforms.uIsPoba&&Wr(U.uniforms.uIsPoba.value>.5)}function Wr(e=!0){B.avatarsCelShaded&&(B.avatarsCelShaded.repeat.set(.5,-1),B.avatarsCelShaded.offset.set(e?0:.5,1))}var Gr,Kr,qr,U,Jr,Yr,Xr,W,Zr,G,Qr,K,$r,ei,ti,ni=O((()=>{wt(),ye(),_n(),Mt(),we(),Ir(),Rr(),Br(),Gr=function(e){this.uniforms&&Ar(e,this.uniforms)}}));function ri(){if(window._cvState===`falling`||window._cvState===`shattered`||window._cvState===`resetting`)return;if(window._cvState===`sucking`){window._cvState=`falling`;return}window._cvState=`falling`;let e=document.getElementById(`cv-container`),t=document.getElementById(`cv-content`),n=document.getElementById(`cv-scroller`);if(!e||!t)return;e.classList.contains(`collapsed`)?(e.classList.remove(`collapsed`),setTimeout(r,400)):r();function r(){if(window._cvState===`resetting`||window._cvState===`idle`)return;window._cvState=`falling`,e.style.overflow=`visible`,n&&(n.style.overflow=`visible`);let r=document.getElementById(`main-ui`);r&&(r.style.pointerEvents=`none`),t.style.position=`relative`;let i=Array.from(t.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.contact-grid div`,`.terminal-footer div`,`.collapsible-content p`,`.collapsible-content ul li`].join(`, `))),a=n.getBoundingClientRect(),o=[];i.forEach(e=>{if(e.querySelector(`svg`)||e.querySelector(`img`))return;let t=e.getBoundingClientRect(),n=t.bottom>=a.top&&t.top<=a.bottom;if(e.dataset.originalHtml||(e.dataset.originalHtml=e.innerHTML),!n){e.style.visibility=`hidden`,e.dataset.wasHiddenByViewport=`true`;return}let r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null,!1),i=[];for(;r.nextNode();)i.push(r.currentNode);i.forEach(e=>{if(e.nodeValue.trim()===``)return;let t=e.nodeValue.split(/(\s+)/),n=document.createDocumentFragment();t.forEach(e=>{if(e.trim()===``)n.appendChild(document.createTextNode(e));else{let t=document.createElement(`span`);t.textContent=e,t.style.display=`inline-block`,t.classList.add(`falling-word`),o.push(t),n.appendChild(t)}}),e.parentNode.replaceChild(n,e)})});let s=o.map(e=>{let t=window.getComputedStyle(e);return{sColor:t.color,sFontSize:t.fontSize,sFontWeight:t.fontWeight,sLetterSpacing:t.letterSpacing,sTextTransform:t.textTransform,sFontFamily:t.fontFamily,sLineHeight:t.lineHeight,sTextShadow:t.textShadow===`none`?``:t.textShadow}});o.forEach((e,t)=>{let n=s[t];e.style.color=n.sColor,e.style.fontSize=n.sFontSize,e.style.fontWeight=n.sFontWeight,e.style.letterSpacing=n.sLetterSpacing,e.style.textTransform=n.sTextTransform,e.style.fontFamily=n.sFontFamily,e.style.lineHeight=n.sLineHeight,e.style.textShadow=n.sTextShadow,e.style.whiteSpace=`nowrap`});let c=t.getBoundingClientRect(),l=Array.from(t.querySelectorAll(`.header-photo, .scanline-deco, .fui-corners, .audience-badge`)),u=[...o,...l],d=u.map(e=>e.getBoundingClientRect()),f=[];u.forEach((e,t)=>{let n=d[t];if(n.width===0||n.height===0)return;let r=n.left-c.left,i=n.top-c.top,a=e.classList.contains(`falling-word`),o=e;a||(o=e.cloneNode(!0),o.classList.add(`falling-clone`),o.style.margin=`0`),f.push({el:o,isClone:!a,x:r,y:i,startX:r,startY:i,width:n.width,height:n.height,vx:window._cvState===`ritual`?(Math.random()-.5)*5:(Math.random()-.5)*12,vy:window._cvState===`ritual`?0:Math.random()*-8-2,rx:Math.random()*30-15,ry:Math.random()*30-15,rz:Math.random()*30-15,vrx:(Math.random()-.5)*(window._cvState===`ritual`?30:6),vry:(Math.random()-.5)*(window._cvState===`ritual`?30:6),vrz:(Math.random()-.5)*(window._cvState===`ritual`?30:6)}),a||(e.style.visibility=`hidden`)}),f.forEach(e=>{t.appendChild(e.el),e.el.style.position=`absolute`,e.el.style.left=e.x+`px`,e.el.style.top=e.y+`px`,e.el.style.width=e.width+`px`,e.el.style.height=e.height+`px`,e.el.style.margin=`0`,e.el.style.transition=`none`,e.el.style.animation=`none`,e.el.style.boxSizing=`border-box`,e.el.style.userSelect=`none`,e.el.style.willChange=`transform`,e.el.style.transformOrigin=`center center`}),Array.from(t.children).forEach(e=>{f.find(t=>t.el===e)||(e.style.display=`none`)});let p=.55,m=.9,h=t.getBoundingClientRect(),g=window.innerHeight-h.top+20;function _(){if(window._cvState===`resetting`)return;let e=!0;f.forEach(t=>{if(t.settled)return;let n=window._cvGravity===void 0?.6:window._cvGravity;t.vy+=n,t.x+=t.vx,t.y+=t.vy,t.rx+=t.vrx,t.ry+=t.vry,t.rz+=t.vrz,t.y<=0&&(t.y=0,t.vy<0&&(t.vy*=-p,t.vx+=(Math.random()-.5)*4)),t.y+t.height>=g&&(t.y=g-t.height,t.vy*=-p,t.vx*=m,t.vrx*=m,t.vry*=m,t.vrz*=m,Math.abs(t.vy)<1.2&&(t.vy=0),Math.abs(t.vx)<.2&&(t.vx=0));let r=t.x-t.startX,i=t.y-t.startY;t.el.style.transform=`translate3d(${r}px, ${i}px, 0) rotateX(${t.rx}deg) rotateY(${t.ry}deg) rotateZ(${t.rz}deg)`,t.el._cvPhysics={dx:r,dy:i,rx:t.rx,ry:t.ry,rz:t.rz};let a=window._cvGravity!==void 0&&window._cvGravity<0,o=window._cvState===`ritual`;!a&&!o&&Math.abs(t.vy)<=.1&&Math.abs(t.vx)<=.1&&t.y+t.height>=g-2?t.settled=!0:e=!1}),e?(t.style.pointerEvents=`none`,window._cvState=`shattered`):requestAnimationFrame(_)}requestAnimationFrame(_)}}function ii(e=900){if(!window._cvState||window._cvState===`idle`){if(document.querySelectorAll(`.falling-word, .falling-clone`).length===0)return;window._cvState=`shattered`}if(window._cvState===`resetting`)return;window._cvState=`resetting`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`),r=document.getElementById(`cv-scroller`);if(!t||!n){window._cvState=`idle`;return}let i=document.querySelectorAll(`.falling-word, .falling-clone`);if(i.length>0&&h!==void 0){let t=0,n=i.length,r=[];i.forEach(i=>{let a=i._cvPhysics||{dx:0,dy:0,rx:0,ry:0,rz:0,scale:1};i.style.display===`none`&&(i.style.display=`inline-block`);let o=e*.4,c=e-o,l=Math.random()*o,u=new h.Tween(a).to({dx:0,dy:0,rx:0,ry:0,rz:0,scale:1},c).easing(h.Easing.Cubic.InOut).delay(l).onUpdate(()=>{let e=a.scale===void 0?1:a.scale;i.style.transform=`translate3d(${a.dx}px, ${a.dy}px, 0) rotateX(${a.rx}deg) rotateY(${a.ry}deg) rotateZ(${a.rz}deg) scale(${e})`}).onComplete(()=>{t++,t===n&&s()}).start();r.push(u)});let o=!1,s=()=>{o||(o=!0,r.forEach(e=>e.stop()),c&&cancelAnimationFrame(c),a())},c;function l(){o||(t<n?c=requestAnimationFrame(l):s())}c=requestAnimationFrame(l),setTimeout(s,e+100)}else a();function a(){t.style.overflow=``,r&&(r.style.overflow=``);let e=document.getElementById(`main-ui`);e&&(e.style.pointerEvents=``),n.style.position=``,n.style.pointerEvents=``,document.querySelectorAll(`.falling-clone, .falling-word`).forEach(e=>e.remove()),Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.contact-grid div`,`.terminal-footer div`,`.collapsible-content p`,`.collapsible-content ul li`].join(`, `))).forEach(e=>{e.dataset.originalHtml&&(e.innerHTML=e.dataset.originalHtml,delete e.dataset.originalHtml),e.dataset.wasHiddenByViewport&&(e.style.visibility=``,delete e.dataset.wasHiddenByViewport)}),Array.from(n.children).forEach(e=>{e.style.display===`none`&&(e.style.display=``)}),Array.from(n.querySelectorAll(`.header-photo, .scanline-deco, .fui-corners, .audience-badge`)).forEach(e=>{e.style.visibility===`hidden`&&(e.style.visibility=``)}),window._cvState=`idle`}}function ai(e=0){if(window._cvState&&window._cvState!==`idle`&&window._cvState!==`shattered`)return;window._cvState=`sucking`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`),r=document.getElementById(`cv-scroller`);if(!t||!n)return;t.classList.contains(`collapsed`)?(t.classList.remove(`collapsed`),setTimeout(i,400)):i();function i(){if(window._cvState===`resetting`||window._cvState===`idle`)return;t.style.overflow=`visible`,r&&(r.style.overflow=`visible`);let i=document.getElementById(`main-ui`);i&&(i.style.pointerEvents=`none`),n.style.position=`relative`;let a=Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.contact-grid div`,`.terminal-footer div`,`.collapsible-content p`,`.collapsible-content ul li`].join(`, `))),o=[];a.forEach(e=>{if(e.querySelector(`svg`)||e.querySelector(`img`))return;e.dataset.originalHtml||(e.dataset.originalHtml=e.innerHTML);let t=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null,!1),n=[];for(;t.nextNode();)n.push(t.currentNode);n.forEach(e=>{if(e.nodeValue.trim()===``)return;let t=e.nodeValue.split(/(\s+)/),n=document.createDocumentFragment();t.forEach(e=>{if(e.trim()===``)n.appendChild(document.createTextNode(e));else{let t=document.createElement(`span`);t.textContent=e,t.style.display=`inline-block`,t.classList.add(`falling-word`),o.push(t),n.appendChild(t)}}),e.parentNode.replaceChild(n,e)})});let s=o.map(e=>{let t=window.getComputedStyle(e);return{sColor:t.color,sFontSize:t.fontSize,sFontWeight:t.fontWeight,sLetterSpacing:t.letterSpacing,sTextTransform:t.textTransform,sFontFamily:t.fontFamily,sLineHeight:t.lineHeight,sTextShadow:t.textShadow===`none`?``:t.textShadow}});o.forEach((e,t)=>{let n=s[t];e.style.color=n.sColor,e.style.fontSize=n.sFontSize,e.style.fontWeight=n.sFontWeight,e.style.letterSpacing=n.sLetterSpacing,e.style.textTransform=n.sTextTransform,e.style.fontFamily=n.sFontFamily,e.style.lineHeight=n.sLineHeight,e.style.textShadow=n.sTextShadow,e.style.whiteSpace=`nowrap`});let c=n.getBoundingClientRect(),l=(e+1)/2*window.innerHeight-c.top,u=Array.from(n.querySelectorAll(`.header-photo, .scanline-deco, .fui-corners, .audience-badge`)),d=[...o,...u],f=d.map(e=>e.getBoundingClientRect()),p=[];d.forEach((e,t)=>{let n=f[t];if(n.width===0||n.height===0)return;let r=n.left-c.left,i=n.top-c.top,a=e.classList.contains(`falling-word`),o=e;a||(o=e.cloneNode(!0),o.classList.add(`falling-clone`),o.style.margin=`0`),p.push({el:o,isClone:!a,x:r,y:i,startX:r,startY:i,width:n.width,height:n.height,vx:(Math.random()-.5)*6,vy:(Math.random()-.5)*6,rx:Math.random()*30-15,ry:Math.random()*30-15,rz:Math.random()*30-15,vrx:(Math.random()-.5)*15,vry:(Math.random()-.5)*15,vrz:(Math.random()-.5)*15,scale:1}),a||(e.style.visibility=`hidden`)}),p.forEach(e=>{n.appendChild(e.el),e.el.style.position=`absolute`,e.el.style.left=e.x+`px`,e.el.style.top=e.y+`px`,e.el.style.width=e.width+`px`,e.el.style.height=e.height+`px`,e.el.style.margin=`0`,e.el.style.transition=`none`,e.el.style.animation=`none`,e.el.style.boxSizing=`border-box`,e.el.style.userSelect=`none`,e.el.style.willChange=`transform`,e.el.style.transformOrigin=`center center`}),Array.from(n.children).forEach(e=>{p.find(t=>t.el===e)||(e.style.display=`none`)});let m=.6,h=.55,g=.9;function _(){if(window._cvState===`resetting`)return;let e=!0;p.forEach(t=>{if(t.settled)return;if(window._cvState===`falling`){let n=window.innerHeight-c.top+20;t.vy+=.6,t.x+=t.vx,t.y+=t.vy,t.rx+=t.vrx,t.ry+=t.vry,t.rz+=t.vrz,t.y+t.height>=n&&(t.y=n-t.height,t.vy*=-h,t.vx*=g,t.vrx*=g,t.vry*=g,t.vrz*=g,Math.abs(t.vy)<1.2&&(t.vy=0),Math.abs(t.vx)<.2&&(t.vx=0)),Math.abs(t.vy)<=.1&&Math.abs(t.vx)<=.1&&t.y+t.height>=n-2?t.settled=!0:e=!1}else{let n=0-(t.x+t.width/2),r=l-(t.y+t.height/2),i=Math.sqrt(n*n+r*r)||1;t.vx+=n/i*m,t.vy+=r/i*m,t.x+=t.vx,t.y+=t.vy,t.rx+=t.vrx,t.ry+=t.vry,t.rz+=t.vrz,t.x<=0&&(t.x=0,t.vx*=-h,t.vy*=g,t.vrx*=g,t.vry*=g,t.vrz*=g,Math.abs(t.vx)<1.2&&(t.vx=0),Math.abs(t.vy)<.2&&(t.vy=0)),Math.abs(t.vx)<=.1&&Math.abs(t.vy)<=.1&&t.x<=2?t.settled=!0:e=!1}let n=t.x-t.startX,r=t.y-t.startY;t.el.style.transform=`translate3d(${n}px, ${r}px, 0) rotateX(${t.rx}deg) rotateY(${t.ry}deg) rotateZ(${t.rz}deg)`,t.el._cvPhysics={dx:n,dy:r,rx:t.rx,ry:t.ry,rz:t.rz}}),e?(n.style.pointerEvents=`none`,window._cvState=`shattered`):requestAnimationFrame(_)}requestAnimationFrame(_)}}function oi(e=1e3){if(window._cvState&&window._cvState!==`idle`&&window._cvState!==`shattered`)return;window._cvState=`shaking`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`);if(!t||!n||t.classList.contains(`collapsed`)){window._cvState=`idle`;return}let r=Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.fui-corners div`,`.scanline-deco`,`.header-photo`].join(`, `)));if(r.length===0||h===void 0){window._cvState=`idle`;return}let i=0,a=r.length,o=[];r.forEach((t,n)=>{let r=window.getComputedStyle(t).display;r===`inline`&&(t.style.display=`inline-block`);let s=e*.35,l=Math.random()*s,u=e-l,d=new h.Tween({t:0}).to({t:1},u).easing(h.Easing.Quadratic.Out).delay(l).onUpdate(e=>{let r=1-e.t;if(r<=.02){t.style.transform=`translate3d(0, 0, 0) rotateZ(0deg)`;return}n*12.5;let i=(Math.random()-.5)*8*r,a=(Math.random()-.5)*6*r,o=(Math.random()-.5)*3*r;t.style.transform=`translate3d(${i}px, ${a}px, 0) rotateZ(${o}deg)`}).onComplete(()=>{t.style.transform=``,r===`inline`&&(t.style.display=``),i++,i===a&&c()}).start();o.push(d)});let s=!1,c=()=>{s||(s=!0,o.forEach(e=>e.stop()),l&&cancelAnimationFrame(l),r.forEach(e=>{e.style.transform=``}),window._cvState===`shaking`&&(window._cvState=`idle`))},l;function u(){if(window._cvState!==`shaking`){c();return}i<a?l=requestAnimationFrame(u):c()}l=requestAnimationFrame(u),setTimeout(c,e+100)}function si(e=1e3){if(window._cvState&&window._cvState!==`idle`)return;window._cvState=`jumping`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`);if(!t||!n||t.classList.contains(`collapsed`)){window._cvState=`idle`;return}let r=Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.fui-corners div`,`.scanline-deco`,`.header-photo`].join(`, `)));if(r.length===0||h===void 0){window._cvState=`idle`;return}let i=0,a=r.length,o=[];r.forEach(t=>{let n=window.getComputedStyle(t).display;n===`inline`&&(t.style.display=`inline-block`);let r=e*.4,s=Math.random()*r,l=e-s,u=new h.Tween({t:0}).to({t:1},l).easing(h.Easing.Linear.None).delay(s).onUpdate(e=>{let n=Math.sin(e.t*Math.PI)*-45;t.style.transform=`translate3d(0, ${n}px, 0)`}).onComplete(()=>{t.style.transform=``,n===`inline`&&(t.style.display=``),i++,i===a&&c()}).start();o.push(u)});let s=!1,c=()=>{s||(s=!0,o.forEach(e=>e.stop()),l&&cancelAnimationFrame(l),r.forEach(e=>{e.style.transform=``}),window._cvState===`jumping`&&(window._cvState=`idle`))},l;function u(){if(window._cvState!==`jumping`){c();return}i<a?l=requestAnimationFrame(u):c()}l=requestAnimationFrame(u),setTimeout(c,e+100)}var ci=O((()=>{window.cvFall=ri,window.cvReset=ii,window.cvSuck=ai,window.cvShake=oi,window.cvJump=si}));function li(e,t=3e3,n=null){let r=e.globalUniformsHub,i=e.constantUniform,a=[];n===`pc`?r&&r.uniforms.uPCBSODState?a.push(r.uniforms.uPCBSODState):i&&i.uPCBSODState&&a.push(i.uPCBSODState):n===`laptop`?r&&r.uniforms.uLaptopBSODState?a.push(r.uniforms.uLaptopBSODState):i&&i.uLaptopBSODState&&a.push(i.uLaptopBSODState):(r&&(r.uniforms.uBSODState&&a.push(r.uniforms.uBSODState),r.uniforms.uPCBSODState&&a.push(r.uniforms.uPCBSODState),r.uniforms.uLaptopBSODState&&a.push(r.uniforms.uLaptopBSODState)),i&&(i.uBSODState&&a.push(i.uBSODState),i.uPCBSODState&&a.push(i.uPCBSODState),i.uLaptopBSODState&&a.push(i.uLaptopBSODState))),a.length!==0&&(e._bsodTimeout&&clearTimeout(e._bsodTimeout),a.forEach(e=>e.value=1),e._bsodTimeout=setTimeout(()=>{a.forEach(e=>e.value=0),e._bsodTimeout=null},t))}function ui(e,t=3e3){!U||!U.uniforms.uBootState||(e._bootingTimeout&&clearTimeout(e._bootingTimeout),U.uniforms.uBootState.value=0,e._bootingTimeout=setTimeout(()=>{U.uniforms.uBootState.value=1,e._bootingTimeout=null},t))}function di(t){if(!t.physicBodies||t.physicBodies.length===0){setTimeout(()=>di(t),1e3);return}if(t.world?.hasPointGravityOnBH||window._cvState===`sucking`){setTimeout(()=>di(t),1e3);return}let n=0;t.physicBodies.forEach(t=>{if(!t.isIntegrityCheckTarget&&!t.isIntegrityResetTarget)return;let r,i;if(t.threeObject&&t.threeObject.userData&&t.threeObject.userData.originalPos){let n=t.threeObject.userData.originalPos,a=t.threeObject.userData.originalRot;if(r=new e.Vector3(n.x,n.y,n.z),a&&a.isEuler)i=new e.Quaternion().setFromEuler(a);else if(t.threeObject.userData.originalQuaternion){let n=t.threeObject.userData.originalQuaternion;i=new e.Quaternion(n.x,n.y,n.z,n.w)}else{let n=t.rotation();i=new e.Quaternion(n.x,n.y,n.z,n.w)}}else{let n=t.translation(),a=t.rotation();r=new e.Vector3(n.x,n.y,n.z),i=new e.Quaternion(a.x,a.y,a.z,a.w)}t.integrity={position:r,quaternion:i},n++}),t.allowsResetting=!0,t.integrityBaselineCaptured=!0}function fi(t,n,r,i=0){if(n.isResetting)return;if(t.world&&t.world.isBusy){setTimeout(()=>fi(t,n,r,i),16);return}if(n.isResetting=!0,!n.integrity){n.isResetting=!1;return}try{n.rapierCollider&&n.rapierCollider.setSensor(!0)}catch{n.isResetting=!1;return}let a=n.integrity.position.clone(),o=n.integrity.quaternion,s;try{s=n.bodyType()}catch{n.isResetting=!1;return}t._activeResetCount=(t._activeResetCount||0)+1,bi(t,!0);let c=n.mass(),l=(Math.random()*8+2)*c;n.applyImpulse({x:0,y:i+l,z:0},!0);let u=(i+2)*c*.2;n.applyTorqueImpulse({x:(Math.random()-.5)*u,y:(Math.random()-.5)*u,z:(Math.random()-.5)*u},!0),n.wakeUp(),wr(n,()=>{let i=`integrity-beam-${n.handle}`,c=n.threeObject&&n.threeObject.userData.isDragonBall?16763904:I.ELECTRIC_CYAN||65535,l=null;if(Bo){let r=n.translation();Bo(t,``,``,new e.Vector3(r.x,r.y,r.z),i,!0,c,!0,1/0,!0),l=t.getObjectByName(i)}let u=t.getObjectByName(`mixamorigSpine1`)||t.getObjectByName(`a-char`),d=u?new e.Vector3().setFromMatrixPosition(u.matrixWorld):null;Tr(n,a,o,r,s,()=>{l&&(l.visible=!1,l.activeRequestID&&cancelAnimationFrame(l.activeRequestID)),n.isResetting=!1,t._activeResetCount--,bi(t,!1)},(n,r)=>{if(l&&l.visible){let r=X(t,`drone`);if(r){let t=r.getObjectByName(`Sphere001_0`);if(t){let r=new e.Vector3;t.getWorldPosition(r);let i=r.distanceTo(n);l.position.copy(r),l.lookAt(n),l.children.forEach(e=>{e.scale.z=i})}}}},d)})}function pi(t){if(t.allowsIntegrityCheck=!0,!t.allowsIntegrityCheck)return;let n,r=()=>{clearTimeout(n),n=setTimeout(i,_i)},i=()=>{if(!t.scenarioState||t.scenarioState.name!==`room`){r();return}if(!t.integrityBaselineCaptured){r();return}if(t.world?.hasPointGravityOnBH||t.isHeroAnimating){r();return}if(t.allowsResetting===!1){r();return}let n=[];t.physicBodies.forEach(r=>{if(!r.isIntegrityCheckTarget||!r.integrity||t.isHeroAnimating||r.isResetting||r.isManualControl)return;let i=r.threeObject;i&&i.name;let a=r.translation(),o=r.rotation(),s=new e.Vector3(a.x,a.y,a.z),c=new e.Quaternion(o.x,o.y,o.z,o.w),l=r.integrity.position,u=s.distanceTo(l),d=!1;if(u>vi)d=!0;else{let e=r.integrity.quaternion;c.angleTo(e)>yi&&(d=!0)}d&&n.push(r)});let i=!1,a=``;if(U.uniforms.uBootState&&U.uniforms.uBootState.value<.5&&(i=!0,a=R(`SYS_STORY_INTEGRITY_BOOTING`)),t.objectMap&&[{obj:t.objectMap.get(`screenDisplay001`),name:`Main Screen`},{obj:t.objectMap.get(`verticalMonitorDisplay`),name:`Vertical Screen`}].forEach(e=>{e.obj&&e.obj.material!==U&&(i=!0,a=e.obj.material===W?R(`SYS_STORY_INTEGRITY_NETFLIX`):e.obj.material===G||e.obj.material===Qr?R(`SYS_STORY_INTEGRITY_DOTA`):R(`SYS_STORY_INTEGRITY_WORK_FOCUS`))}),n.length>0||i){if(t.allowsResetting=!1,t.isHeroAnimating=!0,n.length>0&&n.map(e=>e.threeObject?e.threeObject.name:`Unknown Body`),i&&n.length===0?Z(a):n.length<3?Z(R(`SYS_STORY_INTEGRITY_MESS_LIGHT`)):Z(R(`SYS_STORY_INTEGRITY_MESS_HEAVY`)),t.conversationManager)if(i){if(t.objectMap){let e=t.objectMap.get(`screenDisplay001`);e&&e.material===W?t.conversationManager.shout(L.SHOUT_RESET_NETFLIX.en):e&&(e.material===G||e.material===Qr)?t.conversationManager.shout(L.SHOUT_RESET_DOTA.en):t.conversationManager.shout(L.SHOUT_RESET_GENERIC.en)}}else n.length>0&&t.conversationManager.shout(L.SHOUT_RESET_MESS.en);let o=i?Math.max(n.length,2):n.length,s=Math.min(1+(o-1)*.5,4),c=Math.min(800+o*200,2e3),l=o/1.25,u=Math.max(l*l,2)*2.5,d=Sr(t,`bangingFist`,{speed:s,randomize:!1,onComplete:()=>{}}),f=d.duration*1e3;if(setTimeout(()=>{t.allowsResetting=!0,t.isHeroAnimating=!1,r()},f+100),d&&d.duration){let n=d.duration*1e3*.4;setTimeout(()=>{hi(t),gi(t,u*.2),ii(c),typeof window.cvJump==`function`&&window.cvJump(200),t.objectMap&&([`screenDisplay001`,`screenDisplay002`,`verticalMonitorDisplay`].forEach(e=>{let n=t.objectMap.get(e);n&&(n.material=U,n.userData.originalMaterial=U)}),U.uniforms.uBootState&&(U.uniforms.uBootState.value=1)),Z(R(`SYS_STORY_INTEGRITY_RESTORING`));let n=performance.now()+c+200;if(t.physicBodies.forEach(e=>{try{e.isIntegrityResetTarget&&e.integrity&&e.handle!==void 0&&fi(t,e,n,u)}catch{}}),Oi(t),Ri&&Ri.length>0){let r=[`Object_12001`,`Object_108`],i=r[Math.floor(Math.random()*r.length)],a=t.getObjectByName(i);if(a){let r=new e.Vector3;a.getWorldPosition(r);let i=1.265+Math.random()*.46;Ri.forEach((a,o)=>{if(!a.visible)return;let s=o/Ri.length*Math.PI*2,c=r.x+Math.cos(s)*i,l=r.y+.05,d=r.z+Math.sin(s)*i,f=a.rapierBody;if(f){f.rapierCollider&&f.rapierCollider.setSensor(!0);let r=f.mass(),i=Math.random()*u*r;f.applyImpulse({x:0,y:u+i,z:0},!0);let a=u*r*.5;f.applyTorqueImpulse({x:(Math.random()-.5)*a,y:(Math.random()-.5)*a,z:(Math.random()-.5)*a},!0),f.wakeUp(),wr(f,()=>{let r=new e.Vector3(c,l,d),i=new e.Quaternion().setFromEuler(new e.Euler(0,Math.random()*Math.PI,0)),a=`coin-integrity-beam-${f.handle}`,o=I.ELECTRIC_CYAN||65535;t._activeResetCount=(t._activeResetCount||0)+1,bi(t,!0);let s=null;if(Bo){let n=f.translation();Bo(t,``,``,new e.Vector3(n.x,n.y,n.z),a,!0,o,!0,1/0,!0),s=t.getObjectByName(a)}let u=t.getObjectByName(`mixamorigSpine1`)||t.getObjectByName(`a-char`),p=u?new e.Vector3().setFromMatrixPosition(u.matrixWorld):null;Tr(f,r,i,n,_.RigidBodyType.Dynamic,()=>{s&&(s.visible=!1,s.activeRequestID&&cancelAnimationFrame(s.activeRequestID)),t._activeResetCount--,bi(t,!1)},(n,r)=>{if(s&&s.visible){let r=X(t,`drone`);if(r){let t=r.getObjectByName(`Sphere001_0`);if(t){let r=new e.Vector3;t.getWorldPosition(r);let i=r.distanceTo(n);s.position.copy(r),s.lookAt(n),s.children.forEach(e=>{e.scale.z=i})}}}},p)})}})}}},n)}}else r()};window.addEventListener(`pointerdown`,()=>{r()}),r()}function mi(e){e.allowsIntegrityCheck=!1}function hi(t){let n=new e.Group,r=new e.Color(`#ffc783`),i=I.ACCENT_GOLD||new e.Color(`#ffcc00`);new e.Color(`#ffffff`),n.position.set(-1.95,2.64,-1.35),t.add(n);let a=new e.TorusGeometry(1,.04,16,100),o=Nt(r,1.5,.01,4),s=new e.Mesh(a,o);s.rotation.x=Math.PI/2;let c=Nt(i,1.2,.01,4.5),l=new e.Mesh(a,c);l.rotation.x=Math.PI/2,l.rotation.z=.2,n.add(s,l);let u=new e.IcosahedronGeometry(.1,0),d=[];for(let t=0;t<24;t++){let a=t%2==0?r:i,o=Pt(a,1.5,4),s=new e.Mesh(u,o),c=Nt(a,1.5,.01,4.5),l=new e.Mesh(u,c);l.scale.setScalar(1.4),s.add(l);let f=Math.random()*Math.PI*2,p=Math.random()*Math.PI*.6,m=.05+Math.random()*.15;s.userData.velocity=new e.Vector3(Math.sin(p)*Math.cos(f)*m,Math.cos(p)*m,Math.sin(p)*Math.sin(f)*m),s.userData.rotationSpeed=new e.Vector3(Math.random()*.15,Math.random()*.15,Math.random()*.15),n.add(s),d.push(s)}let f=new e.SphereGeometry(.2,8,8),p=Pt(r,1,5),m=new e.Mesh(f,p);n.add(m),new h.Tween({progress:0}).to({progress:1},3500).easing(h.Easing.Exponential.Out).onUpdate(e=>{let t=e.progress;d.forEach(e=>{e.position.add(e.userData.velocity),e.userData.velocity.multiplyScalar(.98),e.rotation.x+=e.userData.rotationSpeed.x,e.rotation.y+=e.userData.rotationSpeed.y,e.rotation.z+=e.userData.rotationSpeed.z;let n=1-t;e.scale.setScalar(n),e.material.uniforms&&(e.material.uniforms.glowIntensity.value=4*n);let r=e.children[0];r&&r.material.uniforms&&(r.material.uniforms.outerGlowStrength.value=1.5*n)}),s.scale.setScalar(.1+t*15),s.material.uniforms.outerGlowStrength.value=1.5*(1-t),l.scale.setScalar(.05+t*10),l.material.uniforms.outerGlowStrength.value=1.2*(1-t),m.scale.setScalar(2*(1-t*1.5)),m.material.uniforms&&(m.material.uniforms.glowIntensity.value=5*(1-t*2))}).onComplete(()=>{t.remove(n),a.dispose(),u.dispose(),f.dispose(),d.forEach(e=>{e.material.dispose(),e.children[0]&&e.children[0].material.dispose()}),o.dispose(),c.dispose(),p.dispose()}).start()}function gi(t,n=.15,r=600){let i=t.camera;i&&(i._shakeOffset||=new e.Vector3,new h.Tween({t:0}).to({t:1},r).easing(h.Easing.Quadratic.Out).onUpdate(e=>{let t=n*(1-e.t);i.position.sub(i._shakeOffset),i._shakeOffset.set((Math.random()-.5)*t,(Math.random()-.5)*t,(Math.random()-.5)*t),i.position.add(i._shakeOffset)}).onComplete(()=>{i.position.sub(i._shakeOffset),i._shakeOffset.set(0,0,0)}).start())}var _i,vi,yi,bi,xi=O((()=>{Cr(),Cs(),we(),rs(),ni(),Ji(),Se(),ci(),_n(),ye(),Or(),_i=3e3,vi=2,yi=.25,bi=(e,t=!1)=>{if(e._activeResetCount===void 0&&(e._activeResetCount=0),e.globalUniformsHub&&e.cyanPulseActive){let n=e.globalUniformsHub.uniforms,r=e.cyanPulseActive;t?(r.value=1,n.uWorldGridProgress.value=1):e._activeResetCount<=0&&new h.Tween(n.uWorldGridProgress).to({value:0},150).onComplete(()=>{r.value=0}).start()}}}));function Si(t){if(!t)return new e.Vector3(0,0,0);if(t.skeleton&&t.skeleton.bones.length>0){let n=t.skeleton.bones[0],r=new e.Vector3;return n.getWorldPosition(r),r}t.updateMatrixWorld(!0);let n=new e.Vector3;return t.getWorldPosition(n),n}function Ci(t,n){let r=t.getObjectByName(`Lathe_Center`),i=new e.Vector3;r?r.getWorldPosition(i):i.set(-8.5,7.25,-.39);let a=t.getObjectByName(`a-char`),o=new e.Vector3;a?a.getWorldPosition(o):o.set(0,1,0),o.y+=.8,Z(`Dragon Balls drawn to the singularity...`),t.fanAction&&new h.Tween(t.fanAction).to({timeScale:12},1500).easing(h.Easing.Quadratic.In).start(),Ti(t,i,()=>{Ei(t,r),setTimeout(()=>{if(t._spawnStopSignal)return;let n=o.clone();n.y+=6+Math.random()*2.5,n.x+=(Math.random()-.5)*1.5,n.z+=(Math.random()-.5)*1.5;let r=ki(t,i.clone(),null);if(r&&r.rapierBody){let a=r.rapierBody;a.setBodyType(_.RigidBodyType.KinematicPositionBased);let o=i.clone(),s=o.clone(),c=new e.Vector3().subVectors(n,i);n.addVectors(i,c.multiplyScalar(1.5));let l=null;new h.Tween(s).to({x:n.x,y:n.y,z:n.z},1400).easing(h.Easing.Cubic.Out).onStart(()=>{let e=`coin-erupt-beam`;Bo&&(Bo(t,``,``,i.clone(),e,!1,16766720,!0,1/0,!0),l=t.getObjectByName(e))}).onUpdate(()=>{a.setNextKinematicTranslation(s);let i=s.distanceTo(o),c=n.distanceTo(o),u=c>0?i/c:0,d=1+Math.sin(u*Math.PI)*.4;r.scale.setScalar(.5*d);let f=X(t,`drone`);if(l&&l.visible&&f){let n=f.getObjectByName(`Sphere001_0`);if(n){let i=new e.Vector3;n.getWorldPosition(i);let a=i.distanceTo(s);l.position.copy(i),l.lookAt(s),l.children.forEach(e=>{e.scale.z=a}),t.gazeFollower&&t.gazeFollower.lookAtTarget(r)}}}).onComplete(()=>{r.scale.setScalar(.5);let e=t.getObjectByName(`coin-erupt-beam`);e&&(e.visible=!1,e.activeRequestID&&cancelAnimationFrame(e.activeRequestID)),a.setBodyType(_.RigidBodyType.Dynamic),a.wakeUp(),a.applyImpulse({x:(Math.random()-.5)*6,y:18+Math.random()*12,z:(Math.random()-.5)*6},!0)}).start()}},250),setTimeout(()=>{t._spawnStopSignal||Di(t,i)},500)})}function wi(e,t,n){if(!(!e.rapierBody||!t.world))try{let r=e.rapierBody.collider(0),i=t.world.getCollider(r);i&&(i.setCollisionGroups(n),i.setSolverGroups(n))}catch{}}function Ti(t,n,r){or(t,!1),setTimeout(()=>{let i=(t.dragonBalls||[]).filter(e=>e);if(i.length===0){r&&r();return}let a=i.length;i.forEach((o,s)=>{o.ritualStartScale=o.scale.clone(),o.position.clone(),o.rapierBody&&o.rapierBody.setBodyType(_.RigidBodyType.KinematicPositionBased),wi(o,t,Ki);let c=s*60;setTimeout(()=>{let t=o.position.clone(),c=new e.Vector3().subVectors(n,t).normalize(),l=s/Math.max(i.length,1)*Math.PI*2,u={t:0};new h.Tween(u).to({t:1},1e3).easing(h.Easing.Cubic.In).onUpdate(()=>{let r=u.t,i=new e.Vector3().lerpVectors(t,n,r);i.y+=Math.sin(r*Math.PI)*5;let a=r*Math.PI*3+l,s=r*(1-r)*4*2,d=new e.Vector3(-c.z,0,c.x).normalize();i.addScaledVector(d,Math.cos(a)*s),i.y+=Math.sin(a)*s*.5,o.rapierBody&&o.rapierBody.setNextKinematicTranslation(i);let f=1-r*.9;o.ritualStartScale&&o.scale.copy(o.ritualStartScale).multiplyScalar(f)}).onComplete(()=>{o.visible=!1,a--,a===0&&r&&r()}).start()},c)})},150)}function Ei(e,t){if(!t)return;let n=e.globalUniformsHub;if(n&&n.uNebulaRotationSpeed&&n.uNebulaSwirlSpeed){let e=.3,t=.25;new h.Tween({rot:e,swirl:t}).to({rot:3,swirl:25},600).easing(h.Easing.Exponential.Out).onUpdate(e=>{n.uNebulaRotationSpeed.value=e.rot,n.uNebulaSwirlSpeed.value=e.swirl}).onComplete(()=>{new h.Tween({rot:3,swirl:25}).to({rot:e,swirl:t},1500).easing(h.Easing.Quadratic.InOut).onUpdate(e=>{n.uNebulaRotationSpeed.value=e.rot,n.uNebulaSwirlSpeed.value=e.swirl}).start()}).start()}e.fanAction&&new h.Tween(e.fanAction).to({timeScale:1},2500).easing(h.Easing.Cubic.Out).start(),e.raycasterWrapper&&wn(e)}function Di(e,t){let n=e.dragonBalls||[];n.forEach((r,i)=>{if(r&&(r.rapierBody&&(r.rapierBody.setTranslation({x:t.x,y:t.y,z:t.z},!0),r.rapierBody.setLinvel({x:0,y:0,z:0},!0),r.rapierBody.setAngvel({x:0,y:0,z:0},!0)),r.visible=!0,r.ritualStartScale&&r.scale.copy(r.ritualStartScale),wi(r,e,qi),r.rapierBody)){r.rapierBody.setBodyType(_.RigidBodyType.Dynamic),r.rapierBody.wakeUp();let e=i/Math.max(n.length,1)*Math.PI*2+Math.random()*.4,t=20+Math.random()*15,a=10+Math.random()*8;r.rapierBody.applyImpulse({x:Math.cos(e)*t,y:a,z:Math.sin(e)*t},!0),r.rapierBody.applyTorqueImpulse({x:(Math.random()-.5)*4,y:(Math.random()-.5)*4,z:(Math.random()-.5)*4},!0)}})}function Oi(t,n=null,r=null){if(t.world&&t.world.isBusy){setTimeout(()=>Oi(t,n,r),16);return}let i=t.world.hasPointGravityOnBalls;t._dragonBallRestoreTimeout&&=(clearTimeout(t._dragonBallRestoreTimeout),null),or(t,!1);let a=t.dragonBalls||[];if(a.length===0){r&&r();return}let o=new e.Vector3(0,.8,0);if(n)o.copy(n);else{let e=Si(t.getObjectByName(`Object_108`));o.copy(e),o.y+=.25}let s=1.035,c=performance.now()+1200+200,l=a.length;a.forEach((n,u)=>{if(!n||!n.rapierBody)return;let d=n.rapierBody;d.rapierCollider&&d.rapierCollider.setSensor(!0);let f=u/a.length*Math.PI*2,p=o.x+Math.cos(f)*s,m=o.y,h=o.z+Math.sin(f)*s,g=d.mass(),v=Math.random()*5*g;d.applyImpulse({x:0,y:5+v,z:0},!0);let y=5*g*.5;d.applyTorqueImpulse({x:(Math.random()-.5)*y,y:(Math.random()-.5)*y,z:(Math.random()-.5)*y},!0),d.wakeUp(),wr(d,()=>{let n=new e.Vector3(p,m,h),a=new e.Quaternion,s=`dragon-beam-${u}`,f=null;if(Bo){let n=d.translation();Bo(t,``,``,new e.Vector3(n.x,n.y,n.z),s,!0,16747520,!0,1/0,!0),f=t.getObjectByName(s)}t._activeResetCount=(t._activeResetCount||0)+1,bi&&bi(t,!0),Tr(d,n,a,c,_.RigidBodyType.Dynamic,()=>{f&&(f.visible=!1,f.activeRequestID&&cancelAnimationFrame(f.activeRequestID)),t._activeResetCount--,bi&&bi(t,!1),l--,l===0&&(r&&r(),t.gazeFollower&&(t.gazeFollower.isLocked=!1,zo(t,t.camera,!1)),i&&(t._dragonBallRestoreTimeout=setTimeout(()=>{t.world&&t.world.ballBodies&&or(t,!0),t._dragonBallRestoreTimeout=null},3e3)))},(n,r)=>{let i=t.getObjectByName(`drone`);if(f&&f.visible&&i){let r=i.getObjectByName(`Sphere001_0`);if(r){let i=new e.Vector3;r.getWorldPosition(i);let a=i.distanceTo(n);f.position.copy(i),f.lookAt(n),f.children.forEach(e=>{e.scale.z=a}),u===0&&zo(t,o,!0)}}})})})}function ki(e,t,n,r=!1,i=null){let a=e.getObjectByName(`btc_symbol`),o=e.getObjectByName(`eth_symbol`);if(!a){console.warn(`btc_symbol not found in scene`);return}let s=.5;Pi||(Pi=pn.clone(),Fi=fn.clone());let c=`BTC`,l=a;i?(c=i===`ETH`?`ETH`:`BTC`,l=c===`ETH`?o:a):o&&Math.random()>.5&&(c=`ETH`,l=o);let u=null,d=!1,f=null;if(Ri.length>=Ui){let t=Ri.shift();t&&(f=t.userData.coinType,Ai(e,t))}if(Ri.length+Vi.length>=Hi){let t=Vi.shift();!t&&Ri.length>0&&(t=Ri.shift()),t&&(ji(e,t),t.userData.coinType===`ETH`?Bi.push(t):zi.push(t))}let p=c===`ETH`?Bi:zi;if(p.length>0)u=p.shift(),d=!0,u.visible=!0,So(e,u);else{u=l.clone(),u.scale.setScalar(s),u.name=`${c}_${performance.now()} `,u.userData.coinType=c,u.material=Pi,So(e,u);let t=u.clone();t.name=`Aura`,t.material=Fi,t.position.set(0,0,0),t.rotation.set(0,0,0),t.scale.setScalar(1.25),u.add(t),e.add(u)}Ri.push(u),t&&u.position.copy(t),u.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);let m=l.scale.clone(),g=m.clone();if(e.world){let r=d&&u.rapierBody?u.rapierBody:null;if(r)r.wakeUp(),r.setTranslation({x:t.x,y:t.y,z:t.z},!0),r.setLinvel({x:0,y:0,z:0},!0),r.setAngvel({x:0,y:0,z:0},!0);else{let{body:t,shape:n}=Oe(e,u,{bodyType:`dynamic`,mass:1,restitution:.2,friction:.8,canSleep:!0,isConvexHull:!0,isBhTarget:!0,linearDamping:.8,angularDamping:.8});Ee(e,u,t,n)}let i=u.rapierBody;i&&(n&&i.applyImpulse({x:n.x,y:n.y,z:n.z},!0),i.applyTorqueImpulse({x:Math.random(),y:Math.random(),z:Math.random()},!0),e.bhTargets&&!e.bhTargets.includes(u)&&e.bhTargets.push(u))}if(d||yn(e,u,{onMouseEnter:t=>{let n=Ii[c.toLowerCase()],r=`Push ${c}`;if(n){let e=n.toLocaleString(`en-US`,{style:`currency`,currency:`USD`,minimumFractionDigits:n<1?4:0,maximumFractionDigits:n<1?4:0}),t=new Date,i=t.toLocaleString(`en-US`,{month:`short`}),a=t.getDate(),o=t.getFullYear(),s=t.toLocaleTimeString(`en-US`,{hour:`2-digit`,minute:`2-digit`,hour12:!1});r=`${c}: ${e} \nat ${i}${a} ${o}, ${s}`}Wi(e,c===`ETH`?Yn:Xn,r),bn(e,t)},onMouseLeave:t=>{Gi(e)},onMouseDown:(t,n)=>{Cn(e,t,n,5)}}),!r&&e.fireflies&&e.fireflies.triggerFlash&&Li!==c&&(e.fireflies.triggerFlash(c),Li=c),Ri.length%5,!r){let e=c===`BTC`?`Bitcoin`:`Ethereum`;Z(f?`Received 1 ${e}, lost 1 ${f===`BTC`?`Bitcoin`:`Ethereum`}. Even you can't hold that much power!`:`The Cosmos has manifested 1 ${e} just for you!`)}let _=.1;u.scale.copy(m).multiplyScalar(s*_);let v={t:0};u.userData.oscStrength=5;let y=u.getObjectByName(`Aura`);if(y&&(y.userData.oscStrength=5),!d){let e=e=>{e.onBeforeRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&(this.userData.prevOsc=i.uniforms.uOscillationStrength.value,i.uniforms.uOscillationStrength.value=this.userData.oscStrength)},e.onAfterRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&this.userData.prevOsc!==void 0&&(i.uniforms.uOscillationStrength.value=this.userData.prevOsc)}};e(u),y&&e(y)}return u.userData.activeTween&&u.userData.activeTween.stop(),u.userData.activeTween=new h.Tween(v).to({t:1},5e3).easing(h.Easing.Cubic.Out).onUpdate(()=>{let e=v.t;u.scale.lerpVectors(m.clone().multiplyScalar(s*_),g.clone().multiplyScalar(s),e);let t=5*(1-e);u.userData.oscStrength=t,y&&(y.userData.oscStrength=t)}).onComplete(()=>{u.userData.activeTween=null}).start(),u}function Ai(t,n){if(Vi.length>40){ji(t,n),n.userData.coinType===`ETH`?Bi.push(n):zi.push(n);return}if(Vi.push(n),n.rapierBody){n.rapierBody.setBodyType(_.RigidBodyType.Dynamic),n.rapierBody.wakeUp();let t=new e.Vector3(6,7,8),r=new e.Vector3().subVectors(t,n.position).normalize();r.multiplyScalar(30),n.rapierBody.applyImpulse({x:r.x,y:r.y,z:r.z},!0),n.rapierBody.applyTorqueImpulse({x:Math.random(),y:Math.random(),z:Math.random()},!0)}n.userData.activeTween&&n.userData.activeTween.stop(),n.userData.activeTween=new h.Tween(n.scale).to({x:0,y:0,z:0},500).delay(1500).easing(h.Easing.Back.In).onComplete(()=>{n.userData.activeTween=null,ji(t,n);let e=Vi.indexOf(n);e>-1&&Vi.splice(e,1),n.userData.coinType===`ETH`?Bi.push(n):zi.push(n)}).start()}function ji(e,t){if(t&&(e.world&&e.world.ballBodies&&e.world.ballBodies.includes(t.rapierBody)&&e.world.ballBodies.splice(e.world.ballBodies.indexOf(t.rapierBody),1),e.bhTargets&&e.bhTargets.includes(t)&&e.bhTargets.splice(e.bhTargets.indexOf(t),1),Co(e,t.name),t.userData.activeTween&&(t.userData.activeTween.stop(),t.userData.activeTween=null),t.visible=!1,t.rapierBody)){t.rapierBody.setBodyType(_.RigidBodyType.Dynamic),t.rapierBody.setTranslation({x:0,y:-100,z:0},!0),t.rapierBody.setLinvel({x:0,y:0,z:0},!0),t.rapierBody.setAngvel({x:0,y:0,z:0},!0),t.rapierBody.sleep();let n=`coin-integrity-beam-${t.rapierBody.handle}`,r=e.getObjectByName(n);r&&(r.visible=!1,r.activeRequestID&&cancelAnimationFrame(r.activeRequestID))}}function Mi(e){Ni(e)}function Ni(e){let t=[...Ri,...Vi];Ri.length=0,Vi.length=0;let n=0,r=()=>{if(!e)return;let i=Math.min(n+5,t.length);for(let r=n;r<i;r++){let n=t[r];n&&ji(e,n)}n=i,n<t.length?requestAnimationFrame(r):e.children.forEach(t=>{t&&t.name&&(t.name.startsWith(`BTC_`)||t.name.startsWith(`ETH_`))&&t.visible&&ji(e,t)})};t.length>0&&r()}var Pi,Fi,Ii,Li,Ri,zi,Bi,Vi,Hi,Ui,Wi,Gi,Ki,qi,Ji=O((()=>{Dn(),Ie(),_n(),Qn(),gr(),Cs(),xr(),Cr(),Or(),rs(),xi(),Pi=null,Fi=null,Ii={},Li=null,_r().then(e=>{e.forEach(e=>{Ii[e.symbol.toLowerCase()]=e.current_price})}),Ri=[],zi=[],Bi=[],Vi=[],Hi=120,Ui=60,Wi=(e,t,n)=>{e.raycasterWrapper?.mouseInContainer&&(V(e,t,n),document.body.style.cursor=`pointer`)},Gi=e=>{H(e),document.body.style.cursor=`auto`},Ki=131074,qi=4294967295}));function Yi(){let t=document.getElementById(`narrative-shader-canvas`),n=document.querySelector(`.modal-narrative`);if(!t||!n)return;q.parent=n;let r=new e.WebGLRenderer({canvas:t,alpha:!0,antialias:!1});r.setPixelRatio(.5),r.setSize(n.clientWidth,n.clientHeight),q.renderer=r;let i=new e.Scene,a=new e.OrthographicCamera(-1,1,1,-1,0,1);q.scene=i,q.camera=a;let o=new e.PlaneGeometry(2,2),s=new e.TextureLoader().load(ea);s.wrapS=e.RepeatWrapping,s.wrapT=e.RepeatWrapping;let c=new e.ShaderMaterial({uniforms:{iTime:{value:0},iResolution:{value:new e.Vector2(n.clientWidth,n.clientHeight)},iMouse:{value:new e.Vector4(0,0,0,0)},iChannel0:{value:s}},vertexShader:`
    ...
    `,transparent:!0});q.material=c;let l=new e.Mesh(o,c);i.add(l),q.mesh=l,window.addEventListener(`mousemove`,e=>{n.getBoundingClientRect();let t=window.innerWidth,r=window.innerHeight,i=e.clientX/t*2-1,a=e.clientY/r*2-1,o=(i+1)*.5*n.clientWidth,s=(1-(a+1)*.5)*n.clientHeight;q.targetMouse.set(o,s,1,1)}),q.startTime=performance.now(),window.addEventListener(`resize`,Qi)}function Xi(){q.active||(Qi(),q.startTime=performance.now(),q.currentMouse.x=q.targetMouse.x,q.currentMouse.y=q.targetMouse.y,q.currentMouse.z=1,q.currentMouse.w=1,q.active=!0,$i())}function Zi(){q.active=!1,q.animationId&&(cancelAnimationFrame(q.animationId),q.animationId=null)}function Qi(){let{parent:e,renderer:t,material:n}=q;if(!e||!t||!n)return;let r=e.clientWidth,i=e.clientHeight;t.setSize(r,i),n.uniforms.iResolution.value.set(r,i)}function $i(){if(!q.active)return;q.animationId=requestAnimationFrame($i);let{renderer:e,scene:t,camera:n,material:r,startTime:i,targetMouse:a,currentMouse:o,lerpFactor:s}=q;!e||!t||!n||!r||(o.x+=(a.x-o.x)*s,o.y+=(a.y-o.y)*s,o.z+=(a.z-o.z)*s,o.w+=(a.w-o.w)*s,r.uniforms.iTime.value=(performance.now()-i)*.001,r.uniforms.iMouse.value.copy(o),e.render(t,n))}var q,ea,ta=O((()=>{q={renderer:null,scene:null,camera:null,material:null,mesh:null,parent:null,animationId:null,active:!1,startTime:0,targetMouse:new e.Vector4(0,0,0,0),currentMouse:new e.Vector4(0,0,0,0),lerpFactor:.08},ea=`./textures/noise.webp`}));function na(e){ia(e),Yi(),window.addEventListener(`keydown`,t=>{let n=t.key.toLowerCase();if(n===`g`)aa(e);else if(n===`l`)da(e,null,!0);else if(n===`i`||n===`d`){let e=document.getElementById(`cv-container`);if(e){let t=document.getElementById(`app-container`),r=t?t.offsetWidth:window.innerWidth,i=r*.05,a=e.offsetWidth,o=n===`i`?a+i:a-i;o>200&&o<r*.9&&(e.style.width=`${o}px`,e.classList.contains(`collapsed`)&&(e.style.transform=`translateX(${o}px)`,e.style.marginRight=`-${o}px`,e.userData&&(e.userData.x=o,e.userData.margin=-o))),window.dispatchEvent(new Event(`resize`))}}}),window.addEventListener(`subtitleClose`,t=>{let n=e.scenarioState?.name===`room`,r=!e.isHeroAnimating&&!e.isTransitioning;t.detail?.manual&&n&&r&&aa(e)})}function ra(e,t){let n=_a.filter(e=>e.event===`click`);for(let r of n){let n=e.target.closest(r.selector);if(n){r.action(e,t,n);return}}}function ia(e){document.body.addEventListener(`click`,t=>ra(t,e)),_a.forEach(t=>{t.event!==`click`&&document.querySelectorAll(t.selector).forEach(n=>{n.addEventListener(t.event,r=>t.action(r,e,n))}),t.event===`click`&&document.querySelectorAll(t.selector).forEach(e=>{e.tagName!==`A`&&(e.style.cursor=`pointer`)})})}async function aa(t,n={}){let{onImpact:r=null,onComplete:i=null}=n;if(!(t.scenarioState&&t.scenarioState.name===`room`)||t.isHeroAnimating||!window.boneTracker){console.warn(`[Cinematic] Aborted: Context mismatch or active animation.`);return}let a=t.getObjectByName(`a-char`),o=t.getObjectByName(`stool_bound`);if(!a||!o)return;t.isHeroAnimating=!0,t.allowsResetting=!1;let s=[`pokeball`,`pokeball2`,`questionCube`],c=null,l=1/0;s.forEach(e=>{let n=t.getObjectByName(e);if(n&&n.visible&&n.rapierBody){let e=n.position.distanceTo(a.position);e<l&&(l=e,c=n)}});let u=()=>{let e=e=>{if(!e)return!1;let t=e.getBoundingClientRect();return t.top<window.innerHeight&&t.bottom>0},t=document.querySelector(`#persona-switch-btn`);return e(t)?t:Array.from(document.querySelectorAll(`h2`)).find(t=>e(t))||document.querySelector(`#cv-export-btn`)||document.querySelector(`#cv-header`)},d=document.querySelector(`#persona-switch-btn`);if(d&&d.classList.add(`persona-aggressive-jitter`),c&&c.rapierBody){let n=c.rapierBody,r=new e.Vector3(1,1,-1.5),i=new e.Quaternion(0,0,0,1),o=n.bodyType();n.rapierCollider&&n.rapierCollider.setSensor(!0);let s=n.mass();n.wakeUp(),n.applyImpulse({x:0,y:15*s,z:0},!0);let l=t.getObjectByName(`mixamorigSpine1`),u=new e.Vector3;l?l.getWorldPosition(u):a.getWorldPosition(u),wr(n,()=>{let a=`ritual-beam-${n.handle}`,s=I.ELECTRIC_CYAN||65535,c=n.translation();Bo(t,``,``,new e.Vector3(c.x,c.y,c.z),a,!0,s,!0,1/0,!0);let l=t.getObjectByName(a);Tr(n,r,i,performance.now()+1e3,o,()=>{l&&(l.visible=!1,l.activeRequestID&&cancelAnimationFrame(l.activeRequestID)),n.setTranslation(r,!0),n.setLinvel({x:0,y:0,z:0},!0),n.setAngvel({x:0,y:0,z:0},!0)},(n,r)=>{if(l&&l.visible){let r=t.objectMap&&t.objectMap.get?t.objectMap.get(`drone`):t.getObjectByName(`drone`);if(r){let t=r.getObjectByName(`Sphere001_0`);if(t){let r=new e.Vector3;t.getWorldPosition(r);let i=r.distanceTo(n);l.position.copy(r),l.lookAt(n),l.children.forEach(e=>{e.scale.z=i})}}}},u)})}if(setTimeout(()=>{Sr(t,`sitToStand`,{speed:1.2,autoReturn:!1})},2e3),await va(t,{x:1,y:0,z:.75}),d&&d.classList.remove(`persona-aggressive-jitter`),window.boneTracker){let e=u(),n=e&&e.tagName===`H2`;n&&(e.style.outline=`2px solid var(--c-cyan)`,e.style.outlineOffset=`4px`,e.style.transition=`outline 0.3s ease`),window.boneTracker.hasHitThisSwing=!1,window.boneTracker.initTargetElement(e),window.boneTracker.setOffset(.05,.36,-.05),window.boneTracker.setRotationOffset(-30,0,110),window.boneTracker.setScale(3),window.boneTracker.toggleTracking(()=>{Sr(t,`golfDrive`,{speed:.7,autoReturn:!1,onComplete:()=>{window.boneTracker&&window.boneTracker.isActive&&window.boneTracker.toggleTracking(),Sr(t,`standClap`,{speed:1,crossFadeDuration:.8,onComplete:async()=>{await new Promise(e=>setTimeout(e,500)),await va(t,null),n&&(e.style.outline=``,e.style.outlineOffset=``),t.isHeroAnimating=!1,t.allowsResetting=!0,i&&i()}})}}),setTimeout(()=>{r&&r()},660)})}}async function oa(e,t=!0){let n=e.scenarioState?.name===`room`;if(t){let t=Q.currentMode===F.DEV?F.POBA:F.DEV;if(n){if(e.isHeroAnimating){V(e,Rn!==void 0&&Kn?Kn:null,`CHANGING PROTOCOL...`),e._informerTimeout&&clearTimeout(e._informerTimeout),e._informerTimeout=setTimeout(()=>H(e),1500);return}Q.setPersona(t),aa(e,{onImpact:()=>{let n=t===F.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`,r=typeof R==`function`?R(n):``;r&&(ps(r),Bo(e,null,r))}});return}let r=e.pointsApp,i=e.scenarioState&&e.scenarioState.name===`points`,a=r&&typeof r.getCurrentStep==`function`&&r.getCurrentStep()===0;i&&a?Q.setPersona(t,{skipPointsSync:!0}):Q.setPersona(t)}}function sa(t){if(t.isHeroAnimating||t.allowsResetting===!1||t.scenarioState&&t.scenarioState.name!==`room`)return;let n=t.getObjectByName(`stool_bound`),r=t.getObjectByName(`a-char`);if(!n||!r)return;t.isHeroAnimating=!0,t.allowsResetting=!1;let i=new e.Vector3,a=new e.Quaternion;n.getWorldPosition(i),n.getWorldQuaternion(a);let o=r.position.x,s=r.position.y,c=r.position.z,l=[{name:`gangnam`,moveOffset:new e.Vector3(5,0,0),returnSpeed:1,returnDuration:440,isRobot:!1},{name:`breakDance`,moveOffset:new e.Vector3(3,0,-2),returnSpeed:1.2,returnDuration:440,isRobot:!1},{name:`robotDance`,moveOffset:new e.Vector3(1,0,0),returnSpeed:1,returnDuration:200,isRobot:!0}].filter(e=>t.heroClips?.some(t=>t.name.toLowerCase()===e.name.toLowerCase()));if(l.length===0)return;let u=Math.random(),d;d=u<.5?l.find(e=>e.name===`breakDance`):u<.75?l.find(e=>e.name===`gangnam`):l.find(e=>e.name===`robotDance`),d||=l[Math.floor(Math.random()*l.length)];let f=t.heroClips.find(e=>e.name.toLowerCase()===d.name.toLowerCase()),p=d.moveOffset,m=d.returnDuration,g=d.returnSpeed,v=d.isRobot,y=new e.Vector3;r.getWorldPosition(y);let b=y.clone().add(p).clone();r.parent&&r.parent.worldToLocal(b);let x=n.rapierBody;if(x){x.setBodyType(_.RigidBodyType.Dynamic),x.wakeUp();let t=new e.Vector3(75+Math.random()*10,50+Math.random()*5,(Math.random()-.5)*5),n=new e.Vector3(Math.random()*2,Math.random()*5,Math.random()*2);x.applyImpulse({x:t.x,y:t.y,z:t.z},!0),x.applyTorqueImpulse(n,!0)}new h.Tween(r.position).to({x:b.x,y:b.y,z:b.z},800).easing(h.Easing.Quadratic.Out).start(),f&&Sr(t,f.name,{idleClipName:v?`typing`:`walking`,onComplete:()=>S()});function S(){if(v)new h.Tween(r.position).to({x:o,y:s,z:c},m).easing(h.Easing.Quadratic.Out).onComplete(()=>{t.isHeroAnimating=!1,t.allowsResetting=!0}).start(),C();else{Sr(t,`walking`,{idleClipName:`typing`,speed:g});let n=r.position.clone(),i=new e.Vector3(o,s,c),a={t:0};new h.Tween(a).to({t:1},1200).easing(h.Easing.Linear.None).onUpdate(()=>{let e=a.t;e=e<.2?(e/.2)**3*.05:.05+(e-.2)/.8*.95,r.position.lerpVectors(n,i,e)}).onComplete(()=>{Sr(t,`typing`,{crossFadeDuration:.2}),C(500),t.isHeroAnimating=!1,t.allowsResetting=!0}).start()}}function C(r=1e3){if(!x)return;x.setBodyType(_.RigidBodyType.KinematicPositionBased),x.setLinvel({x:0,y:0,z:0},!0),x.setAngvel({x:0,y:0,z:0},!0),x.wakeUp();let o=x.translation(),s=x.rotation(),c={t:0};new h.Tween(c).to({t:1},r).easing(h.Easing.Cubic.Out).onUpdate(()=>{let t=new e.Vector3().lerpVectors(o,i,c.t),r=new e.Quaternion().copy(s).slerp(a,c.t);x.setTranslation(t,!0),x.setRotation(r,!0);let l=t.clone();n.parent&&n.parent.worldToLocal(l),n.position.copy(l);let u=r.clone();if(n.parent){let t=new e.Quaternion;n.parent.getWorldQuaternion(t),n.quaternion.copy(t.invert().multiply(u))}else n.quaternion.copy(u)}).onComplete(()=>{v&&t.heroClips&&Sr(t,`typing`,{crossFadeDuration:.5})}).onStart(()=>{t.stoolGridUniforms&&(t.stoolGridUniforms.uWorldGridActive.value=1,t.stoolGridUniforms.uWorldGridProgress.value=0,new h.Tween(t.stoolGridUniforms.uWorldGridProgress).to({value:1},600).easing(h.Easing.Quadratic.Out).onComplete(()=>{setTimeout(()=>{new h.Tween(t.stoolGridUniforms.uWorldGridProgress).to({value:0},500).onComplete(()=>{t.stoolGridUniforms.uWorldGridActive.value=0}).start()},200)}).start())}).start()}}function ca(e,t){Ta&&=(clearTimeout(Ta),null),t?Ta=setTimeout(()=>{la(e,!0)},Ea):la(e,!1)}function la(t,n){let r=t.pointsApp;if(!r||!r.material)return;n?(V(t,Wn,`The closer you look...`),t.conversationManager?.shout(`...the less you see.`)):H(t);let i=(r.getCurrentStep?r.getCurrentStep():0)===2?.3:1,a=t.camera,o=t.orbitControls;o&&n&&(o.isStrategicHover=!0);let s=r.material.uniforms;ba&&ba.stop();let c=n?.8+2.7*i:.8,l=n?800:500;if(ba=new h.Tween(s.uModelVibFactor).to({value:c},l).easing(h.Easing.Cubic.Out).start(),!a||!o)return;Sa||=a.position.clone(),Ca||=a.rotation.clone(),wa===null&&(wa=a.fov),ya&&ya.stop(),xa&&xa.stop();let u=new e.Vector3(1.8,.6,-1.8).multiplyScalar(i),d=n?Sa.clone().add(u):Sa.clone(),f=(wa-38)*i,p=n?wa-f:wa;ya=new h.Tween(a.position).to({x:d.x,y:d.y,z:d.z},l).easing(h.Easing.Cubic.Out).onUpdate(()=>{if(n){let t=.05*i,n=.04*i;a.rotation.x=e.MathUtils.lerp(a.rotation.x,Ca.x-t,.05),a.rotation.y=e.MathUtils.lerp(a.rotation.y,Ca.y+n,.05)}}).onComplete(()=>{n||(Sa=null,Ca=null,wa=null,o&&(o.isStrategicHover=!1))}).start(),xa=new h.Tween(a).to({fov:p},l).easing(h.Easing.Cubic.Out).onUpdate(()=>{a.updateProjectionMatrix()}).start()}function ua(e){let t=e.pointsApp;if(!t||!t.getCurrentStep)return;let n=t.getCurrentStep(),r=t.material.uniforms;switch(n){case 0:new h.Tween(r.uModelScale).to({value:0},150).easing(h.Easing.Exponential.In).onComplete(()=>{new h.Tween(r.uModelScale).to({value:1.2},300).easing(h.Easing.Back.Out).onComplete(()=>{new h.Tween(r.uModelScale).to({value:1},400).easing(h.Easing.Quadratic.Out).start()}).start()}).start();break;case 1:e.stoolGridUniforms&&(e.stoolGridUniforms.uWorldGridActive.value=1,e.stoolGridUniforms.uWorldGridProgress.value=0,new h.Tween(e.stoolGridUniforms.uWorldGridProgress).to({value:1},800).easing(h.Easing.Cubic.Out).onComplete(()=>{e.stoolGridUniforms.uWorldGridActive.value=0}).start());break;case 2:t.playNextDance&&t.playNextDance();break}}function da(e,t,n){let r=document.getElementById(`cv-container`);if(!r)return;r.userData||={};let i=r.userData,a;a=n===void 0?!r.classList.contains(`collapsed`):n,a?r.classList.add(`collapsed`):r.classList.remove(`collapsed`),document.body.classList.toggle(`cv-collapsed`,a),i.tween&&i.tween.stop();let o=!a,s=r.offsetWidth||600,c=a?s:0,l=a?-s:0;i.x===void 0&&(i.x=a?0:s),i.margin===void 0&&(i.margin=a?0:-s),i.tween=new h.Tween(i).to({x:c,margin:l},800).easing(h.Easing.Back.Out).onUpdate(()=>{r.style.transform=`translateX(${i.x}px)`,r.style.marginRight=`${i.margin}px`}).onComplete(()=>{a&&(r.style.opacity=`0`)}).onStart(()=>{o&&(r.style.opacity=`1`)}).start(),window.dispatchEvent(new CustomEvent(`cvToggle`,{detail:{collapsed:a}})),e.HUD&&typeof e.HUD.breathe==`function`&&e.HUD.breathe(I.ELECTRIC_CYAN),t&&V(e,null,a?`EXPAND CV PANEL`:`COLLAPSE CV PANEL`,!0)}function fa(e,t){if(t){let t=document.getElementById(`cv-container`);V(e,null,!t||t.classList.contains(`collapsed`)?`EXPAND CV PANEL`:`COLLAPSE CV PANEL`,!0),e.HUD&&typeof e.HUD.breathe==`function`&&e.HUD.breathe(I.ELECTRIC_CYAN)}else H(e)}function pa(e,t,n){if(n){let n=t.getAttribute(`data-label`),r=t.getAttribute(`data-platform`);V(e,null,`COPY ${n.toUpperCase()} & OPEN ${r.toUpperCase()}`,!0,!0)}else H(e)}async function ma(e,t){t.getAttribute(`data-label`);let n=t.getAttribute(`data-url`),r=t.getAttribute(`data-id`)===`gmail`,i=n;try{await navigator.clipboard.writeText(i),V(e,null,`COPIED TO CLIPBOARD!`,!0,!0);let a=r?`mailto:${n}`:n;window.open(a,`_blank`),setTimeout(()=>{t.matches(`:hover`)&&pa(e,t,!0)},1500)}catch(e){console.error(`Clipboard copy failed:`,e)}window.uiAnims&&window.uiAnims.triggerSpring&&window.uiAnims.triggerSpring(t)}function ha(e){let t=document.getElementById(e),n=document.getElementById(`cv-scroller`);if(t&&n){let e=t.nextElementSibling;e&&e.classList.contains(`collapsed`)&&t.click();let r=t.offsetTop;n.scrollTo({top:r-85,behavior:`smooth`})}}async function ga(e){let t=document.getElementById(`work-experience-modal`);t&&(t.style.display=`none`,e&&(e.raycasterEnabled=!0),Zi()),da(e,null,!1),await new Promise(e=>setTimeout(e,400));let n=document.getElementById(`board`),r=document.querySelector(`.three-js-backdrop`);n&&(n.style.opacity=`1`),r&&(r.style.opacity=`1`),e.HUD&&typeof e.HUD.runTweenOpen==`function`&&e.HUD.runTweenOpen()}var _a,va,ya,ba,xa,Sa,Ca,wa,Ta,Ea,Da=O((()=>{Ds(),Cr(),Or(),ye(),Qn(),Dn(),rs(),we(),Cs(),ta(),_a=[{selector:`#persona-switch-btn`,event:`click`,action:(e,t)=>{e.stopPropagation(),Q.togglePersonaPanel()}},{selector:`.header-photo`,event:`click`,action:(e,t)=>oa(t,!0)},{selector:`.name`,event:`mouseenter`,action:(e,t)=>ca(t,!0)},{selector:`.name`,event:`mouseleave`,action:(e,t)=>ca(t,!1)},{selector:`.name`,event:`click`,action:(e,t)=>{t.scenarioState?.name===`room`?oa(t,!1):ua(t)}},{selector:`.choice-box`,event:`click`,action:(e,t,n)=>{let r=n.getAttribute(`data-mode`);r&&Q.setPersona(r)}},{selector:`#cv-mode-selector .mode-option`,event:`click`,action:(e,t,n)=>{let r=n.getAttribute(`data-mode`);r&&Q.setPersona(r)}},{selector:`.nav-item`,event:`click`,action:(e,t,n)=>{let r=n.getAttribute(`data-target`);if(document.querySelectorAll(`.nav-modules .nav-item`).forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`),r===`cv-header`&&t.scenarioState?.name===`room`){t.isTransitioning||qo(t);return}let i=document.getElementById(r),a=document.getElementById(`cv-scroller`);i&&a&&a.scrollTo({bottom:0,top:i.offsetTop-80,behavior:`smooth`})}},{selector:`#hud-nav-btn-3`,event:`click`,action:(e,t)=>{let n=document.querySelector(`.nav-modules .nav-item[data-target="cv-header"]`);n&&(document.querySelectorAll(`.nav-modules .nav-item`).forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`)),t.scenarioState?.name===`room`&&!t.isTransitioning&&(H(t),qo(t))}},{selector:`#hud-nav-btn-2`,event:`click`,action:(e,t)=>{if(t.scenarioState?.name===`points`&&!t.isTransitioning&&(H(t),t.pointsApp&&typeof t.pointsApp.triggerStep==`function`)){t.pointsApp.triggerStep(3);let e=document.querySelector(`.nav-modules .nav-item[data-target="LAB"]`)||document.querySelector(`.nav-modules .nav-item[data-target="cv-header"]`);e&&(document.querySelectorAll(`.nav-modules .nav-item`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`))}}},{selector:`#hud-nav-btn-1`,event:`click`,action:async(e,t)=>{if(t.isTransitioning)return;H(t),t.HUD&&typeof t.HUD.runTweenClose==`function`&&t.HUD.runTweenClose(1e3),ha(`cv-work-header`);let n=document.getElementById(`board`),r=document.querySelector(`.three-js-backdrop`);n&&(n.style.transition=`opacity 0.4s`),n&&(n.style.opacity=`0`),r&&(r.style.transition=`opacity 0.4s`),r&&(r.style.opacity=`0`),await new Promise(e=>setTimeout(e,1100));let i=document.getElementById(`cv-container`);i&&i.classList.remove(`slow-transition`),da(t,null,!0),await new Promise(e=>setTimeout(e,400));let a=document.getElementById(`work-experience-modal`);a&&(a.style.display=`flex`,t&&(t.raycasterEnabled=!1),Xi())}},{selector:`#work-modal-close-btn`,event:`click`,action:(e,t)=>ga(t)},{selector:`#cv-export-btn, #modal-cv-export-btn`,event:`click`,action:(e,t)=>{let n=document.createElement(`a`);n.href=`./cvs/Bui_Quoc_Hieu_CV_Portable.pdf`,n.download=`Bui_Quoc_Hieu_CV_Portable.pdf`,document.body.appendChild(n),n.click(),document.body.removeChild(n),t.scenarioState?.name===`room`&&sa(t)}},{selector:`#work-experience-modal`,event:`click`,action:(e,t)=>{(e.target.id===`work-experience-modal`||e.target.classList.contains(`modal-backdrop`))&&ga(t)}},{selector:`#cv-toggle-btn`,event:`click`,action:(e,t,n)=>da(t,n)},{selector:`#cv-toggle-btn`,event:`mouseenter`,action:(e,t)=>fa(t,!0)},{selector:`#cv-toggle-btn`,event:`mouseleave`,action:(e,t)=>fa(t,!1)},{selector:`.contact-btn-tiny`,event:`mouseenter`,action:(e,t,n)=>pa(t,n,!0)},{selector:`.contact-btn-tiny`,event:`mouseleave`,action:(e,t,n)=>pa(t,n,!1)},{selector:`.contact-btn-tiny`,event:`click`,action:(e,t,n)=>ma(t,n)}],va=(e,t=null)=>{let n=e.getObjectByName(`a-char`),r=e.getObjectByName(`stool`),i=e.getObjectByName(`stool_bound`);if(!n||!i)return Promise.resolve();if(n.userData.origPos===void 0&&(n.userData.origPos=n.position.clone()),r&&r.userData.origPos===void 0&&(r.userData.origPos=r.position.clone()),i.rapierBody&&i.userData.origTranslation===void 0){let e=i.rapierBody.translation();i.userData.origTranslation={x:e.x,y:e.y,z:e.z},n.userData.stoolOffset={x:e.x-n.userData.origPos.x,y:e.y-n.userData.origPos.y,z:e.z-n.userData.origPos.z}}let a=1500,o=h.Easing.Cubic.InOut,s=t||n.userData.origPos,c={x:s.x+(n.userData.stoolOffset?.x||0),y:s.y+(n.userData.stoolOffset?.y||0),z:s.z+(n.userData.stoolOffset?.z||0)};return new Promise(e=>{if(new h.Tween(n.position).to({x:s.x,y:s.y,z:s.z},a).easing(o).onComplete(e).start(),r&&new h.Tween(r.position).to({x:c.x,y:c.y,z:c.z},a).easing(o).start(),i.rapierBody){let e=i.rapierBody.translation(),t={x:e.x,y:e.y,z:e.z};new h.Tween(t).to(c,a).easing(o).onUpdate(()=>{i.rapierBody.setNextKinematicTranslation(t)}).start()}})},typeof window<`u`&&(window.triggerRitual=e=>{aa(window.scene,{onImpact:()=>{let t=e||(Q.currentMode===F.DEV?F.POBA:F.DEV);Q.setPersona(t)}})}),ya=null,ba=null,xa=null,Sa=null,Ca=null,wa=null,Ta=null,Ea=400}));function Oa(e,t,n){let r=n.get(`catBlack`),i=n.get(`catWhite`),a=t===F.POBA?L.UI_INFORMER_CAT_MAX_POBA.en:L.UI_INFORMER_CAT_MAX_DEV.en,o=t===F.POBA?L.UI_INFORMER_CAT_MIN_POBA.en:L.UI_INFORMER_CAT_MIN_DEV.en;r&&(r.userData.assignedRole=a[Math.floor(Math.random()*a.length)]),i&&(i.userData.assignedRole=o[Math.floor(Math.random()*o.length)])}function ka(t){let n=new Map;t.shootDroneBeam=Bo,t.traverse(e=>{e.name&&n.set(e.name,e),/^book\d+$/.test(e.name)&&Ka.push(e)}),t.objectMap=n;let r=Ja(t,n,{gravityCenter:new e.Vector3(-.5,3.5,4.9),tgtPos:new e.Vector3(-2,3.09,6.42),tgtQuat:new e.Quaternion(-.09,.48,-.05,.87)});Oa(t,Q.currentMode,n),window.addEventListener(`personaToggle`,e=>{Oa(t,e.detail.mode,n)});let i=n.get(`a-char`);if(i){let t=1/i.scale.y,r=3.675*t,a=1.6*t,o=new e.Mesh(new e.BoxGeometry(a,r,a),new e.MeshBasicMaterial({color:16711935,transparent:!0,opacity:0,visible:!1}));o.name=`hero_hitbox`,o.position.set(0,r/2,0),i.add(o),n.set(o.name,o)}let a=[...Object.keys(r),`aegis`,`aegis2`,`caseCover`,`mjolnir_low_mjolnir_hammer_0`,`Object_34001`,`screenDisplay001`,`screenDisplay002`,`verticalMonitorDisplay`,`Model_0001`,`pictureLionFrame`],o=0;a.forEach(e=>{let i=n.get(e),a=r[e]||{};if(!i)return;o++;let s=a.onMouseEnter?e=>{a.onMouseEnter(e)}:e=>qa(t,e),c=e=>{t.gazeFollower&&t.gazeFollower.lookAtTarget(e),s(e)},l=a.onMouseLeave?e=>a.onMouseLeave(e):e=>J(t,e);yn(t,i,{onMouseEnter:c,onMouseLeave:e=>{t.gazeFollower&&t.gazeFollower.lookAtTarget(t.camera),l(e)},onMouseDown:a.onMouseDown?(e,t)=>a.onMouseDown(e,t):(e,n)=>Y(t,e,n),onMouseHover:a.onMouseHover?(e,t)=>a.onMouseHover(e,t):null})}),Ka.forEach(e=>{yn(t,e,{onMouseEnter:()=>{qa(t,e),t.gazeFollower&&t.gazeFollower.lookAtTarget(e),t.raycasterWrapper?.mouseInContainer&&V(t,Wn,R(`UI_INFORMER_BOOK`))},onMouseLeave:()=>{J(t),Ya(t),t.gazeFollower&&t.gazeFollower.lookAtTarget(t.camera)},onMouseDown:(e,n)=>Y(t,e,n)})}),Ga.forEach(e=>{let r=n.get(e);r&&yn(t,r,{onMouseEnter:()=>{},onMouseLeave:()=>{}})}),t.testBH=(e=`y`)=>{let n=t.getObjectByName(`Lathe_Center`);if(!n||![`x`,`y`,`z`].includes(e))return;let r={};r[e]=n.rotation[e]-Math.PI*6,new h.Tween(n.rotation).to(r,1500).easing(h.Easing.Back.Out).start()}}function Aa(e,t,n,r,i,a,o=null){if(e.isSucking||!t||!t.rapierBody)return;let s=Array.isArray(n)?[...n]:[n];e.world.hasPointGravityOnPokeball=!1,ja(e,t,r),Ma(e,t,s,i,a)}function ja(e,t,n){let r=t.rapierBody;if(!r)return;e.world.pokeballBody=r,e.world.gravityCenterForPokeball=n;let i=t.position.clone();i.normalize();let a=r.mass()*15,o=i.multiplyScalar(a*-1);o.y=Math.max(8*Math.abs(i.y),8),o.x/=Fa(1,2),o.y*=Fa(1,1.5),o.z/=Fa(1,2),t.rapierBody.applyImpulse({x:o.x,y:o.y,z:o.z},!0)}function Ma(t,n,r,i,a){t.isSucking=!0;let o=It(`#FBC189`,1.5,1),s=r.length;r.forEach(r=>{if(r.ignoreRaycast=!0,r.traverse(e=>{e.ignoreRaycast=!0,e.userData&&(e.userData.isRaycastTarget=!1)}),t.raycastObjects&&=t.raycastObjects.filter(e=>{let t=e===r;return t||r.traverse(n=>{n===e&&(t=!0)}),t||e.traverse(e=>{e===r&&(t=!0)}),!t}),t.raycasterWrapper?.currentObjectTarget){let e=t.raycasterWrapper.currentObjectTarget,n=e===r;n||r.traverse(t=>{t===e&&(n=!0)}),n&&H(t)}let c=new e.Vector3,l=new e.Quaternion,u={value:0},d=new h.Tween(o.uniforms.uprogress).to({value:2},1500).easing(h.Easing.Bounce.Out).onComplete(()=>{if(t.world.hasPointGravityOnPokeball=!1,n.rapierBody){n.rapierBody.setBodyType(0);let t=new e.Vector3(0,-4,0);n.rapierBody.applyImpulse({x:t.x,y:t.y,z:t.z},!0)}r.traverse(e=>{if(e.rapierBody){let n=e.rapierBody;e.isRapierBound=!1,n.isObjectBound=!1;try{t.world.removeRigidBody(n)}catch(t){console.warn(`[Catch] RigidBody removal failed for `+e.name,t)}t.physicBodies&&=t.physicBodies.filter(e=>e!==n),t.skinnedMeshBodies&&=t.skinnedMeshBodies.filter(e=>e!==n),t.objectControlledBodies&&=t.objectControlledBodies.filter(e=>e!==n),t.physicsControlledObjects&&=t.physicsControlledObjects.filter(t=>t!==e),t.physicObjects&&=t.physicObjects.filter(t=>t!==e),e.rapierBody=null}}),t.physicsControlledObjects&&=t.physicsControlledObjects.filter(e=>e!==r),t.physicObjects&&=t.physicObjects.filter(e=>e!==r),t.remove(r),(r.name===`catBlack`||r.name===`blackCat`)&&(t.isMaxMissing=!0),(r.name===`catWhite`||r.name===`Object_108`)&&(t.isMinMissing=!0),r.visible=!1,s--,s<=0&&(t.isSucking=!1)}),f=new h.Tween(u).to({value:1},1e3).easing(h.Easing.Back.InOut).onStart(()=>{n.rapierBody&&n.rapierBody.setBodyType(1),c.copy(n.position),l.copy(n.rotation),typeof t.shootDroneBeam==`function`&&t.shootDroneBeam(t,``,``,c.clone(),`drone-beam`,!1,null,!0,1/0,!0)}).onUpdate(()=>{let r=new e.Vector3().lerpVectors(c,i,u.value);n.rapierBody&&n.rapierBody.setTranslation({x:r.x,y:r.y,z:r.z},!1);let o=t.getObjectByName(`drone-beam`),s=t.getObjectByName(`drone`);if(o&&o.visible&&s){let i=s.getObjectByName(`Sphere001_0`);if(i){let a=new e.Vector3;i.getWorldPosition(a);let s=a.distanceTo(r);o.position.copy(a),o.lookAt(r),o.children.forEach(e=>{e.scale.z=s}),t.gazeFollower&&t.gazeFollower.lookAtTarget(n)}}let d=l.clone().slerp(a,u.value);n.rapierBody&&n.rapierBody.setRotation({x:d.x,y:d.y,z:d.z,w:d.w},!1)}).onComplete(()=>{let e=t.getObjectByName(`drone-beam`);e&&(e.visible=!1,e.activeRequestID&&cancelAnimationFrame(e.activeRequestID)),o.uniforms.catchPoint.value.copy(i),r.traverse(e=>{e.isMesh&&(e.material=o,e.userData.originalMaterial=o)})}).chain(d);setTimeout(()=>{t.world.hasPointGravityOnPokeball=!0},1e3),setTimeout(()=>{f.start()},3e3)})}function Na(e,t={}){let{forcedX:n=null,environmentRatio:r=null,duration:i=1e3,delay:a=0}=t,o=e.getObjectByName(`glassInvi`);if(!o)return;let s=5.4,c=.75,l=o.rapierBody,u=l.translation(),d=u.x,f;f=n===null?o.slideDirection?o.slideDirection*-1:1:n<.5?1:-1;let p=(e,t,n)=>e+(t-e)*n,m;m=n===null?f===1?0:1:n;let g=n===null?f===1?s:c:p(s,c,m),_=r===null?m:r,v=e?e.environmentIntensity??1:1,y=p(1,0,_),b=(e,t,n,r,i=null)=>({name:e,properties:[{prop:t,closedVal:n,openVal:r,axis:i}]}),x=[{name:`floor`,properties:[{prop:`envMapRotation`,axis:`x`,closedVal:1.91,openVal:2.07},{prop:`envMapIntensity`,closedVal:.15,openVal:1}]},b(`Object_0003_3`,`envMapIntensity`,.3,1),b(`Object_0003`,`envMapIntensity`,.2,.75),b(`Object_32`,`envMapIntensity`,.5,2.5),{name:`mjolnir_low_mjolnir_hammer_0`,properties:[{prop:`envMapIntensity`,closedVal:1,openVal:5},{prop:`metalness`,closedVal:.6,openVal:1},{prop:`roughness`,closedVal:.2,openVal:1}]},b(`aegis`,`envMapIntensity`,1,5),b(`Object_34001`,`envMapIntensity`,5,10),b(`Object_0003`,`envMapIntensity`,.5,3),b(`shelf`,`envMapIntensity`,.5,1.65),b(`Object_15`,`envMapIntensity`,3,20),b(`Object_15001`,`envMapIntensity`,.5,2),b(`Object_31`,`envMapIntensity`,1,5),b(`Object_0007`,`envMapIntensity`,.1,.8),b(`Object_108`,`envMapIntensity`,.6,1.2)];for(let e=1;e<=38;e++){let t=`book`+String(e).padStart(3,`0`);x.push(b(t,`envMapIntensity`,.5,20))}let S=new Map;x.forEach(t=>{let n=e.getObjectByName(t.name);n&&n.material&&t.properties.forEach(e=>{let r=`${t.name}-${e.prop}`,i=0;e.prop===`envMapRotation`?n.material.envMapRotation&&e.axis===`x`&&(i=n.material.envMapRotation.x):i=n.material[e.prop],S.set(r,i)})});let C={value:0};new h.Tween(C).to({value:1},i).easing(h.Easing.Back.InOut).delay(a).onUpdate(()=>{l.setNextKinematicTranslation({x:d+(g-d)*C.value,y:u.y,z:u.z}),e&&(e.environmentIntensity=p(v,y,C.value),x.forEach(t=>{let n=e.getObjectByName(t.name);if(!n||!n.material)return;let r=n.material;t.properties.forEach(e=>{let n=`${t.name}-${e.prop}`,i=p(S.get(n)??0,p(e.closedVal===void 0?0:e.closedVal,e.openVal===void 0?0:e.openVal,_),C.value);e.prop===`envMapRotation`?r.envMapRotation&&e.axis===`x`&&(r.envMapRotation.x=i):r[e.prop]=i})}))}).onComplete(()=>{o.slideDirection=f;let t=e.globalUniformsHub;if(t&&t.uniforms&&t.uniforms.uWaterIntensity){let e=f===-1?2:.1;new h.Tween(t.uniforms.uWaterIntensity).to({value:e},3e3).easing(h.Easing.Cubic.InOut).start()}}).start()}function Pa(e,t=!0){e.world.hasPointGravityOnBH=t,t&&(e.world.hasPointGravityOnBalls=!1),e.physicBodies.forEach(e=>{e.wakeUp()}),e.allowsResetting=!t}function Fa(e,t){return Math.random()*(t-e)+e}function Ia(t,n){if(Xa)return;Xa=!0;let r=t.bulb;if(!r||!r.geometry||!r.geometry.isMorphGeo){Ra(t,null,1e3),Ci(t,n),Xa=!1;return}let i=r.geometry,a=r.material,o=r.getObjectByName(`bulbAura`),s=o?o.material:null,c=a.uniforms.uTransformProgress,l=s?s.uniforms.uTransformProgress:null,u={value:0};a.uniforms.uTransformProgress=u,s&&(s.uniforms.uTransformProgress=u),i.setMorphInfo(0,2);let d=new e.Color(`#ffe0b2`),f=new e.Color(`#9cc1f2`),p=`#`+f.getHexString();if(t.bulbLight){let e=t.bulbLight.color;p=Math.abs(e.r-d.r)+Math.abs(e.g-d.g)+Math.abs(e.b-d.b)<.5?`#`+f.getHexString():`#`+d.getHexString()}a.visible=!0,o&&(o.visible=!0),Ra(t,`#ffe0b2`,400),new h.Tween(u).to({value:1},600).easing(h.Easing.Cubic.Out).onComplete(()=>{Ci(t,n),setTimeout(()=>{new h.Tween(u).to({value:0},800).easing(h.Easing.Cubic.In).onComplete(()=>{if(a.visible=!0,o&&(o.visible=!0),i.setMorphInfo(0,1),a.uniforms.uTransformProgress=c,s&&l&&(s.uniforms.uTransformProgress=l),t.bulbLight){let e=t.bulbLight.color;a.uniforms.glowColor.value.setRGB(e.r,e.g,e.b)}Ra(t,p,600),Xa=!1}).start()},300)}).start()}function La(t,n,r,i=1e3,a={}){let{easing:o=h.Easing.Cubic.Out,onComplete:s=null,delay:c=0}=a,l=t.bulbLight;if(!l)return;l._activeParamTween&&=(l._activeParamTween.stop(),null);let u=l.intensity,d=l.angle,f={t:0};return l._activeParamTween=new h.Tween(f).to({t:1},i).delay(c).easing(o).onUpdate(()=>{l.intensity=e.MathUtils.lerp(u,n,f.t),l.angle=e.MathUtils.lerp(d,r,f.t)}).onComplete(()=>{l._activeParamTween=null,s&&s()}).start(),l._activeParamTween}function Ra(t,n=null,r=3e3){let i=new e.Color(`#ffe0b2`),a=new e.Color(`#9cc1f2`),o;if(n)o=new e.Color(n);else if(t.bulbLight){let e=t.bulbLight.color;o=Math.abs(e.r-i.r)+Math.abs(e.g-i.g)+Math.abs(e.b-i.b)<.5?a:i}else o=a;if(t.bulbLight&&new h.Tween(t.bulbLight.color).to({r:o.r,g:o.g,b:o.b},r).easing(h.Easing.Cubic.Out).start(),t.bulb&&t.bulb.material&&t.bulb.material.uniforms.glowColor){new h.Tween(t.bulb.material.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(h.Easing.Cubic.Out).start();let e=t.bulb.getObjectByName(`bulbAura`);e&&e.material&&e.material.uniforms.glowColor&&new h.Tween(e.material.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(h.Easing.Cubic.Out).start()}K&&K.uniforms&&(K.uniforms.glowColor&&new h.Tween(K.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(h.Easing.Cubic.Out).start(),K.uniforms.glowIntensity&&new h.Tween(K.uniforms.glowIntensity).to({value:1},r).easing(h.Easing.Cubic.Out).start()),$r&&$r.uniforms&&($r.uniforms.glowColor&&new h.Tween($r.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(h.Easing.Cubic.Out).start(),$r.uniforms.outerGlowStrength&&new h.Tween($r.uniforms.outerGlowStrength).to({value:1.5},r).easing(h.Easing.Cubic.Out).start())}function za(t,n){if(Za||!n)return;Za=!0;let r=t.bulbLight;r&&t._bulbBaseline===void 0&&(t._bulbBaseline={intensity:r.intensity,angle:r.angle});let i=r?r.color.clone():I.ELECTRIC_CYAN||62463,a=t.getObjectByName(`cFanBulb`)||n,o=new e.Vector3;a.getWorldPosition(o);let s=new e.IcosahedronGeometry(.3,1),c=as(i);c.uniforms.uOpacity.value=.5,c.uniforms.uBrightness.value=3.5;let l=new e.Mesh(s,c);l.position.copy(o),t.add(l),new h.Tween(l.scale).to({x:3.5,y:3.5,z:3.5},800).easing(h.Easing.Quintic.Out).start();let u=performance.now(),d=e=>{l.parent&&(c.uniforms.iTime.value=(e-u)/1e3,l.rotation.y+=.05,l.rotation.z+=.03,requestAnimationFrame(d))};requestAnimationFrame(d),t.fanAction&&new h.Tween(t.fanAction).to({timeScale:65},800).easing(h.Easing.Exponential.In).start(),Z(`SYNCHRONIZING KINETIC VECTORS...`),r&&t._bulbBaseline&&La(t,1e4,.3,800,{easing:h.Easing.Exponential.In,onComplete:()=>{La(t,t._bulbBaseline.intensity,t._bulbBaseline.angle,400,{delay:800,easing:h.Easing.Cubic.Out})}}),setTimeout(()=>{Za=!1},2200),setTimeout(()=>{t.remove(l),s.dispose(),c.dispose();let n=Math.abs(o.y- -.55),r=new e.CylinderGeometry(1.5,1.5,n,32,1,!0);r.translate(0,-n/2,0);let a=as(i);a.uniforms.uOpacity.value=.9,a.uniforms.uBrightness.value=5;let u=new e.Mesh(r,a);u.position.copy(o),t.add(u),u.scale.set(.1,1,.1),new h.Tween(u.scale).to({x:2.2,z:2.2},150).easing(h.Easing.Exponential.Out).onComplete(()=>{new h.Tween(a.uniforms.uOpacity).to({value:0},500).delay(300).start(),setTimeout(()=>{t.remove(u),r.dispose(),a.dispose()},800)}).start();let d=performance.now(),f=e=>{u.parent&&(a.uniforms.iTime.value=(e-d)/1e3,u.rotation.y+=.02,requestAnimationFrame(f))};requestAnimationFrame(f);let p=[];t.bhTargets&&p.push(...t.bhTargets),t.dragonBalls&&p.push(...t.dragonBalls),[...new Set(p)].forEach(t=>{if(!t||!t.rapierBody)return;let n=t.rapierBody,r=new e.Vector3;t.getWorldPosition(r);let i=new e.Vector3(o.x,r.y,o.z),a=new e.Vector3().subVectors(r,i),s=a.length();a.normalize(),a.y=1.35,a.normalize();let c=n.mass(),l=500*c/(Math.max(1,s)+.15);n.applyImpulse({x:a.x*l,y:a.y*l*1.6,z:a.z*l},!0);let u=150*c;n.applyTorqueImpulse({x:(Math.random()-.5)*u,y:(Math.random()-.5)*u,z:(Math.random()-.5)*u},!0)}),Z(`KINETIC DISCHARGE: STABLE`),typeof bi==`function`&&bi(t,!0),setTimeout(()=>{typeof bi==`function`&&bi(t,!1),t.fanAction&&new h.Tween(t.fanAction).to({timeScale:1},4e3).easing(h.Easing.Cubic.Out).start()},150)},800)}function Ba(e){let t=e.getObjectByName(`Lathe_Center`);return t?t.makeEye?t:(t.userData.initValues={rotation:t.rotation.clone(),scale:t.scale.clone(),nebulaCoreRadius:10,nebulaSwirlSpeed:.25},t.material&&t.material.uniforms&&t.material.uniforms.nebulaCoreRadius&&(t.userData.initValues.nebulaCoreRadius=t.material.uniforms.nebulaCoreRadius.value),e.globalUniformsHub&&e.globalUniformsHub.uNebulaSwirlSpeed&&(t.userData.initValues.nebulaSwirlSpeed=e.globalUniformsHub.uNebulaSwirlSpeed.value),t.makeEye=function(t){this.userData.eyeTweens&&this.userData.eyeTweens.forEach(e=>e.stop()),this.userData.eyeTweens=[];let n=new h.Tween(this.rotation).to({y:-.3},t).easing(h.Easing.Cubic.Out).start(),r=new h.Tween(this.scale).to({x:.675,y:1.5,z:.875},t).easing(h.Easing.Cubic.Out).start();if(this.userData.eyeTweens.push(n,r),this.material&&this.material.uniforms&&this.material.uniforms.nebulaCoreRadius){let e=new h.Tween(this.material.uniforms.nebulaCoreRadius).to({value:15},t).easing(h.Easing.Cubic.Out).start();this.userData.eyeTweens.push(e)}if(e.globalUniformsHub&&e.globalUniformsHub.uNebulaSwirlSpeed){let n=new h.Tween(e.globalUniformsHub.uNebulaSwirlSpeed).to({value:2},t).easing(h.Easing.Cubic.Out).start();this.userData.eyeTweens.push(n)}},t.stopEye=function(t){this.userData.eyeTweens&&this.userData.eyeTweens.forEach(e=>e.stop()),this.userData.eyeTweens=[];let n=this.userData.initValues,r=new h.Tween(this.rotation).to({x:n.rotation.x,y:n.rotation.y,z:n.rotation.z},t).easing(h.Easing.Cubic.Out).start(),i=new h.Tween(this.scale).to({x:n.scale.x,y:n.scale.y,z:n.scale.z},t).easing(h.Easing.Cubic.Out).start();if(this.userData.eyeTweens.push(r,i),this.material&&this.material.uniforms&&this.material.uniforms.nebulaCoreRadius){let e=new h.Tween(this.material.uniforms.nebulaCoreRadius).to({value:n.nebulaCoreRadius},t).easing(h.Easing.Cubic.Out).start();this.userData.eyeTweens.push(e)}if(e.globalUniformsHub&&e.globalUniformsHub.uNebulaSwirlSpeed){let r=new h.Tween(e.globalUniformsHub.uNebulaSwirlSpeed).to({value:n.nebulaSwirlSpeed},t).easing(h.Easing.Cubic.Out).start();this.userData.eyeTweens.push(r)}},t):null}function Va(e,t=3e3){let n=X(e,`wallArea`);if(!n||!n.material)return;let r=n.material.uniforms,i=Ba(e);n.userData.eyeTween&&(n.userData.eyeTween.stop(),n.userData.eyeTween=null),n.userData.latheEyeTweenObj&&(n.userData.latheEyeTweenObj.stop(),n.userData.latheEyeTweenObj=null),r&&r.uEyeActive&&(r.uEyeActive.value=!0),r&&r.uEyeOpenness&&(n.userData.eyeTween=new h.Tween(r.uEyeOpenness).to({value:1},t).easing(h.Easing.Cubic.Out).onStart(()=>{n.material.visible=!0}).start(),i&&i.makeEye(t))}function Ha(e,t=3e3){let n=X(e,`wallArea`);if(!n||!n.material)return;let r=n.material.uniforms,i=Ba(e);n.userData.eyeTween&&(n.userData.eyeTween.stop(),n.userData.eyeTween=null),n.userData.latheEyeTweenObj&&(n.userData.latheEyeTweenObj.stop(),n.userData.latheEyeTweenObj=null),r&&r.uEyeOpenness&&(n.userData.eyeTween=new h.Tween(r.uEyeOpenness).to({value:0},t).easing(h.Easing.Cubic.Out).onComplete(()=>{n.material.visible=!1,r&&r.uEyeActive&&(r.uEyeActive.value=!1)}).start(),i&&i.stopEye(t))}function Ua(t){if(t.isHeroAnimating)return;let n=t.getObjectByName(`a-char`),r=t.getObjectByName(`stool_bound`);if(!n||!r)return;let i=n.position.clone(),a=new e.Vector3,o=new e.Quaternion;r.getWorldPosition(a),r.getWorldQuaternion(o);let s=-9.81,c=L.SYS_SPELL_CHANNELING.en,l=L.SYS_SPELL_CAST.en,u=c[Math.floor(Math.random()*c.length)],d=l[Math.floor(Math.random()*l.length)],f=Sr(t,`castSpell`,{autoReturn:!0,speed:.75,onComplete:()=>{t.world&&(t.world.gravity={x:0,y:s,z:0},console.log(`[Spell Ritual] Animation complete. Gravity restored to ${s}.`)),window._cvGravity=.6,window._cvState===`ritual`&&(window._cvState=`falling`),t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`0%`),t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=``);let c=1200;if(new h.Tween(n.position).to({x:i.x,y:i.y,z:i.z},c).easing(h.Easing.Cubic.InOut).onComplete(()=>{Sr(t,`typing`,{crossFadeDuration:.5})}).start(),r.rapierBody){let n=r.rapierBody,i=n.translation(),s=n.rotation(),l={t:0};new h.Tween(l).to({t:1},c).easing(h.Easing.Cubic.Out).onUpdate(()=>{let t=new e.Vector3().lerpVectors(i,a,l.t),c=new e.Quaternion().copy(s).slerp(o,l.t);n.setTranslation(t,!0),n.setRotation(c,!0);let u=t.clone();r.parent&&r.parent.worldToLocal(u),r.position.copy(u)}).onComplete(()=>{n.setBodyType(_.RigidBodyType.Fixed),t.isHeroAnimating=!1}).start()}else t.isHeroAnimating=!1;setTimeout(()=>{t.allowsResetting=!0,console.log(`[Spell Ritual] Ritual fully finalized.`)},3e3)}});if(!f)return;t.allowsResetting=!1,t.isHeroAnimating=!0;let p=f.action,m=p.getClip();if(new h.Tween(n.position).to({x:1},800).easing(h.Easing.Cubic.Out).start(),r.rapierBody){r.rapierBody.setBodyType(_.RigidBodyType.KinematicPositionBased);let e=r.rapierBody.translation();new h.Tween(e).to({x:e.x+.5},800).easing(h.Easing.Cubic.Out).onUpdate(()=>{r.rapierBody.setNextKinematicTranslation(e)}).start()}let g=m.duration*.5/.75*1e3;t.world&&(t.world.gravity={x:0,y:0,z:0}),t.physicBodies&&t.physicBodies.forEach(e=>e.wakeUp()),window._cvState=`ritual`,window._cvGravity=0,typeof ri==`function`&&ri(),typeof oi==`function`&&oi(g);let v={value:0};new h.Tween(v).to({value:100},g).easing(h.Easing.Quadratic.In).onUpdate(()=>{let e=v.value/100*9;t.world&&(t.world.gravity={x:0,y:e,z:0});let n=-(v.value/100)*1.5;window._cvGravity=n,t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`${v.value}%`),t.cursorInformerText&&(t.cursorInformerText.textContent=`${u}... ${Math.floor(v.value)}%`),v.value>=100&&t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=`var(--c-cyan)`)}).onComplete(()=>{t.world&&(t.world.gravity={x:0,y:27,z:0}),window._cvGravity=-6,t.cursorInformerText&&(t.cursorInformerText.textContent=``),t.conversationManager&&t.conversationManager.shout(d,3e3),p.timeScale=1,console.log(`[Spell Ritual] Peak reached: ${d}. Elements pinned to ceiling.`)}).start()}function Wa(t,n){if(Qa||!n)return;Qa=!0,n.visible=!1;let r=n.position.clone(),i=r.y+3.5,a=n.rapierBody?n.rapierBody:null;a&&a.setBodyType(1);let o=new e.Group;o.position.copy(r),o.rotation.copy(n.rotation),t.add(o);let s=new e.IcosahedronGeometry(.35,1),c=new e.MeshStandardMaterial({color:`#00F3FF`,emissive:`#00F3FF`,emissiveIntensity:15,transparent:!0,opacity:0,wireframe:!0}),l=new e.Mesh(s,c);o.add(l);let u=[];[{pos:[0,0,.5],rot:[0,0,0],dir:[0,0,1]},{pos:[0,0,-.5],rot:[0,Math.PI,0],dir:[0,0,-1]},{pos:[0,.5,0],rot:[-Math.PI/2,0,0],dir:[0,1,0]},{pos:[0,-.5,0],rot:[Math.PI/2,0,0],dir:[0,-1,0]},{pos:[-.5,0,0],rot:[0,-Math.PI/2,0],dir:[-1,0,0]},{pos:[.5,0,0],rot:[0,Math.PI/2,0],dir:[1,0,0]}].forEach(t=>{let n=as(`#00F3FF`,0),r=new e.Mesh(new e.PlaneGeometry(.98,.98),n);r.position.set(...t.pos),r.rotation.set(...t.rot),r.userData.dir=new e.Vector3(...t.dir),o.add(r),u.push(r)}),typeof Va==`function`&&(Va(t,800),Z(`SECTOR_7_BREACH: SYNCHRONIZING_CORE`));let d={y:r.y,opacity:0};new h.Tween(d).to({y:i,opacity:1},450).easing(h.Easing.Back.Out).onUpdate(()=>{o.position.y=d.y,o.rotation.y+=.08,u.forEach(e=>{e.material.uniforms?.uOpacity?e.material.uniforms.uOpacity.value=d.opacity:e.material.opacity=d.opacity}),a&&a.setTranslation({x:o.position.x,y:o.position.y,z:o.position.z},!0)}).onComplete(()=>{setTimeout(()=>{let r={unfold:0,corePulse:.1};c.opacity=1,l.scale.setScalar(.1),new h.Tween(r).to({unfold:2.2,corePulse:1.6},1e3).easing(h.Easing.Elastic.Out).onUpdate(()=>{u.forEach(e=>{let t=r.unfold,n=e.userData.dir.clone().multiplyScalar(.5+t);e.position.copy(n),e.material.uniforms?.uOpacity&&(e.material.uniforms.uOpacity.value=.7+Math.random()*.3)}),l.scale.setScalar(r.corePulse+Math.sin(performance.now()*.015)*.15),l.rotation.y+=.07,l.rotation.z+=.04,o.rotation.y+=.01}).onComplete(()=>{Z(`CORE_DECRYPTED: REWARD_STREAM_ACTIVE`);let i=Math.floor(Math.random()*5)+6;for(let n=0;n<i;n++){let n={x:(Math.random()-.5)*15,y:12+Math.random()*8,z:(Math.random()-.5)*15};ki(t,o.position.clone().add(new e.Vector3(0,.5,0)),n)}new h.Tween(r).to({unfold:0,corePulse:.1},600).easing(h.Easing.Back.In).delay(1200).onUpdate(()=>{u.forEach(e=>{e.position.copy(e.userData.dir.clone().multiplyScalar(.5+r.unfold)),e.material.uniforms?.uOpacity&&(e.material.uniforms.uOpacity.value=.5+r.unfold*.5)}),l.scale.setScalar(Math.max(.01,r.corePulse)),c.opacity=Math.max(0,r.corePulse),o.rotation.z+=.05}).onComplete(()=>{t.remove(o),n.visible=!0,n.position.copy(o.position),n.rotation.copy(o.rotation),a&&(a.setTranslation({x:o.position.x,y:o.position.y,z:o.position.z},!0),a.setRotation({x:n.quaternion.x,y:n.quaternion.y,z:n.quaternion.z,w:n.quaternion.w},!0),a.setBodyType(0),a.applyImpulse({x:0,y:-2,z:0},!0)),Qa=!1,Z(`SYSTEM_STABLE: CORE_REINTEGRATED`),typeof Ha==`function`&&Ha(t,1e3)}).start()}).start()},250)}).start()}var Ga,Ka,qa,J,Y,Ja,Ya,Xa,Za,Qa,$a=O((()=>{Dn(),Ie(),_n(),Ln(),Qn(),Cs(),Ji(),Cr(),xi(),ni(),ci(),rs(),we(),Ds(),ye(),Se(),Da(),us(),Ga=[`floor`,`backWall_rapier`,`rightWall`],Ka=[],qa=(e,t)=>{document.body.style.cursor=`pointer`,bn(e,t),e.gazeFollower&&e.gazeFollower.lookAtTarget(t)},J=e=>{document.body.style.cursor=`auto`,Sn(e),e.gazeFollower&&e.gazeFollower.lookAtTarget(e.camera)},Y=(e,t,n,r=null)=>{r||=Math.random()*1+2.5,Cn(e,t,n,r)},Ja=(t,n,r)=>{let i=n.get(`pokeball`),a=n.get(`pokeball2`),o=n.get(`pokeball3`),s=n.get(`catBlack`),c=n.get(`blackCat`),l=n.get(`catWhite`);n.get(`Object_108`),n.get(`drone`);let u=null,d=0,f=[],p=!1,m=null,g=null,_=null,v=null,y=null,b=(t,n,r)=>{if(console.log(`[Dragon Fortune] Triggered Blessing ritual.`),p){Z(R(`SYS_STORY_VOID_EXHAUSTED`));return}p=!0,Z(R(`SYS_STORY_VOID_RAIN`)),Oi(t);let i=t.globalUniformsHub,a=1;i&&i.uStormSharpness&&(a=i.uStormSharpness.value,new h.Tween(i.uStormSharpness).to({value:0},1500).easing(h.Easing.Cubic.Out).start());let o=t.bulbLight;o&&(t._bulbBaseline===void 0&&(t._bulbBaseline={intensity:o.intensity,angle:o.angle}),La(t,t._bulbBaseline.intensity*.04,t._bulbBaseline.angle,1500));let s=t.getObjectByName(`a-char`),c=new e.Vector3;s?s.getWorldPosition(c):c.set(0,1,0),c.y+=.8;for(let s=0;s<54;s++){let l=r&&r.point?r.point.clone():n.position.clone();l.add(new e.Vector3((Math.random()-.5)*.3,(Math.random()-.5)*.3,(Math.random()-.5)*.3));let u=new e.Vector3().subVectors(c,l).normalize();u.x+=(Math.random()-.5)*.15,u.z+=(Math.random()-.5)*.15,u.normalize();let d=28+Math.random()*12,f=u.multiplyScalar(d);f.y=Math.max(f.y,0)+(15+Math.random()*8),setTimeout(()=>{requestAnimationFrame(()=>{ki(t,l,f,s<53),s===53&&(i&&i.uStormSharpness&&new h.Tween(i.uStormSharpness).to({value:a},2e3).easing(h.Easing.Cubic.InOut).start(),o&&t._bulbBaseline&&La(t,t._bulbBaseline.intensity,t._bulbBaseline.angle,2e3,{easing:h.Easing.Cubic.InOut}),setTimeout(()=>{p=!1},1e3))})},s*60)}},x=()=>{u&&cancelAnimationFrame(u),d=performance.now();let e=3e3,n=0,r={value:0};_=new h.Tween(r).to({value:100},e).onUpdate(()=>{t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`${r.value}%`),r.value>=100&&t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=`var(--c-cyan)`)}).onComplete(()=>{_=null}).start();let i=r=>{let a=r-d,o=Math.min(a/e,1),s=Math.max(0,3-Math.floor(a/1e3));if(s>0){let e=a%1e3/1e3,n=`.`;e>.33&&(n=`..`),e>.66&&(n=`...`),t.cursorInformerText&&(t.cursorInformerText.textContent=`Gravity Well in ${s}${n} `)}else if(o>=1){t.cursorInformerText&&(t.cursorInformerText.textContent=`Nom Nom Nom`),Pa(t,!0);let e=t.raycasterWrapper?t.raycasterWrapper.pointer.y:0;typeof ai==`function`&&ai(-e),u=null;return}let c=1+o*o*20;n+=c,t.cursorInformerIcon&&(t.cursorInformerIcon.style.transform=`rotate(${n}deg)`),u=requestAnimationFrame(i)};u=requestAnimationFrame(i)},S=()=>{u&&=(cancelAnimationFrame(u),null),_&&=(_.stop(),null),t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`0%`),t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=``)},C=()=>{t.cursorInformerIcon&&(t.cursorInformerIcon.style.transform=`rotate(0deg)`)},w=0,T=()=>{let e=performance.now();e-w<500||(w=e,S(),t.cursorInformerText&&(t.cursorInformerText.textContent=`Gravity Well ACTIVE`),li(t,5e3,`pc`),Pa(t,!0),ai(-(t.raycasterWrapper?t.raycasterWrapper.pointer.y:0)))},E=()=>{t.pokeballGridUniforms&&(t.pokeballGridUniforms.uWorldGridActive.value=1,t.pokeballGridUniforms.uWorldGridProgress.value=0,new h.Tween(t.pokeballGridUniforms.uWorldGridProgress).to({value:1},600).easing(h.Easing.Quadratic.Out).onComplete(()=>{setTimeout(()=>{new h.Tween(t.pokeballGridUniforms.uWorldGridProgress).to({value:0},500).onComplete(()=>{t.pokeballGridUniforms.uWorldGridActive.value=0}).start()},500)}).start())},D=e=>{let t=X(e,`a-char`);if(!t||e.isHeroAnimating)return;e.isHeroAnimating=!0,e.allowsResetting=!1;let n=X(e,`stool_bound`);t.userData.originalPosX===void 0&&(t.userData.originalPosX=t.position.x);let r=n?.rapierBody,i=n?.userData.originalTranslation;if(r&&!i){let e=r.translation();n.userData.originalTranslation={x:e.x,y:e.y,z:e.z},i=n.userData.originalTranslation}if(r&&i){let e={x:i.x};new h.Tween(e).to({x:.52},200).easing(h.Easing.Quadratic.Out).onUpdate(()=>r.setNextKinematicTranslation({x:e.x,y:i.y,z:i.z})).start()}new h.Tween(t.position).to({x:.4},200).easing(h.Easing.Quadratic.Out).onComplete(()=>{Sr(e,`sitToStand`,{autoReturn:!1,onComplete:()=>{if(new h.Tween(t.position).to({x:t.userData.originalPosX},300).easing(h.Easing.Quadratic.InOut).onComplete(()=>{e.isHeroAnimating=!1,e.allowsResetting=!0}).start(),r&&i){let e={x:.52};new h.Tween(e).to({x:i.x},300).easing(h.Easing.Quadratic.InOut).onUpdate(()=>r.setNextKinematicTranslation({x:e.x,y:i.y,z:i.z})).start()}Sr(e,`typing`,{crossFadeDuration:.2})}});let n=Q.currentMode===F.POBA?L.SHOUT_STRETCH_LEG_POBA.en:L.SHOUT_STRETCH_LEG_DEV.en;e.conversationManager?.shout(n[Math.floor(Math.random()*n.length)])}).start()},O=(e,t)=>{let r=X(e,`a-char`),i=e.isHeroAnimating||e.allowsResetting===!1;if(y&&=(clearTimeout(y),null),e.heroMenuInterval&&=(clearInterval(e.heroMenuInterval),null),t&&!i){let t=[{label:`DANCE`,icon:Wn,action:()=>sa(e)},{label:`STRETCH`,icon:Gn,action:()=>D(e)},{label:`GOLF`,icon:Wn,action:()=>aa(e)},{label:`SPELL`,icon:zn,action:()=>Ua(e)}];e.heroMenuIndex===void 0&&(e.heroMenuIndex=0);let r=()=>{let n=t[e.heroMenuIndex],r=t.map((t,n)=>`<span style="${n===e.heroMenuIndex?`background: var(--c-cyan); color: var(--c-black); padding: 2px 8px; font-weight: 800; border-radius: 2px; text-shadow: none; box-shadow: 0 0 10px var(--c-cyan);`:`opacity: 0.6; padding: 2px 8px;`}">${t.label}</span>`).join(` `);V(e,n.icon,`<div style="display: flex; gap: 4px; align-items: center; font-family: 'Rajdhani', sans-serif; font-size: 13px; letter-spacing: 1px;">${r}</div>`)};r(),e.heroMenuInterval=setInterval(()=>{e.heroMenuIndex=(e.heroMenuIndex+1)%t.length,r()},800);let i=n.get(`hero_hitbox`);if(e.raycastObjects&&f.length===0&&i&&(f=[...e.raycastObjects],e.raycastObjects=[i],e.world&&(e._originalBallGravity=e.world.hasPointGravityOnBalls,e.world.hasPointGravityOnBalls=!1)),e.conversationManager&&!e._hasShoutedHeroMenu){let t=L.UI_HERO_MENU_ENCOURAGEMENT.en,n=t[Math.floor(Math.random()*t.length)];e.conversationManager.shout(n,1e4,{small:!0}),e._hasShoutedHeroMenu=!0}}else{if(r){let t=X(e,`Ch23_Suit`);t?.material&&t.userData.originalToneMapped!==void 0&&(t.material.toneMapped=t.userData.originalToneMapped)}e.conversationManager&&e.conversationManager.hide(),e._hasShoutedHeroMenu=!1,H(e),f.length>0&&(e.raycastObjects=[...f],f=[],e.world&&e._originalBallGravity!==void 0&&(e.world.hasPointGravityOnBalls=e._originalBallGravity,delete e._originalBallGravity))}},k=(e,t,n,r=!0)=>{if(t)if(e.monitorMenuInterval&&=(clearInterval(e.monitorMenuInterval),null),r&&n){t.userData.menuIndex===void 0&&(t.userData.menuIndex=0);let r=()=>{n[t.userData.menuIndex];let r=n.map((e,n)=>`<span style="${n===t.userData.menuIndex?`background: var(--c-cyan); color: var(--c-black); padding: 2px 8px; font-weight: 800; border-radius: 2px; text-shadow: none; box-shadow: 0 0 10px var(--c-cyan);`:`opacity: 0.6; padding: 2px 8px;`}">${e.label}</span>`).join(` `);V(e,Zn,`<div style="display: flex; gap: 4px; align-items: center; font-family: 'Rajdhani', sans-serif; font-size: 11px; letter-spacing: 1px;">${r}</div>`)};r(),e.monitorMenuInterval=setInterval(()=>{t.userData.menuIndex=(t.userData.menuIndex+1)%n.length,r()},800)}else H(e)},A=(e,t,n,r=!0)=>{if(t)if(e.wallMenuInterval&&=(clearInterval(e.wallMenuInterval),null),r&&n){t.userData.menuIndex===void 0&&(t.userData.menuIndex=0);let r=()=>{n[t.userData.menuIndex];let r=n.map((e,n)=>`<span style="${n===t.userData.menuIndex?`background: var(--c-cyan); color: var(--c-black); padding: 2px 8px; font-weight: 800; border-radius: 2px; text-shadow: none; box-shadow: 0 0 10px var(--c-cyan);`:`opacity: 0.6; padding: 2px 8px;`}">${e.label}</span>`).join(` `);V(e,qn,`<div style="display: flex; gap: 4px; align-items: center; font-family: 'Rajdhani', sans-serif; font-size: 13px; letter-spacing: 1px;">${r}</div>`)};r(),e.wallMenuInterval=setInterval(()=>{t.userData.menuIndex=(t.userData.menuIndex+1)%n.length,r()},1e3)}else H(e)};return{hero_hitbox:{onMouseEnter:e=>{try{document.body.style.cursor=`pointer`,t.isHeroAnimating||t.allowsResetting,t.raycasterWrapper?.mouseInContainer,O(t,!0)}catch(e){console.error(`Error in hero_hitbox onMouseEnter:`,e)}},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t),O(t,!1)},onMouseDown:()=>{if(t.isHeroAnimating||t.allowsResetting===!1)return;let e=[()=>sa(t),()=>D(t),()=>aa(t),()=>Ua(t)][t.heroMenuIndex||0];e&&(H(t),e())}},catBlack:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&V(t,Gn,e.userData.assignedRole||`MAX - TECH LEAD`),xn(t,e,Tn),c&&xn(t,c,Tn),s&&!s.userData.hasShoutedHover&&(v&&clearTimeout(v),v=setTimeout(()=>{t.conversationManager?.shout(L.SHOUT_CAT_BLACK_HOVER.en[0]),s.userData.hasShoutedHover=!0,v=null},400)))},onMouseLeave:e=>{v&&=(clearTimeout(v),null),document.body.style.cursor=`auto`,J(t),H(t)},onMouseDown:(e,n)=>{if(Y(t,e,n),i&&r){let n=[s];c&&n.push(c),Aa(t,i,n,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}s.userData.hasShoutedClick||(t.conversationManager?.shout(L.SHOUT_CAT_BLACK_CLICK.en[0],4e3,{extraSmall:!0}),s.userData.hasShoutedClick=!0)}},catWhite:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,xn(t,e,Tn),t.raycasterWrapper?.mouseInContainer&&V(t,Gn,e.userData.assignedRole||`MIN - QA ENGINEER`),l&&!l.userData.hasShoutedHover&&(v&&clearTimeout(v),v=setTimeout(()=>{t.conversationManager?.shout(L.SHOUT_CAT_WHITE_HOVER.en[0]),l.userData.hasShoutedHover=!0,v=null},400)))},onMouseLeave:e=>{v&&=(clearTimeout(v),null),document.body.style.cursor=`auto`,J(t),H(t)},onMouseDown:(e,n)=>{Y(t,e,n),i&&r&&Aa(t,i,l,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},pokeball:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,Sn(t),xn(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;Y(t,e,n),E();let a=[l,s].filter(e=>e&&e.visible);a.length>0&&Aa(t,i,a,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},pokeball2:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,Sn(t),xn(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;Y(t,e,n),E();let i=[l,s].filter(e=>e&&e.visible);i.length>0&&Aa(t,a,i,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},pokeball3:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,Sn(t),xn(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;Y(t,e,n),E();let i=[l,s].filter(e=>e&&e.visible);i.length>0&&Aa(t,o,i,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},Object_2001:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&V(t,Wn,R(`UI_INFORMER_CHAIR`)),qa(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t),J(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&Y(t,e,n)}},Lathe_Center:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&t.integrityBaselineCaptured&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&V(t,Hn,R(`UI_INFORMER_BLACKHOLE`)),t.raycastObjects&&f.length===0&&(f=[...t.raycastObjects],t.raycastObjects=[e]),x())},onMouseLeave:()=>{if(document.body.style.cursor=`auto`,!t.integrityBaselineCaptured)return;S(),C(),f.length>0&&(t.raycastObjects=[...f],f=[]);let e=n.get(`Object_2001`);e&&e.rapierBody.sleep(),Pa(t,!1),H(t),window._cvState===`sucking`&&ri()},onMouseDown:()=>{t.raycasterEnabled!==!1&&t.integrityBaselineCaptured&&T()},onMouseHover:()=>{wn(t)}},planeSky:{onMouseEnter:()=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&V(t,zn,R(`UI_INFORMER_SKY`)))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t)},onMouseDown:(n,r)=>{if(t.raycasterEnabled===!1)return;let i=r.point.clone(),a=n.worldToLocal(i),o=new e.Vector2(2*a.x,2*a.y),s=t.globalUniformsHub;kn({scene:t,constantUniform:s?s.uniforms:null,windowLight:t.windowLight},2,o,!1)}},glassInvi:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,V(t,Bn,R(`UI_INFORMER_DOOR`)),qa(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t),J(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&(e.userData.hasClickedOnce?Na(t):(Na(t,{forcedX:0}),e.userData.hasClickedOnce=!0))}},lamp:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,V(t,Jn,R(`UI_INFORMER_LAMP`)),qa(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t),J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;let r=n.point.clone();e.worldToLocal(r).y>.1?Mn(t):Y(t,e,n)}},computer:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,V(t,Zn,R(`UI_INFORMER_SCREEN`)),qa(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t),J(t)},onMouseDown:(e,r)=>{if(t.raycasterEnabled===!1)return;Oa(t,Q.currentMode,n),t.conversationManager?.shout(`PERSONNEL ROLES REASSIGNED`);let i=t.globalUniformsHub;Nn({constantUniform:i?i.uniforms:null,windowLight:t.windowLight},.96,null,!1)}},questionCube:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&V(t,Wn,R(`UI_INFORMER_CUBE`)),qa(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t),J(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&(console.log(`[Raycast] questionCube clicked! Triggering ritual.`,e.name),Wa(t,e))}},mjolnir_low_mjolnir_hammer_0:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,V(t,zn,R(`UI_INFORMER_MJOLNIR`)),qa(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t),J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;let r=t.globalUniformsHub;Y(t,e,n,8),kn({scene:t,constantUniform:r?r.uniforms:null,windowLight:t.windowLight},.96,null,!1)}},cFanBulb:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,V(t,Vn,R(`UI_INFORMER_BULB`)))},onMouseLeave:()=>{document.body.style.cursor=`auto`,H(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&Ia(t,e)},onMouseHover:()=>{}},cFanBody:{onMouseEnter:e=>{document.body.style.cursor=`pointer`;let n=R(`UI_INFORMER_FAN_BODY`)||`BOOST & BLAST`;V(t,Vn,n),qa(t,e)},onMouseLeave:()=>{H(t),J(t)},onMouseDown:(e,n)=>{za(t,e)},onMouseHover:()=>{}},wallArea:{onMouseEnter:e=>{if(t.raycasterEnabled===!1)return;document.body.style.cursor=`pointer`,m&&=(clearTimeout(m),null),Va(t);let n=t.objectMap?t.objectMap.get(`wallArea`):null;t.gazeFollower&&t.gazeFollower.lookAtTarget(n),A(t,e,[{label:`BLESSING`,action:()=>b(t,e)},{label:`WRATH`,action:()=>{let e=t.getObjectByName(`cFanBody`)||(t.objectMap?t.objectMap.get(`cFanBody`):null);e&&za(t,e)}}],!0)},onMouseLeave:e=>{document.body.style.cursor=`auto`,t.gazeFollower&&t.gazeFollower.lookAtTarget(t.camera),m=setTimeout(()=>{Ha(t)},4e3),A(t,e,null,!1)},onMouseDown:(e,n)=>{let r=[{label:`BLESSING`,action:()=>b(t,e,n)},{label:`WRATH`,action:()=>{let e=t.getObjectByName(`cFanBody`)||(t.objectMap?t.objectMap.get(`cFanBody`):null);e&&za(t,e)}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action()},onMouseHover:()=>{}},shelf:{},caseCover:{onMouseEnter:e=>{if(t.raycasterEnabled===!1)return;document.body.style.cursor=`pointer`,V(t,Zn,R(`UI_INFORMER_REBOOT`)),qa(t,e),g&&g.stop();let n=t.globalUniformsHub;!n||!n.uFireHeightOverride||(n.uFireHeightOverride.value<.01&&(n.uFireHeightOverride.value=2.5),g=new h.Tween(n.uFireHeightOverride).to({value:6},4e3).easing(h.Easing.Cubic.Out).start())},onMouseLeave:()=>{H(t),J(t);let e=t.globalUniformsHub;!e||!e.uFireHeightOverride||(g=new h.Tween(e.uFireHeightOverride).to({value:0},1e3).easing(h.Easing.Cubic.In).onComplete(()=>{e.uFireHeightOverride&&(e.uFireHeightOverride.value=0)}).start())},onMouseDown:(e,n)=>{g&&g.stop();let r=t.globalUniformsHub;r&&r.uFireHeightOverride&&(r.uFireHeightOverride.value=0),Y(t,e,n),ui(t,4500),[`screenDisplay001`,`screenDisplay002`,`verticalMonitorDisplay`].forEach(e=>{let n=t.objectMap.get(e);n&&(n.material=U,n.userData.originalMaterial=U)})}},droneRC:{onMouseEnter:()=>{document.body.style.cursor=`pointer`;let n=t.getObjectByName(`drone`);n&&(n.userData.isHovering=!0,zo(t,new e.Vector3(0,-.76,.5).unproject(t.camera),!0))},onMouseLeave:()=>{document.body.style.cursor=`auto`;let e=t.getObjectByName(`drone`);if(e){e.userData.isHovering=!1;let n=t.getObjectByName(`drone-beam`);!(n&&n.visible)&&t.gazeFollower&&(t.gazeFollower.isLocked=!1,zo(t,t.camera,!1))}},onMouseDown:e=>{let n=Q.currentMode===F.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`,r=L[n]?.en||[],i;if(r.length>1){let t=r.filter(t=>t!==e.userData.lastSubtitle);i=t[Math.floor(Math.random()*t.length)]}else i=R(n);e.userData.lastSubtitle=i,ps(i),Bo(t,i)}},Object_34001:{onMouseEnter:e=>{document.body.style.cursor=`pointer`,k(t,e,[{label:`FIREWKS`,action:()=>{e.material=qr,e.userData.originalMaterial=qr}},{label:`MOON`,action:()=>{e.material=Jr,e.userData.originalMaterial=Jr}},{label:`SUNSET`,action:()=>{e.material=Yr,e.userData.originalMaterial=Yr}},{label:`NETFLIX`,action:()=>{e.material=Xr,e.userData.originalMaterial=Xr,t.globalUniformsHub?.uniforms.iTime&&(Xr.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[G,Qr],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}],!0)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1)},onMouseDown:(e,n)=>{let r=[{label:`FIREWKS`,action:()=>{e.material=qr,e.userData.originalMaterial=qr}},{label:`MOON`,action:()=>{e.material=Jr,e.userData.originalMaterial=Jr}},{label:`SUNSET`,action:()=>{e.material=Yr,e.userData.originalMaterial=Yr}},{label:`NETFLIX`,action:()=>{e.material=Xr,e.userData.originalMaterial=Xr,t.globalUniformsHub?.uniforms.iTime&&(Xr.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[G,Qr],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,Y(t,t.objectMap.get(`Object_31`),n,4),k(t,e,r)}},screenDisplay001:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,k(t,e,[{label:`CODE`,action:()=>{e.material=U,e.userData.originalMaterial=U,typeof window.cvReset==`function`&&window.cvReset(1500)}},{label:`NETFLIX`,action:()=>{e.material=W,e.userData.originalMaterial=W,ri(),t.globalUniformsHub?.uniforms.iTime&&(W.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[G,Qr],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n,ri()}}],!0),U.uniforms.uHoverActive&&(U.uniforms.uHoverActive.value=1))},onMouseHover:(e,t)=>{if(!U.uniforms.uHoverActive)return;let n=t.uv,r=.045;1-r;let i=(n.x-r)/.955-.5,a=.035;.8999999999999999-a;let o=(n.y-a)/.8649999999999999;U.uniforms.uTargetHoverPos.value.set(i,o)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1),U.uniforms.uHoverActive&&(U.uniforms.uHoverActive.value=0)},onMouseDown:(e,n)=>{let r=[{label:`CODE`,action:()=>{e.material=U,e.userData.originalMaterial=U,typeof window.cvReset==`function`&&window.cvReset(1500)}},{label:`NETFLIX`,action:()=>{e.material=W,e.userData.originalMaterial=W,ri(),t.globalUniformsHub?.uniforms.iTime&&(W.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[G,Qr],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n,ri()}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,Y(t,t.objectMap.get(`screenDisplay`),n,4),k(t,e,r)}},verticalMonitorDisplay:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,k(t,e,[{label:`SPLIT`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(0),t.needsUpdate=!0)}},{label:`FULL`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(1),t.needsUpdate=!0)}}],!0),U.uniforms.uHoverActive&&(U.uniforms.uHoverActive.value=1))},onMouseHover:(e,t)=>{if(!U.uniforms.uHoverActive)return;let n=t.uv,r=.045;1-r;let i=(n.x-r)/.955,a=.035;.8999999999999999-a;let o=(n.y-a)/.8649999999999999;U.uniforms.uTargetHoverPos.value.set(i,o)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1),U.uniforms.uHoverActive&&(U.uniforms.uHoverActive.value=0)},onMouseDown:(e,n)=>{let r=[{label:`SPLIT`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(0),t.needsUpdate=!0)}},{label:`FULL`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(1),t.needsUpdate=!0)}}];if(e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,n.uv&&U.uniforms.uClickPos){let e=n.uv,r=.045;1-r;let i=(e.x-r)/.955,a=.035;.8999999999999999-a;let o=(e.y-a)/.8649999999999999;U.uniforms.uClickPos.value.set(i,o),t.globalUniformsHub?.uniforms.iTime&&(U.uniforms.uClickTime.value=t.globalUniformsHub.uniforms.iTime.value)}Y(t,t.objectMap.get(`verticalMonitor`),n,4),k(t,e,r)}},screenDisplay002:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,k(t,e,[{label:`CODE`,action:()=>{e.material=U,e.userData.originalMaterial=U}},{label:`NETFLIX`,action:()=>{e.material=W,e.userData.originalMaterial=W,t.globalUniformsHub?.uniforms.iTime&&(W.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[G,Qr],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}],!0),U.uniforms.uHoverActive&&(U.uniforms.uHoverActive.value=1))},onMouseHover:(e,t)=>{if(!U.uniforms.uHoverActive)return;let n=t.uv,r=.045;1-r;let i=.54+(n.x-r)/.955,a=.035;.8999999999999999-a;let o=(n.y-a)/.8649999999999999;U.uniforms.uTargetHoverPos.value.set(i,o)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1),U.uniforms.uHoverActive&&(U.uniforms.uHoverActive.value=0)},onMouseDown:(e,n)=>{let r=[{label:`CODE`,action:()=>{e.material=U,e.userData.originalMaterial=U}},{label:`NETFLIX`,action:()=>{e.material=W,e.userData.originalMaterial=W,t.globalUniformsHub?.uniforms.iTime&&(W.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[G,Qr],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,Y(t,t.objectMap.get(`screenDisplay2`),n,4),k(t,e,r)}},aegis:{onMouseEnter:e=>{qa(t,e),V(t,Zn,R(`UI_INFORMER_AEGIS`)),ls(t,e)},onMouseLeave:e=>{J(t),H(t),cs(t)},onMouseDown:(e,n)=>{let r=t.objectMap.get(`screenDisplay001`),i=t.objectMap.get(`Object_34001`),a=[{screen:r,pool:[G,Qr]},{screen:i,pool:[G,Qr]}],o=a[Math.floor(Math.random()*a.length)];if(o.screen&&o.pool.length>0){let e=o.pool[Math.floor(Math.random()*o.pool.length)];o.screen.material=e,o.screen.userData.originalMaterial=e,Z(R(`SYS_STORY_DOTA_LIFE`))}Y(t,e,n)}},aegis2:{onMouseEnter:e=>{qa(t,e),V(t,Zn,R(`UI_INFORMER_AEGIS`)),ls(t,e)},onMouseLeave:e=>{J(t),H(t),cs(t)},onMouseDown:(e,n)=>{let r=t.objectMap.get(`screenDisplay001`),i=t.objectMap.get(`Object_34001`),a=[{screen:r,pool:[G,Qr]},{screen:i,pool:[G,Qr]}],o=a[Math.floor(Math.random()*a.length)];if(o.screen&&o.pool.length>0){let e=o.pool[Math.floor(Math.random()*o.pool.length)];o.screen.material=e,o.screen.userData.originalMaterial=e,Z(`PICK ME!!`)}Y(t,e,n)}}}},Ya=e=>{H(e),document.body.style.cursor=`auto`},Xa=!1,Za=!1,Qa=!1}));function eo(e){return function(t){let n=e*1.525;return(t*=2)<1?.5*(t*t*((n+1)*t-n)):.5*((t-=2)*t*((n+1)*t+n)+2)}}function to(e){return function(t){let n=e;return--t*t*((n+1)*t+n)+1}}var no,ro,io=O((()=>{no=eo(.4),ro=to(.04)})),ao,oo=O((()=>{ao={isUnlocked:!0,init:e=>{let t=e.HUD;!t||!t.navButtons||t.navButtons.forEach(e=>{e.hide(0),e.setActive(!1)})},onHudOpen:e=>{let t=e.HUD;if(!t||!t.navButtons)return;t.navButtons.forEach((e,t)=>{t!==0&&e.hide(0)});let n=t.navButtons[0];n.show(1200,1),n.setActive(!1)},onMorphToAbout:e=>{let t=e.HUD;if(!t||!t.navButtons)return;let n=1e3,r=t.navButtons[3];r.setText(`ABOUT`),r.show(n,2),r.setActive(!0),setTimeout(()=>{let e=t.navButtons[2];e.setText(`LAB`),e.show(n,1.8),e.setActive(!1)},150),setTimeout(()=>{let e=t.navButtons[1];e.setText(`WORK`),e.show(n,2.2),e.setActive(!1)},300)},onRoomAssemble:e=>{let t=e.HUD;if(!t||!t.navButtons)return;ao.isUnlocked=!0,t.navButtons[0].show(1500,1);let n=t.navButtons[2];n.setText(`LAB`),n.show(1500,1.8),n.setActive(!0);let r=t.navButtons[1];r.setText(`WORK`),r.show(1500,2.2),r.setActive(!1);let i=t.navButtons[3];i.setText(`ABOUT`),i.show(1500,2),i.setActive(!1)}}}));function so(e){if(!e||!e.renderer)return;let t=(window.devicePixelRatio||1)*.2,n=e.renderer.getPixelRatio();Math.abs(n-t)>.01&&(e.renderer.setPixelRatio(t),e.pointsApp&&typeof e.pointsApp.onWindowResize==`function`&&e.pointsApp.onWindowResize())}async function co(e,t,n,r=800){if(!e||!e.renderer)return;let i=window.devicePixelRatio||1,a=[.35,.5,n];for(let n of a)n<=t||(await Do(r),e.renderer&&(e.renderer.setPixelRatio(i*n),e.pointsApp&&typeof e.pointsApp.onWindowResize==`function`&&e.pointsApp.onWindowResize()))}async function lo(e,t=800,n=!1){performance.now(),e.isTransitioning=!0,e.HUD&&typeof e.HUD.stopBreathing==`function`&&e.HUD.stopBreathing(),e.renderer&&(e.renderer.shadowMap.autoUpdate=!1,so(e));let r=X(e,`roomGLBModel`);r&&(r.visible=!0,r.scale.set(1,1,1),r.position.set(0,0,0),e.physicObjects&&e.physicObjects.forEach(e=>{e.visible=!0}),[`rightWall-cover`,`floor`,`planeSky`].forEach(t=>{let n=X(e,t);n&&(n.visible=!0)}));let i=e.isLowPowerMode,a=n?0:i?600:1050;[`floor`,`planeSky`,`rightWall-cover`].forEach(n=>{let r=X(e,n);r&&(r.visible=!0,vo({obj:r,duration:t*(i?.1:.2),delay:a,easing:to(.25)}))});let o=X(e,`a-char`);o&&(o.visible=!0,o.scale.setScalar(1e-4),o.userData.originalPos&&o.position.copy(o.userData.originalPos),o.userData.originalRot&&o.rotation.copy(o.userData.originalRot),o.updateMatrix());let s=X(e,`stool`);s&&(s.visible=!0,s.scale.setScalar(1e-4),s.userData.originalPos&&s.position.copy(s.userData.originalPos),s.userData.originalRot&&s.rotation.copy(s.userData.originalRot),s.updateMatrix());let c=X(e,`stool_bound`);c&&(c.visible=!1,c.userData.originalPos&&c.position.copy(c.userData.originalPos),c.userData.originalScale&&c.scale.copy(c.userData.originalScale),c.userData.originalRot&&c.rotation.copy(c.userData.originalRot),c.updateMatrix()),e.points.material.uniforms.uPixelRatio.value,e.points.material.uniforms.uSize.value;let l=n?0:i?900:1500,u=.15,d=.05,f=l*(1-u-d),p=he[1].toneMappingExposure,m=t=>new h.Tween(e.points.material.uniforms.uPixelRatio).to({value:t},f).easing(h.Easing.Exponential.In),g=t=>new h.Tween(e.points.material.uniforms.uSize).to({value:t},f).easing(h.Easing.Exponential.In),_=t=>new h.Tween(e.renderer).to({toneMappingExposure:t},f).easing(h.Easing.Linear.None);if(n)o&&(o.visible=!0,vo({obj:o,duration:100})),s&&(s.visible=!0,vo({obj:s,duration:100})),Uo(e,0);else{let t=new h.Tween(e.points.bloomPass).to({strength:0},l*u).delay(l*d).easing(h.Easing.Back.InOut).onComplete(async()=>{let t=X(e,`rightWall-cover`);t&&(t.visible=!0),window.showSectionPoint&&window.showSectionPoint()});new h.Tween(e.points.bloomPass).to({strength:5},f).easing(h.Easing.Quadratic.In).onComplete(async()=>{o&&o.scale.copy(o.userData.originalScale),s&&s.scale.copy(s.userData.originalScale),c&&(c.visible=!0,c.userData.originalPos&&c.position.copy(c.userData.originalPos),c.userData.originalRot&&c.rotation.copy(c.userData.originalRot),c.scale.copy(c.userData.originalScale),c.updateMatrix()),e.pointsApp&&e.pointsApp.points&&(e.pointsApp.points.visible=!1),t.start()}).start(),m(0).start(),g(0).start(),setTimeout(()=>{Uo(e)},f*.1)}_(p).start()}async function uo(e,t){let n=yo(e);n.forEach((e,t)=>{}),e.loadedModel&&e.loadedModel.model&&e.loadedModel.model.position.set(0,0,0);let r=n.filter(e=>/^book\d+$/.test(e.name)),i=n.filter(e=>!/^book\d+$/.test(e.name)),a=e.isLowPowerMode,o=(e,t,n=1,r=!1,i=null)=>new Promise(a=>{if(e.length===0)return a();let o=0,s=e.length,c=r?h.Easing.Cubic.Out:to(1),l=Math.ceil(s/5),u=0,d=()=>{let f=Math.min(u+l,s);performance.now();for(let l=u;l<f;l++){let u=e[l];u.userData.scenarioTween&&(u.userData.scenarioTween.stop(),u.userData.scenarioTween=null),u.userData.wasMatrixAutoUpdate=u.matrixAutoUpdate,u.matrixAutoUpdate=!1;let d=u.userData,f=(Math.random()-.5)*500,p=Math.max(0,l/s*t*n+f),m=t*(r?1:.7+Math.random()*.7),g={t:0};u.userData.scenarioTween=new h.Tween(g).to({t:1},m).delay(p).easing(c).onUpdate(()=>{let e=g.t;d.originalPos&&d.hidePos&&(u.position.x=d.hidePos.x+(d.originalPos.x-d.hidePos.x)*e,u.position.y=d.hidePos.y+(d.originalPos.y-d.hidePos.y)*e,u.position.z=d.hidePos.z+(d.originalPos.z-d.hidePos.z)*e),d.originalScale&&d.hideScale&&(u.scale.x=d.hideScale.x+(d.originalScale.x-d.hideScale.x)*e,u.scale.y=d.hideScale.y+(d.originalScale.y-d.hideScale.y)*e,u.scale.z=d.hideScale.z+(d.originalScale.z-d.hideScale.z)*e),r&&d.originalRot&&d.hideRot&&(u.rotation.x=d.hideRot.x+(d.originalRot.x-d.hideRot.x)*e,u.rotation.y=d.hideRot.y+(d.originalRot.y-d.hideRot.y)*e,u.rotation.z=d.hideRot.z+(d.originalRot.z-d.hideRot.z)*e),u.matrixAutoUpdate===!1&&u.updateMatrix()}).onComplete(async()=>{u.userData.scenarioTween=null,o++,o===s&&(i&&await i(),a())}).start()}u=f,u<s&&requestAnimationFrame(d)};d()});await o(i,t,a?.3:.5),await Do(a?34:68),await o(r,t*.8,a?.3:.4,!0,async()=>{await fo(e,n),Vo(e,1),setTimeout(()=>{$o(e),e.physicObjects&&e.physicObjects.forEach((e,t)=>{e.rapierBody&&setTimeout(()=>{e.rapierBody&&e.rapierBody.wakeUp()},t*6)})},250),await Do(a?300:500)})}function fo(e,t){return new Promise(n=>{let r=0,i=()=>{let a=Math.min(r+20,t.length);for(let e=r;e<a;e++){let n=t[e];n.matrixAutoUpdate=n.userData.wasMatrixAutoUpdate===void 0?!0:n.userData.wasMatrixAutoUpdate,n.updateMatrix()}r=a,r<t.length?requestAnimationFrame(i):(e.loadedModel&&e.loadedModel.model&&e.loadedModel.model.updateMatrixWorld(!0),n())};i()})}async function po(e,t=!0){e.objectMap.get(`planeSky`),e.objectMap.forEach((e,n)=>{/^dragonBall\d+Stars$/.test(n)&&(e.visible=t)}),t?(e.clock.start(),Z(`Clock Resumed.`)):(e.clock.stop(),Z(`Clock Paused.`)),e.world&&(e.world.isActive=t,Z(t?`Physics Activated.`:`Physics Deactivated.`))}function mo(e){e.userData.originalPos=e.position.clone(),e.userData.originalScale=e.scale.clone(),e.userData.originalRot=e.rotation.clone(),bo(e,Zo,`x`,-1),e.scale.set(0,0,0),e.rotation.z+=.1*Math.PI*2,e.visible=!0}function ho(e,t,n=0){let r=e.objectMap.get(`blackholeScene`);if(!r.userData.originalPos||!r.userData.originalScale||!r.userData.originalRot)return;let i=r.position.clone(),a=r.userData.originalPos,o=r.scale.clone(),s=r.userData.originalScale,c=r.rotation.z,l=r.userData.originalRot.z,u=t*2,d={t:0};new h.Tween(d).to({t:2},u).easing(h.Easing.Linear.None).delay(n).onUpdate(()=>{let t=d.t;if(t<=1){let e=h.Easing.Back.Out(t);r.position.lerpVectors(i,a,e)}else{r.position.copy(a),e.fireflies.material.uniforms.uSizeFactor.value=1;let n=Math.min(t-1,1),i=h.Easing.Back.Out(n);r.scale.lerpVectors(o,s,i);let u=h.Easing.Back.InOut(n);r.rotation.z=c+(l-c)*u}}).onComplete(()=>{r.position.copy(a),r.scale.copy(s),r.rotation.z=l,new h.Tween(e.fireflies.material.uniforms.uKamikazeScale).to({value:1},t).easing(h.Easing.Cubic.In).start()}).start()}function go(e){let t=e.objectMap.get(`planeSky`);t&&(t.visible=!1);let n=e.objectMap.get(`blackholeScene`);n&&mo(n),[`rightWall-cover`,`a-char`,`stool`,`stool_bound`,`floor`,`moon`,`planeSky`].forEach(t=>{let n=e.getObjectByName(t);if(n){_o(n);let e=t===`a-char`||t===`stool`||t===`stool_bound`;t!==`floor`&&t!==`moon`&&!e?(n.position.set(0,-Zo,0),n.visible=!1):e?(n.visible=!0,n.scale.setScalar(1e-4)):n.visible=!1}}),yo(e).forEach(e=>{/^book\d+$/.test(e.name)?_o(e,{fixedAxis:`x`,fixedDirection:1,enableSpin:!0,ignoreAxisOffset:!1}):_o(e,{fixedAxis:`x`,fixedDirection:-1,ignoreAxisOffset:!1})})}function _o(e,t={}){let{fixedAxis:n=null,fixedDirection:r=null,enableSpin:i=!1,ignoreAxisOffset:a=!1}=t;e.userData.originalPos=e.position.clone(),e.userData.originalScale=e.scale.clone(),e.userData.originalRot=e.rotation.clone();let o=r===null?Math.random()>.5?1:-1:r;if(a?xo(e,Zo,n,o):bo(e,Zo,n,o),i){let t=(Math.random()*50+50)*(Math.PI*2),n=Math.random()>.5?1:-1;e.rotation.y+=t*n}e.scale.set(0,0,0),e.visible=!0,e.userData.hidePos=e.position.clone(),e.userData.hideScale=e.scale.clone(),e.userData.hideRot=e.rotation.clone(),e.name}function vo({obj:e,duration:t,delay:n=0,enableSpin:r=!1,easing:i=h.Easing.Cubic.Out}){if(!e.userData.originalPos)return;let a=e.position.clone(),o=e.scale.clone(),s=e.rotation.clone(),c=e.userData.originalPos,l=e.userData.originalScale,u=e.userData.originalRot,d=e.castShadow,f=e.receiveShadow,p=e.matrixAutoUpdate,m=e.frustumCulled;e.castShadow=!1,e.receiveShadow=!1,e.matrixAutoUpdate=!1,e.frustumCulled=!1;let g={t:0};new h.Tween(g).to({t:1},t).delay(n).easing(h.Easing.Linear.None).onUpdate(()=>{let t=g.t,n=i(Math.min(t/.7,1));e.position.lerpVectors(a,c,n);let d=Math.max(0,(t-.2)/.6),f=h.Easing.Back.Out(Math.min(d,1));if(e.scale.lerpVectors(o,l,f),r){let n=Math.max(0,(t-.4)/.6),r=h.Easing.Quadratic.Out(Math.min(n,1));e.rotation.x=s.x+(u.x-s.x)*r,e.rotation.y=s.y+(u.y-s.y)*r,e.rotation.z=s.z+(u.z-s.z)*r}e.updateMatrix()}).onComplete(()=>{e.castShadow=d,e.receiveShadow=f,e.matrixAutoUpdate=p,e.frustumCulled=m,e.position.copy(c),e.scale.copy(l),e.rotation.copy(u),e.updateMatrix(),e.updateMatrixWorld(!0)}).start()}function yo(e){if(e.assembleGroups)return e.assembleGroups;let t=e.children.filter(t=>!t.name||t.isCamera||t.isLight||t.isBone||t.name===`roomGLBModel`||t===e||t.name===`HUDFrame`||Qo.includes(t.name)||/^dragonBall\d+Stars$/.test(t.name)||/^Ch23_/.test(t.name)||/^mixamorig/.test(t.name)||/^BTC_/.test(t.name)||/^ETH_/.test(t.name)?!1:t.isObject3D);return t.sort((e,t)=>{let n=e=>e.material?Array.isArray(e.material)?e.material[0].uuid:e.material.uuid:``;return n(e).localeCompare(n(t))}),e.assembleGroups=t,t}function bo(e,t,n=null,r=1){let i=[`x`,`y`,`z`],a=n;(!a||!i.includes(a))&&(a=i[Math.floor(Math.random()*3)]),a===`y`&&(r=1),e.position[a]+=t*r}function xo(e,t,n=null,r=1){let i=[`x`,`y`,`z`],a=n;(!a||!i.includes(a))&&(a=i[Math.floor(Math.random()*3)]),a===`y`&&(r=1),e.position[a]+=t*r;let o=t*.5;i.filter(e=>e!==a).forEach(t=>{let n=Math.random()>.5?1:-1;t===`y`&&(n=1),e.position[t]+=o*n})}function X(e,t){if(!t)return null;if(e.objectMap||wo(e),e.objectMap.has(t))return e.objectMap.get(t);let n=e.getObjectByName(t);return n&&e.objectMap.set(t,n),n}function So(e,t){!t||!t.name||(e.objectMap||wo(e),e.objectMap.set(t.name,t))}function Co(e,t){e.objectMap&&e.objectMap.delete(t)}function wo(e){let t=new Map;return e.traverse(e=>{e.name&&t.set(e.name,e)}),e.objectMap=t,t}async function To(){let e=document.getElementById(`progress-text`),t=document.getElementById(`progress-bar`),n=document.getElementById(`cv-container`);e&&(e.innerText=R(`SYS_READY`)),t&&(t.parentElement.style.opacity=`0`),n&&n.classList.add(`collapsed`);let r=document.getElementById(`main-ui`);r&&(r.style.opacity=`0`),await Do(200)}async function Eo(){let e=document.getElementById(`loading-container`),t=document.querySelector(`.loader-content`);if(t&&(t.style.transition=`opacity 0.5s ease`,t.style.opacity=`0`),e){await Do(100),e.style.transition=`opacity 0.4s ease`,e.style.opacity=`0`,await Do(400),e.style.display=`none`;let t=document.getElementById(`main-ui`);t&&(t.style.transition=`opacity 1s ease`,t.style.opacity=`1`)}}function Do(e){return new Promise(t=>setTimeout(t,e))}async function Oo(t,n={}){let{duration:r=3e3,delay:i=0,onStart:a,onComplete:o}=n,s=t.getObjectByName(`drone`);if(!s){console.error(`Drone not found`);return}return new Promise(n=>{let c=s.position.clone(),l=new e.Vector3(9,1,-1.3),u=new e.Vector3(-1,9,-5);ns=u;let d=new e.CatmullRomCurve3([c,l,u],!1,`centripetal`),f=s.quaternion.clone(),p=new e.Euler(-Math.PI/2,.2,1.25),m=new e.Quaternion().setFromEuler(p),g=new e.Quaternion().setFromAxisAngle(new e.Vector3(1,0,0),Math.PI/2);m.multiply(g);let _={val:0},v=new e.Quaternion;new h.Tween(_).to({val:1},r).delay(i).easing(h.Easing.Quadratic.InOut).onStart(()=>{let e=new Le(s);e.init(),t.gazeFollower=e,a&&a()}).onUpdate(()=>{if(t._spawnStopSignal){_.val=1;return}let e=d.getPoint(_.val);s.rapierBody.setNextKinematicTranslation(e),v.copy(f).slerp(m,_.val);let n=t.world;if(n&&!n.isBusy)try{let e=n.isBusy;n.isBusy=!0,s.rapierBody.setRotation({x:v.x,y:v.y,z:v.z,w:v.w},!0),n.isBusy=e}catch(e){console.error(`[Scenario] Rapier failed to set rotation @CurveAnim:`,e.message),e.message.includes(`recursive`)&&console.trace(`[Scenario] Recursive WASM call trace @CurveAnim:`)}}).onComplete(()=>{if(t._spawnStopSignal){n();return}t.world&&!t.world.isBusy&&(s.rapierBody.setTranslation({x:u.x,y:u.y,z:u.z},!0),s.rapierBody.setRotation({x:m.x,y:m.y,z:m.z,w:m.w},!0)),o&&o(),n()}).start()})}function ko(e){e.globalUniformsHub.uStormSharpness.value=0}function Ao(e){e.globalUniformsHub.enableLightning.value=!1,e.globalUniformsHub.uRainHeaviness.value=0,e.globalUniformsHub.glassRainAmount.value=0,e.globalUniformsHub.rainGlassOpacity.value=0}function jo(e){let t=e.getObjectByName(`floor`),n=e.getObjectByName(`Object_0003_3`),r=e.getObjectByName(`Object_12001`);t?.material&&(t.material.envMapIntensity=.1),n?.material&&(n.material.envMapIntensity=.7),r?.material&&(r.material.envMapIntensity=0),e.environmentIntensity=.4}function Mo(e){ko(e),Ao(e),jo(e)}function No(e,t=12e3){let n=e.globalUniformsHub,r=t,i=h.Easing.Linear.None,a={val:0},o=new h.Tween(a).to({val:1},r).easing(i).onUpdate(()=>{e.globalUniformsHub.glassRainAmount.value=a.val,e.globalUniformsHub.rainGlassOpacity.value=a.val}),s=new h.Tween(n.uMoonPosition.value).to({x:`+0.001`,y:`+0.05`},r*2).easing(i),c=new h.Tween(n.uMoonSize).to({value:n.uMoonSize.value*.65},r*2).easing(i),l={t:0};new h.Tween(l).to({t:1},r).easing(i).onUpdate(()=>{e.globalUniformsHub.uStormSharpness.value=l.t,e.globalUniformsHub.uRainHeaviness.value=l.t*.75}).onStart(()=>{setTimeout(()=>{o.start(),s.start(),c.start()},r*.4)}).onComplete(()=>{}).start()}async function Po(t,n=3e3){let r=t.objectMap.get(`bulb`);if(!r)return;let i=new e.Vector3(1,1,1),a=new e.Vector3(0,9.2,0),o=r.rotation.clone(),s=r.getObjectByName(`bulbLight`);s||(s=t.getObjectByName(`bulbLight`)||t.bulbLight,s&&r&&(r.attach(s),s.position.set(0,0,0),s.target&&(r.add(s.target),s.target.position.set(0,-10,0))));let c=s?s.intensity:0,l=s?s.distance:0,u=new e.Vector3(0,0,0);t.objectMap.get(`Lathe_Center`);let d=new e.Vector3;d.copy(r.position),r.position.copy(d),r.visible=!0,r.scale.setScalar(0),r.material.visible=!0,s&&s.parent!==r&&(r.add(s),s.target&&r.add(s.target),s.position.set(0,0,0),s.target.position.set(0,-10,0));let f=r.getObjectByName(`bulbAura`);f&&(f.visible=!0);let p={t:0},m=t.animations[1],g=t.mixer.clipAction(m);g.reset(),g.play(),new h.Tween(p).to({t:1},n).easing(h.Easing.Back.Out).onStart(()=>{}).onUpdate(()=>{let t=p.t;r.scale.lerpVectors(u,i,t),s&&(s.intensity=e.MathUtils.lerp(c,1e3,t),s.distance=e.MathUtils.lerp(l,25,Math.min(t*5,1))),r.position.lerpVectors(d,a,t);let n=Math.sin(t*Math.PI)*1.5,f=-t*Math.PI*2*4;r.position.y+=Math.cos(f)*n,r.position.z+=Math.sin(f)*n;let m=(1-t)*Math.PI*2*4;r.rotation.set(o.x+m,o.y+m*.5,o.z)}).onComplete(()=>{t.raycasterEnabled=!0,Z(`Scenario Stable. System interactions re-enabled.`),s&&new h.Tween(s).to({intensity:800},3e3).easing(h.Easing.Back.Out).start(),t._spawnStopSignal||(!t.dragonBalls||t.dragonBalls.length===0)&&Fo(t,r)}).start()}function Fo(t,n){t.dragonBalls&&t.dragonBalls.length>0&&t.dragonBalls.forEach(e=>{e.parent&&e.parent.remove(e),t.remove(e)}),t.dragonBalls=[],setTimeout(()=>{Z(`The Dragon Balls descend...`);for(let r=1;r<=7;r++){let i=()=>{if(t._spawnStopSignal)return;if(t.world.isBusy){setTimeout(i,16);return}let a=rr(t,r);if(!a){setTimeout(i,16);return}let o=new e.Vector3;n.getWorldPosition(o),o.y-=.5,o.x+=(Math.random()-.5)*.2,o.z+=(Math.random()-.5)*.2,a.position.copy(o),a.userData.originalPos=a.position.clone(),a.userData.originalScale=a.scale.clone(),a.userData.originalRot=a.rotation.clone(),a.rapierBody&&(a.rapierBody.setTranslation(o,!0),a.rapierBody.wakeUp()),a.userData.oscStrength=2;let s=a.children.find(e=>e.name.startsWith(`Aura`));s&&(s.userData.oscStrength=2);let c=e=>{e.onBeforeRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&(this.userData.prevOsc=i.uniforms.uOscillationStrength.value,i.uniforms.uOscillationStrength.value=this.userData.oscStrength)},e.onAfterRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&(i.uniforms.uOscillationStrength.value=this.userData.prevOsc)}};c(a),s&&c(s);let l=a.scale.clone(),u=.1;if(a.scale.multiplyScalar(u),Ee(t,a,a.rapierBody,a.rapierShape),a.rapierBody){let e=a.rapierBody.mass(),t=(Math.random()>.5?1:-1)*(.7+Math.random());a.rapierBody.applyImpulse({x:1.6*e,y:0,z:t*e},!0)}let d=.5;a.rapierShape&&a.rapierShape.radius&&l.x>0&&(d=a.rapierShape.radius/l.x),a.rapierCollider.setRadius(a.scale.x*d),setTimeout(()=>{let e=4500,t=l.clone().multiplyScalar(u),n={t:0};new h.Tween(n).to({t:1},e).easing(h.Easing.Cubic.Out).onUpdate(()=>{let e=n.t;if(a.scale.lerpVectors(t,l,e),a.rapierCollider)try{typeof a.rapierCollider.setRadius==`function`&&a.rapierCollider.setRadius(a.scale.x*d)}catch{}}).start();let r={t:0};new h.Tween(r).to({t:1},e).easing(h.Easing.Exponential.In).onUpdate(()=>{let e=2*(1-r.t);a.userData.oscStrength=e,s&&(s.userData.oscStrength=e)}).start()},3e3)};setTimeout(i,r*300)}let r=8*300;setTimeout(()=>{Z(`Point Gravity System Online.`),t.world&&(t.world.hasPointGravityOnBalls=!0)},r+3e3),setTimeout(()=>{let n=t.getObjectByName(`cFanBulb`),r=t.getObjectByName(`bulb`),i=t.getObjectByName(`bulbLight`);if(!n||!r)return;if(i){n.attach(i),i.position.set(0,0,0);let r=new e.Vector3;i.getWorldPosition(r),t.add(i.target),i.target.position.set(r.x,r.y-10,r.z)}let a=new e.Vector3;r.getWorldPosition(a);let o=new e.Vector3;n.getWorldPosition(o),r.scale.x,new h.Tween(r.scale).to({x:.1,y:.1,z:.9},2e3).easing(h.Easing.Cubic.In).start(),new h.Tween(r.position).to(o,2e3).easing(h.Easing.Cubic.In).start().onComplete(()=>{r.visible=!1,K&&K.uniforms&&K.uniforms.glowIntensity&&new h.Tween(K.uniforms.glowIntensity).to({value:1},500).easing(h.Easing.Quadratic.Out).start(),K&&K.uniforms&&K.uniforms.glowPower&&new h.Tween(K.uniforms.glowPower).to({value:.015},500).easing(h.Easing.Quadratic.Out).start(),Z(`Power transferred to ceiling array.`),new h.Tween(r.scale).to({x:.1,y:.1,z:.1},500).easing(h.Easing.Quadratic.Out).onComplete(()=>{r.visible=!1}).start()}).start()},r)},100)}function Io(t,n={}){let{duration:r=2e3,delay:i=0,onComplete:a}=n,o=new e.Object3D;o.name=`testObj`,t.add(o);let s=t.getObjectByName(`mjolnir_low_mjolnir_hammer_0`);if(!s.isFlying)if(s.isFlying=!0,s&&s.rapierBody){Z(`Boomerang Mjolnir initiated`);let n=s.userData.originalPos,o=s.userData.originalRot;if(!n||!o){console.error(`Mjolnir missing userData.originalPos/Rot`);return}let c=new e.Vector3(-1.5,9,7.3),l=new e.Vector3(-20,15,30);s.rapierBody.setBodyType(_.RigidBodyType.KinematicPositionBased),s.rapierBody.isManualControl=!0,s.rapierBody.wakeUp(),s.rapierBody.setTranslation(l,!0);let u=new e.Quaternion(0,0,0,1),d=new e.Quaternion().setFromAxisAngle(new e.Vector3(0,0,1),Math.PI/2);u.multiply(d),s.rapierBody.setRotation(u,!0);let f=new e.Vector3(7,6,8),p=new e.Vector3(12,4,0),m=t.getObjectByName(`drone`),g=new e.Vector3(m.position.x,m.position.y,m.position.z),v=new e.CatmullRomCurve3([l,f,p,g,c],!1,`centripetal`),y=null;s.rapierBody.numColliders()>0&&(y=s.rapierBody.collider(0),y.setSensor(!0)),s.userData.hitDrone=!1;let b={val:0};new h.Tween(b).to({val:1},r).easing(h.Easing.Cubic.Out).delay(i).onUpdate(()=>{if(t._spawnStopSignal){b.val=1,s.isFlying=!1;return}let n=v.getPoint(b.val);s.rapierBody.setNextKinematicTranslation({x:n.x,y:n.y,z:n.z});let r=b.val*Math.PI*30,i=new e.Vector3(0,1,0),a=new e.Quaternion().setFromAxisAngle(i,r),o=u.clone().multiply(a);if(s.rapierBody.setNextKinematicRotation(o),m&&m.rapierBody&&!s.userData.hitDrone&&v.getPoint(b.val).distanceTo(m.position)<3){let n=m.quaternion.clone(),r=ns.clone();Z(R(Q.currentMode===F.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`)),m.rapierBody.setBodyType(_.RigidBodyType.Dynamic),m.rapierBody.wakeUp(),m.rapierBody.applyImpulse({x:-100,y:75,z:-100},!0),m.rapierBody.applyTorqueImpulse({x:5,y:5,z:5},!0),s.userData.hitDrone=!0,setTimeout(()=>{if(t._spawnStopSignal)return;Z(R(Q.currentMode===F.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`)),m.rapierBody.setBodyType(_.RigidBodyType.KinematicPositionBased);let i=m.position.clone(),a=m.quaternion.clone(),o={val:0};new h.Tween(o).to({val:1},2e3).easing(h.Easing.Back.Out).onUpdate(()=>{let t=new e.Vector3().lerpVectors(i,r,o.val),s=a.clone().slerp(n,o.val);m.rapierBody.setNextKinematicTranslation(t),m.rapierBody.setNextKinematicRotation(s)}).onComplete(async()=>{if(t._spawnStopSignal)return;m.rapierBody.setGravityScale(0),m.rapierBody.setLinvel({x:0,y:0,z:0},!0),m.rapierBody.setAngvel({x:0,y:0,z:0},!0),m.rapierBody.setBodyType(_.RigidBodyType.Fixed);let e=Q.currentMode===F.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`;Z(R(e)),pi(t),await Ho(t,`welcome`,{scale:1.65,duration:2500,isAsync:!0}),await Do(5500),!t._spawnStopSignal&&(ps(R(e)),t.cursorInformer&&t.cursorInformer.switchToOpacityMode&&t.cursorInformer.switchToOpacityMode())}).start()},2e3)}}).onComplete(()=>{Z(`Mjolnir Returned.`),s.rapierBody.setBodyType(_.RigidBodyType.Dynamic),s.rapierBody.isManualControl=!1,s.userData.originalPos=s.position.clone(),s.userData.originalRot=new e.Euler().setFromQuaternion(s.quaternion),y&&y.setSensor(!1),s.userData.hitDrone=!1,s.rapierBody.wakeUp(),s.isFlying=!1,a&&a()}).start()}else console.warn(`Mjolnir mesh or rapierBody not found`)}function Lo(t,n=`drone-beam`,r=null){let i=new e.Group;i.name=n;let a=r||I.ELECTRIC_CYAN||65535,o=(t,n,r,i)=>{let a=new e.CylinderGeometry(r,r,1,8,1,!0);a.rotateX(Math.PI/2),a.translate(0,0,.5);let o=new e.MeshBasicMaterial({color:n,transparent:!0,opacity:i,blending:e.AdditiveBlending,depthWrite:!1,side:e.DoubleSide}),s=new e.Mesh(a,o);return s.name=t,s};return i.add(o(`beam-core`,16777215,.005,1)),i.add(o(`beam-glow`,a,.015,.6)),i.add(o(`beam-outer`,I.ACCENT_GOLD||16763904,.03,.3)),i.frustumCulled=!1,t.add(i),i}function Ro(t,n,r=null,i=null){let a=new e.Group;a.position.copy(n),t.add(a);let o=new e.Group;r&&o.lookAt(r),a.add(o);let s=new e.IcosahedronGeometry(.1,0),c=[],l=i||[16777215,65535,35071,52479];for(let t=0;t<35;t++){let n=l[t%l.length],r=Pt(n,1.2,2.5),i=new e.Mesh(s,r),a=Nt(n,1,.01,4,e.FrontSide),u=new e.Mesh(s,a);u.scale.setScalar(1.35),i.add(u);let d=Math.random()*Math.PI*2,f=Math.PI*.4*Math.random(),p=new e.Vector3(Math.sin(f)*Math.cos(d),Math.sin(f)*Math.sin(d),Math.cos(f)).multiplyScalar(.08+Math.random()*.12);i.userData.velocity=p,i.lookAt(p.clone().add(i.position)),i.scale.setScalar(.1+Math.random()*.5),o.add(i),c.push(i)}let u=new e.TorusGeometry(1,.015,8,32),d=Nt(l[1]||l[0],2,.01,4,e.DoubleSide),f=new e.Mesh(u,d);f.rotation.x=Math.PI/2,a.add(f);let p=l[0]||16777215,m=Nt(p,1.5,.01,4,e.DoubleSide),g=new e.Mesh(u,m);g.rotation.x=Math.PI/2,g.scale.setScalar(.5),a.add(g);let _=new e.SphereGeometry(.4,16,16),v=Pt(p,1,4),y=new e.Mesh(_,v);a.add(y),new h.Tween({progress:0}).to({progress:1},1e3).easing(h.Easing.Quadratic.Out).onUpdate(e=>{let t=e.progress;c.forEach(e=>{e.position.add(e.userData.velocity);let n=1-t,r=1+t*4;e.scale.set((.3+Math.random()*.4)*n,(.3+Math.random()*.4)*n,(.4+Math.random()*.6)*n*r),e.material.uniforms&&(e.material.uniforms.glowIntensity.value=2.5*n);let i=e.children[0];i&&i.material.uniforms&&(i.material.uniforms.outerGlowStrength.value=1*n)});let n=.1+t*3.5;f.scale.set(n,n,1),f.material.uniforms.outerGlowStrength.value=2*(1-t);let r=.1+t*4.5;g.scale.set(r,r,1),g.material.uniforms.outerGlowStrength.value=1*(1-t);let i=Math.min(t*4,1)<.5?t*8:(1-t)*1.5;y.scale.setScalar(i),y.material.uniforms&&(y.material.uniforms.glowIntensity.value=2.5*(1-t))}).onComplete(()=>{t.remove(a),s.dispose(),u.dispose(),_.dispose(),c.forEach(e=>{e.material.dispose(),e.children[0]&&e.children[0].material.dispose()}),f.material.dispose(),g.material.dispose(),v.dispose()}).start()}function zo(t,n,r=!1,i=!1){let a=X(t,`drone`);if(!a||!t.gazeFollower)return;r&&(t.gazeFollower.isLocked=!0);let o=n;n instanceof e.Vector3&&(a.userData.gazeProxy||(a.userData.gazeProxy=new e.Object3D),a.userData.gazeProxy.position.copy(n),o=a.userData.gazeProxy),o&&(r&&(a.userData.lockTarget=o),t.gazeFollower.lookAtTarget(o,i))}function Bo(t,n,r=``,i=null,a=`drone-beam`,o=!1,s=null,c=!1,l=null,u=!1){let d=X(t,`drone`),f=d?d.getObjectByName(`Sphere001_0`):null;if(!f)return;let p=X(t,a);p||=Lo(t,a,s),p.activeRequestID&&cancelAnimationFrame(p.activeRequestID);let m=t.camera,h=new e.Vector3,g=new e.Vector3,_=i!==null,v=l===1/0,y;if(v)y=1/0;else if(l!==null)y=l;else{let e=_?400:1e3,t=_?600:3e3;y=_?500:Math.min(Math.max(r.length*50,e),t)}let b=performance.now();p.visible=!1;let x=e=>{p.children.forEach((t,n)=>{let r=n===0?1:n===1?.7:.4;t.material.opacity=e*r})},S=(e,t)=>{let n=e.distanceTo(t);p.position.copy(e),p.lookAt(t),p.children.forEach(e=>{e.scale.z=n})},C=()=>{let e=performance.now(),r=e-b,a=Math.min(r/y,1);if(a<1){let r=!1;_?(g.copy(i),r=!0):n&&n.isMesh&&(n.getWorldPosition(g),r=!0),r?(f.getWorldPosition(h),u||(S(h,g),o||zo(t,g,!0)),p.visible=!0,_&&a<.1&&!p.hitTriggered&&!c&&(Ro(t,g,h,s?[16777215,s,s]:null),p.hitTriggered=!0)):p.visible=!1;let l=.7+Math.sin(e*.08)*.3,d;d=v?1:_?a<.2?a*5:1-(a-.5)*2:1-a**2,x(l*Math.max(0,d)),p.activeRequestID=requestAnimationFrame(C)}else p.visible=!1,x(0),p.activeRequestID=null,p.hitTriggered=!1,t.gazeFollower&&!d.userData.isHovering&&(t.gazeFollower.isLocked=!1,t.gazeFollower.lookAtTarget(m))};p.hitTriggered=!1,p.activeRequestID=requestAnimationFrame(C)}function Vo(t,n=0){let r=he[n];if(!r){console.error(`Scenario state index ${n} not found`);return}if(t.scenarioState=r,r.ui&&(r.ui.cursorInformer!==void 0&&(t.cursorInformerEnabled=r.ui.cursorInformer,t.cursorInformer&&(r.ui.cursorInformer?t.cursorInformer.show?t.cursorInformer.show():t.cursorInformer.style.display=`block`:t.cursorInformer.hide?t.cursorInformer.hide():t.cursorInformer.style.display=`none`)),r.ui.subtitle===!1&&(Z(``),ms(!0)),r.ui.personaButton3D===!1&&window.boneTracker&&typeof window.boneTracker.forceReset==`function`&&window.boneTracker.forceReset()),r.environment){let n=t.domElement;n&&(r.environment.cssBackground?n.style.background=r.environment.cssBackground:r.environment.background&&(n.style.background=r.environment.background)),r.environment.sceneBackground!==void 0&&(r.environment.sceneBackground===null?t.background=null:t.background=new e.Color(r.environment.sceneBackground))}if(t.renderer){if(!t.isTransitioning){let e=(window.devicePixelRatio||1)*(r.pixelRatioScale===void 0?1:r.pixelRatioScale);t.renderer.setPixelRatio(e),t.points&&typeof t.points.onWindowResize==`function`&&t.points.onWindowResize()}r.toneMappingExposure!==void 0&&(t.renderer.toneMappingExposure=r.toneMappingExposure)}if(t.HUD&&t.HUD.material.uniforms&&r.hudUniforms){let e=3e3,n=h.Easing.Quadratic.Out;for(let[i,a]of Object.entries(r.hudUniforms)){let r=t.HUD.material.uniforms[i];r&&(r._currentTween&&r._currentTween.stop(),a&&a.isColor?r._currentTween=new h.Tween(r.value).to({r:a.r,g:a.g,b:a.b},e).easing(n).start():typeof a==`number`?r._currentTween=new h.Tween(r).to({value:a},e).easing(n).start():r.value=a)}}}function Ho(t,n=`welcome`,r={}){let{scale:i=null,rotation:a=null,position:o=null,duration:s=2e3,isAsync:c=!1,scanline:l=1}=r,u=t.globalUniformsHub&&t.globalUniformsHub.uniforms||t.constantUniform;if(!u||!u.uWelcomeProgress){console.warn(`Welcome Text uniforms not found on scene`);return}i!==null&&u.uWelcomeScale&&(u.uWelcomeScale.value=i),a!==null&&u.uWelcomeRotation&&(u.uWelcomeRotation.value=a),o!==null&&u.uWelcomePosition&&(o instanceof e.Vector2?u.uWelcomePosition.value.copy(o):o.x!==void 0&&o.y!==void 0&&u.uWelcomePosition.value.set(o.x,o.y)),u.uWelcomeScanline&&(u.uWelcomeScanline.value=l),u.uWelcomeOpacity&&(u.uWelcomeOpacity.value=1),u.uWelcomeGlow&&(u.uWelcomeGlow.value=0),u.uWelcomeProgress&&(u.uWelcomeProgress.value=0);let d=new h.Tween(u.uWelcomeProgress).to({value:1},s).easing(h.Easing.Linear.None),f=new h.Tween(u.uWelcomeGlow).to({value:5.2},500).repeat(3).yoyo(!0).easing(h.Easing.Quadratic.InOut),p=new h.Tween(u.uWelcomeOpacity).to({value:0},1e3).delay(4e3).easing(h.Easing.Quadratic.In).onComplete(()=>{u.uWelcomeProgress.value=0,u.uWelcomeGlow.value=0});return d.chain(f),f.chain(p),d.start(),c?new Promise(e=>d.onComplete(e)):d}async function Uo(t,n=800){let r=t.isLowPowerMode,i=r?n*.6:n;Ni(t),t._spawnStopSignal=!1,t._assembleCount===void 0&&(t._assembleCount=0),t._assembleCount++,t.renderer&&(t.renderer.shadowMap&&(t.renderer.shadowMap.autoUpdate=!1),so(t)),t.isTransitioning=!0,t.raycasterEnabled=!1,t.world&&(t.world.isActive=!1),es(t);try{t._assembleCount<=1?(PerformanceLogger.start(`Tween Blackhole`),ho(t,i),PerformanceLogger.end(`Tween Blackhole`)):setTimeout(()=>{ho(t,i)},400),t.HUD&&typeof t.HUD.tweenGardenMode==`function`&&t.HUD.tweenGardenMode(!0,i),PerformanceLogger.start(`Tween Remaining Objects`),await uo(t,i),PerformanceLogger.end(`Tween Remaining Objects`),t.points&&t.points.bloomPass&&new h.Tween(t.points.bloomPass).to({strength:r?.8:1,threshold:.21,radius:.4},i).easing(h.Easing.Cubic.Out).start(),t.HUD&&t.HUD.material.uniforms.uIsGardenFlower&&(t.HUD.material.uniforms.uIsGardenFlower.value=1),t.renderer&&(t.renderer.toneMappingExposure=.25),t.points&&t.points.bloomPass&&(t.points.bloomPass.threshold=.21,t.points.bloomPass.strength=1),t.background=new e.Color(0),await Do(200),Po(t),setTimeout(async()=>{await co(t,.2,.625,800),t.isTransitioning=!1,await Do(4e3),t.windowLight&&(t.windowLight.intensity=1e7,await Do(40),t.windowLight.intensity=0)},800)}finally{}Z(R(`ENV_ATMOS_INIT`)),No(t,Xo*.6),PerformanceLogger.start(`Sync Bodies`),t.rapierWorldWrapper&&t.rapierWorldWrapper.syncBodiesToMeshes&&t.rapierWorldWrapper.syncBodiesToMeshes(),PerformanceLogger.end(`Sync Bodies`),Z(R(`SYS_PHYSICS_INIT`)),Z(R(`SYS_DRONE_START`)),Oo(t,{duration:r?2e3:3e3,delay:r?1500:2500,onStart:()=>{},onComplete:()=>{Io(t,{duration:r?2e3:4e3,onComplete:()=>{di(t);let e=t.getObjectByName(`wallArea`);e&&e.material&&e.material.uniforms&&e.material.uniforms.uEyeActive&&(e.material.uniforms.uEyeActive.value=!0,Va(t),setTimeout(()=>{e&&e.material&&e.material.uniforms&&Ha(t)},3e3)),t.HUD&&typeof t.HUD.runTweenShowIsland==`function`&&t.HUD.runTweenShowIsland(r?2500:3e3),ao.onRoomAssemble(t),window.cvReset&&window.cvReset(1500),t.HUD&&typeof t.HUD.runTweenShowDecos==`function`&&t.HUD.runTweenShowDecos()}});let e=t.getObjectByName(`planeSky`);e&&(e.visible=!0),setTimeout(()=>{Na(t,{forcedX:.65,environmentRatio:1,delay:0})},600)}}),await Do(r?1e3:2e3),t.renderer&&setTimeout(()=>{},500),setTimeout(()=>{t.raycasterEnabled=!0,t.targetAnimHz=51},r?5500:9e3),t.globalUniformsHub.enableLightning.value=!0,t.renderer&&(window.devicePixelRatio||1)*(he[1].pixelRatioScale||.625)}async function Wo(e,t=1500){mi(e),Yo(e),e._spawnStopSignal=!0,Z(``),ms(!0),e.gazeFollower&&typeof e.gazeFollower.stop==`function`&&e.gazeFollower.stop(),e.world&&(e.world.isActive=!1,e.world.hasPointGravityOnBalls=!1),e.windowLight&&(e.windowLight.intensity=0),window.boneTracker&&typeof window.boneTracker.forceReset==`function`&&window.boneTracker.forceReset(),Go(e,t),Vo(e,0),e.renderer,e.pointsApp&&(e.pointsApp.points.visible=!0)}function Go(e,t=1500){let n=e.getObjectByName(`roomGLBModel`);if(!n)return;let r=Array.from(n.children),i=r.length,a=0,o=()=>{let e=Math.min(a+20,i);for(let n=a;n<e;n++){let e=r[n];if(e.userData.scenarioTween&&(e.userData.scenarioTween.stop(),e.userData.scenarioTween=null),e.userData.originalPos){let n=t+Math.random()*500;new h.Tween(e.position).to({x:e.userData.hidePos?.x||0,y:e.userData.hidePos?.y||-Zo,z:e.userData.hidePos?.z||0},n).easing(h.Easing.Cubic.In).onComplete(()=>{e.visible=!1}).start()}else e.visible=!1}a=e,a<i&&requestAnimationFrame(o)};requestAnimationFrame(o),new h.Tween(n.scale).to({x:0,y:0,z:0},t).easing(h.Easing.Cubic.In).onComplete(()=>{n.visible=!1}).start(),[`rightWall-cover`,`a-char`,`stool`,`floor`,`planeSky`].forEach(n=>{let r=e.getObjectByName(n);if(r){let e=r.userData.hidePos||{x:0,y:-Zo,z:0};new h.Tween(r.position).to(e,t).easing(h.Easing.Cubic.In).onComplete(()=>{r.visible=!1}).start(),new h.Tween(r.scale).to({x:0,y:0,z:0},t).easing(h.Easing.Cubic.In).start()}}),e.physicObjects&&e.physicObjects.forEach(e=>{e.userData.scenarioTween&&(e.userData.scenarioTween.stop(),e.userData.scenarioTween=null);let n=e.userData;if(n.hidePos){let r=t+Math.random()*500;e.userData.scenarioTween=new h.Tween(e.position).to({x:n.hidePos.x,y:n.hidePos.y,z:n.hidePos.z},r).easing(h.Easing.Cubic.In).onComplete(()=>{e.visible=!1,e.userData.scenarioTween=null}).start()}else e.visible=!1;e.userData.originalScale&&new h.Tween(e.scale).to({x:0,y:0,z:0},t).start()}),e.points&&e.points.bloomPass&&new h.Tween(e.points.bloomPass).to({strength:1.5,radius:.4,threshold:.85},t).easing(h.Easing.Quadratic.Out).start()}function Ko(e){pi(e),e.world.isActive=!0,lo(e,1500,!0)}async function qo(t,n=500){t.globalUniformsHub.enableLightning.value=!1,mi(t),window.cvReset&&window.cvReset(1500),ts(t),Mi(t);let r=[];t.children.forEach(e=>{e.userData.hidePos&&(r.includes(e)||Jo(e,n))});let i=t.getObjectByName(`roomGLBModel`);if(i&&(i.children.forEach(e=>{Jo(e,n)}),new h.Tween(i.scale).to({x:0,y:0,z:0},n).easing(h.Easing.Cubic.In).onComplete(()=>{i.visible=!1}).start()),t.camera&&t.orbitControls){let r={x:61.56,y:2.97,z:30},i=new e.Vector3(0,0,0);new h.Tween(t.camera.position).to(r,n*3).easing(h.Easing.Cubic.Out).onUpdate(()=>{t.camera.lookAt(i),t.orbitControls.target.copy(i)}).start(),new h.Tween(t.orbitControls.target).to({x:0,y:0,z:0},n*3).easing(h.Easing.Cubic.Out).start()}let a=new h.Tween(t.fireflies.material.uniforms.uKamikazeScale).to({value:1},n).easing(h.Easing.Cubic.In);new h.Tween(t.fireflies.material.uniforms.uSizeFactor).to({value:0},n).easing(h.Easing.Cubic.In).chain(a).onComplete(o).start();function o(){new h.Tween(t.points.bloomPass).to({strength:1.5,threshold:.85,radius:.4},800).easing(h.Easing.Quadratic.Out),new h.Tween(t.points.bloomPass).to({strength:12,threshold:0,radius:1},400).easing(h.Easing.Quadratic.In).onComplete(()=>{Yo(t),Vo(t,0),t.isTransitioning=!1,t.pointsApp&&(t.pointsApp.points.visible=!0,typeof t.pointsApp.setScrollLock==`function`&&t.pointsApp.setScrollLock(!0),typeof t.pointsApp.triggerStep==`function`&&t.pointsApp.triggerStep(1,1500,!0),typeof t.HUD.tweenGardenMode==`function`&&t.HUD.tweenGardenMode(!1,1500),typeof t.HUD.runTweenShowDecos==`function`&&t.HUD.runTweenShowDecos(1500));let e=document.getElementById(`board`);e&&(e.style.display=``,e.classList.remove(`mode-room`),window.fitBoardTexts&&(window.__boardScale=1,window.__boardSubProgress=0,window.fitBoardTexts(1,0)));let n=document.querySelectorAll(`.nav-modules .nav-item`);n.forEach(e=>e.classList.remove(`active`));let r=Array.from(n).find(e=>e.getAttribute(`data-target`)===`cv-header`);r&&r.classList.add(`active`),new h.Tween(t.points.bloomPass).to({strength:1.5,threshold:.85,radius:.5},1200).easing(h.Easing.Cubic.Out).onComplete(()=>{t.isTransitioning=!1,t.points&&t.points.bloomPass&&(t.points.bloomPass.threshold=.85,t.points.bloomPass.strength=1.5)}).start()}).start()}}function Jo(e,t,n){if(e.userData.hidePos){let r=t+Math.random()*500;new h.Tween(e.position).to({x:e.userData.hidePos.x,y:e.userData.hidePos.y,z:e.userData.hidePos.z},r).easing(h.Easing.Cubic.In).onComplete(()=>{e.visible=!1,n&&n()}).start(),e.userData.hideRot&&new h.Tween(e.rotation).to({x:e.userData.hideRot.x,y:e.userData.hideRot.y,z:e.userData.hideRot.z},r).easing(h.Easing.Cubic.In).start(),e.userData.hideScale&&new h.Tween(e.scale).to({x:e.userData.hideScale.x,y:e.userData.hideScale.y,z:e.userData.hideScale.z},r).easing(h.Easing.Cubic.In).start()}}function Yo(e){let t=e.getObjectByName(`drone`);t&&t.userData.hidePos&&(t.position.copy(t.userData.hidePos),t.visible=!1);let n=e.getObjectByName(`mjolnir_low_mjolnir_hammer_0`);n&&(n.userData.hidePos&&(n.position.copy(n.userData.hidePos),n.visible=!1),n.isFlying=!1),e.dragonBalls&&(e.dragonBalls.forEach(t=>{if(t.rapierBody&&e.world&&e.world.physics&&e.world.physics.removeRigidBody(t.rapierBody),t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose()),[e.physicObjects,e.physicsControlledObjects,e.bhTargets].forEach(e=>{if(e){let n=e.indexOf(t);n!==-1&&e.splice(n,1)}}),e.physicBodies&&t.rapierBody){let n=e.physicBodies.indexOf(t.rapierBody);n!==-1&&e.physicBodies.splice(n,1)}t.parent&&t.parent.remove(t)}),e.dragonBalls=[],e.world&&(e.world.ballBodies=[]));let r=e.getObjectByName(`bulb`)||e.bulb;r&&(r.visible=!1,r.traverse(e=>{e.visible=!1,e.isLight&&(e.intensity=0)}));let i=e.getObjectByName(`bulbLight`)||e.bulbLight;i&&(i.intensity=.001,i.distance=0,i.visible=!0);let a=e.getObjectByName(`Object_120`);if(a&&a.material&&a.material.uniforms){let e=a.material;e.uniforms.glowPower&&(e.uniforms.glowPower.value=0),e.uniforms.glowIntensity&&(e.uniforms.glowIntensity.value=0)}e.background=null,e._spawnStopSignal=!0,Ni(e),typeof ms==`function`&&ms(),e.conversationManager&&typeof e.conversationManager.clear==`function`&&e.conversationManager.clear(),e.children.forEach(e=>{e&&e.name&&(e.name.toLowerCase().includes(`beam`)||e.name.toLowerCase().includes(`aura`))&&(e.visible=!1,e.activeRequestID&&=(cancelAnimationFrame(e.activeRequestID),null))});let o=e.getObjectByName(`a-char`);o&&o.traverse(e=>{e&&e.name&&e.name.toLowerCase().includes(`beam`)&&(e.visible=!1,e.activeRequestID&&=(cancelAnimationFrame(e.activeRequestID),null))}),e.targetAnimHz=30}var Xo,Zo,Qo,$o,es,ts,ns,rs=O((()=>{Ie(),Re(),$a(),Cs(),we(),Ds(),ye(),gr(),xi(),io(),_n(),oo(),ni(),Ji(),Xo=15e3,Zo=100,Qo=[`planeSky`,`blackholeScene`,`PointsCloud`,`bulb`,`bulbLight`,`a-char`,`stool`,`stool_bound`,`rightWall-cover`,`floor`],$o=e=>po(e,!0),es=e=>po(e,!1),ts=e=>po(e,!1)}));function is(t,n,r){let i=new e.Group;i.name=n;let a=r||65535,o=(t,n,r,i)=>{let a=new e.CylinderGeometry(n,n,1,6,1,!0);a.rotateX(Math.PI/2),a.translate(0,0,.5);let o=new e.MeshBasicMaterial({color:i,transparent:!0,opacity:r,blending:e.AdditiveBlending,depthWrite:!1,side:e.DoubleSide}),s=new e.Mesh(a,o);return s.name=t,s};return i.add(o(`beam-core`,.002,1,16777215)),i.add(o(`beam-glow`,.006,.5,a)),i.frustumCulled=!1,i}function as(t){return new e.ShaderMaterial({uniforms:{iTime:{value:0},uColor:{value:new e.Color(t)},uOpacity:{value:.15},uBrightness:{value:1}},vertexShader:`
            varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,transparent:!0,blending:e.AdditiveBlending,depthWrite:!1,side:e.DoubleSide})}function os(t,n,r,i=.5){let{camera:a,renderer:o}=t;if(!a||!o)return new e.Vector3;let s=o.domElement.getBoundingClientRect(),c,l;r===`TL`?(c=n.left,l=n.top):r===`TR`?(c=n.right,l=n.top):r===`BL`?(c=n.left,l=n.bottom):r===`BR`?(c=n.right,l=n.bottom):r===`ScanTop`?(c=n.left+n.width/2,l=n.top):r===`ScanBot`&&(c=n.left+n.width/2,l=n.bottom);let u=(c-s.left)/s.width*2-1,d=-(l-s.top)/s.height*2+1,f=new e.Vector3(u,d,i);return f.unproject(a),f}function ss(t,n=2e3){let r=t.getObjectByName(`drone`);if(!r)return;let i=r.getObjectByName(`Sphere001_0`);if(!i)return;let a=document.querySelector(`#stat-subtitle.active`);if(!a)return;a.getBoundingClientRect();let o=I.ELECTRIC_CYAN||65535,s;for(;s=t.getObjectByName(`hologram-deployment`);)s._isDead=!0,t.remove(s),s.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())});let c=new e.Group;c.name=`hologram-deployment`,t.add(c);let l={TL:new e.Vector3,TR:new e.Vector3,BL:new e.Vector3,BR:new e.Vector3},u=new e.Vector3;i.getWorldPosition(u);let d=as(o),f=new e.BufferGeometry,p=new Float32Array(36),m=new Float32Array([.5,1,0,0,1,0,.5,1,0,0,1,0,.5,1,0,0,1,0,.5,1,0,0,1,0]);f.setAttribute(`position`,new e.BufferAttribute(p,3)),f.setAttribute(`uv`,new e.BufferAttribute(m,2));let g=new e.Mesh(f,d);c.add(g);let _=[`TL`,`TR`,`BL`,`BR`].map(e=>({beam:is(t,`pyramid-beam-${e}`,o),key:e}));_.forEach(e=>c.add(e.beam));let v=new e.BufferGeometry;v.setAttribute(`position`,new e.BufferAttribute(new Float32Array(9),3));let y=as(o);y.uniforms.uOpacity.value=.2;let b=new e.Mesh(v,y);c.add(b);let x=[is(t,`tri-beam-top`,o),is(t,`tri-beam-bot`,o)];x.forEach(e=>c.add(e)),d.uniforms.uOpacity.value=.8,new h.Tween(d.uniforms.uOpacity).to({value:.15},150).delay(100).start();let S=!0;setTimeout(()=>{c._isDead||new h.Tween(d.uniforms.uOpacity).to({value:0},800).onUpdate(()=>{let e=d.uniforms.uOpacity.value;_.forEach(t=>{t.beam.children.forEach(t=>{t.material.opacity=e*(t.name===`beam-core`?1:.5)})})}).onComplete(()=>{S=!1,_.forEach(e=>{e.beam.visible=!1}),g.visible=!1}).start()},1500);let C=!0;setTimeout(()=>{c._isDead||new h.Tween(y.uniforms.uOpacity).to({value:0},800).onUpdate(()=>{let e=y.uniforms.uOpacity.value;x.forEach(t=>{t.children.forEach(t=>{t.material.opacity=e*(t.name===`beam-core`?1:.5)})})}).onComplete(()=>{C=!1,x.forEach(e=>e.visible=!1),b.visible=!1,t.gazeFollower&&t.gazeFollower.isLocked&&(t.gazeFollower.isLocked=!1)}).start()},n+200);let w=n=>{if(!a.classList.contains(`active`)||c._isDead){t.gazeFollower&&t.gazeFollower.isLocked&&(t.gazeFollower.isLocked=!1),t.remove(c);return}let r=a.getBoundingClientRect();if(i.getWorldPosition(u),C){let n=a.querySelector(`.scanner-line`);if(n){let r=n.getBoundingClientRect(),i=os(t,r,`ScanTop`),a=os(t,r,`ScanBot`),o=v.attributes.position.array;o[0]=u.x,o[1]=u.y,o[2]=u.z,o[3]=i.x,o[4]=i.y,o[5]=i.z,o[6]=a.x,o[7]=a.y,o[8]=a.z,v.attributes.position.needsUpdate=!0,zo(t,new e.Vector3().lerpVectors(i,a,.5),!0),x.forEach((e,t)=>{let n=t===0?i:a;e.position.copy(u),e.lookAt(n),e.children.forEach(e=>e.scale.z=u.distanceTo(n))})}}if(S){Object.keys(l).forEach(e=>l[e]=os(t,r,e));let e=f.attributes.position.array,n=[l.TL,l.TR,l.BR,l.BL,l.TL];for(let t=0;t<4;t++){let r=t*9;e[r]=u.x,e[r+1]=u.y,e[r+2]=u.z,e[r+3]=n[t].x,e[r+4]=n[t].y,e[r+5]=n[t].z,e[r+6]=n[t+1].x,e[r+7]=n[t+1].y,e[r+8]=n[t+1].z}f.attributes.position.needsUpdate=!0,_.forEach(e=>{let t=l[e.key];e.beam.position.copy(u),e.beam.lookAt(t),e.beam.children.forEach(e=>e.scale.z=u.distanceTo(t))})}d.uniforms.iTime.value=n/1e3,y.uniforms.iTime.value=n/1e3,requestAnimationFrame(w)};requestAnimationFrame(w)}function cs(e){let t;for(;t=e.getObjectByName(`hologram-deployment`);)t._isDead=!0,e.remove(t),t.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())});e.gazeFollower&&e.gazeFollower.isLocked&&(e.gazeFollower.isLocked=!1)}function ls(t,n,r){if(!n)return;let i=r||I.ELECTRIC_CYAN||65535;cs(t);let a=new e.Group;a.name=`hologram-deployment`,a.userData.targetObject=n,t.add(a);let o=new e.Vector3,s=new e.Vector3,c=as(i);c.uniforms.uOpacity.value=.2;let l=new e.BufferGeometry,u=new Float32Array(36),d=new Float32Array([.5,0,0,1,1,1,.5,0,0,1,1,1,.5,0,0,1,1,1,.5,0,0,1,1,1]);l.setAttribute(`position`,new e.BufferAttribute(u,3)),l.setAttribute(`uv`,new e.BufferAttribute(d,2));let f=new e.Mesh(l,c);a.add(f);let p=[`TL`,`TR`,`BL`,`BR`].map(e=>({beam:is(t,`pyramid-beam-${e}`,i),key:e}));p.forEach(e=>a.add(e.beam));let m=null,h=t.getObjectByName(`btc_symbol`),g=t.getObjectByName(`eth_symbol`),_=n.name===`aegis2`||Math.random()>.5?g:h;if(_){m=_.clone(),m.name=`hologram-coin`;let e=as(i);e.uniforms.uOpacity.value=.15,m.traverse(t=>{t.isMesh&&(t.material=e,t.castShadow=!1,t.receiveShadow=!1)}),m.scale.setScalar(_.scale.x*.8),a.add(m)}let v=new e.Box3,y=new e.Vector3,b=t=>{if(a._isDead||!n.parent)return;v.setFromObject(n),v.getSize(y),v.getCenter(o);let r=Math.max(y.x,y.z)*1.5;s.copy(o);let i=Math.sin(t/400)*.05,u=o.y+y.y*1.5+i,d={TL:new e.Vector3(o.x-r,u,o.z-r),TR:new e.Vector3(o.x+r,u,o.z-r),BL:new e.Vector3(o.x-r,u,o.z+r),BR:new e.Vector3(o.x+r,u,o.z+r)},f=l.attributes.position.array,h=[d.TL,d.TR,d.BR,d.BL,d.TL];for(let e=0;e<4;e++){let t=e*9;f[t]=s.x,f[t+1]=s.y,f[t+2]=s.z,f[t+3]=h[e].x,f[t+4]=h[e].y,f[t+5]=h[e].z,f[t+6]=h[e+1].x,f[t+7]=h[e+1].y,f[t+8]=h[e+1].z}l.attributes.position.needsUpdate=!0,p.forEach(e=>{let t=d[e.key];e.beam.position.copy(s),e.beam.lookAt(t),e.beam.children.forEach(e=>e.scale.z=s.distanceTo(t))}),m&&(m.position.set(o.x,o.y+y.y*.8+i*2,o.z),m.rotation.y+=.02,m.traverse(e=>{e.material&&e.material.uniforms&&(e.material.uniforms.iTime.value=t/1e3)})),c.uniforms.iTime.value=t/1e3,requestAnimationFrame(b)};requestAnimationFrame(b)}var us=O((()=>{rs(),ye()}));function ds(){hs=document.getElementById(`stat-coords`),gs=document.querySelector(`.frame_story-text`),_s=document.getElementById(`stat-subtitle`),hs&&(hs.innerText=`00 FPS | 1.0 DPR | 000 DRC`),vs=performance.now()}function fs(e,t=1){ys+=t;let n=performance.now(),r=n-vs;if(e.HUD&&e.HUD.material.uniforms){let t=Math.min(1,bs/60),n=e.HUD.material.uniforms.uIslBarProgress1.value;if(e.HUD.material.uniforms.uIslBarProgress1.value=n+(t-n)*.05,e.renderer){let t=e.renderer.getPixelRatio()/(window.devicePixelRatio||1),n=e.HUD.material.uniforms.uIslBarProgress2.value;e.HUD.material.uniforms.uIslBarProgress2.value=n+(t-n)*.05}}if(hs&&e.renderer){let t=window.devicePixelRatio||1,n=Math.round(e.renderer.getPixelRatio()/t*100),r=(e,t)=>e>=t?`stat-optimal`:e<40?`stat-critical`:`stat-stable`;hs.querySelector(`.stat-fps-val`)||(hs.innerHTML=`<span class="stat-fps-val">FPS 00</span> | <span class="stat-dpr-val">DPR 00%</span> | <span class="stat-drc-val">DRC 000</span>`);let i=hs.querySelector(`.stat-fps-val`),a=hs.querySelector(`.stat-dpr-val`),o=hs.querySelector(`.stat-drc-val`),s=`FPS ${bs}`;i.textContent!==s&&(i.textContent=s,i.className=`stat-fps-val ${r(bs,54)}`);let c=`DPR ${n}%`;a.textContent!==c&&(a.textContent=c,a.className=`stat-dpr-val ${r(n,90)}`);let l=e.renderer.info.render.calls,u=`DRC ${l.toString().padStart(3,`0`)}`;o.textContent!==u&&(o.textContent=u,o.className=`stat-drc-val ${l<100?`stat-optimal`:l>200?`stat-critical`:`stat-stable`}`)}r>=1e3&&(bs=Math.round(ys*1e3/r),ys=0,vs=n)}function Z(e){if(window.scene&&window.scene._spawnStopSignal){gs&&(gs.textContent=``);return}if(gs){if(gs.textContent===e)return;gs.textContent=e,gs.style.willChange=`transform, opacity`;let t=gs.dataset.lastHudHeight,n=window.scene&&window.scene.HUD;if(n&&n.material&&n.material.uniforms){let e=n.material.uniforms,r=e.uBNotchHRatio.value;if(t!==r.toString()){let t=e.uMarginPct.value,n=t+(1-2*t)*r;gs.style.bottom=`0`,gs.style.height=(n*100).toFixed(4)+`vh`,gs.dataset.lastHudHeight=r}}xs&&clearTimeout(xs),xs=setTimeout(()=>{gs&&(gs.textContent=``)},5e3)}}function ps(e){if(window.scene&&window.scene._spawnStopSignal){ms(!0);return}if(_s||=document.getElementById(`stat-subtitle`),_s){Ss&&cancelAnimationFrame(Ss),_s.classList.add(`active`),_s.innerHTML=`<div class="subtitle-close">×</div><span class="subtitle-text"></span><div class="scanner-line"></div>`;let t=_s.querySelector(`.subtitle-text`),n=_s.querySelector(`.subtitle-close`);n&&(n.onclick=()=>{ms(),window.dispatchEvent(new CustomEvent(`subtitleClose`,{detail:{manual:!0}}))});let r=Math.min(Math.max(e.length*50,1e3),3e3);_s.style.setProperty(`--reveal-dur`,`${r}ms`),window.scene&&ss(window.scene,r);let i=performance.now(),a=i,o=n=>{if(window.scene&&window.scene._spawnStopSignal){Ss&&cancelAnimationFrame(Ss),ms(!0);return}n||=performance.now();let s=n-i,c=Math.min(s/r,1);if(n-a>41.666666666666664||c===1){a=n;let r=e.length,i=``;for(let t=0;t<r;t++){let n=e[t];n===` `||n===`
`||c*(r+5)>t?i+=n:i+=`ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789$#@%&*`[Math.floor(Math.random()*42)]}t.textContent=i}c<1?Ss=requestAnimationFrame(o):t.textContent=e};Ss=requestAnimationFrame(o)}}function ms(e=!1){if(Ss&&cancelAnimationFrame(Ss),_s||=document.getElementById(`stat-subtitle`),_s){if(_s.classList.remove(`active`),e){_s.innerHTML=``;return}setTimeout(()=>{_s.classList.contains(`active`)||(_s.innerHTML=``)},650)}}var hs,gs,_s,vs,ys,bs,xs,Ss,Cs=O((()=>{us(),vs=0,ys=0,bs=0})),ws,Ts=O((()=>{ws=class{constructor(e){this.canvas=document.getElementById(e),this.gl=this.canvas.getContext(`webgl2`,{alpha:!0,premultipliedAlpha:!0,antialias:!0}),this.gl||=(console.error(`WebGL2 not supported, falling back to WebGL1 (expect artifacts)`),this.canvas.getContext(`webgl`)),this.uProgress=0,this.targetProgress=0,this.mouse={x:.5,y:.5},this.textures={poba:null,dev:null},this.ktx2Loader=new x,this.ktx2Loader.setTranscoderPath(`https://cdn.jsdelivr.net/npm/three@0.170.0/examples/jsm/libs/basis/`),this.ktx2Loader.detectSupport({capabilities:{isWebGL2:!0},extensions:{has:e=>!!this.gl.getExtension(e),get:e=>this.gl.getExtension(e)}}),this.init()}async init(){console.log(`[AvatarEngine] Initializing WebGL2 Lab (KTX2 Edition)...`),await this.loadTextures(),this.setupProgram(),this.onResize(),window.addEventListener(`resize`,()=>this.onResize()),window.addEventListener(`mousemove`,e=>this.onMouseMove(e)),requestAnimationFrame(e=>this.render(e)),console.log(`[AvatarEngine] Engine Ready.`)}async loadTextures(){let e=e=>new Promise((t,n)=>{this.ktx2Loader.load(e,e=>{let n=this.gl,r=n.createTexture();n.bindTexture(n.TEXTURE_2D,r),e.mipmaps.forEach((t,r)=>{n.compressedTexImage2D(n.TEXTURE_2D,r,e.format,t.width,t.height,0,t.data)}),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,e.mipmaps.length>1?n.LINEAR_MIPMAP_LINEAR:n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MAG_FILTER,n.LINEAR),t(r)},void 0,t=>{console.error(`Failed to load KTX2:`,e,t),n(t)})}),t=`/PFL/`;this.textures.poba=await e(`${t}textures/ktx2/cv-poba-nobg.ktx2`),this.textures.dev=await e(`${t}textures/ktx2/cv-dev-nobg.ktx2`),this.ktx2Loader.dispose()}setupProgram(){this.program=this.createProgram(`#version 300 es
            in vec2 aPosition;
            out vec2 vUv;
            void main() {
...
`).replace(/,$/,``)}\n}`):i=e.summary,this.elements.summaryInner.innerHTML=`
    ...
    `,fragmentShader:Is(),transparent:!0,uniforms:a,blending:e.NormalBlending,depthTest:!1,depthWrite:!1,side:e.FrontSide}),s=new e.Mesh(r,o);s.name=`HUDFrame`,s.frustumCulled=!1,s.renderOrder=9999,s.isOpen=!1,t.HUD=s,i();let c=(e,t,n,r,i,a,o)=>{let s=r,c=-n,l=t-s,u=-(e-c),d=-(t-(r-i)),f=(e-(c+o))*-.7071+(t-s)*.7071,p=(e-(c+a))*.7071+(t-s)*-.7071;return Math.max(Math.max(Math.max(Math.max(l,u),d),p),f)},l=performance.now(),u=0,d=[new e.Vector2,new e.Vector2],f={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:1,getMOI:e=>1/12*1*(e*2)**2},p={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:2,getMOI:(e,t)=>1/12*2*(e*e+t*t)},m={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:1.5,getMOI:(e,t)=>1/12*1.5*(e*e+t*t)},g={pos:new e.Vector2(0,0),vel:new e.Vector2(0,0),rot:0,angVel:0,isActive:!1,shouldSnapToAnchor:!0,mass:1.5,getMOI:(e,t)=>1/12*1.5*(e*e+t*t)};s.applyBeamImpulse=()=>{f.isActive=!0,f.shouldSnapToAnchor=!1;let n=t.width||window.innerWidth,r=t.height||window.innerHeight,i=r*a.uMarginPct.value,o=r*(a.uMarginPct.value+a.uVerticalMarginPct.value),s=new e.Vector2((n-i*2)*.5,(r-o*2)*.5),c=s.x*2,l=s.y*2;f.pos.lengthSq()<.001&&f.pos.set(s.x,0);let u=a.uBNotchHRatio.value,d=a.uBNotchWRatio.value,p=-s.y+l*u,_=l*u*.57735*2,v=c*d-_,y=a.uBNotchBarProgress.value,b=new e.Vector2(-v*.5+y*v,p),x=a.uRNotchHRatio.value,S=s.y*2*x*.8*.5,C=a.uBeamAttachRatio.value,w=new e.Vector2(s.x,e.MathUtils.mapLinear(C,0,1,-S,S)),T=new e.Vector2().subVectors(w,b).normalize().multiplyScalar(2800),E=new e.Vector2().subVectors(w,f.pos);f.vel.add(T.clone().divideScalar(f.mass));let D=E.x*T.y-E.y*T.x;f.angVel+=D/f.getMOI(S),new h.Tween(a.uRNotchBarThickness).to({value:.002},300).easing(h.Easing.Back.Out).start(),setTimeout(()=>{m.isActive=!0,m.shouldSnapToAnchor=!1,m.vel.set(-100+Math.random()*-200,-100),m.angVel=(Math.random()-.5)*5,g.isActive=!0,g.shouldSnapToAnchor=!1,g.vel.set(-150+Math.random()*-200,-50),g.angVel=(Math.random()-.5)*5},100)},s.resetBarPhysics=()=>{f.isActive=!1,f.shouldSnapToAnchor=!0,f.pos.set(0,0),f.vel.set(0,0),f.rot=0,f.angVel=0,p.isActive=!1,p.pos.set(0,0),p.vel.set(0,0),p.rot=0,p.angVel=0,m.isActive=!1,m.pos.set(0,0),m.vel.set(0,0),m.rot=0,m.angVel=0,g.isActive=!1,g.pos.set(0,0),g.vel.set(0,0),g.rot=0,g.angVel=0};let _=performance.now();s.onBeforeRender=()=>{!a.uSpriteSheet.value&&B.spriteSheet&&(a.uSpriteSheet.value=B.spriteSheet);let n=performance.now(),r=Math.min(.032,(n-_)/1e3);_=n;let o=a.iTime.value,c=t.width||window.innerWidth,h=t.height||window.innerHeight,y=h*a.uMarginPct.value,b=h*(a.uMarginPct.value+a.uVerticalMarginPct.value),x=(c-y*2)*.5,S=(h-b*2)*.5;if(u++,n>l+1e3){Math.round(u*1e3/(n-l)),l=n,u=0;let e=c-y*2-$.CUT_SIZE*2;e*$.ISL_TO_MAIN_WRatio_NOT_FOUND||e*$.ISL_TO_MAIN_W_RATIO;let t=h-b*2;t*$.ISL_BAR_HEIGHT_RATIO,t*$.ISL_BAR_GAP_RATIO,t*$.ISL_BAR_MARGIN_Y_RATIO;let r=t*($.ISL_BAR_MARGIN_Y_RATIO*2+2*$.ISL_BAR_HEIGHT_RATIO+1*$.ISL_BAR_GAP_RATIO);$.CUT_SIZE+r-$.CORNER_RADIUS}let C=h*a.uMarginPct.value;h*(a.uMarginPct.value+a.uVerticalMarginPct.value);let w=(c-C*2)*.5;f.shouldSnapToAnchor&&f.pos.set(w,0);let T=S*2*a.uBNotchHRatio.value,E=-S+T;if(p.shouldSnapToAnchor&&p.pos.set(0,E),a.uRBarRot.value=f.rot,a.uRBarPos.value.copy(f.pos),a.uBBarRot.value=p.rot,a.uBBarPos.value.copy(p.pos),f.isActive||p.isActive||m.isActive||g.isActive){let e=-1200,t=.6,n=S*a.uRNotchHRatio.value*.8;if(f.isActive){f.vel.y+=e*r,f.pos.addScaledVector(f.vel,r),f.rot+=f.angVel*r,f.vel.multiplyScalar(.99),f.angVel*=.98;let i=-h*.5+5,o=c*.5-5;d[0].set(0,n),d[1].set(0,-n);let s=d;for(let e of s){let n=Math.sin(f.rot),r=Math.cos(f.rot),s=e.x*r-e.y*n,c=e.x*n+e.y*r,l=f.pos.x+s,u=f.pos.y+c;if(u<i){let e=i-u;f.pos.y+=e,f.vel.y=Math.abs(f.vel.y)*t,f.vel.x*=.95,f.angVel+=(l-f.pos.x)*f.vel.y*1e-4}if(l>o){let e=l-o;f.pos.x-=e,f.vel.x=-Math.abs(f.vel.x)*t,f.angVel+=(u-f.pos.y)*-f.vel.x*1e-4}if(l<-o){let e=-o-l;f.pos.x+=e,f.vel.x=Math.abs(f.vel.x)*t,f.angVel+=(u-f.pos.y)*f.vel.x*1e-4}if(!p.isActive){let e=x*2;S*2;let t=e*a.uBNotchWRatio.value;Math.abs(l)<t*.5&&Math.abs(u-E)<20&&(p.isActive=!0,p.shouldSnapToAnchor=!1,p.vel.addScaledVector(f.vel,.8),p.angVel=(Math.random()-.5)*10,p.vel.y-=200,f.vel.y*=-.5,f.angVel+=(Math.random()-.5)*5)}}}if(p.isActive){p.vel.y+=e*r,p.pos.addScaledVector(p.vel,r),p.rot+=p.angVel*r,-h*.5-200;let t=c*.5-5;(p.pos.x>t||p.pos.x<-t)&&(p.vel.x*=-.8)}let i=(t,n)=>{if(t.isActive){t.vel.y+=e*r,t.pos.addScaledVector(t.vel,r),t.rot+=t.angVel*r;let n=-h*.5,i=c*.5;t.pos.y<n&&(t.pos.y=n,t.vel.y=Math.abs(t.vel.y)*.6,t.vel.x*=.9,t.angVel*=.9),(t.pos.x>i||t.pos.x<-i)&&(t.vel.x*=-.8)}};i(m,0),i(g,1)}let D=a.uCutSize.value,O=new e.Vector2(x,S),k=S*2,A=(x*2-D*2)*a.uIslToMainWRatio.value,ee=k*a.uIslBarHeightRatio.value,te=k*a.uIslBarGapRatio.value,j=k*a.uIslBarMarginLeftRatio.value,M=k*a.uIslBarMarginRightRatio.value,ne=k*a.uIslBarMarginYRatio.value,N=e=>{let t=O.y-D-ne-P(e)*(ee+te)-ee*.5,n=t-O.y;return{x:(-O.x+j+n+(-O.x+A+n-M))*.5,y:t}},P=e=>e;if(!m.isActive){let e=N(0);m.pos.set(e.x,e.y),m.rot=0}if(a.uIslBar1Pos.value.copy(m.pos),a.uIslBar1Rot.value=m.rot,!g.isActive){let e=N(1);g.pos.set(e.x,e.y),g.rot=0}a.uIslBar2Pos.value.copy(g.pos),a.uIslBar2Rot.value=g.rot;let re=o*$.DIAMOND_ROT_SPEED;a.uDiamondRot.value.set(Math.cos(re),Math.sin(re));let ie=a.uCutSize.value,ae=(c-y*2-ie*2)*a.uIslToMainWRatio.value,oe=h-b,se=y,ce=se+ae+ie+20,le=S*2,ue=$.ISL_BAR_MARGIN_Y_RATIO,de=$.ISL_BAR_HEIGHT_RATIO,fe=$.ISL_BAR_GAP_RATIO,F=$.CORNER_RADIUS,pe=ie+le*(ue*2+2*de+1*fe)-F,me=oe-pe-20;if(t.points&&t.points.material&&t.points.material.uniforms.uMaskRect){t.points.material.uniforms.uMaskRect.value.set(se,me,ce,oe);let e=se+ae,n=oe;t.points.material.uniforms.uMaskSlant&&t.points.material.uniforms.uMaskSlant.value.set(e,n);let r=pe+$.CORNER_RADIUS,i=a.uNavGap?a.uNavGap.value:$.TL_GAP,o=a.uNavigatorVisibility?a.uNavigatorVisibility.value:1,s=0,l=a.uNavVis.value,u=a.uNavWH.value;for(let e=0;e<6;e++)l[e]>.01&&u[e]>.01&&(s+=r*u[e]+i);s>0&&(s-=i),s*=o;let d=c-y+$.CORNER_RADIUS+20,f=c-y+$.CORNER_RADIUS-s-i,p=h-b+$.CORNER_RADIUS+20,m=h-b+$.CORNER_RADIUS-pe-i;t.points.material.uniforms.uMaskRectNav&&t.points.material.uniforms.uMaskRectNav.value.set(f,m,d,p)}let I=S*2*a.uBNotchHRatio.value,he=-S+I;a.uPosStart.value.set(0,he),a.uPosHead.value.set(0,he);let ge=a.uVerticalMarginPct.value,_e=a.uCutSize.value,ve=a.uIslToMainWRatio.value,ye=ge>=.5,be=s._lastVMargin!==ge||s._lastCutSize!==_e||s._lastIslW!==ve||s._lastResX!==c||s._lastResY!==h;if(v&&be&&!ye){let e=y,t=b,n=S*2,r=n*a.uIslBarHeightRatio.value,o=n*a.uIslBarGapRatio.value,l=n*a.uIslBarMarginLeftRatio.value,u=n*a.uIslBarMarginYRatio.value,d=a.uCutSize.value;s._labelGroups&&s._labelGroups.forEach((n,i)=>{let a=t+d+u+i*(r+o)+r*.5,s=t-a,c=e+l+s,f=r*1.6;n.style.height=`${r}px`,n.style.fontSize=`${f}px`,n.style.transform=`translate(${c-20}px, ${a}px) translate(-100%, -50%)`;let p=n.querySelector(`.hud-label-text`);if(p){let t=c-e-25;p.style.maxWidth=`${t}px`}}),s._lastVMargin=ge,s._lastCutSize=d,s._lastIslW=ve,s._lastResX=c,s._lastResY=h,i()}if(s._navLabelGroups&&a.uNavCount&&a.uNavCount.value>0&&!ye){let e=a.uNavGap?a.uNavGap.value:$.TL_GAP,t=S*2,n=a.uIslBarMarginYRatio.value*2+2*a.uIslBarHeightRatio.value+1*a.uIslBarGapRatio.value,r=$.CORNER_RADIUS,i=_e+t*n+r,o=b-r,l=c-y+r,u=i*.32,d=0;s._navLabelGroups.forEach((t,n)=>{let r=a.uNavVis.value[n],s=a.uNavWH.value[n],c=i*s,f=a.uNavigatorVisibility?a.uNavigatorVisibility.value:1,p=r>.001&&s>.001&&f>.001,m=c*.02,h=l-d-c*.5+m,g=o+i*.5;t.style.left=`0`,t.style.top=`0`,t.style.width=`${c}px`,t.style.height=`${i}px`,t.style.fontSize=`${u}px`,t.style.transform=`translate(${h}px, ${g}px) translate(-50%, -50%)`,t.style.opacity=r*f,t.style.display=p?`flex`:`none`,p&&(d+=c+e)})}};let v=(()=>{let e=document.createElement(`div`);e.className=`hud-island-labels`,e.innerHTML=`
...
const vec3 BORDER_COLOR = ${Rs($.BORDER_COLOR)};
uniform vec3 uOutsideColor;
const vec3 ERR_RED = ${zs.COLORS.BAD};
    ...
    if (p.x < resX * 0.1) {
        for (int i = 0; i < 2; i++) {
            ...
            if (dBar < 2.0) {
                ...
                float tGood = ${(zs.FPS.GOOD/60).toFixed(4)};
                float tNorm = ${(zs.FPS.NORMAL/60).toFixed(4)};
...
`}var $,Ls,Rs,zs,Bs=O((()=>{_n(),wt(),ye(),io(),Ps(),$={MARGIN_PCT:.025,VERTICAL_MARGIN_PCT:.5,CUT_SIZE:0,CORNER_RADIUS:4,TL_GAP:5,B_NOTCH_TO_MAIN_W_RATIO:0,B_NOTCH_TO_MAIN_H_RATIO:0,NOTCH_ANGLE:60,R_NOTCH_TO_MAIN_H_RATIO:0,R_NOTCH_TO_MAIN_W_RATIO:0,RIGHT_NOTCH_ANGLE:45,ISL_BAR_COUNT:2,ISL_BAR_HEIGHT_RATIO:.005,ISL_BAR_GAP_RATIO:.01,ISL_BAR_MARGIN_LEFT_RATIO:.1,ISL_BAR_MARGIN_RIGHT_RATIO:.4,ISL_BAR_MARGIN_Y_RATIO:.01,ISL_BAR_PROGRESS:[.15,.42],ISL_TO_MAIN_W_RATIO:-1,NAV_COUNT:6,NAVIGATOR_VISIBILITY:1,NAV_BUTTON_WH_RATIO:2,NAV_CV_BUTTON_WH_RATIO:1,NAV_GAP:5,NAV_FILL_OPACITY:.15,DUR_FILL:1,DUR_HOLD:.5,DUR_WIPE:.25,DUR_PAUSE:.25,DIAMOND_ROT_SPEED:5,BORDER_COLOR:I.ELECTRIC_CYAN,OUTSIDE_COLOR:new e.Color(0,0,0),BORDER_THICK_RATIO:.075,PATTERN_WIDTH:10,PATTERN_GAP:4,PATTERN_LINE_THICK:1,PATTERN_HEIGHT_PCT:.75,BG_GRID_SIZE:60,GRID_LINE_THICKNESS:.6,GRID_PULSE_SPEED:1,GRID_PULSE_DENSITY:1,R_NOTCH_BAR_THICKNESS:2e-4,R_NOTCH_BAR_DIAMOND_SIZE:.00125,R_NOTCH_BAR_PROGRESS:.75,R_NOTCH_BAR_ACTIVE_COLOR:I.ELECTRIC_CYAN,R_NOTCH_BAR_INACTIVE_COLOR:I.ACCENT_GOLD,R_NOTCH_H_RATIO:.4,R_NOTCH_W_RATIO:.02,B_NOTCH_BAR_PROGRESS:1,B_NOTCH_BAR_ALPHA:0,B_NOTCH_BAR_MARGIN_X:.2,B_NOTCH_BAR_MARGIN_Y:.45,B_NOTCH_BAR_COLOR:I.ELECTRIC_CYAN,ELEC_SPEED:256,ELEC_FREQUENCY:4,ELEC_INTENSITY:2,HEAD_SPRITE_SIZE:0,SPRITE_INDEX:26,SPRITE_COLS:8,SPRITE_ROWS:4,HEAD_SCALE:1,SURGE_GRID_SIZE_PX:60,SURGE_GRID_THICK_PX:.4,RING_SPEED:4,RING_INTENSITY:.01,FLOWER_GLOW_HOVER:1.5,GARDEN_HOVER_GRAVITY_MULT:-1,GARDEN_HOVER_TWEEN_DUR:2500,FLOWER_GLOW_BASE:1,FLOWER_COLOR:I.ELECTRIC_CYAN,FLOWER_ROTATION:Math.PI/2,FLOWER_SCALE:.1,GARDEN_IS_FLOWER:0,GROK_SCALE_FACTOR:0,GROK_OFFSET_Y:0,BEAM_SPEED:30,BEAM_FREQ:.512,BEAM_MAX_HEIGHT:.03,BEAM_WAVE_THICKNESS:.0012,BEAM_BASE_THICKNESS:.001,BEAM_TRIM_RATIO:.99,BEAM_GROWTH:1,BEAM_ATTACH_RATIO:1,BEAM_BLOOM:1.5,BEAM_WOBBLE:0,BEAM_GLOW_STRENGTH:.05,BEAM_COLOR:I.ELECTRIC_CYAN,BREATH_AUTO_STRENGTH:.15,BREATH_MANUAL_STRENGTH:.2},Ls={hideDeco:{FLOWER_ROTATION:Math.PI/2,HEAD_SPRITE_SIZE:0},showDeco:{FLOWER_ROTATION:0}},Rs=e=>`vec3(${e.r.toFixed(4)}, ${e.g.toFixed(4)}, ${e.b.toFixed(4)})`,zs={FPS:{PERFECT:60,GOOD:54,NORMAL:24,BAD:0},COLORS:{BAD:Rs(I.CRIMSON_RED)}}}));function Vs(e){let t=`1.5px`,n=`40px`,r=`80px`,i=document.createElement(`div`);Object.assign(i.style,{position:`fixed`,top:`0`,left:`0`,width:`100%`,height:`100%`,pointerEvents:`none`,zIndex:`2000`,overflow:`hidden`});let a=`${($&&$.MARGIN_PCT?$.MARGIN_PCT:.025)*100}vh`,o={position:`absolute`,zIndex:`11`,pointerEvents:`auto`,backgroundColor:`transparent`},s={position:`absolute`,zIndex:`12`,pointerEvents:`auto`,backgroundColor:`rgba(8, 12, 16, 0.9)`,color:`#00F3FF`,border:`1px solid rgba(0, 243, 255, 0.4)`,display:`flex`,justifyContent:`center`,alignItems:`center`,width:r,height:r,boxSizing:`border-box`,backdropFilter:`blur(12px)`,cursor:`pointer`,opacity:`0`,transform:`scale(0.8)`,transition:`all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)`,boxShadow:`0 0 25px rgba(0, 243, 255, 0.1)`},c=e=>{let n=`width: 6px; height: 6px; background: #00F3FF; transform: rotate(45deg); display: block; box-shadow: 0 0 10px rgba(0, 243, 255, 0.8); transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);`,r=`display: flex; gap: ${t}; justify-content: center; align-items: center;`,i=`display: flex; flex-direction: column; gap: ${t}; align-items: center; justify-content: center; width: max-content; overflow: visible;`;return e===`bottom`?`<div style="${i}"><div style="${r}"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div><div class="dot" style="${n}"></div></div>`:e===`top`?`<div style="${i}"><div class="dot" style="${n}"></div><div style="${r}"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div></div>`:e===`left`?`<div style="${i} flex-direction: row;"><div class="dot" style="${n}"></div><div style="${r} flex-direction: column;"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div></div>`:e===`right`?`<div style="${i} flex-direction: row;"><div style="${r} flex-direction: column;"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div><div class="dot" style="${n}"></div></div>`:``},l=(e,t,n,r)=>{let a=document.createElement(`div`);a.id=`zone-${e}`,Object.assign(a.style,o,t);let l=document.createElement(`div`);return l.id=`btn-${e}`,l.innerHTML=c(e),Object.assign(l.style,s,n),r&&(l.style.clipPath=r),l.addEventListener(`mouseenter`,()=>{l.style.backgroundColor=`rgba(0, 243, 255, 0.15)`,l.style.borderColor=`rgba(0, 243, 255, 0.8)`,l.style.boxShadow=`0 0 40px rgba(0, 243, 255, 0.25)`,l.querySelectorAll(`.dot`).forEach(e=>{e.style.background=`#fff`,e.style.boxShadow=`0 0 20px rgba(255, 255, 255, 1)`})}),l.addEventListener(`mouseleave`,()=>{l.style.backgroundColor=`rgba(8, 12, 16, 0.9)`,l.style.borderColor=`rgba(0, 243, 255, 0.4)`,l.style.boxShadow=`0 0 25px rgba(0, 243, 255, 0.1)`,l.querySelectorAll(`.dot`).forEach(e=>{e.style.background=`#00F3FF`,e.style.boxShadow=`0 0 10px rgba(0, 243, 255, 0.8)`})}),a.appendChild(l),i.appendChild(a),{zone:a,btn:l}},u=l(`left`,{top:`0`,left:`0`,width:a,height:`100%`},{top:`50%`,left:`0`,marginTop:`-${n}`,width:n,height:r,borderLeft:`none`},`polygon(0 0, 100% 25%, 100% 75%, 0 100%)`),d=l(`right`,{top:`0`,right:`0`,width:a,height:`100%`},{top:`50%`,right:`0`,marginTop:`-${n}`,width:n,height:r,borderRight:`none`},`polygon(0 25%, 100% 0, 100% 100%, 0 75%)`),f=l(`top`,{top:`0`,left:`0`,width:`100%`,height:a},{top:`0`,left:`50%`,marginLeft:`-${n}`,width:r,height:n,borderTop:`none`},`polygon(0 0, 100% 0, 75% 100%, 25% 100%)`),p=l(`bottom`,{bottom:`0`,left:`0`,width:`100%`,height:a},{bottom:`0`,left:`50%`,marginLeft:`-${n}`,width:r,height:n,borderBottom:`none`},`polygon(25% 0, 75% 0, 100% 100%, 0 100%)`);return e.appendChild(i),{left:u,right:d,top:f,bottom:p,wrapper:i}}function Hs(t,n,r,i=!0,a=!0){let o=new S(n,r.domElement);o.enableDamping=!0,o.dampingFactor=.25,o.minDistance=2,o.maxDistance=100,i&&(o.enableRotate=!1,o.enablePan=!1,o.enableZoom=!1),t.orbitControls=o,o.moveState={left:!1,right:!1,up:!1,down:!1};let s=0,c=0;if(i&&a){let e=r.domElement.parentNode,t=Vs(document.body),n=()=>{if(e){let n=e.getBoundingClientRect();t.wrapper.style.left=`${n.left}px`,t.wrapper.style.top=`${n.top}px`,t.wrapper.style.width=`${n.width}px`,t.wrapper.style.height=`${n.height}px`}};n(),window.addEventListener(`resize`,n);let i=[t.left.btn,t.right.btn,t.top.btn,t.bottom.btn],a=[t.left.zone,t.right.zone,t.top.zone,t.bottom.zone],s=()=>i.forEach(e=>{e.style.opacity=`1`,e.style.transform=`scale(1)`}),c=()=>i.forEach(e=>{e.style.opacity=`0`,e.style.transform=`scale(0.8)`});a.forEach(e=>{e.addEventListener(`mouseenter`,s),e.addEventListener(`mouseleave`,c)});let l=(e,t)=>{e.addEventListener(`mouseenter`,()=>{o.moveState[t]=!0}),e.addEventListener(`mouseleave`,()=>{o.moveState[t]=!1})};l(t.left.btn,`left`),l(t.right.btn,`right`),l(t.top.btn,`up`),l(t.bottom.btn,`down`),o.domUI=t,o.syncWrapperPosition=n,o.showEdgeUI=s,o.hideEdgeUI=c}o.edgeControlUpdate=()=>{if(!i||o.isStrategicHover){o.update();return}let t=0,r=0;if(o.moveState.left&&(t=Ws),o.moveState.right&&(t=-Ws),o.moveState.up&&(r=-Gs),o.moveState.down&&(r=Gs),t!==0){let e=s+t;Math.abs(e)>Ks&&(t=Math.sign(e)*Ks-s),s+=t}else Math.abs(s)>.001?(t=-(s*Us),s+=t):s=0;if(r!==0){let e=c+r;Math.abs(e)>qs&&(r=Math.sign(e)*qs-c),c+=r}else Math.abs(c)>.001?(r=-(c*Us),c+=r):c=0;let a=n._shakeOffset||new e.Vector3(0,0,0);if(n.position.sub(a),t!==0){let r=new e.Matrix4().makeRotationY(t);n.position.sub(o.target).applyMatrix4(r).add(o.target)}if(r!==0){let t=new e.Vector3().subVectors(n.position,o.target),i=new e.Vector3().crossVectors(n.up,t).normalize(),a=new e.Matrix4().makeRotationAxis(i,r);n.position.sub(o.target).applyMatrix4(a).add(o.target)}n.position.add(a),o.update()};let l=o.dispose;return o.dispose=()=>{o.domUI&&o.domUI.wrapper&&o.domUI.wrapper.remove(),o.syncWrapperPosition&&window.removeEventListener(`resize`,o.syncWrapperPosition),l.call(o)},o.update(),o}var Us,Ws,Gs,Ks,qs,Js=O((()=>{Bs(),Us=.05,Ws=.01,Gs=.008,Ks=1,qs=.08}));function Ys(t){let n=new e.MeshStandardMaterial({color:16777215,metalness:.05,roughness:.2,name:`floorMat`,side:e.FrontSide,envMapIntensity:2.5});n.uniforms={...t.globalUniformsHub.uniforms,uBorderColor:{value:new e.Color(65535)}},B.environmentMap&&(n.envMap=B.environmentMap,n.envMapIntensity=2.5,B.environmentMap.mapping=e.EquirectangularReflectionMapping),n.onBeforeCompile=e=>{kr(e,n.uniforms),Ar(e,n.uniforms),jr(e,n.uniforms)};function r(t,r,i=e.NoColorSpace){ot.load(`textures/ktx2/${t}`,function(t){t.wrapS=e.RepeatWrapping,t.wrapT=e.RepeatWrapping,t.anisotropy=4,t.repeat.set(.5,4),t.colorSpace=i,n[r]=t,n.needsUpdate=!0,r===`bumpMap`&&(n.bumpScale=1.2)})}r(`hardwood2_diffuse.ktx2`,`map`,e.SRGBColorSpace),r(`hardwood2_bump.ktx2`,`bumpMap`),r(`hardwood2_roughness.ktx2`,`roughnessMap`);let i=new e.Mesh(Qs,n);return i.rotation.x=-Math.PI/2,i.receiveShadow=!0,i.position.set(3,0,-4),i.name=`floor`,i.scale.set(20,24.8,1),i.visible=!1,i}function Xs(e,t){let n=e.initialParent||e.parent,r={uuid:e.uuid,name:e.name,position:e.position.clone(),rotation:{x:e.rotation.x,y:e.rotation.y,z:e.rotation.z,order:e.rotation.order},scale:e.scale.clone(),parent:n};t.tweenData=t.tweenData||{},t.tweenData[e.uuid]=r}function Zs(e){$s.envMap=e.environment;let t=Ys(e);e.add(t),Xs(t,e);let n=e.getObjectByName(`leftWall`),r=e.getObjectByName(`rightWall`),i=e.getObjectByName(`backWall`),a=e.getObjectByName(`frontWall`),o=e.getObjectByName(`rightWall-cover`);n?n.material=$s:console.warn(`Missing: leftWall`),r?r.material=$s:console.warn(`Missing: rightWall`),o?o.material=$s:console.warn(`Missing: rightWall-cover`),i?i.material=ec:console.warn(`Missing: backWall`),a?a.material=$s:console.warn(`Missing: frontWall`),[`rightWall`,`leftWallFoot001`].forEach(t=>{let n=e.getObjectByName(t);n&&n.material&&(n.material=n.material.clone(),n.material.uniforms=e.globalUniformsHub.uniforms,n.material.onBeforeCompile=e=>{kr(e,n.material.uniforms)})})}var Qs,$s,ec,tc=O((()=>{ct(),er(),wt(),Ir(),Qs=$n.plane,$s=new e.MeshStandardMaterial({roughness:.9,color:661043,metalness:.25,side:e.FrontSide,name:`wallMat`}),ec=new e.MeshStandardMaterial({roughness:.9,color:`#090919`,metalness:.25,side:e.FrontSide,name:`backWallMat`}),$s.envMapRotation.y=1.4,new e.MeshBasicMaterial({color:661043})}));function nc(t,n,r,i=null,a=null,o=`REPEAT`){let s=t?t.itemSize:r,c=new(a||(t?t.array.constructor:Float32Array))(n*s);if(i&&i.length===s)for(let e=0;e<n;e++)for(let t=0;t<s;t++)c[e*s+t]=i[t];if(t){let e=t.array,n=e.length;if(c.set(e),o===`REPEAT`)for(let t=n;t<c.length;t++)c[t]=e[t%n]}return new e.BufferAttribute(c,s)}var rc,ic=O((()=>{rc=class extends e.BufferGeometry{constructor(e){super(),this.isMorphGeo=!0,this.targetGeos=e;let t=Array.isArray(e)?e:[e],n=Math.max(...t.map(e=>e.attributes.position?e.attributes.position.count:0));this.maxCount=n;let r=Math.max(...t.map(e=>e.index?e.index.count:0)),i=t.some(e=>e.attributes.uv),a=t.some(e=>e.attributes.normal);this.morphInfo=[],e.forEach(e=>{let t=null;e.index&&(t=nc(e.index,r,1,null,Uint32Array,`ZERO`));let o={position:nc(e.attributes.position,n,3),normal:a?nc(e.attributes.normal,n,3,[0,1,0]):null,uv:i?nc(e.attributes.uv,n,2):null,index:t};this.morphInfo.push(o)})}setMorphInfo(e,t=null){t??=e;let n=this.morphInfo[e],r=this.morphInfo[t];n.position&&this.setAttribute(`position`,n.position),n.normal&&this.setAttribute(`normal`,n.normal),n.uv&&this.setAttribute(`uv`,n.uv),n.index&&(this.setIndex(n.index),this.originalIndex=n.index),r.position&&this.setAttribute(`targetPosition`,r.position),r.normal&&this.setAttribute(`targetNormal`,r.normal),r.uv&&this.setAttribute(`targetUV`,r.uv),r.index&&(this.targetIndex=r.index)}addTargets(e){let t=Array.isArray(e)?e:[e];this.targetGeos.push(...t);let n=this.maxCount,r=Math.max(...t.map(e=>e.index?e.index.count:0)),i=t.some(e=>e.attributes.uv),a=t.some(e=>e.attributes.normal);t.forEach(e=>{let t=null;if(e.index){let n=Math.max(r,e.index.count);t=nc(e.index,n,1,null,Uint32Array,`ZERO`)}let o={position:nc(e.attributes.position,n,3),normal:a||this.attributes&&this.attributes.normal?nc(e.attributes.normal,n,3,[0,1,0]):null,uv:i||this.attributes&&this.attributes.uv?nc(e.attributes.uv,n,2):null,index:t};this.morphInfo.push(o)})}}})),ac,oc,sc=O((()=>{ac=class e extends c{constructor(){super(e.Geometry,new l({opacity:0,transparent:!0})),this.isLensflare=!0,this.type=`Lensflare`,this.frustumCulled=!0,this.renderOrder=1/0;let r=new p,o=new p,s=new a(16,16),h=new a(16,16),g=d,_=e.Geometry,v=new u({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
    ...
    const float radius =  ${fc.toFixed(1)};
    ...
    void main() {
        ...
        if (random > 0.8) {
            ...
            vec2 pivot = vec2(${pc.y.toFixed(1)}, ${pc.z.toFixed(1)});
