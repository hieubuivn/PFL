...
}`}}var Dr,Or,kr,Ar,jr=M((()=>{Et(),Dr={core:{iTime:0,iResolution:new e.Vector2(1024,1024)},water:xt,grid:{...St,uObjectStagger:0},dotaLogo:Ct,welcome:wt},Or=(e,t,n,r=`vec2`)=>{let i=`varying ${r} ${n};`;e.vertexShader&&!e.vertexShader.includes(n+`;`)&&(e.vertexShader=e.vertexShader.replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${i}\n${e}`)),e.fragmentShader&&!e.fragmentShader.includes(n+`;`)&&(e.fragmentShader.includes(`#include <common>`)?e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>\n${i}`):e.fragmentShader=`${i}\n${e.fragmentShader}`)},kr=(e,t,n)=>{let r=t===`vertex`?`vertexShader`:`fragmentShader`;e[r]&&!e[r].includes(n.trim())&&(e[r]=e[r].replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${e}\n    ${n}`))},Ar=(e,t,n)=>{let r=Dr[n];if(r){n!==`core`&&Ar(e,t,`core`);for(let[n,i]of Object.entries(r))e.uniforms[n]||(e.uniforms[n]=t[n]||{value:i})}}})),Mr,Nr=M((()=>{Mr=`
    uniform vec2 iResolution;
    uniform float iTime;
    uniform float uBSODState; // 0.0 = Normal, 1.0 = BSOD
...
const vec3 BORDER_COLOR = ${Ps($.BORDER_COLOR)};
uniform vec3 uOutsideColor;
const vec3 ERR_RED = ${Fs.COLORS.BAD};
    ...
    if (p.x < resX * 0.1) {
        for (int i = 0; i < 2; i++) {
            ...
            if (dBar < 2.0) {
                ...
                float tGood = ${(Fs.FPS.GOOD/60).toFixed(4)};
                float tNorm = ${(Fs.FPS.NORMAL/60).toFixed(4)};
...
`}var $,Ns,Ps,Fs,Is=M((()=>{dn(),vt(),me(),eo(),As(),$={MARGIN_PCT:.025,VERTICAL_MARGIN_PCT:.5,CUT_SIZE:0,CORNER_RADIUS:4,TL_GAP:5,B_NOTCH_TO_MAIN_W_RATIO:0,B_NOTCH_TO_MAIN_H_RATIO:0,NOTCH_ANGLE:60,R_NOTCH_TO_MAIN_H_RATIO:0,R_NOTCH_TO_MAIN_W_RATIO:0,RIGHT_NOTCH_ANGLE:45,ISL_BAR_COUNT:2,ISL_BAR_HEIGHT_RATIO:.005,ISL_BAR_GAP_RATIO:.01,ISL_BAR_MARGIN_LEFT_RATIO:.1,ISL_BAR_MARGIN_RIGHT_RATIO:.4,ISL_BAR_MARGIN_Y_RATIO:.01,ISL_BAR_PROGRESS:[.15,.42],ISL_TO_MAIN_W_RATIO:-1,NAV_COUNT:6,NAVIGATOR_VISIBILITY:1,NAV_BUTTON_WH_RATIO:2,NAV_CV_BUTTON_WH_RATIO:1,NAV_GAP:5,NAV_FILL_OPACITY:.15,DUR_FILL:1,DUR_HOLD:.5,DUR_WIPE:.25,DUR_PAUSE:.25,DIAMOND_ROT_SPEED:5,BORDER_COLOR:I.ELECTRIC_CYAN,OUTSIDE_COLOR:new e.Color(0,0,0),BORDER_THICK_RATIO:.075,PATTERN_WIDTH:10,PATTERN_GAP:4,PATTERN_LINE_THICK:1,PATTERN_HEIGHT_PCT:.75,BG_GRID_SIZE:60,GRID_LINE_THICKNESS:.6,GRID_PULSE_SPEED:1,GRID_PULSE_DENSITY:1,R_NOTCH_BAR_THICKNESS:2e-4,R_NOTCH_BAR_DIAMOND_SIZE:.00125,R_NOTCH_BAR_PROGRESS:.75,R_NOTCH_BAR_ACTIVE_COLOR:I.ELECTRIC_CYAN,R_NOTCH_BAR_INACTIVE_COLOR:I.ACCENT_GOLD,R_NOTCH_H_RATIO:.4,R_NOTCH_W_RATIO:.02,B_NOTCH_BAR_PROGRESS:1,B_NOTCH_BAR_ALPHA:0,B_NOTCH_BAR_MARGIN_X:.2,B_NOTCH_BAR_MARGIN_Y:.45,B_NOTCH_BAR_COLOR:I.ELECTRIC_CYAN,ELEC_SPEED:256,ELEC_FREQUENCY:4,ELEC_INTENSITY:2,HEAD_SPRITE_SIZE:0,SPRITE_INDEX:26,SPRITE_COLS:8,SPRITE_ROWS:4,HEAD_SCALE:1,SURGE_GRID_SIZE_PX:60,SURGE_GRID_THICK_PX:.4,RING_SPEED:4,RING_INTENSITY:.01,FLOWER_GLOW_HOVER:1.5,GARDEN_HOVER_GRAVITY_MULT:-1,GARDEN_HOVER_TWEEN_DUR:2500,FLOWER_GLOW_BASE:1,FLOWER_COLOR:I.ELECTRIC_CYAN,FLOWER_ROTATION:Math.PI/2,FLOWER_SCALE:.1,GARDEN_IS_FLOWER:0,GROK_SCALE_FACTOR:0,GROK_OFFSET_Y:0,BEAM_SPEED:30,BEAM_FREQ:.512,BEAM_MAX_HEIGHT:.03,BEAM_WAVE_THICKNESS:.0012,BEAM_BASE_THICKNESS:.001,BEAM_TRIM_RATIO:.99,BEAM_GROWTH:1,BEAM_ATTACH_RATIO:1,BEAM_BLOOM:1.5,BEAM_WOBBLE:0,BEAM_GLOW_STRENGTH:.05,BEAM_COLOR:I.ELECTRIC_CYAN,BREATH_AUTO_STRENGTH:.15,BREATH_MANUAL_STRENGTH:.2},Ns={hideDeco:{FLOWER_ROTATION:Math.PI/2,HEAD_SPRITE_SIZE:0},showDeco:{FLOWER_ROTATION:0}},Ps=e=>`vec3(${e.r.toFixed(4)}, ${e.g.toFixed(4)}, ${e.b.toFixed(4)})`,Fs={FPS:{PERFECT:60,GOOD:54,NORMAL:24,BAD:0},COLORS:{BAD:Ps(I.CRIMSON_RED)}}}));function Ls(e){let t=`1.5px`,n=`40px`,r=`80px`,i=document.createElement(`div`);Object.assign(i.style,{position:`fixed`,top:`0`,left:`0`,width:`100%`,height:`100%`,pointerEvents:`none`,zIndex:`2000`,overflow:`hidden`});let a=`${($&&$.MARGIN_PCT?$.MARGIN_PCT:.025)*100}vh`,o={position:`absolute`,zIndex:`11`,pointerEvents:`auto`,backgroundColor:`transparent`},s={position:`absolute`,zIndex:`12`,pointerEvents:`auto`,backgroundColor:`rgba(8, 12, 16, 0.9)`,color:`#00F3FF`,border:`1px solid rgba(0, 243, 255, 0.4)`,display:`flex`,justifyContent:`center`,alignItems:`center`,width:r,height:r,boxSizing:`border-box`,backdropFilter:`blur(12px)`,cursor:`pointer`,opacity:`0`,transform:`scale(0.8)`,transition:`all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)`,boxShadow:`0 0 25px rgba(0, 243, 255, 0.1)`},c=e=>{let n=`width: 6px; height: 6px; background: #00F3FF; transform: rotate(45deg); display: block; box-shadow: 0 0 10px rgba(0, 243, 255, 0.8); transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);`,r=`display: flex; gap: ${t}; justify-content: center; align-items: center;`,i=`display: flex; flex-direction: column; gap: ${t}; align-items: center; justify-content: center; width: max-content; overflow: visible;`;return e===`bottom`?`<div style="${i}"><div style="${r}"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div><div class="dot" style="${n}"></div></div>`:e===`top`?`<div style="${i}"><div class="dot" style="${n}"></div><div style="${r}"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div></div>`:e===`left`?`<div style="${i} flex-direction: row;"><div class="dot" style="${n}"></div><div style="${r} flex-direction: column;"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div></div>`:e===`right`?`<div style="${i} flex-direction: row;"><div style="${r} flex-direction: column;"><div class="dot" style="${n}"></div><div class="dot" style="${n}"></div></div><div class="dot" style="${n}"></div></div>`:``},l=(e,t,n,r)=>{let a=document.createElement(`div`);a.id=`zone-${e}`,Object.assign(a.style,o,t);let l=document.createElement(`div`);return l.id=`btn-${e}`,l.innerHTML=c(e),Object.assign(l.style,s,n),r&&(l.style.clipPath=r),l.addEventListener(`mouseenter`,()=>{l.style.backgroundColor=`rgba(0, 243, 255, 0.15)`,l.style.borderColor=`rgba(0, 243, 255, 0.8)`,l.style.boxShadow=`0 0 40px rgba(0, 243, 255, 0.25)`,l.querySelectorAll(`.dot`).forEach(e=>{e.style.background=`#fff`,e.style.boxShadow=`0 0 20px rgba(255, 255, 255, 1)`})}),l.addEventListener(`mouseleave`,()=>{l.style.backgroundColor=`rgba(8, 12, 16, 0.9)`,l.style.borderColor=`rgba(0, 243, 255, 0.4)`,l.style.boxShadow=`0 0 25px rgba(0, 243, 255, 0.1)`,l.querySelectorAll(`.dot`).forEach(e=>{e.style.background=`#00F3FF`,e.style.boxShadow=`0 0 10px rgba(0, 243, 255, 0.8)`})}),a.appendChild(l),i.appendChild(a),{zone:a,btn:l}},u=l(`left`,{top:`0`,left:`0`,width:a,height:`100%`},{top:`50%`,left:`0`,marginTop:`-${n}`,width:n,height:r,borderLeft:`none`},`polygon(0 0, 100% 25%, 100% 75%, 0 100%)`),d=l(`right`,{top:`0`,right:`0`,width:a,height:`100%`},{top:`50%`,right:`0`,marginTop:`-${n}`,width:n,height:r,borderRight:`none`},`polygon(0 25%, 100% 0, 100% 100%, 0 75%)`),f=l(`top`,{top:`0`,left:`0`,width:`100%`,height:a},{top:`0`,left:`50%`,marginLeft:`-${n}`,width:r,height:n,borderTop:`none`},`polygon(0 0, 100% 0, 75% 100%, 25% 100%)`),p=l(`bottom`,{bottom:`0`,left:`0`,width:`100%`,height:a},{bottom:`0`,left:`50%`,marginLeft:`-${n}`,width:r,height:n,borderBottom:`none`},`polygon(25% 0, 75% 0, 100% 100%, 0 100%)`);return e.appendChild(i),{left:u,right:d,top:f,bottom:p,wrapper:i}}function Rs(t,n,r,i=!0,a=!0){let o=new T(n,r.domElement);o.enableDamping=!0,o.dampingFactor=.25,o.minDistance=2,o.maxDistance=100,i&&(o.enableRotate=!1,o.enablePan=!1,o.enableZoom=!1),t.orbitControls=o,o.moveState={left:!1,right:!1,up:!1,down:!1};let s=0,c=0;if(i&&a){let e=r.domElement.parentNode,t=Ls(document.body),n=()=>{if(e){let n=e.getBoundingClientRect();t.wrapper.style.left=`${n.left}px`,t.wrapper.style.top=`${n.top}px`,t.wrapper.style.width=`${n.width}px`,t.wrapper.style.height=`${n.height}px`}};n(),window.addEventListener(`resize`,n);let i=[t.left.btn,t.right.btn,t.top.btn,t.bottom.btn],a=[t.left.zone,t.right.zone,t.top.zone,t.bottom.zone],s=()=>i.forEach(e=>{e.style.opacity=`1`,e.style.transform=`scale(1)`}),c=()=>i.forEach(e=>{e.style.opacity=`0`,e.style.transform=`scale(0.8)`});a.forEach(e=>{e.addEventListener(`mouseenter`,s),e.addEventListener(`mouseleave`,c)});let l=(e,t)=>{e.addEventListener(`mouseenter`,()=>{o.moveState[t]=!0}),e.addEventListener(`mouseleave`,()=>{o.moveState[t]=!1})};l(t.left.btn,`left`),l(t.right.btn,`right`),l(t.top.btn,`up`),l(t.bottom.btn,`down`),o.domUI=t,o.syncWrapperPosition=n,o.showEdgeUI=s,o.hideEdgeUI=c}o.edgeControlUpdate=()=>{if(!i||o.isStrategicHover){o.update();return}let t=0,r=0;if(o.moveState.left&&(t=Bs),o.moveState.right&&(t=-Bs),o.moveState.up&&(r=-Vs),o.moveState.down&&(r=Vs),t!==0){let e=s+t;Math.abs(e)>Hs&&(t=Math.sign(e)*Hs-s),s+=t}else Math.abs(s)>.001?(t=-(s*zs),s+=t):s=0;if(r!==0){let e=c+r;Math.abs(e)>Us&&(r=Math.sign(e)*Us-c),c+=r}else Math.abs(c)>.001?(r=-(c*zs),c+=r):c=0;let a=n._shakeOffset||new e.Vector3(0,0,0);if(n.position.sub(a),t!==0){let r=new e.Matrix4().makeRotationY(t);n.position.sub(o.target).applyMatrix4(r).add(o.target)}if(r!==0){let t=new e.Vector3().subVectors(n.position,o.target),i=new e.Vector3().crossVectors(n.up,t).normalize(),a=new e.Matrix4().makeRotationAxis(i,r);n.position.sub(o.target).applyMatrix4(a).add(o.target)}n.position.add(a),o.update()};let l=o.dispose;return o.dispose=()=>{o.domUI&&o.domUI.wrapper&&o.domUI.wrapper.remove(),o.syncWrapperPosition&&window.removeEventListener(`resize`,o.syncWrapperPosition),l.call(o)},o.update(),o}var zs,Bs,Vs,Hs,Us,Ws=M((()=>{Is(),zs=.05,Bs=.01,Vs=.008,Hs=1,Us=.08}));function Gs(t){let n=new e.MeshStandardMaterial({color:16777215,metalness:.05,roughness:.2,name:`floorMat`,side:e.FrontSide,envMapIntensity:2.5});n.uniforms={...t.globalUniformsHub.uniforms,uBorderColor:{value:new e.Color(65535)}},V.environmentMap&&(n.envMap=V.environmentMap,n.envMapIntensity=2.5,V.environmentMap.mapping=e.EquirectangularReflectionMapping),n.onBeforeCompile=e=>{wr(e,n.uniforms),Tr(e,n.uniforms),Er(e,n.uniforms)};function r(t,r,i=e.NoColorSpace){et.load(`textures/ktx2/${t}`,function(t){t.wrapS=e.RepeatWrapping,t.wrapT=e.RepeatWrapping,t.anisotropy=4,t.repeat.set(.5,4),t.colorSpace=i,n[r]=t,n.needsUpdate=!0,r===`bumpMap`&&(n.bumpScale=1.2)})}r(`hardwood2_diffuse.ktx2`,`map`,e.SRGBColorSpace),r(`hardwood2_bump.ktx2`,`bumpMap`),r(`hardwood2_roughness.ktx2`,`roughnessMap`);let i=new e.Mesh(Js,n);return i.rotation.x=-Math.PI/2,i.receiveShadow=!0,i.position.set(3,0,-4),i.name=`floor`,i.scale.set(20,24.8,1),i.visible=!1,i}function Ks(e,t){let n=e.initialParent||e.parent,r={uuid:e.uuid,name:e.name,position:e.position.clone(),rotation:{x:e.rotation.x,y:e.rotation.y,z:e.rotation.z,order:e.rotation.order},scale:e.scale.clone(),parent:n};t.tweenData=t.tweenData||{},t.tweenData[e.uuid]=r}function qs(e){Ys.envMap=e.environment;let t=Gs(e);e.add(t),Ks(t,e);let n=e.getObjectByName(`leftWall`),r=e.getObjectByName(`rightWall`),i=e.getObjectByName(`backWall`),a=e.getObjectByName(`frontWall`),o=e.getObjectByName(`rightWall-cover`);n?n.material=Ys:console.warn(`Missing: leftWall`),r?r.material=Ys:console.warn(`Missing: rightWall`),o?o.material=Ys:console.warn(`Missing: rightWall-cover`),i?i.material=Xs:console.warn(`Missing: backWall`),a?a.material=Ys:console.warn(`Missing: frontWall`),[`rightWall`,`leftWallFoot001`].forEach(t=>{let n=e.getObjectByName(t);n&&n.material&&(n.material=n.material.clone(),n.material.uniforms=e.globalUniformsHub.uniforms,n.material.onBeforeCompile=e=>{wr(e,n.material.uniforms)})})}var Js,Ys,Xs,Zs=M((()=>{nt(),Yn(),vt(),jr(),Js=Jn.plane,Ys=new e.MeshStandardMaterial({roughness:.9,color:661043,metalness:.25,side:e.FrontSide,name:`wallMat`}),Xs=new e.MeshStandardMaterial({roughness:.9,color:`#090919`,metalness:.25,side:e.FrontSide,name:`backWallMat`}),Ys.envMapRotation.y=1.4,new e.MeshBasicMaterial({color:661043})}));function Qs(t,n,r,i=null,a=null,o=`REPEAT`){let s=t?t.itemSize:r,c=new(a||(t?t.array.constructor:Float32Array))(n*s);if(i&&i.length===s)for(let e=0;e<n;e++)for(let t=0;t<s;t++)c[e*s+t]=i[t];if(t){let e=t.array,n=e.length;if(c.set(e),o===`REPEAT`)for(let t=n;t<c.length;t++)c[t]=e[t%n]}return new e.BufferAttribute(c,s)}var $s,ec=M((()=>{$s=class extends e.BufferGeometry{constructor(e){super(),this.isMorphGeo=!0,this.targetGeos=e;let t=Array.isArray(e)?e:[e],n=Math.max(...t.map(e=>e.attributes.position?e.attributes.position.count:0));this.maxCount=n;let r=Math.max(...t.map(e=>e.index?e.index.count:0)),i=t.some(e=>e.attributes.uv),a=t.some(e=>e.attributes.normal);this.morphInfo=[],e.forEach(e=>{let t=null;e.index&&(t=Qs(e.index,r,1,null,Uint32Array,`ZERO`));let o={position:Qs(e.attributes.position,n,3),normal:a?Qs(e.attributes.normal,n,3,[0,1,0]):null,uv:i?Qs(e.attributes.uv,n,2):null,index:t};this.morphInfo.push(o)})}setMorphInfo(e,t=null){t??=e;let n=this.morphInfo[e],r=this.morphInfo[t];n.position&&this.setAttribute(`position`,n.position),n.normal&&this.setAttribute(`normal`,n.normal),n.uv&&this.setAttribute(`uv`,n.uv),n.index&&(this.setIndex(n.index),this.originalIndex=n.index),r.position&&this.setAttribute(`targetPosition`,r.position),r.normal&&this.setAttribute(`targetNormal`,r.normal),r.uv&&this.setAttribute(`targetUV`,r.uv),r.index&&(this.targetIndex=r.index)}addTargets(e){let t=Array.isArray(e)?e:[e];this.targetGeos.push(...t);let n=this.maxCount,r=Math.max(...t.map(e=>e.index?e.index.count:0)),i=t.some(e=>e.attributes.uv),a=t.some(e=>e.attributes.normal);t.forEach(e=>{let t=null;if(e.index){let n=Math.max(r,e.index.count);t=Qs(e.index,n,1,null,Uint32Array,`ZERO`)}let o={position:Qs(e.attributes.position,n,3),normal:a||this.attributes&&this.attributes.normal?Qs(e.attributes.normal,n,3,[0,1,0]):null,uv:i||this.attributes&&this.attributes.uv?Qs(e.attributes.uv,n,2):null,index:t};this.morphInfo.push(o)})}}})),tc,nc,rc=M((()=>{tc=class e extends c{constructor(){super(e.Geometry,new l({opacity:0,transparent:!0})),this.isLensflare=!0,this.type=`Lensflare`,this.frustumCulled=!0,this.renderOrder=1/0;let r=new h,o=new h,s=new a(16,16),d=new a(16,16),f=p,_=e.Geometry,v=new u({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
    ...
    const float radius =  ${cc.toFixed(1)};
    ...
    void main() {
        ...
        if (random > 0.8) {
            ...
            vec2 pivot = vec2(${lc.y.toFixed(1)}, ${lc.z.toFixed(1)});
