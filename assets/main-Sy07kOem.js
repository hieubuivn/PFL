...
`,dn=Rt(`#FBC189`,1,1),dn.name=`goldInner`,dn.clone(),fn=Lt(`#FBC189`,1,.01,6.5,e.FrontSide),fn.name=`goldOuter`,pn=`
// Simplex 3D Noise 
...
`,hn=Vt(`#FBC189`,1,1,1),Ut(`#FBC189`,1,1,1),gn=Ht(`#FBC189`,1,.01,6.5,e.FrontSide,1),Wt(`#FBC189`,1,.01,6.5,e.FrontSide,1),_n=Kt(`#FBC189`,1,1,.1),vn=`
    uniform vec2 iResolution;
    uniform float iTime;
    uniform vec2 uMouse;
    uniform vec2 uSmoothedMouse;
...
`+e.fragmentShader,Rr(e,`fragment`,`
    ...
    `),e.fragmentShader=e.fragmentShader.replace(/UV\s*=\s*vUv/g,`UV = vWarpedUv`).replace(/texture2D\(\s*map\s*,\s*vMapUv\s*\)/g,`texture2D( map, vWarpedUv )`).replace(/texture2D\(\s*roughnessMap\s*,\s*vMapUv\s*\)/g,`texture2D( roughnessMap, vWarpedUv )`).replace(/texture2D\(\s*metalnessMap\s*,\s*vMapUv\s*\)/g,`texture2D( metalnessMap, vWarpedUv )`).replace(/texture2D\(\s*bumpMap\s*,\s*vMapUv\s*\)/g,`texture2D( bumpMap, vWarpedUv )`).replace(/texture2D\(\s*iChannel([0-9X])\s*,\s*(vUv|uv)\s*\)/g,`texture2D( iChannel$1, vWarpedUv )`).replace(/textureLod\(\s*iChannelX\s*,\s*UV\+n\s*,\s*focus\s*\)/g,`textureLod( iChannelX, vWarpedUv+n, focus )`).replace(/texture2D\(\s*fireFliesTexture\s*,\s*uv\s*\)/g,`texture2D( fireFliesTexture, vWarpedUv )`),e.fragmentShader.includes(`#include <normal_fragment_begin>`)&&(e.fragmentShader=e.fragmentShader.replace(`#include <normal_fragment_begin>`,`
            ...
            `))}function Pr(e,t={}){if(zr(e,t,`grid`),Lr(e,`vertex`,`vPatchedUv`,`vec2`),Lr(e,`vertex`,`vWorldPos`,`vec3`),Rr(e,`vertex`,`vPatchedUv = uv;`),Rr(e,`vertex`,`vWorldPos = (modelMatrix * vec4(position, 1.0)).xyz;`),e.fragmentShader.includes(`Holographic Grid Overlay`))return;let n=`
        ${e.fragmentShader.includes(`uniform float iTime;`)?``:`uniform float iTime;`}
...
}`}}function Fr(e,t={}){if(zr(e,t,`welcome`),Lr(e,`vertex`,`vPatchedUv`,`vec2`),Rr(e,`vertex`,`vPatchedUv = uv;`),e.fragmentShader.includes(`Welcome Text Header`))return;let n=e.fragmentShader.includes(`uniform float iTime;`),r=e.fragmentShader.includes(`uniform vec2 iResolution;`),i=`
        // --- Welcome Text Header ---
...
}`}}var Ir,Lr,Rr,zr,Br=M((()=>{It(),Ir={core:{iTime:0,iResolution:new e.Vector2(1024,1024)},water:jt,grid:{...Mt,uObjectStagger:0},dotaLogo:Nt,welcome:Pt},Lr=(e,t,n,r=`vec2`)=>{let i=`varying ${r} ${n};`;e.vertexShader&&!e.vertexShader.includes(n+`;`)&&(e.vertexShader=e.vertexShader.replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${i}\n${e}`)),e.fragmentShader&&!e.fragmentShader.includes(n+`;`)&&(e.fragmentShader.includes(`#include <common>`)?e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>\n${i}`):e.fragmentShader=`${i}\n${e.fragmentShader}`)},Rr=(e,t,n)=>{let r=t===`vertex`?`vertexShader`:`fragmentShader`;e[r]&&!e[r].includes(n.trim())&&(e[r]=e[r].replace(/void\s+main\s*\(\s*\)\s*\{/,e=>`${e}\n    ${n}`))},zr=(e,t,n)=>{let r=Ir[n];if(r){n!==`core`&&zr(e,t,`core`);for(let[n,i]of Object.entries(r))e.uniforms[n]||(e.uniforms[n]=t[n]||{value:i})}}})),Vr,Hr=M((()=>{Vr=`
    uniform vec2 iResolution;
    uniform float iTime;
    uniform float uBSODState; // 0.0 = Normal, 1.0 = BSOD
...
`}));async function Ur(){return new Promise(e=>requestAnimationFrame(e))}var Wr=M((()=>{}));function Gr(t,n,r={}){let{transparent:i=!1,blending:a=e.AdditiveBlending,side:o=e.FrontSide,derivatives:s=!1,uniforms:c={},vs:l=Xt}=r,u=t.globalUniformsHub?t.globalUniformsHub.core:{};return new e.ShaderMaterial({vertexShader:l,fragmentShader:n,uniforms:{...u,...c},blending:a,side:o,transparent:i,extensions:{derivatives:s}})}async function Kr(t,n){n&&(n.innerText=z(`SYS_CONFIG_MATERIALS`));let r=t.globalUniformsHub,i=r?r.uniforms:{};Xr=Gr(t,Qt,{transparent:!0,uniforms:{uFireHeightOverride:i.uFireHeightOverride||{value:0},uSmoothedMouse:{value:new e.Vector2(0,0)}}}),Zr=Gr(t,rn),G=Gr(t,Vr,{blending:e.NormalBlending,uniforms:{uBSODState:i.uPCBSODState||{value:0},uIsPoba:i.uIsPoba||{value:0},uHoverPos:{value:new e.Vector2(0,0)},uTargetHoverPos:{value:new e.Vector2(0,0)},uHoverActive:{value:0},uClickPos:{value:new e.Vector2(.5,.5)},uClickTime:{value:-99},uBootState:{value:0},uChannelAvatars:i.uChannelAvatars||{value:null},uHasAvatarTexture:{value:1},uSpecialPos1:{value:new e.Vector2(0,1)},uSpecialPos2:{value:new e.Vector2(2,0)}}}),Qr=Gr(t,en,{blending:e.NormalBlending}),$r=Gr(t,nn,{blending:e.NormalBlending}),ei=Gr(t,tn,{blending:e.NormalBlending,derivatives:!0,uniforms:{uBSODState:i.uLaptopBSODState||{value:0},uNetflixStartTime:i.uNetflixStartTime||{value:0}}}),ti=Gr(t,tn,{blending:e.NormalBlending,derivatives:!0,uniforms:{uBSODState:i.uPCBSODState||{value:0},uNetflixStartTime:i.uNetflixStartTime||{value:0}}}),ni=Gr(t,vn,{depthWrite:!1,depthTest:!1,transparent:!0,uniforms:{uEyeActive:{value:!1},uOffsetY:{value:-.017},uEyeOpenness:{value:0},uEyeAngle:{value:-.36},uEyeScale:{value:.5},uEyeFlameOffset:{value:new e.Vector2(0,.52)},uFlameScale:{value:new e.Vector2(.5,.5)},uEyeScreenPosition:{value:new e.Vector2(.6,0)},uFireHeightOverride:i.uFireHeightOverride||{value:0},uSmoothedMouse:{value:new e.Vector2(0,0)}}}),ri=Gr(t,yn,{transparent:!0,uniforms:{...t.globalUniformsHub.core,uSelectedSlot:{value:new e.Vector2(3,1)},uGlowIntensity:{value:.05},uBorderThickness:{value:.02},uCurrentSpeed:{value:5},uIconScale:{value:.75},uDarkness:{value:.74},uAspect:{value:1.77}}}),ii=Gr(t,bn,{blending:e.NormalBlending,uniforms:{uBSODState:i.uPCBSODState||{value:0},uAspect:{value:1.77}}}),oi=[Zr,Qr,$r,ei,ri,ii],si=[G,ti,ri,ii];let a=async n=>{let r=[{name:[`screenDisplay001_1`],envMapIntensity:10,metalness:.1,roughness:.5,envMapRotation:new e.Euler(0,.5,.5)},{name:[`verticalMonitorBody`],envMapIntensity:10,metalness:0,roughness:.15,envMapRotation:new e.Euler(0,1.97,.39),toneMapped:!1},{name:`Object_0003_3`,envMapIntensity:1,metalness:0,roughness:.32,envMapRotation:new e.Euler(0,Math.PI/2,0)},{name:`shelf`,envMapIntensity:2.65,metalness:0,roughness:1,envMapRotation:new e.Euler(1.2,.1,.2),side:e.BackSide,toneMapped:!0},{name:`mjolnir_low_mjolnir_hammer_0`,envMapIntensity:5,metalness:1,roughness:1},{name:`Object_15`,envMapIntensity:20,metalness:.15,roughness:.5},{name:`Object_15001`,envMapIntensity:2,metalness:.15,roughness:.2,envMapRotation:new e.Euler(Math.PI,-Math.PI/2,-1)},{name:`book001`,envMapIntensity:20,metalness:0,roughness:1,envMapRotation:new e.Euler(Math.PI/2,Math.PI/2,0)},{name:`blackCat`,envMapIntensity:.75,envMapRotation:new e.Euler(0,1,0),toneMapped:!1},{name:`Object_108`,envMapIntensity:1},{name:`leftWallFoot001`,envMapIntensity:.5},{name:`Object_17`,envMapIntensity:.5},{name:`Ch23_Body`,envMapIntensity:8,metalness:0,roughness:1,envMapRotation:new e.Euler(-2.17,-2.83,.73)},{name:`PokeBall__0002`},{name:`PokeBall__0002_1`},{name:`PokeBall__0002_2`},{name:`Model_0001`},{name:`pictureLion`,map:H.avatarsCelShaded,envMapIntensity:1.5,metalness:0,roughness:1},{name:`PokeBall__0003`},{name:`PokeBall__0003_1`},{name:`PokeBall__0003_2`},{name:`pillow-small-2`,envMapIntensity:.3},{name:`pillow-small-1`,envMapIntensity:.3},{name:`Sphere001_0`,toneMapped:!1},{name:`stool1`},{name:`stool2`},{name:`stool_seat`,envMapIntensity:5,envMapRotation:new e.Euler(0,-.4,.2)},{name:`Object_8001`},{name:`aegis`,envMapIntensity:5},{name:`questionCube`,envMapIntensity:5,metalness:0,roughness:0},{name:`Object_34001`,envMapIntensity:10,metalness:0,roughness:.7,side:e.BackSide},{name:`Object_32`,envMapIntensity:2.5},{name:`Object_31`,envMapIntensity:5,envMapRotation:new e.Euler(Math.PI,0,0)},{name:`Object_33`,envMapIntensity:2,envMapRotation:new e.Euler(Math.PI,0,0),roughness:0},{name:`Object_42001`,envMapIntensity:6},{name:`Object_40001`,envMapIntensity:15,roughness:0},{name:`bedMain`,envMapIntensity:.15,roughness:1,envMapRotation:new e.Euler(Math.PI,Math.PI,Math.PI)},{name:`bedStand`,envMapIntensity:.9,roughness:1},{name:`Object_0007`,toneMapped:!1,envMapIntensity:.4},{name:`Lathe_S_Blackhole_01_0`,toneMapped:!1,emissiveIntensity:.7},{name:`Circle_0`,envMapIntensity:3.5,roughness:.1},{name:`Cube_1`,envMapIntensity:1.5,roughness:.1},{name:`Circle002_0`,envMapIntensity:6,roughness:.1}],i=new Map;for(let e of r){let t=Array.isArray(e.name)?e.name:[e.name];for(let n of t)i.set(n,e)}let a=performance.now(),o=0,s=[t];for(;s.length>0;){let e=s.pop();if(e.name&&i.has(e.name)){let{name:t,...r}=i.get(e.name);e.traverse(e=>{e.isMesh&&e.material&&(e.material.envMap=n,Object.assign(e.material,r))})}if(e.children)for(let t=e.children.length-1;t>=0;t--)s.push(e.children[t]);if(o++,o%50==0&&performance.now()-a>8){await Ur(),a=performance.now();let e=.2+Math.min(o/600,1)*.6;updateTaskProgress(`model-assembly`,e)}}t.isAdjusted=!0};H.environmentMap?await a(H.environmentMap):t.environment&&await a(t.environment);let o=t.getObjectByName(`Object_34001`);o&&(o.material=Zr),o.material.side=e.BackSide;let s=t.getObjectByName(`screenDisplay002`);if(s){s.material=G,s.userData.originalMaterial=G;let t=s.geometry.attributes.position.count;s.geometry.setAttribute(`aLayoutMode`,new e.BufferAttribute(new Float32Array(t).fill(2),1))}let c=t.getObjectByName(`screenDisplay001`);if(c){c.material=G,c.userData.originalMaterial=G,c.onBeforeRender=()=>{if(!G.uniforms.uHoverPos||!G.uniforms.uTargetHoverPos)return;let e=G.uniforms.uTargetHoverPos.value,t=G.uniforms.uHoverPos.value,n=.12;if(t.x+=(e.x-t.x)*n,t.y+=(e.y-t.y)*n,t.distanceTo(e)<.001&&t.copy(e),G.uniforms.uIsPoba.value>.5){let e=performance.now();if(c.userData.lastShuffleTime||(c.userData.lastShuffleTime=e),e-c.userData.lastShuffleTime>5e3){c.userData.lastShuffleTime=e;let t=e=>{let t=(Math.round(e.y*3+e.x)+1)%6;e.x=t%3,e.y=Math.floor(t/3)};t(G.uniforms.uSpecialPos1.value),t(G.uniforms.uSpecialPos2.value)}}};let t=c.geometry.attributes.position.count;c.geometry.setAttribute(`aLayoutMode`,new e.BufferAttribute(new Float32Array(t).fill(0),1))}let l=t.getObjectByName(`verticalMonitorDisplay`);if(l){l.material=G,l.userData.originalMaterial=G;let t=l.geometry.attributes.position.count;l.geometry.setAttribute(`aLayoutMode`,new e.BufferAttribute(new Float32Array(t).fill(1),1))}let u=t.getObjectByName(`wallArea`);if(u){u.material=ni,u.onBeforeRender=()=>{let e=ni.uniforms.uMouse.value,t=ni.uniforms.uSmoothedMouse.value,n=.06;t.x+=(e.x-t.x)*n,t.y+=(e.y-t.y)*n};let e=u.scale.x/u.scale.y;ni.uniforms.uDragonEyeAspect={value:e}}ni.visible=!1;let d=t.getObjectByName(`caseCoverArea`);d&&(d.material=Xr,d.onBeforeRender=()=>{let e=Xr.uniforms.uMouse.value,t=Xr.uniforms.uSmoothedMouse.value,n=.22;t.x+=(e.x-t.x)*n,t.y+=(e.y-t.y)*n});let f=t.getObjectByName(`chairBack`);f&&(f.material=ri),K=Rt(`#FBC189`,1,.05),K.side=e.DoubleSide,ai=Lt(`#FBC189`,1.5,.01,6.5,e.FrontSide);let p=t.getObjectByName(`cFanBulbAura`);p&&(p.material=ai);let m=t.getObjectByName(`cFanBulb`);m&&(m.material=K)}async function qr(t){if(!t.physicBodies||!t.globalUniformsHub)return;let n=t.globalUniformsHub.uniforms,r=L.ELECTRIC_CYAN,i=L.ACCENT_GOLD;t.cyanPulseActive||={value:0};let a={...n,uWorldGridActive:n.uWorldGridActive,uGroupGridActive:t.cyanPulseActive,uBorderColor:{value:r},uObjectStagger:{value:.5}},o={...n,uWorldGridActive:n.uWorldGridActive,uGroupGridActive:{value:0},uBorderColor:{value:i},uObjectStagger:{value:.5}},s=0,c=0,l=0,u=new Map,d=t=>{if(!t.geometry)return!1;t.geometry.boundingBox||t.geometry.computeBoundingBox();let n=new e.Vector3;return t.geometry.boundingBox.getSize(n),n.x*n.y*n.z<1e-4},f=t=>{if(t.isShaderMaterial||t.type===`ShaderMaterial`)return`shader|${t.fragmentShader.length}|${t.vertexShader.length}|${t.name||`unnamed`}`;let n=t.color?t.color.getHex():0,r=t.emissive?t.emissive.getHex():0,i=t.emissiveIntensity??0,a=t.map?t.map.uuid:`n1`,o=t.alphaMap?t.alphaMap.uuid:`n2`,s=t.normalMap?t.normalMap.uuid:`n3`,c=t.aoMap?t.aoMap.uuid:`n4`,l=t.emissiveMap?t.emissiveMap.uuid:`n5`,u=t.metalness??0,d=t.roughness??1,f=t.opacity??1,p=t.transparent?1:0,m=t.envMapIntensity??1,h=t.side??e.FrontSide,g=t.toneMapped?1:0,_=t.envMapRotation?`${t.envMapRotation.x.toFixed(2)}|${t.envMapRotation.y.toFixed(2)}|${t.envMapRotation.z.toFixed(2)}`:`0`;return`std|${t.name||`unnamed`}|${n}|${r}|${i}|${a}|${o}|${s}|${c}|${l}|${u}|${d}|${f}|${p}|${m}|${h}|${g}|${_}`},p=(e,t)=>{if(!e.material||e.material.isGridPatched)return;if(d(e)){l++;return}s++;let n=f(e.material),r=u.get(n);r||(r=new Map,u.set(n,r));let i=r.get(t);if(i){e.material=i;return}c++;let a=e.material.clone();a.uniforms=t,a.onBeforeCompile=Yr,a.isGridPatched=!0,r.set(t,a),e.material=a},m=0,h=performance.now();for(let e of t.physicBodies){let s=e.threeObject;if(!s)continue;m++,(m%5==0||performance.now()-h>2)&&(await Ur(),h=performance.now());let c=s.name,l=null;c===`stool`||c===`stool_bound`?(t.stoolGridUniforms||={...n,uWorldGridActive:{value:0},uWorldGridProgress:{value:0},uGroupGridActive:n.uWorldGridActive,uGroupGridProgress:n.uWorldGridProgress,uBorderColor:{value:i},uObjectStagger:{value:0}},l=t.stoolGridUniforms):[`Object_0003`,`Object_108`,`GLTF_created_0001`,`pokeball`,`pokeball2`].includes(c)||c.includes(`pokeball`)?(t.pokeballGridUniforms||={...n,uWorldGridActive:{value:0},uGroupGridActive:n.uWorldGridActive,uWorldGridProgress:{value:0},uGroupGridProgress:n.uWorldGridProgress,uBorderColor:{value:r},uObjectStagger:{value:0}},l=t.pokeballGridUniforms):l=e.bodyType()===0?a:o,s.traverse(e=>{e.isMesh&&p(e,l)})}G&&G.uniforms.uIsPoba&&Jr(G.uniforms.uIsPoba.value>.5)}function Jr(e=!0){H.avatarsCelShaded&&(H.avatarsCelShaded.repeat.set(.5,-1),H.avatarsCelShaded.offset.set(e?0:.5,1))}var Yr,Xr,Zr,G,Qr,$r,ei,ti,ni,ri,ii,K,ai,oi,si,ci=M((()=>{Ot(),we(),xn(),It(),ke(),Br(),Hr(),Wr(),Yr=function(e){this.uniforms&&Pr(e,this.uniforms)}}));function li(){if(window._cvState===`falling`||window._cvState===`shattered`||window._cvState===`resetting`)return;if(window._cvState===`sucking`){window._cvState=`falling`;return}window._cvState=`falling`;let e=document.getElementById(`cv-container`),t=document.getElementById(`cv-content`),n=document.getElementById(`cv-scroller`);if(!e||!t)return;e.classList.contains(`collapsed`)?(e.classList.remove(`collapsed`),setTimeout(r,400)):r();function r(){if(window._cvState===`resetting`||window._cvState===`idle`)return;window._cvState=`falling`,e.style.overflow=`visible`,n&&(n.style.overflow=`visible`);let r=document.getElementById(`main-ui`);r&&(r.style.pointerEvents=`none`),t.style.position=`relative`;let i=Array.from(t.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.contact-grid div`,`.terminal-footer div`,`.collapsible-content p`,`.collapsible-content ul li`].join(`, `))),a=n.getBoundingClientRect(),o=[];i.forEach(e=>{if(e.querySelector(`svg`)||e.querySelector(`img`))return;let t=e.getBoundingClientRect(),n=t.bottom>=a.top&&t.top<=a.bottom;if(e.dataset.originalHtml||(e.dataset.originalHtml=e.innerHTML),!n){e.style.visibility=`hidden`,e.dataset.wasHiddenByViewport=`true`;return}let r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null,!1),i=[];for(;r.nextNode();)i.push(r.currentNode);i.forEach(e=>{if(e.nodeValue.trim()===``)return;let t=e.nodeValue.split(/(\s+)/),n=document.createDocumentFragment();t.forEach(e=>{if(e.trim()===``)n.appendChild(document.createTextNode(e));else{let t=document.createElement(`span`);t.textContent=e,t.style.display=`inline-block`,t.classList.add(`falling-word`),o.push(t),n.appendChild(t)}}),e.parentNode.replaceChild(n,e)})});let s=o.map(e=>{let t=window.getComputedStyle(e);return{sColor:t.color,sFontSize:t.fontSize,sFontWeight:t.fontWeight,sLetterSpacing:t.letterSpacing,sTextTransform:t.textTransform,sFontFamily:t.fontFamily,sLineHeight:t.lineHeight,sTextShadow:t.textShadow===`none`?``:t.textShadow}});o.forEach((e,t)=>{let n=s[t];e.style.color=n.sColor,e.style.fontSize=n.sFontSize,e.style.fontWeight=n.sFontWeight,e.style.letterSpacing=n.sLetterSpacing,e.style.textTransform=n.sTextTransform,e.style.fontFamily=n.sFontFamily,e.style.lineHeight=n.sLineHeight,e.style.textShadow=n.sTextShadow,e.style.whiteSpace=`nowrap`});let c=t.getBoundingClientRect(),l=Array.from(t.querySelectorAll(`.header-photo, .scanline-deco, .fui-corners, .audience-badge`)),u=[...o,...l],d=u.map(e=>e.getBoundingClientRect()),f=[];u.forEach((e,t)=>{let n=d[t];if(n.width===0||n.height===0)return;let r=n.left-c.left,i=n.top-c.top,a=e.classList.contains(`falling-word`),o=e;a||(o=e.cloneNode(!0),o.classList.add(`falling-clone`),o.style.margin=`0`),f.push({el:o,isClone:!a,x:r,y:i,startX:r,startY:i,width:n.width,height:n.height,vx:window._cvState===`ritual`?(Math.random()-.5)*5:(Math.random()-.5)*12,vy:window._cvState===`ritual`?0:Math.random()*-8-2,rx:Math.random()*30-15,ry:Math.random()*30-15,rz:Math.random()*30-15,vrx:(Math.random()-.5)*(window._cvState===`ritual`?30:6),vry:(Math.random()-.5)*(window._cvState===`ritual`?30:6),vrz:(Math.random()-.5)*(window._cvState===`ritual`?30:6)}),a||(e.style.visibility=`hidden`)}),f.forEach(e=>{t.appendChild(e.el),e.el.style.position=`absolute`,e.el.style.left=e.x+`px`,e.el.style.top=e.y+`px`,e.el.style.width=e.width+`px`,e.el.style.height=e.height+`px`,e.el.style.margin=`0`,e.el.style.transition=`none`,e.el.style.animation=`none`,e.el.style.boxSizing=`border-box`,e.el.style.userSelect=`none`,e.el.style.willChange=`transform`,e.el.style.transformOrigin=`center center`}),Array.from(t.children).forEach(e=>{f.find(t=>t.el===e)||(e.style.display=`none`)});let p=.55,m=.9,h=t.getBoundingClientRect(),g=window.innerHeight-h.top+20;function _(){if(window._cvState===`resetting`)return;let e=!0;f.forEach(t=>{if(t.settled)return;let n=window._cvGravity===void 0?.6:window._cvGravity;t.vy+=n,t.x+=t.vx,t.y+=t.vy,t.rx+=t.vrx,t.ry+=t.vry,t.rz+=t.vrz,t.y<=0&&(t.y=0,t.vy<0&&(t.vy*=-p,t.vx+=(Math.random()-.5)*4)),t.y+t.height>=g&&(t.y=g-t.height,t.vy*=-p,t.vx*=m,t.vrx*=m,t.vry*=m,t.vrz*=m,Math.abs(t.vy)<1.2&&(t.vy=0),Math.abs(t.vx)<.2&&(t.vx=0));let r=t.x-t.startX,i=t.y-t.startY;t.el.style.transform=`translate3d(${r}px, ${i}px, 0) rotateX(${t.rx}deg) rotateY(${t.ry}deg) rotateZ(${t.rz}deg)`,t.el._cvPhysics={dx:r,dy:i,rx:t.rx,ry:t.ry,rz:t.rz};let a=window._cvGravity!==void 0&&window._cvGravity<0,o=window._cvState===`ritual`;!a&&!o&&Math.abs(t.vy)<=.1&&Math.abs(t.vx)<=.1&&t.y+t.height>=g-2?t.settled=!0:e=!1}),e?(t.style.pointerEvents=`none`,window._cvState=`shattered`):requestAnimationFrame(_)}requestAnimationFrame(_)}}function ui(e=900){if(!window._cvState||window._cvState===`idle`){if(document.querySelectorAll(`.falling-word, .falling-clone`).length===0)return;window._cvState=`shattered`}if(window._cvState===`resetting`)return;window._cvState=`resetting`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`),r=document.getElementById(`cv-scroller`);if(!t||!n){window._cvState=`idle`;return}let i=document.querySelectorAll(`.falling-word, .falling-clone`);if(i.length>0&&v!==void 0){let t=0,n=i.length,r=[];i.forEach(i=>{let a=i._cvPhysics||{dx:0,dy:0,rx:0,ry:0,rz:0,scale:1};i.style.display===`none`&&(i.style.display=`inline-block`);let o=e*.4,c=e-o,l=Math.random()*o,u=new v.Tween(a).to({dx:0,dy:0,rx:0,ry:0,rz:0,scale:1},c).easing(v.Easing.Cubic.InOut).delay(l).onUpdate(()=>{let e=a.scale===void 0?1:a.scale;i.style.transform=`translate3d(${a.dx}px, ${a.dy}px, 0) rotateX(${a.rx}deg) rotateY(${a.ry}deg) rotateZ(${a.rz}deg) scale(${e})`}).onComplete(()=>{t++,t===n&&s()}).start();r.push(u)});let o=!1,s=()=>{o||(o=!0,r.forEach(e=>e.stop()),c&&cancelAnimationFrame(c),a())},c;function l(){o||(t<n?c=requestAnimationFrame(l):s())}c=requestAnimationFrame(l),setTimeout(s,e+100)}else a();function a(){t.style.overflow=``,r&&(r.style.overflow=``);let e=document.getElementById(`main-ui`);e&&(e.style.pointerEvents=``),n.style.position=``,n.style.pointerEvents=``,document.querySelectorAll(`.falling-clone, .falling-word`).forEach(e=>e.remove()),Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.contact-grid div`,`.terminal-footer div`,`.collapsible-content p`,`.collapsible-content ul li`].join(`, `))).forEach(e=>{e.dataset.originalHtml&&(e.innerHTML=e.dataset.originalHtml,delete e.dataset.originalHtml),e.dataset.wasHiddenByViewport&&(e.style.visibility=``,delete e.dataset.wasHiddenByViewport)}),Array.from(n.children).forEach(e=>{e.style.display===`none`&&(e.style.display=``)}),Array.from(n.querySelectorAll(`.header-photo, .scanline-deco, .fui-corners, .audience-badge`)).forEach(e=>{e.style.visibility===`hidden`&&(e.style.visibility=``)}),window._cvState=`idle`}}function di(e=0){if(window._cvState&&window._cvState!==`idle`&&window._cvState!==`shattered`)return;window._cvState=`sucking`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`),r=document.getElementById(`cv-scroller`);if(!t||!n)return;t.classList.contains(`collapsed`)?(t.classList.remove(`collapsed`),setTimeout(i,400)):i();function i(){if(window._cvState===`resetting`||window._cvState===`idle`)return;t.style.overflow=`visible`,r&&(r.style.overflow=`visible`);let i=document.getElementById(`main-ui`);i&&(i.style.pointerEvents=`none`),n.style.position=`relative`;let a=Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.contact-grid div`,`.terminal-footer div`,`.collapsible-content p`,`.collapsible-content ul li`].join(`, `))),o=[];a.forEach(e=>{if(e.querySelector(`svg`)||e.querySelector(`img`))return;e.dataset.originalHtml||(e.dataset.originalHtml=e.innerHTML);let t=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null,!1),n=[];for(;t.nextNode();)n.push(t.currentNode);n.forEach(e=>{if(e.nodeValue.trim()===``)return;let t=e.nodeValue.split(/(\s+)/),n=document.createDocumentFragment();t.forEach(e=>{if(e.trim()===``)n.appendChild(document.createTextNode(e));else{let t=document.createElement(`span`);t.textContent=e,t.style.display=`inline-block`,t.classList.add(`falling-word`),o.push(t),n.appendChild(t)}}),e.parentNode.replaceChild(n,e)})});let s=o.map(e=>{let t=window.getComputedStyle(e);return{sColor:t.color,sFontSize:t.fontSize,sFontWeight:t.fontWeight,sLetterSpacing:t.letterSpacing,sTextTransform:t.textTransform,sFontFamily:t.fontFamily,sLineHeight:t.lineHeight,sTextShadow:t.textShadow===`none`?``:t.textShadow}});o.forEach((e,t)=>{let n=s[t];e.style.color=n.sColor,e.style.fontSize=n.sFontSize,e.style.fontWeight=n.sFontWeight,e.style.letterSpacing=n.sLetterSpacing,e.style.textTransform=n.sTextTransform,e.style.fontFamily=n.sFontFamily,e.style.lineHeight=n.sLineHeight,e.style.textShadow=n.sTextShadow,e.style.whiteSpace=`nowrap`});let c=n.getBoundingClientRect(),l=(e+1)/2*window.innerHeight-c.top,u=Array.from(n.querySelectorAll(`.header-photo, .scanline-deco, .fui-corners, .audience-badge`)),d=[...o,...u],f=d.map(e=>e.getBoundingClientRect()),p=[];d.forEach((e,t)=>{let n=f[t];if(n.width===0||n.height===0)return;let r=n.left-c.left,i=n.top-c.top,a=e.classList.contains(`falling-word`),o=e;a||(o=e.cloneNode(!0),o.classList.add(`falling-clone`),o.style.margin=`0`),p.push({el:o,isClone:!a,x:r,y:i,startX:r,startY:i,width:n.width,height:n.height,vx:(Math.random()-.5)*6,vy:(Math.random()-.5)*6,rx:Math.random()*30-15,ry:Math.random()*30-15,rz:Math.random()*30-15,vrx:(Math.random()-.5)*15,vry:(Math.random()-.5)*15,vrz:(Math.random()-.5)*15,scale:1}),a||(e.style.visibility=`hidden`)}),p.forEach(e=>{n.appendChild(e.el),e.el.style.position=`absolute`,e.el.style.left=e.x+`px`,e.el.style.top=e.y+`px`,e.el.style.width=e.width+`px`,e.el.style.height=e.height+`px`,e.el.style.margin=`0`,e.el.style.transition=`none`,e.el.style.animation=`none`,e.el.style.boxSizing=`border-box`,e.el.style.userSelect=`none`,e.el.style.willChange=`transform`,e.el.style.transformOrigin=`center center`}),Array.from(n.children).forEach(e=>{p.find(t=>t.el===e)||(e.style.display=`none`)});let m=.6,h=.55,g=.9;function _(){if(window._cvState===`resetting`)return;let e=!0;p.forEach(t=>{if(t.settled)return;if(window._cvState===`falling`){let n=window.innerHeight-c.top+20;t.vy+=.6,t.x+=t.vx,t.y+=t.vy,t.rx+=t.vrx,t.ry+=t.vry,t.rz+=t.vrz,t.y+t.height>=n&&(t.y=n-t.height,t.vy*=-h,t.vx*=g,t.vrx*=g,t.vry*=g,t.vrz*=g,Math.abs(t.vy)<1.2&&(t.vy=0),Math.abs(t.vx)<.2&&(t.vx=0)),Math.abs(t.vy)<=.1&&Math.abs(t.vx)<=.1&&t.y+t.height>=n-2?t.settled=!0:e=!1}else{let n=0-(t.x+t.width/2),r=l-(t.y+t.height/2),i=Math.sqrt(n*n+r*r)||1;t.vx+=n/i*m,t.vy+=r/i*m,t.x+=t.vx,t.y+=t.vy,t.rx+=t.vrx,t.ry+=t.vry,t.rz+=t.vrz,t.x<=0&&(t.x=0,t.vx*=-h,t.vy*=g,t.vrx*=g,t.vry*=g,t.vrz*=g,Math.abs(t.vx)<1.2&&(t.vx=0),Math.abs(t.vy)<.2&&(t.vy=0)),Math.abs(t.vx)<=.1&&Math.abs(t.vy)<=.1&&t.x<=2?t.settled=!0:e=!1}let n=t.x-t.startX,r=t.y-t.startY;t.el.style.transform=`translate3d(${n}px, ${r}px, 0) rotateX(${t.rx}deg) rotateY(${t.ry}deg) rotateZ(${t.rz}deg)`,t.el._cvPhysics={dx:n,dy:r,rx:t.rx,ry:t.ry,rz:t.rz}}),e?(n.style.pointerEvents=`none`,window._cvState=`shattered`):requestAnimationFrame(_)}requestAnimationFrame(_)}}function fi(e=1e3){if(window._cvState&&window._cvState!==`idle`&&window._cvState!==`shattered`)return;window._cvState=`shaking`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`);if(!t||!n||t.classList.contains(`collapsed`)){window._cvState=`idle`;return}let r=Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.fui-corners div`,`.scanline-deco`,`.header-photo`].join(`, `)));if(r.length===0||v===void 0){window._cvState=`idle`;return}let i=0,a=r.length,o=[];r.forEach((t,n)=>{let r=window.getComputedStyle(t).display;r===`inline`&&(t.style.display=`inline-block`);let s=e*.35,l=Math.random()*s,u=e-l,d=new v.Tween({t:0}).to({t:1},u).easing(v.Easing.Quadratic.Out).delay(l).onUpdate(e=>{let r=1-e.t;if(r<=.02){t.style.transform=`translate3d(0, 0, 0) rotateZ(0deg)`;return}n*12.5;let i=(Math.random()-.5)*8*r,a=(Math.random()-.5)*6*r,o=(Math.random()-.5)*3*r;t.style.transform=`translate3d(${i}px, ${a}px, 0) rotateZ(${o}deg)`}).onComplete(()=>{t.style.transform=``,r===`inline`&&(t.style.display=``),i++,i===a&&c()}).start();o.push(d)});let s=!1,c=()=>{s||(s=!0,o.forEach(e=>e.stop()),l&&cancelAnimationFrame(l),r.forEach(e=>{e.style.transform=``}),window._cvState===`shaking`&&(window._cvState=`idle`))},l;function u(){if(window._cvState!==`shaking`){c();return}i<a?l=requestAnimationFrame(u):c()}l=requestAnimationFrame(u),setTimeout(c,e+100)}function pi(e=1e3){if(window._cvState&&window._cvState!==`idle`)return;window._cvState=`jumping`;let t=document.getElementById(`cv-container`),n=document.getElementById(`cv-content`);if(!t||!n||t.classList.contains(`collapsed`)){window._cvState=`idle`;return}let r=Array.from(n.querySelectorAll([`.header h1`,`.header .role`,`.contact-info span`,`.contact-info a`,`.collapsible-header`,`.role-header .company`,`.title-row .job-title`,`.title-row .date`,`.skills-grid span`,`.fui-corners div`,`.scanline-deco`,`.header-photo`].join(`, `)));if(r.length===0||v===void 0){window._cvState=`idle`;return}let i=0,a=r.length,o=[];r.forEach(t=>{let n=window.getComputedStyle(t).display;n===`inline`&&(t.style.display=`inline-block`);let r=e*.4,s=Math.random()*r,l=e-s,u=new v.Tween({t:0}).to({t:1},l).easing(v.Easing.Linear.None).delay(s).onUpdate(e=>{let n=Math.sin(e.t*Math.PI)*-45;t.style.transform=`translate3d(0, ${n}px, 0)`}).onComplete(()=>{t.style.transform=``,n===`inline`&&(t.style.display=``),i++,i===a&&c()}).start();o.push(u)});let s=!1,c=()=>{s||(s=!0,o.forEach(e=>e.stop()),l&&cancelAnimationFrame(l),r.forEach(e=>{e.style.transform=``}),window._cvState===`jumping`&&(window._cvState=`idle`))},l;function u(){if(window._cvState!==`jumping`){c();return}i<a?l=requestAnimationFrame(u):c()}l=requestAnimationFrame(u),setTimeout(c,e+100)}var mi=M((()=>{window.cvFall=li,window.cvReset=ui,window.cvSuck=di,window.cvShake=fi,window.cvJump=pi}));function hi(e,t=3e3,n=null){let r=e.globalUniformsHub,i=e.constantUniform,a=[];n===`pc`?r&&r.uniforms.uPCBSODState?a.push(r.uniforms.uPCBSODState):i&&i.uPCBSODState&&a.push(i.uPCBSODState):n===`laptop`?r&&r.uniforms.uLaptopBSODState?a.push(r.uniforms.uLaptopBSODState):i&&i.uLaptopBSODState&&a.push(i.uLaptopBSODState):(r&&(r.uniforms.uBSODState&&a.push(r.uniforms.uBSODState),r.uniforms.uPCBSODState&&a.push(r.uniforms.uPCBSODState),r.uniforms.uLaptopBSODState&&a.push(r.uniforms.uLaptopBSODState)),i&&(i.uBSODState&&a.push(i.uBSODState),i.uPCBSODState&&a.push(i.uPCBSODState),i.uLaptopBSODState&&a.push(i.uLaptopBSODState))),a.length!==0&&(e._bsodTimeout&&clearTimeout(e._bsodTimeout),a.forEach(e=>e.value=1),e._bsodTimeout=setTimeout(()=>{a.forEach(e=>e.value=0),e._bsodTimeout=null},t))}function gi(e,t=3e3){!G||!G.uniforms.uBootState||(e._bootingTimeout&&clearTimeout(e._bootingTimeout),G.uniforms.uBootState.value=0,e._bootingTimeout=setTimeout(()=>{G.uniforms.uBootState.value=1,e._bootingTimeout=null},t))}function _i(t){if(!t.physicBodies||t.physicBodies.length===0){setTimeout(()=>_i(t),1e3);return}if(t.world?.hasPointGravityOnBH||window._cvState===`sucking`){setTimeout(()=>_i(t),1e3);return}let n=0;t.physicBodies.forEach(t=>{if(!t.isIntegrityCheckTarget&&!t.isIntegrityResetTarget)return;let r,i;if(t.threeObject&&t.threeObject.userData&&t.threeObject.userData.originalPos){let n=t.threeObject.userData.originalPos,a=t.threeObject.userData.originalRot;if(r=new e.Vector3(n.x,n.y,n.z),a&&a.isEuler)i=new e.Quaternion().setFromEuler(a);else if(t.threeObject.userData.originalQuaternion){let n=t.threeObject.userData.originalQuaternion;i=new e.Quaternion(n.x,n.y,n.z,n.w)}else{let n=t.rotation();i=new e.Quaternion(n.x,n.y,n.z,n.w)}}else{let n=t.translation(),a=t.rotation();r=new e.Vector3(n.x,n.y,n.z),i=new e.Quaternion(a.x,a.y,a.z,a.w)}t.integrity={position:r,quaternion:i},n++}),t.allowsResetting=!0,t.integrityBaselineCaptured=!0}function vi(t,n,r,i=0){if(n.isResetting)return;if(t.world&&t.world.isBusy){setTimeout(()=>vi(t,n,r,i),16);return}if(n.isResetting=!0,!n.integrity){n.isResetting=!1;return}try{n.rapierCollider&&n.rapierCollider.setSensor(!0)}catch{n.isResetting=!1;return}let a=n.integrity.position.clone(),o=n.integrity.quaternion,s;try{s=n.bodyType()}catch{n.isResetting=!1;return}t._activeResetCount=(t._activeResetCount||0)+1,Ei(t,!0);let c=n.mass(),l=(Math.random()*8+2)*c;n.applyImpulse({x:0,y:i+l,z:0},!0);let u=(i+2)*c*.2;n.applyTorqueImpulse({x:(Math.random()-.5)*u,y:(Math.random()-.5)*u,z:(Math.random()-.5)*u},!0),n.wakeUp(),Or(n,()=>{let i=`integrity-beam-${n.handle}`,c=n.threeObject&&n.threeObject.userData.isDragonBall?16763904:L.ELECTRIC_CYAN||65535,l=null;if(Ko){let r=n.translation();Ko(t,``,``,new e.Vector3(r.x,r.y,r.z),i,!0,c,!0,1/0,!0),l=t.getObjectByName(i)}let u=t.getObjectByName(`mixamorigSpine1`)||t.getObjectByName(`a-char`),d=u?new e.Vector3().setFromMatrixPosition(u.matrixWorld):null;kr(n,a,o,r,s,()=>{l&&(l.visible=!1,l.activeRequestID&&cancelAnimationFrame(l.activeRequestID)),n.isResetting=!1,t._activeResetCount--,Ei(t,!1)},(n,r)=>{if(l&&l.visible){let r=X(t,`drone`);if(r){let t=r.getObjectByName(`Sphere001_0`);if(t){let r=new e.Vector3;t.getWorldPosition(r);let i=r.distanceTo(n);l.position.copy(r),l.lookAt(n),l.children.forEach(e=>{e.scale.z=i})}}}},d)})}function yi(t){if(t.allowsIntegrityCheck=!0,!t.allowsIntegrityCheck)return;let n,r=()=>{clearTimeout(n),n=setTimeout(i,Ci)},i=()=>{if(!t.scenarioState||t.scenarioState.name!==`room`){r();return}if(!t.integrityBaselineCaptured){r();return}if(t.world?.hasPointGravityOnBH||t.isHeroAnimating){r();return}if(t.allowsResetting===!1){r();return}let n=[];t.physicBodies.forEach(r=>{if(!r.isIntegrityCheckTarget||!r.integrity||t.isHeroAnimating||r.isResetting||r.isManualControl)return;let i=r.threeObject;i&&i.name;let a=r.translation(),o=r.rotation(),s=new e.Vector3(a.x,a.y,a.z),c=new e.Quaternion(o.x,o.y,o.z,o.w),l=r.integrity.position,u=s.distanceTo(l),d=!1;if(u>wi)d=!0;else{let e=r.integrity.quaternion;c.angleTo(e)>Ti&&(d=!0)}d&&n.push(r)});let i=!1,a=``;if(G.uniforms.uBootState&&G.uniforms.uBootState.value<.5&&(i=!0,a=z(`SYS_STORY_INTEGRITY_BOOTING`)),t.objectMap&&[{obj:t.objectMap.get(`screenDisplay001`),name:`Main Screen`},{obj:t.objectMap.get(`verticalMonitorDisplay`),name:`Vertical Screen`}].forEach(e=>{e.obj&&e.obj.material!==G&&(i=!0,a=e.obj.material===ti?z(`SYS_STORY_INTEGRITY_NETFLIX`):e.obj.material===ri||e.obj.material===ii?z(`SYS_STORY_INTEGRITY_DOTA`):z(`SYS_STORY_INTEGRITY_WORK_FOCUS`))}),n.length>0||i){if(t.allowsResetting=!1,t.isHeroAnimating=!0,n.length>0&&n.map(e=>e.threeObject?e.threeObject.name:`Unknown Body`),i&&n.length===0?Z(a):n.length<3?Z(z(`SYS_STORY_INTEGRITY_MESS_LIGHT`)):Z(z(`SYS_STORY_INTEGRITY_MESS_HEAVY`)),t.conversationManager)if(i){if(t.objectMap){let e=t.objectMap.get(`screenDisplay001`);e&&e.material===ti?t.conversationManager.shout(R.SHOUT_RESET_NETFLIX.en):e&&(e.material===ri||e.material===ii)?t.conversationManager.shout(R.SHOUT_RESET_DOTA.en):t.conversationManager.shout(R.SHOUT_RESET_GENERIC.en)}}else n.length>0&&t.conversationManager.shout(R.SHOUT_RESET_MESS.en);let o=i?Math.max(n.length,2):n.length,s=Math.min(1+(o-1)*.5,4),c=Math.min(800+o*200,2e3),l=o/1.25,u=Math.max(l*l,2)*2.5,d=Er(t,`bangingFist`,{speed:s,randomize:!1,onComplete:()=>{}}),f=d.duration*1e3;if(setTimeout(()=>{t.allowsResetting=!0,t.isHeroAnimating=!1,r()},f+100),d&&d.duration){let n=d.duration*1e3*.4;setTimeout(()=>{xi(t),Si(t,u*.2),ui(c),typeof window.cvJump==`function`&&window.cvJump(200),t.objectMap&&([`screenDisplay001`,`screenDisplay002`,`verticalMonitorDisplay`].forEach(e=>{let n=t.objectMap.get(e);n&&(n.material=G,n.userData.originalMaterial=G)}),G.uniforms.uBootState&&(G.uniforms.uBootState.value=1)),Z(z(`SYS_STORY_INTEGRITY_RESTORING`));let n=performance.now()+c+200;if(t.physicBodies.forEach(e=>{try{e.isIntegrityResetTarget&&e.integrity&&e.handle!==void 0&&vi(t,e,n,u)}catch{}}),Pi(t),Wi&&Wi.length>0){let r=[`Object_12001`,`Object_108`],i=r[Math.floor(Math.random()*r.length)],a=t.getObjectByName(i);if(a){let r=new e.Vector3;a.getWorldPosition(r);let i=1.265+Math.random()*.46;Wi.forEach((a,o)=>{if(!a.visible)return;let s=o/Wi.length*Math.PI*2,c=r.x+Math.cos(s)*i,l=r.y+.05,d=r.z+Math.sin(s)*i,f=a.rapierBody;if(f){f.rapierCollider&&f.rapierCollider.setSensor(!0);let r=f.mass(),i=Math.random()*u*r;f.applyImpulse({x:0,y:u+i,z:0},!0);let a=u*r*.5;f.applyTorqueImpulse({x:(Math.random()-.5)*a,y:(Math.random()-.5)*a,z:(Math.random()-.5)*a},!0),f.wakeUp(),Or(f,()=>{let r=new e.Vector3(c,l,d),i=new e.Quaternion().setFromEuler(new e.Euler(0,Math.random()*Math.PI,0)),a=`coin-integrity-beam-${f.handle}`,o=L.ELECTRIC_CYAN||65535;t._activeResetCount=(t._activeResetCount||0)+1,Ei(t,!0);let s=null;if(Ko){let n=f.translation();Ko(t,``,``,new e.Vector3(n.x,n.y,n.z),a,!0,o,!0,1/0,!0),s=t.getObjectByName(a)}let u=t.getObjectByName(`mixamorigSpine1`)||t.getObjectByName(`a-char`),p=u?new e.Vector3().setFromMatrixPosition(u.matrixWorld):null;kr(f,r,i,n,b.RigidBodyType.Dynamic,()=>{s&&(s.visible=!1,s.activeRequestID&&cancelAnimationFrame(s.activeRequestID)),t._activeResetCount--,Ei(t,!1)},(n,r)=>{if(s&&s.visible){let r=X(t,`drone`);if(r){let t=r.getObjectByName(`Sphere001_0`);if(t){let r=new e.Vector3;t.getWorldPosition(r);let i=r.distanceTo(n);s.position.copy(r),s.lookAt(n),s.children.forEach(e=>{e.scale.z=i})}}}},p)})}})}}},n)}}else r()};window.addEventListener(`pointerdown`,()=>{r()}),r()}function bi(e){e.allowsIntegrityCheck=!1}function xi(t){let n=new e.Group,r=new e.Color(`#ffc783`),i=L.ACCENT_GOLD||new e.Color(`#ffcc00`);new e.Color(`#ffffff`),n.position.set(-1.95,2.64,-1.35),t.add(n);let a=new e.TorusGeometry(1,.04,16,100),o=Lt(r,1.5,.01,4),s=new e.Mesh(a,o);s.rotation.x=Math.PI/2;let c=Lt(i,1.2,.01,4.5),l=new e.Mesh(a,c);l.rotation.x=Math.PI/2,l.rotation.z=.2,n.add(s,l);let u=new e.IcosahedronGeometry(.1,0),d=[];for(let t=0;t<24;t++){let a=t%2==0?r:i,o=Rt(a,1.5,4),s=new e.Mesh(u,o),c=Lt(a,1.5,.01,4.5),l=new e.Mesh(u,c);l.scale.setScalar(1.4),s.add(l);let f=Math.random()*Math.PI*2,p=Math.random()*Math.PI*.6,m=.05+Math.random()*.15;s.userData.velocity=new e.Vector3(Math.sin(p)*Math.cos(f)*m,Math.cos(p)*m,Math.sin(p)*Math.sin(f)*m),s.userData.rotationSpeed=new e.Vector3(Math.random()*.15,Math.random()*.15,Math.random()*.15),n.add(s),d.push(s)}let f=new e.SphereGeometry(.2,8,8),p=Rt(r,1,5),m=new e.Mesh(f,p);n.add(m),new v.Tween({progress:0}).to({progress:1},3500).easing(v.Easing.Exponential.Out).onUpdate(e=>{let t=e.progress;d.forEach(e=>{e.position.add(e.userData.velocity),e.userData.velocity.multiplyScalar(.98),e.rotation.x+=e.userData.rotationSpeed.x,e.rotation.y+=e.userData.rotationSpeed.y,e.rotation.z+=e.userData.rotationSpeed.z;let n=1-t;e.scale.setScalar(n),e.material.uniforms&&(e.material.uniforms.glowIntensity.value=4*n);let r=e.children[0];r&&r.material.uniforms&&(r.material.uniforms.outerGlowStrength.value=1.5*n)}),s.scale.setScalar(.1+t*15),s.material.uniforms.outerGlowStrength.value=1.5*(1-t),l.scale.setScalar(.05+t*10),l.material.uniforms.outerGlowStrength.value=1.2*(1-t),m.scale.setScalar(2*(1-t*1.5)),m.material.uniforms&&(m.material.uniforms.glowIntensity.value=5*(1-t*2))}).onComplete(()=>{t.remove(n),a.dispose(),u.dispose(),f.dispose(),d.forEach(e=>{e.material.dispose(),e.children[0]&&e.children[0].material.dispose()}),o.dispose(),c.dispose(),p.dispose()}).start()}function Si(t,n=.15,r=600){let i=t.camera;i&&(i._shakeOffset||=new e.Vector3,new v.Tween({t:0}).to({t:1},r).easing(v.Easing.Quadratic.Out).onUpdate(e=>{let t=n*(1-e.t);i.position.sub(i._shakeOffset),i._shakeOffset.set((Math.random()-.5)*t,(Math.random()-.5)*t,(Math.random()-.5)*t),i.position.add(i._shakeOffset)}).onComplete(()=>{i.position.sub(i._shakeOffset),i._shakeOffset.set(0,0,0)}).start())}var Ci,wi,Ti,Ei,Di=M((()=>{Dr(),ks(),ke(),ls(),ci(),ea(),De(),mi(),xn(),we(),Mr(),Ci=3e3,wi=2,Ti=.25,Ei=(e,t=!1)=>{if(e._activeResetCount===void 0&&(e._activeResetCount=0),e.globalUniformsHub&&e.cyanPulseActive){let n=e.globalUniformsHub.uniforms,r=e.cyanPulseActive;t?(r.value=1,n.uWorldGridProgress.value=1):e._activeResetCount<=0&&new v.Tween(n.uWorldGridProgress).to({value:0},150).onComplete(()=>{r.value=0}).start()}}}));function Oi(t){if(!t)return new e.Vector3(0,0,0);if(t.skeleton&&t.skeleton.bones.length>0){let n=t.skeleton.bones[0],r=new e.Vector3;return n.getWorldPosition(r),r}t.updateMatrixWorld(!0);let n=new e.Vector3;return t.getWorldPosition(n),n}function ki(t,n){let r=t.getObjectByName(`Lathe_Center`),i=new e.Vector3;r?r.getWorldPosition(i):i.set(-8.5,7.25,-.39);let a=t.getObjectByName(`a-char`),o=new e.Vector3;a?a.getWorldPosition(o):o.set(0,1,0),o.y+=.8,Z(`Dragon Balls drawn to the singularity...`),t.fanAction&&new v.Tween(t.fanAction).to({timeScale:12},1500).easing(v.Easing.Quadratic.In).start(),ji(t,i,()=>{Mi(t,r),setTimeout(()=>{if(t._spawnStopSignal)return;let n=o.clone();n.y+=6+Math.random()*2.5,n.x+=(Math.random()-.5)*1.5,n.z+=(Math.random()-.5)*1.5;let r=Fi(t,i.clone(),null);if(r&&r.rapierBody){let a=r.rapierBody;a.setBodyType(b.RigidBodyType.KinematicPositionBased);let o=i.clone(),s=o.clone(),c=new e.Vector3().subVectors(n,i);n.addVectors(i,c.multiplyScalar(1.5));let l=null;new v.Tween(s).to({x:n.x,y:n.y,z:n.z},1400).easing(v.Easing.Cubic.Out).onStart(()=>{let e=`coin-erupt-beam`;Ko&&(Ko(t,``,``,i.clone(),e,!1,16766720,!0,1/0,!0),l=t.getObjectByName(e))}).onUpdate(()=>{a.setNextKinematicTranslation(s);let i=s.distanceTo(o),c=n.distanceTo(o),u=c>0?i/c:0,d=1+Math.sin(u*Math.PI)*.4;r.scale.setScalar(.5*d);let f=X(t,`drone`);if(l&&l.visible&&f){let n=f.getObjectByName(`Sphere001_0`);if(n){let i=new e.Vector3;n.getWorldPosition(i);let a=i.distanceTo(s);l.position.copy(i),l.lookAt(s),l.children.forEach(e=>{e.scale.z=a}),t.gazeFollower&&t.gazeFollower.lookAtTarget(r)}}}).onComplete(()=>{r.scale.setScalar(.5);let e=t.getObjectByName(`coin-erupt-beam`);e&&(e.visible=!1,e.activeRequestID&&cancelAnimationFrame(e.activeRequestID)),a.setBodyType(b.RigidBodyType.Dynamic),a.wakeUp(),a.applyImpulse({x:(Math.random()-.5)*6,y:18+Math.random()*12,z:(Math.random()-.5)*6},!0)}).start()}},250),setTimeout(()=>{t._spawnStopSignal||Ni(t,i)},500)})}function Ai(e,t,n){if(!(!e.rapierBody||!t.world))try{let r=e.rapierBody.collider(0),i=t.world.getCollider(r);i&&(i.setCollisionGroups(n),i.setSolverGroups(n))}catch{}}function ji(t,n,r){ur(t,!1),setTimeout(()=>{let i=(t.dragonBalls||[]).filter(e=>e);if(i.length===0){r&&r();return}let a=i.length;i.forEach((o,s)=>{o.ritualStartScale=o.scale.clone(),o.position.clone(),o.rapierBody&&o.rapierBody.setBodyType(b.RigidBodyType.KinematicPositionBased),Ai(o,t,Qi);let c=s*60;setTimeout(()=>{let t=o.position.clone(),c=new e.Vector3().subVectors(n,t).normalize(),l=s/Math.max(i.length,1)*Math.PI*2,u={t:0};new v.Tween(u).to({t:1},1e3).easing(v.Easing.Cubic.In).onUpdate(()=>{let r=u.t,i=new e.Vector3().lerpVectors(t,n,r);i.y+=Math.sin(r*Math.PI)*5;let a=r*Math.PI*3+l,s=r*(1-r)*4*2,d=new e.Vector3(-c.z,0,c.x).normalize();i.addScaledVector(d,Math.cos(a)*s),i.y+=Math.sin(a)*s*.5,o.rapierBody&&o.rapierBody.setNextKinematicTranslation(i);let f=1-r*.9;o.ritualStartScale&&o.scale.copy(o.ritualStartScale).multiplyScalar(f)}).onComplete(()=>{o.visible=!1,a--,a===0&&r&&r()}).start()},c)})},150)}function Mi(e,t){if(!t)return;let n=e.globalUniformsHub;if(n&&n.uNebulaRotationSpeed&&n.uNebulaSwirlSpeed){let e=.3,t=.25;new v.Tween({rot:e,swirl:t}).to({rot:3,swirl:25},600).easing(v.Easing.Exponential.Out).onUpdate(e=>{n.uNebulaRotationSpeed.value=e.rot,n.uNebulaSwirlSpeed.value=e.swirl}).onComplete(()=>{new v.Tween({rot:3,swirl:25}).to({rot:e,swirl:t},1500).easing(v.Easing.Quadratic.InOut).onUpdate(e=>{n.uNebulaRotationSpeed.value=e.rot,n.uNebulaSwirlSpeed.value=e.swirl}).start()}).start()}e.fanAction&&new v.Tween(e.fanAction).to({timeScale:1},2500).easing(v.Easing.Cubic.Out).start(),e.raycasterWrapper&&On(e)}function Ni(e,t){let n=e.dragonBalls||[];n.forEach((r,i)=>{if(r&&(r.rapierBody&&(r.rapierBody.setTranslation({x:t.x,y:t.y,z:t.z},!0),r.rapierBody.setLinvel({x:0,y:0,z:0},!0),r.rapierBody.setAngvel({x:0,y:0,z:0},!0)),r.visible=!0,r.ritualStartScale&&r.scale.copy(r.ritualStartScale),Ai(r,e,$i),r.rapierBody)){r.rapierBody.setBodyType(b.RigidBodyType.Dynamic),r.rapierBody.wakeUp();let e=i/Math.max(n.length,1)*Math.PI*2+Math.random()*.4,t=20+Math.random()*15,a=10+Math.random()*8;r.rapierBody.applyImpulse({x:Math.cos(e)*t,y:a,z:Math.sin(e)*t},!0),r.rapierBody.applyTorqueImpulse({x:(Math.random()-.5)*4,y:(Math.random()-.5)*4,z:(Math.random()-.5)*4},!0)}})}function Pi(t,n=null,r=null){if(t.world&&t.world.isBusy){setTimeout(()=>Pi(t,n,r),16);return}let i=t.world.hasPointGravityOnBalls;t._dragonBallRestoreTimeout&&=(clearTimeout(t._dragonBallRestoreTimeout),null),ur(t,!1);let a=t.dragonBalls||[];if(a.length===0){r&&r();return}let o=new e.Vector3(0,.8,0);if(n)o.copy(n);else{let e=Oi(t.getObjectByName(`Object_108`));o.copy(e),o.y+=.25}let s=1.035,c=performance.now()+1200+200,l=a.length;a.forEach((n,u)=>{if(!n||!n.rapierBody)return;let d=n.rapierBody;d.rapierCollider&&d.rapierCollider.setSensor(!0);let f=u/a.length*Math.PI*2,p=o.x+Math.cos(f)*s,m=o.y,h=o.z+Math.sin(f)*s,g=d.mass(),_=Math.random()*5*g;d.applyImpulse({x:0,y:5+_,z:0},!0);let v=5*g*.5;d.applyTorqueImpulse({x:(Math.random()-.5)*v,y:(Math.random()-.5)*v,z:(Math.random()-.5)*v},!0),d.wakeUp(),Or(d,()=>{let n=new e.Vector3(p,m,h),a=new e.Quaternion,s=`dragon-beam-${u}`,f=null;if(Ko){let n=d.translation();Ko(t,``,``,new e.Vector3(n.x,n.y,n.z),s,!0,16747520,!0,1/0,!0),f=t.getObjectByName(s)}t._activeResetCount=(t._activeResetCount||0)+1,Ei&&Ei(t,!0),kr(d,n,a,c,b.RigidBodyType.Dynamic,()=>{f&&(f.visible=!1,f.activeRequestID&&cancelAnimationFrame(f.activeRequestID)),t._activeResetCount--,Ei&&Ei(t,!1),l--,l===0&&(r&&r(),t.gazeFollower&&(t.gazeFollower.isLocked=!1,Go(t,t.camera,!1)),i&&(t._dragonBallRestoreTimeout=setTimeout(()=>{t.world&&t.world.ballBodies&&ur(t,!0),t._dragonBallRestoreTimeout=null},3e3)))},(n,r)=>{let i=t.getObjectByName(`drone`);if(f&&f.visible&&i){let r=i.getObjectByName(`Sphere001_0`);if(r){let i=new e.Vector3;r.getWorldPosition(i);let a=i.distanceTo(n);f.position.copy(i),f.lookAt(n),f.children.forEach(e=>{e.scale.z=a}),u===0&&Go(t,o,!0)}}})})})}function Fi(e,t,n,r=!1,i=null){let a=e.getObjectByName(`btc_symbol`),o=e.getObjectByName(`eth_symbol`);if(!a){console.warn(`btc_symbol not found in scene`);return}let s=.5;Bi||(Bi=_n.clone(),Vi=gn.clone());let c=`BTC`,l=a;i?(c=i===`ETH`?`ETH`:`BTC`,l=c===`ETH`?o:a):o&&Math.random()>.5&&(c=`ETH`,l=o);let u=null,d=!1,f=null;if(Wi.length>=Yi){let t=Wi.shift();t&&(f=t.userData.coinType,Ii(e,t))}if(Wi.length+qi.length>=Ji){let t=qi.shift();!t&&Wi.length>0&&(t=Wi.shift()),t&&(Li(e,t),t.userData.coinType===`ETH`?Ki.push(t):Gi.push(t))}let p=c===`ETH`?Ki:Gi;if(p.length>0)u=p.shift(),d=!0,u.visible=!0,Oo(e,u);else{u=l.clone(),u.scale.setScalar(s),u.name=`${c}_${performance.now()} `,u.userData.coinType=c,u.material=Bi,Oo(e,u);let t=u.clone();t.name=`Aura`,t.material=Vi,t.position.set(0,0,0),t.rotation.set(0,0,0),t.scale.setScalar(1.25),u.add(t),e.add(u)}Wi.push(u),t&&u.position.copy(t),u.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI);let m=l.scale.clone(),h=m.clone();if(e.world){let r=d&&u.rapierBody?u.rapierBody:null;if(r)r.wakeUp(),r.setTranslation({x:t.x,y:t.y,z:t.z},!0),r.setLinvel({x:0,y:0,z:0},!0),r.setAngvel({x:0,y:0,z:0},!0);else{let{body:t,shape:n}=Ne(e,u,{bodyType:`dynamic`,mass:1,restitution:.2,friction:.8,canSleep:!0,isConvexHull:!0,isBhTarget:!0,linearDamping:.8,angularDamping:.8});je(e,u,t,n)}let i=u.rapierBody;i&&(n&&i.applyImpulse({x:n.x,y:n.y,z:n.z},!0),i.applyTorqueImpulse({x:Math.random(),y:Math.random(),z:Math.random()},!0),e.bhTargets&&!e.bhTargets.includes(u)&&e.bhTargets.push(u))}if(d||Cn(e,u,{onMouseEnter:t=>{let n=Hi[c.toLowerCase()],r=`Push ${c}`;if(n){let e=n.toLocaleString(`en-US`,{style:`currency`,currency:`USD`,minimumFractionDigits:n<1?4:0,maximumFractionDigits:n<1?4:0}),t=new Date,i=t.toLocaleString(`en-US`,{month:`short`}),a=t.getDate(),o=t.getFullYear(),s=t.toLocaleTimeString(`en-US`,{hour:`2-digit`,minute:`2-digit`,hour12:!1});r=`${c}: ${e} \nat ${i}${a} ${o}, ${s}`}Xi(e,c===`ETH`?$n:er,r),wn(e,t)},onMouseLeave:t=>{Zi(e)},onMouseDown:(t,n)=>{Dn(e,t,n,5)}}),!r&&e.fireflies&&e.fireflies.triggerFlash&&Ui!==c&&(e.fireflies.triggerFlash(c),Ui=c),Wi.length%5,!r){let e=c===`BTC`?`Bitcoin`:`Ethereum`;Z(f?`Received 1 ${e}, lost 1 ${f===`BTC`?`Bitcoin`:`Ethereum`}. Even you can't hold that much power!`:`The Cosmos has manifested 1 ${e} just for you!`)}let g=.1;u.scale.copy(m).multiplyScalar(s*g);let _={t:0};u.userData.oscStrength=5;let y=u.getObjectByName(`Aura`);if(y&&(y.userData.oscStrength=5),!d){let e=e=>{e.onBeforeRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&(this.userData.prevOsc=i.uniforms.uOscillationStrength.value,i.uniforms.uOscillationStrength.value=this.userData.oscStrength)},e.onAfterRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&this.userData.prevOsc!==void 0&&(i.uniforms.uOscillationStrength.value=this.userData.prevOsc)}};e(u),y&&e(y)}return u.userData.activeTween&&u.userData.activeTween.stop(),u.userData.activeTween=new v.Tween(_).to({t:1},5e3).easing(v.Easing.Cubic.Out).onUpdate(()=>{let e=_.t;u.scale.lerpVectors(m.clone().multiplyScalar(s*g),h.clone().multiplyScalar(s),e);let t=5*(1-e);u.userData.oscStrength=t,y&&(y.userData.oscStrength=t)}).onComplete(()=>{u.userData.activeTween=null}).start(),u}function Ii(t,n){if(qi.length>40){Li(t,n),n.userData.coinType===`ETH`?Ki.push(n):Gi.push(n);return}if(qi.push(n),n.rapierBody){n.rapierBody.setBodyType(b.RigidBodyType.Dynamic),n.rapierBody.wakeUp();let t=new e.Vector3(6,7,8),r=new e.Vector3().subVectors(t,n.position).normalize();r.multiplyScalar(30),n.rapierBody.applyImpulse({x:r.x,y:r.y,z:r.z},!0),n.rapierBody.applyTorqueImpulse({x:Math.random(),y:Math.random(),z:Math.random()},!0)}n.userData.activeTween&&n.userData.activeTween.stop(),n.userData.activeTween=new v.Tween(n.scale).to({x:0,y:0,z:0},500).delay(1500).easing(v.Easing.Back.In).onComplete(()=>{n.userData.activeTween=null,Li(t,n);let e=qi.indexOf(n);e>-1&&qi.splice(e,1),n.userData.coinType===`ETH`?Ki.push(n):Gi.push(n)}).start()}function Li(e,t){if(t&&(e.world&&e.world.ballBodies&&e.world.ballBodies.includes(t.rapierBody)&&e.world.ballBodies.splice(e.world.ballBodies.indexOf(t.rapierBody),1),e.bhTargets&&e.bhTargets.includes(t)&&e.bhTargets.splice(e.bhTargets.indexOf(t),1),ko(e,t.name),t.userData.activeTween&&(t.userData.activeTween.stop(),t.userData.activeTween=null),t.visible=!1,t.rapierBody)){t.rapierBody.setBodyType(b.RigidBodyType.Dynamic),t.rapierBody.setTranslation({x:0,y:-100,z:0},!0),t.rapierBody.setLinvel({x:0,y:0,z:0},!0),t.rapierBody.setAngvel({x:0,y:0,z:0},!0),t.rapierBody.sleep();let n=`coin-integrity-beam-${t.rapierBody.handle}`,r=e.getObjectByName(n);r&&(r.visible=!1,r.activeRequestID&&cancelAnimationFrame(r.activeRequestID))}}function Ri(e){zi(e)}function zi(e){let t=[...Wi,...qi];Wi.length=0,qi.length=0;let n=0,r=()=>{if(!e)return;let i=Math.min(n+5,t.length);for(let r=n;r<i;r++){let n=t[r];n&&Li(e,n)}n=i,n<t.length?requestAnimationFrame(r):e.children.forEach(t=>{t&&t.name&&(t.name.startsWith(`BTC_`)||t.name.startsWith(`ETH_`))&&t.visible&&Li(e,t)})};t.length>0&&r()}var Bi,Vi,Hi,Ui,Wi,Gi,Ki,qi,Ji,Yi,Xi,Zi,Qi,$i,ea=M((()=>{jn(),Ve(),xn(),nr(),br(),ks(),Tr(),Dr(),Mr(),ls(),Di(),Bi=null,Vi=null,Hi={},Ui=null,xr().then(e=>{e.forEach(e=>{Hi[e.symbol.toLowerCase()]=e.current_price})}),Wi=[],Gi=[],Ki=[],qi=[],Ji=120,Yi=60,Xi=(e,t,n)=>{e.raycasterWrapper?.mouseInContainer&&(U(e,t,n),document.body.style.cursor=`pointer`)},Zi=e=>{W(e),document.body.style.cursor=`auto`},Qi=131074,$i=4294967295}));function ta(){let t=document.getElementById(`narrative-shader-canvas`),n=document.querySelector(`.modal-narrative`);if(!t||!n)return;q.parent=n;let r=new e.WebGLRenderer({canvas:t,alpha:!0,antialias:!1});r.setPixelRatio(.5),r.setSize(n.clientWidth,n.clientHeight),q.renderer=r;let i=new e.Scene,a=new e.OrthographicCamera(-1,1,1,-1,0,1);q.scene=i,q.camera=a;let o=new e.PlaneGeometry(2,2),s=new e.TextureLoader().load(oa);s.wrapS=e.RepeatWrapping,s.wrapT=e.RepeatWrapping;let c=new e.ShaderMaterial({uniforms:{iTime:{value:0},iResolution:{value:new e.Vector2(n.clientWidth,n.clientHeight)},iMouse:{value:new e.Vector4(0,0,0,0)},iChannel0:{value:s}},vertexShader:`
    ...
    `,transparent:!0});q.material=c;let l=new e.Mesh(o,c);i.add(l),q.mesh=l,window.addEventListener(`mousemove`,e=>{n.getBoundingClientRect();let t=window.innerWidth,r=window.innerHeight,i=e.clientX/t*2-1,a=e.clientY/r*2-1,o=(i+1)*.5*n.clientWidth,s=(1-(a+1)*.5)*n.clientHeight;q.targetMouse.set(o,s,1,1)}),q.startTime=performance.now(),window.addEventListener(`resize`,ia)}function na(){q.active||(ia(),q.startTime=performance.now(),q.currentMouse.x=q.targetMouse.x,q.currentMouse.y=q.targetMouse.y,q.currentMouse.z=1,q.currentMouse.w=1,q.active=!0,aa())}function ra(){q.active=!1,q.animationId&&(cancelAnimationFrame(q.animationId),q.animationId=null)}function ia(){let{parent:e,renderer:t,material:n}=q;if(!e||!t||!n)return;let r=e.clientWidth,i=e.clientHeight;t.setSize(r,i),n.uniforms.iResolution.value.set(r,i)}function aa(){if(!q.active)return;q.animationId=requestAnimationFrame(aa);let{renderer:e,scene:t,camera:n,material:r,startTime:i,targetMouse:a,currentMouse:o,lerpFactor:s}=q;!e||!t||!n||!r||(o.x+=(a.x-o.x)*s,o.y+=(a.y-o.y)*s,o.z+=(a.z-o.z)*s,o.w+=(a.w-o.w)*s,r.uniforms.iTime.value=(performance.now()-i)*.001,r.uniforms.iMouse.value.copy(o),e.render(t,n))}var q,oa,sa=M((()=>{q={renderer:null,scene:null,camera:null,material:null,mesh:null,parent:null,animationId:null,active:!1,startTime:0,targetMouse:new e.Vector4(0,0,0,0),currentMouse:new e.Vector4(0,0,0,0),lerpFactor:.08},oa=`./textures/noise.webp`}));function ca(e){ua(e),ta(),window.addEventListener(`keydown`,t=>{let n=t.key.toLowerCase();if(n===`g`)da(e);else if(n===`l`)_a(e,null,!0);else if(n===`i`||n===`d`){let e=document.getElementById(`cv-container`);if(e){let t=document.getElementById(`app-container`),r=t?t.offsetWidth:window.innerWidth,i=r*.05,a=e.offsetWidth,o=n===`i`?a+i:a-i;o>200&&o<r*.9&&(e.style.width=`${o}px`,e.classList.contains(`collapsed`)&&(e.style.transform=`translateX(${o}px)`,e.style.marginRight=`-${o}px`,e.userData&&(e.userData.x=o,e.userData.margin=-o))),window.dispatchEvent(new Event(`resize`))}}}),window.addEventListener(`subtitleClose`,t=>{let n=e.scenarioState?.name===`room`,r=!e.isHeroAnimating&&!e.isTransitioning;t.detail?.manual&&n&&r&&da(e)})}function la(e,t){let n=Ca.filter(e=>e.event===`click`);for(let r of n){let n=e.target.closest(r.selector);if(n){r.action(e,t,n);return}}}function ua(e){document.body.addEventListener(`click`,t=>la(t,e)),Ca.forEach(t=>{t.event!==`click`&&document.querySelectorAll(t.selector).forEach(n=>{n.addEventListener(t.event,r=>t.action(r,e,n))}),t.event===`click`&&document.querySelectorAll(t.selector).forEach(e=>{e.tagName!==`A`&&(e.style.cursor=`pointer`)})})}async function da(t,n={}){let{onImpact:r=null,onComplete:i=null}=n;if(!(t.scenarioState&&t.scenarioState.name===`room`)||t.isHeroAnimating||!window.boneTracker){console.warn(`[Cinematic] Aborted: Context mismatch or active animation.`);return}let a=t.getObjectByName(`a-char`),o=t.getObjectByName(`stool_bound`);if(!a||!o)return;t.isHeroAnimating=!0,t.allowsResetting=!1;let s=[`pokeball`,`pokeball2`,`questionCube`],c=null,l=1/0;s.forEach(e=>{let n=t.getObjectByName(e);if(n&&n.visible&&n.rapierBody){let e=n.position.distanceTo(a.position);e<l&&(l=e,c=n)}});let u=()=>{let e=e=>{if(!e)return!1;let t=e.getBoundingClientRect();return t.top<window.innerHeight&&t.bottom>0},t=document.querySelector(`#persona-switch-btn`);return e(t)?t:Array.from(document.querySelectorAll(`h2`)).find(t=>e(t))||document.querySelector(`#cv-export-btn`)||document.querySelector(`#cv-header`)},d=document.querySelector(`#persona-switch-btn`);if(d&&d.classList.add(`persona-aggressive-jitter`),c&&c.rapierBody){let n=c.rapierBody,r=new e.Vector3(1,1,-1.5),i=new e.Quaternion(0,0,0,1),o=n.bodyType();n.rapierCollider&&n.rapierCollider.setSensor(!0);let s=n.mass();n.wakeUp(),n.applyImpulse({x:0,y:15*s,z:0},!0);let l=t.getObjectByName(`mixamorigSpine1`),u=new e.Vector3;l?l.getWorldPosition(u):a.getWorldPosition(u),Or(n,()=>{let a=`ritual-beam-${n.handle}`,s=L.ELECTRIC_CYAN||65535,c=n.translation();Ko(t,``,``,new e.Vector3(c.x,c.y,c.z),a,!0,s,!0,1/0,!0);let l=t.getObjectByName(a);kr(n,r,i,performance.now()+1e3,o,()=>{l&&(l.visible=!1,l.activeRequestID&&cancelAnimationFrame(l.activeRequestID)),n.setTranslation(r,!0),n.setLinvel({x:0,y:0,z:0},!0),n.setAngvel({x:0,y:0,z:0},!0)},(n,r)=>{if(l&&l.visible){let r=t.objectMap&&t.objectMap.get?t.objectMap.get(`drone`):t.getObjectByName(`drone`);if(r){let t=r.getObjectByName(`Sphere001_0`);if(t){let r=new e.Vector3;t.getWorldPosition(r);let i=r.distanceTo(n);l.position.copy(r),l.lookAt(n),l.children.forEach(e=>{e.scale.z=i})}}}},u)})}if(setTimeout(()=>{Er(t,`sitToStand`,{speed:1.2,autoReturn:!1})},2e3),await wa(t,{x:1,y:0,z:.75}),d&&d.classList.remove(`persona-aggressive-jitter`),window.boneTracker){let e=u(),n=e&&e.tagName===`H2`;n&&(e.style.outline=`2px solid var(--c-cyan)`,e.style.outlineOffset=`4px`,e.style.transition=`outline 0.3s ease`),window.boneTracker.hasHitThisSwing=!1,window.boneTracker.initTargetElement(e),window.boneTracker.setOffset(.05,.36,-.05),window.boneTracker.setRotationOffset(-30,0,110),window.boneTracker.setScale(3),window.boneTracker.toggleTracking(()=>{Er(t,`golfDrive`,{speed:.7,autoReturn:!1,onComplete:()=>{window.boneTracker&&window.boneTracker.isActive&&window.boneTracker.toggleTracking(),Er(t,`standClap`,{speed:1,crossFadeDuration:.8,onComplete:async()=>{await new Promise(e=>setTimeout(e,500)),await wa(t,null),n&&(e.style.outline=``,e.style.outlineOffset=``),t.isHeroAnimating=!1,t.allowsResetting=!0,i&&i()}})}}),setTimeout(()=>{r&&r()},660)})}}async function fa(e,t=!0){let n=e.scenarioState?.name===`room`;if(t){let t=Q.currentMode===I.DEV?I.POBA:I.DEV;if(n){if(e.isHeroAnimating){U(e,Hn!==void 0&&Xn?Xn:null,`CHANGING PROTOCOL...`),e._informerTimeout&&clearTimeout(e._informerTimeout),e._informerTimeout=setTimeout(()=>W(e),1500);return}Q.setPersona(t),da(e,{onImpact:()=>{let n=t===I.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`,r=typeof z==`function`?z(n):``;r&&(ys(r),Ko(e,null,r))}});return}let r=e.pointsApp,i=e.scenarioState&&e.scenarioState.name===`points`,a=r&&typeof r.getCurrentStep==`function`&&r.getCurrentStep()===0;i&&a?Q.setPersona(t,{skipPointsSync:!0}):Q.setPersona(t)}}function pa(t){if(t.isHeroAnimating||t.allowsResetting===!1||t.scenarioState&&t.scenarioState.name!==`room`)return;let n=t.getObjectByName(`stool_bound`),r=t.getObjectByName(`a-char`);if(!n||!r)return;t.isHeroAnimating=!0,t.allowsResetting=!1;let i=new e.Vector3,a=new e.Quaternion;n.getWorldPosition(i),n.getWorldQuaternion(a);let o=r.position.x,s=r.position.y,c=r.position.z,l=[{name:`gangnam`,moveOffset:new e.Vector3(5,0,0),returnSpeed:1,returnDuration:440,isRobot:!1},{name:`breakDance`,moveOffset:new e.Vector3(3,0,-2),returnSpeed:1.2,returnDuration:440,isRobot:!1},{name:`robotDance`,moveOffset:new e.Vector3(1,0,0),returnSpeed:1,returnDuration:200,isRobot:!0}].filter(e=>t.heroClips?.some(t=>t.name.toLowerCase()===e.name.toLowerCase()));if(l.length===0)return;let u=Math.random(),d;d=u<.5?l.find(e=>e.name===`breakDance`):u<.75?l.find(e=>e.name===`gangnam`):l.find(e=>e.name===`robotDance`),d||=l[Math.floor(Math.random()*l.length)];let f=t.heroClips.find(e=>e.name.toLowerCase()===d.name.toLowerCase()),p=d.moveOffset,m=d.returnDuration,h=d.returnSpeed,g=d.isRobot,_=new e.Vector3;r.getWorldPosition(_);let y=_.clone().add(p).clone();r.parent&&r.parent.worldToLocal(y);let x=n.rapierBody;if(x){x.setBodyType(b.RigidBodyType.Dynamic),x.wakeUp();let t=new e.Vector3(75+Math.random()*10,50+Math.random()*5,(Math.random()-.5)*5),n=new e.Vector3(Math.random()*2,Math.random()*5,Math.random()*2);x.applyImpulse({x:t.x,y:t.y,z:t.z},!0),x.applyTorqueImpulse(n,!0)}new v.Tween(r.position).to({x:y.x,y:y.y,z:y.z},800).easing(v.Easing.Quadratic.Out).start(),f&&Er(t,f.name,{idleClipName:g?`typing`:`walking`,onComplete:()=>S()});function S(){if(g)new v.Tween(r.position).to({x:o,y:s,z:c},m).easing(v.Easing.Quadratic.Out).onComplete(()=>{t.isHeroAnimating=!1,t.allowsResetting=!0}).start(),C();else{Er(t,`walking`,{idleClipName:`typing`,speed:h});let n=r.position.clone(),i=new e.Vector3(o,s,c),a={t:0};new v.Tween(a).to({t:1},1200).easing(v.Easing.Linear.None).onUpdate(()=>{let e=a.t;e=e<.2?(e/.2)**3*.05:.05+(e-.2)/.8*.95,r.position.lerpVectors(n,i,e)}).onComplete(()=>{Er(t,`typing`,{crossFadeDuration:.2}),C(500),t.isHeroAnimating=!1,t.allowsResetting=!0}).start()}}function C(r=1e3){if(!x)return;x.setBodyType(b.RigidBodyType.KinematicPositionBased),x.setLinvel({x:0,y:0,z:0},!0),x.setAngvel({x:0,y:0,z:0},!0),x.wakeUp();let o=x.translation(),s=x.rotation(),c={t:0};new v.Tween(c).to({t:1},r).easing(v.Easing.Cubic.Out).onUpdate(()=>{let t=new e.Vector3().lerpVectors(o,i,c.t),r=new e.Quaternion().copy(s).slerp(a,c.t);x.setTranslation(t,!0),x.setRotation(r,!0);let l=t.clone();n.parent&&n.parent.worldToLocal(l),n.position.copy(l);let u=r.clone();if(n.parent){let t=new e.Quaternion;n.parent.getWorldQuaternion(t),n.quaternion.copy(t.invert().multiply(u))}else n.quaternion.copy(u)}).onComplete(()=>{g&&t.heroClips&&Er(t,`typing`,{crossFadeDuration:.5})}).onStart(()=>{t.stoolGridUniforms&&(t.stoolGridUniforms.uWorldGridActive.value=1,t.stoolGridUniforms.uWorldGridProgress.value=0,new v.Tween(t.stoolGridUniforms.uWorldGridProgress).to({value:1},600).easing(v.Easing.Quadratic.Out).onComplete(()=>{setTimeout(()=>{new v.Tween(t.stoolGridUniforms.uWorldGridProgress).to({value:0},500).onComplete(()=>{t.stoolGridUniforms.uWorldGridActive.value=0}).start()},200)}).start())}).start()}}function ma(e,t){ja&&=(clearTimeout(ja),null),t?ja=setTimeout(()=>{ha(e,!0)},Ma):ha(e,!1)}function ha(t,n){let r=t.pointsApp;if(!r||!r.material)return;n?(U(t,Jn,`The closer you look...`),t.conversationManager?.shout(`...the less you see.`)):W(t);let i=(r.getCurrentStep?r.getCurrentStep():0)===2?.3:1,a=t.camera,o=t.orbitControls;o&&n&&(o.isStrategicHover=!0);let s=r.material.uniforms;Ea&&Ea.stop();let c=n?.8+2.7*i:.8,l=n?800:500;if(Ea=new v.Tween(s.uModelVibFactor).to({value:c},l).easing(v.Easing.Cubic.Out).start(),!a||!o)return;Oa||=a.position.clone(),ka||=a.rotation.clone(),Aa===null&&(Aa=a.fov),Ta&&Ta.stop(),Da&&Da.stop();let u=new e.Vector3(1.8,.6,-1.8).multiplyScalar(i),d=n?Oa.clone().add(u):Oa.clone(),f=(Aa-38)*i,p=n?Aa-f:Aa;Ta=new v.Tween(a.position).to({x:d.x,y:d.y,z:d.z},l).easing(v.Easing.Cubic.Out).onUpdate(()=>{if(n){let t=.05*i,n=.04*i;a.rotation.x=e.MathUtils.lerp(a.rotation.x,ka.x-t,.05),a.rotation.y=e.MathUtils.lerp(a.rotation.y,ka.y+n,.05)}}).onComplete(()=>{n||(Oa=null,ka=null,Aa=null,o&&(o.isStrategicHover=!1))}).start(),Da=new v.Tween(a).to({fov:p},l).easing(v.Easing.Cubic.Out).onUpdate(()=>{a.updateProjectionMatrix()}).start()}function ga(e){let t=e.pointsApp;if(!t||!t.getCurrentStep)return;let n=t.getCurrentStep(),r=t.material.uniforms;switch(n){case 0:new v.Tween(r.uModelScale).to({value:0},150).easing(v.Easing.Exponential.In).onComplete(()=>{new v.Tween(r.uModelScale).to({value:1.2},300).easing(v.Easing.Back.Out).onComplete(()=>{new v.Tween(r.uModelScale).to({value:1},400).easing(v.Easing.Quadratic.Out).start()}).start()}).start();break;case 1:e.stoolGridUniforms&&(e.stoolGridUniforms.uWorldGridActive.value=1,e.stoolGridUniforms.uWorldGridProgress.value=0,new v.Tween(e.stoolGridUniforms.uWorldGridProgress).to({value:1},800).easing(v.Easing.Cubic.Out).onComplete(()=>{e.stoolGridUniforms.uWorldGridActive.value=0}).start());break;case 2:t.playNextDance&&t.playNextDance();break}}function _a(e,t,n){let r=document.getElementById(`cv-container`);if(!r)return;r.userData||={};let i=r.userData,a;a=n===void 0?!r.classList.contains(`collapsed`):n,a?r.classList.add(`collapsed`):r.classList.remove(`collapsed`),document.body.classList.toggle(`cv-collapsed`,a),i.tween&&i.tween.stop();let o=!a,s=r.offsetWidth||600,c=a?s:0,l=a?-s:0;i.x===void 0&&(i.x=a?0:s),i.margin===void 0&&(i.margin=a?0:-s),i.tween=new v.Tween(i).to({x:c,margin:l},800).easing(v.Easing.Back.Out).onUpdate(()=>{r.style.transform=`translateX(${i.x}px)`,r.style.marginRight=`${i.margin}px`}).onComplete(()=>{a&&(r.style.opacity=`0`)}).onStart(()=>{o&&(r.style.opacity=`1`)}).start(),window.dispatchEvent(new CustomEvent(`cvToggle`,{detail:{collapsed:a}})),e.HUD&&typeof e.HUD.breathe==`function`&&e.HUD.breathe(L.ELECTRIC_CYAN),t&&U(e,null,a?`EXPAND CV PANEL`:`COLLAPSE CV PANEL`,!0)}function va(e,t){if(t){let t=document.getElementById(`cv-container`);U(e,null,!t||t.classList.contains(`collapsed`)?`EXPAND CV PANEL`:`COLLAPSE CV PANEL`,!0),e.HUD&&typeof e.HUD.breathe==`function`&&e.HUD.breathe(L.ELECTRIC_CYAN)}else W(e)}function ya(e,t,n){if(n){let n=t.getAttribute(`data-label`),r=t.getAttribute(`data-platform`);U(e,null,`COPY ${n.toUpperCase()} & OPEN ${r.toUpperCase()}`,!0,!0)}else W(e)}async function ba(e,t){t.getAttribute(`data-label`);let n=t.getAttribute(`data-url`),r=t.getAttribute(`data-id`)===`gmail`,i=n;try{await navigator.clipboard.writeText(i),U(e,null,`COPIED TO CLIPBOARD!`,!0,!0);let a=r?`mailto:${n}`:n;window.open(a,`_blank`),setTimeout(()=>{t.matches(`:hover`)&&ya(e,t,!0)},1500)}catch(e){console.error(`Clipboard copy failed:`,e)}window.uiAnims&&window.uiAnims.triggerSpring&&window.uiAnims.triggerSpring(t)}function xa(e){let t=document.getElementById(e),n=document.getElementById(`cv-scroller`);if(t&&n){let e=t.nextElementSibling;e&&e.classList.contains(`collapsed`)&&t.click();let r=t.offsetTop;n.scrollTo({top:r-85,behavior:`smooth`})}}async function Sa(e){let t=document.getElementById(`work-experience-modal`);t&&(t.style.display=`none`,e&&(e.raycasterEnabled=!0),ra()),_a(e,null,!1),await new Promise(e=>setTimeout(e,400));let n=document.getElementById(`board`),r=document.querySelector(`.three-js-backdrop`);n&&(n.style.opacity=`1`),r&&(r.style.opacity=`1`),e.HUD&&typeof e.HUD.runTweenOpen==`function`&&e.HUD.runTweenOpen()}var Ca,wa,Ta,Ea,Da,Oa,ka,Aa,ja,Ma,Na=M((()=>{Ns(),Dr(),Mr(),we(),nr(),jn(),ls(),ke(),ks(),sa(),Ca=[{selector:`#persona-switch-btn`,event:`click`,action:(e,t)=>{e.stopPropagation(),Q.togglePersonaPanel()}},{selector:`.header-photo`,event:`click`,action:(e,t)=>fa(t,!0)},{selector:`.name`,event:`mouseenter`,action:(e,t)=>ma(t,!0)},{selector:`.name`,event:`mouseleave`,action:(e,t)=>ma(t,!1)},{selector:`.name`,event:`click`,action:(e,t)=>{t.scenarioState?.name===`room`?fa(t,!1):ga(t)}},{selector:`.choice-box`,event:`click`,action:(e,t,n)=>{let r=n.getAttribute(`data-mode`);r&&Q.setPersona(r)}},{selector:`#cv-mode-selector .mode-option`,event:`click`,action:(e,t,n)=>{let r=n.getAttribute(`data-mode`);r&&Q.setPersona(r)}},{selector:`.nav-item`,event:`click`,action:(e,t,n)=>{let r=n.getAttribute(`data-target`);if(document.querySelectorAll(`.nav-modules .nav-item`).forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`),r===`cv-header`&&t.scenarioState?.name===`room`){t.isTransitioning||$o(t);return}let i=document.getElementById(r),a=document.getElementById(`cv-scroller`);i&&a&&a.scrollTo({bottom:0,top:i.offsetTop-80,behavior:`smooth`})}},{selector:`#hud-nav-btn-3`,event:`click`,action:(e,t)=>{let n=document.querySelector(`.nav-modules .nav-item[data-target="cv-header"]`);n&&(document.querySelectorAll(`.nav-modules .nav-item`).forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`)),t.scenarioState?.name===`room`&&!t.isTransitioning&&(W(t),$o(t))}},{selector:`#hud-nav-btn-2`,event:`click`,action:(e,t)=>{if(t.scenarioState?.name===`points`&&!t.isTransitioning&&(W(t),t.pointsApp&&typeof t.pointsApp.triggerStep==`function`)){t.pointsApp.triggerStep(3);let e=document.querySelector(`.nav-modules .nav-item[data-target="LAB"]`)||document.querySelector(`.nav-modules .nav-item[data-target="cv-header"]`);e&&(document.querySelectorAll(`.nav-modules .nav-item`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`))}}},{selector:`#hud-nav-btn-1`,event:`click`,action:async(e,t)=>{if(t.isTransitioning)return;W(t),t.HUD&&typeof t.HUD.runTweenClose==`function`&&t.HUD.runTweenClose(1e3),xa(`cv-work-header`);let n=document.getElementById(`board`),r=document.querySelector(`.three-js-backdrop`);n&&(n.style.transition=`opacity 0.4s`),n&&(n.style.opacity=`0`),r&&(r.style.transition=`opacity 0.4s`),r&&(r.style.opacity=`0`),await new Promise(e=>setTimeout(e,1100));let i=document.getElementById(`cv-container`);i&&i.classList.remove(`slow-transition`),_a(t,null,!0),await new Promise(e=>setTimeout(e,400));let a=document.getElementById(`work-experience-modal`);a&&(a.style.display=`flex`,t&&(t.raycasterEnabled=!1),na())}},{selector:`#work-modal-close-btn`,event:`click`,action:(e,t)=>Sa(t)},{selector:`#cv-export-btn, #modal-cv-export-btn`,event:`click`,action:(e,t)=>{let n=document.createElement(`a`);n.href=`./cvs/Bui_Quoc_Hieu_CV_Portable.pdf`,n.download=`Bui_Quoc_Hieu_CV_Portable.pdf`,document.body.appendChild(n),n.click(),document.body.removeChild(n),t.scenarioState?.name===`room`&&pa(t)}},{selector:`#work-experience-modal`,event:`click`,action:(e,t)=>{(e.target.id===`work-experience-modal`||e.target.classList.contains(`modal-backdrop`))&&Sa(t)}},{selector:`#cv-toggle-btn`,event:`click`,action:(e,t,n)=>_a(t,n)},{selector:`#cv-toggle-btn`,event:`mouseenter`,action:(e,t)=>va(t,!0)},{selector:`#cv-toggle-btn`,event:`mouseleave`,action:(e,t)=>va(t,!1)},{selector:`.contact-btn-tiny`,event:`mouseenter`,action:(e,t,n)=>ya(t,n,!0)},{selector:`.contact-btn-tiny`,event:`mouseleave`,action:(e,t,n)=>ya(t,n,!1)},{selector:`.contact-btn-tiny`,event:`click`,action:(e,t,n)=>ba(t,n)}],wa=(e,t=null)=>{let n=e.getObjectByName(`a-char`),r=e.getObjectByName(`stool`),i=e.getObjectByName(`stool_bound`);if(!n||!i)return Promise.resolve();if(n.userData.origPos===void 0&&(n.userData.origPos=n.position.clone()),r&&r.userData.origPos===void 0&&(r.userData.origPos=r.position.clone()),i.rapierBody&&i.userData.origTranslation===void 0){let e=i.rapierBody.translation();i.userData.origTranslation={x:e.x,y:e.y,z:e.z},n.userData.stoolOffset={x:e.x-n.userData.origPos.x,y:e.y-n.userData.origPos.y,z:e.z-n.userData.origPos.z}}let a=1500,o=v.Easing.Cubic.InOut,s=t||n.userData.origPos,c={x:s.x+(n.userData.stoolOffset?.x||0),y:s.y+(n.userData.stoolOffset?.y||0),z:s.z+(n.userData.stoolOffset?.z||0)};return new Promise(e=>{if(new v.Tween(n.position).to({x:s.x,y:s.y,z:s.z},a).easing(o).onComplete(e).start(),r&&new v.Tween(r.position).to({x:c.x,y:c.y,z:c.z},a).easing(o).start(),i.rapierBody){let e=i.rapierBody.translation(),t={x:e.x,y:e.y,z:e.z};new v.Tween(t).to(c,a).easing(o).onUpdate(()=>{i.rapierBody.setNextKinematicTranslation(t)}).start()}})},typeof window<`u`&&(window.triggerRitual=e=>{da(window.scene,{onImpact:()=>{let t=e||(Q.currentMode===I.DEV?I.POBA:I.DEV);Q.setPersona(t)}})}),Ta=null,Ea=null,Da=null,Oa=null,ka=null,Aa=null,ja=null,Ma=400}));function Pa(e,t,n){let r=n.get(`catBlack`),i=n.get(`catWhite`),a=t===I.POBA?R.UI_INFORMER_CAT_MAX_POBA.en:R.UI_INFORMER_CAT_MAX_DEV.en,o=t===I.POBA?R.UI_INFORMER_CAT_MIN_POBA.en:R.UI_INFORMER_CAT_MIN_DEV.en;r&&(r.userData.assignedRole=a[Math.floor(Math.random()*a.length)]),i&&(i.userData.assignedRole=o[Math.floor(Math.random()*o.length)])}function Fa(t){let n=new Map;t.shootDroneBeam=Ko,t.traverse(e=>{e.name&&n.set(e.name,e),/^book\d+$/.test(e.name)&&Qa.push(e)}),t.objectMap=n;let r=eo(t,n,{gravityCenter:new e.Vector3(-.5,3.5,4.9),tgtPos:new e.Vector3(-2,3.09,6.42),tgtQuat:new e.Quaternion(-.09,.48,-.05,.87)});Pa(t,Q.currentMode,n),window.addEventListener(`personaToggle`,e=>{Pa(t,e.detail.mode,n)});let i=n.get(`a-char`);if(i){let t=1/i.scale.y,r=3.675*t,a=1.6*t,o=new e.Mesh(new e.BoxGeometry(a,r,a),new e.MeshBasicMaterial({color:16711935,transparent:!0,opacity:0,visible:!1}));o.name=`hero_hitbox`,o.position.set(0,r/2,0),i.add(o),n.set(o.name,o)}let a=[...Object.keys(r),`aegis`,`aegis2`,`caseCover`,`mjolnir_low_mjolnir_hammer_0`,`Object_34001`,`screenDisplay001`,`screenDisplay002`,`verticalMonitorDisplay`,`Model_0001`,`pictureLionFrame`],o=0;a.forEach(e=>{let i=n.get(e),a=r[e]||{};if(!i)return;o++;let s=a.onMouseEnter?e=>{a.onMouseEnter(e)}:e=>$a(t,e),c=e=>{t.gazeFollower&&t.gazeFollower.lookAtTarget(e),s(e)},l=a.onMouseLeave?e=>a.onMouseLeave(e):e=>J(t,e);Cn(t,i,{onMouseEnter:c,onMouseLeave:e=>{t.gazeFollower&&t.gazeFollower.lookAtTarget(t.camera),l(e)},onMouseDown:a.onMouseDown?(e,t)=>a.onMouseDown(e,t):(e,n)=>Y(t,e,n),onMouseHover:a.onMouseHover?(e,t)=>a.onMouseHover(e,t):null})}),Qa.forEach(e=>{Cn(t,e,{onMouseEnter:()=>{$a(t,e),t.gazeFollower&&t.gazeFollower.lookAtTarget(e),t.raycasterWrapper?.mouseInContainer&&U(t,Jn,z(`UI_INFORMER_BOOK`))},onMouseLeave:()=>{J(t),to(t),t.gazeFollower&&t.gazeFollower.lookAtTarget(t.camera)},onMouseDown:(e,n)=>Y(t,e,n)})}),Za.forEach(e=>{let r=n.get(e);r&&Cn(t,r,{onMouseEnter:()=>{},onMouseLeave:()=>{}})}),t.testBH=(e=`y`)=>{let n=t.getObjectByName(`Lathe_Center`);if(!n||![`x`,`y`,`z`].includes(e))return;let r={};r[e]=n.rotation[e]-Math.PI*6,new v.Tween(n.rotation).to(r,1500).easing(v.Easing.Back.Out).start()}}function Ia(e,t,n,r,i,a,o=null){if(e.isSucking||!t||!t.rapierBody)return;let s=Array.isArray(n)?[...n]:[n];e.world.hasPointGravityOnPokeball=!1,La(e,t,r),Ra(e,t,s,i,a)}function La(e,t,n){let r=t.rapierBody;if(!r)return;e.world.pokeballBody=r,e.world.gravityCenterForPokeball=n;let i=t.position.clone();i.normalize();let a=r.mass()*15,o=i.multiplyScalar(a*-1);o.y=Math.max(8*Math.abs(i.y),8),o.x/=Va(1,2),o.y*=Va(1,1.5),o.z/=Va(1,2),t.rapierBody.applyImpulse({x:o.x,y:o.y,z:o.z},!0)}function Ra(t,n,r,i,a){t.isSucking=!0;let o=Bt(`#FBC189`,1.5,1),s=r.length;r.forEach(r=>{if(r.ignoreRaycast=!0,r.traverse(e=>{e.ignoreRaycast=!0,e.userData&&(e.userData.isRaycastTarget=!1)}),t.raycastObjects&&=t.raycastObjects.filter(e=>{let t=e===r;return t||r.traverse(n=>{n===e&&(t=!0)}),t||e.traverse(e=>{e===r&&(t=!0)}),!t}),t.raycasterWrapper?.currentObjectTarget){let e=t.raycasterWrapper.currentObjectTarget,n=e===r;n||r.traverse(t=>{t===e&&(n=!0)}),n&&W(t)}let c=new e.Vector3,l=new e.Quaternion,u={value:0},d=new v.Tween(o.uniforms.uprogress).to({value:2},1500).easing(v.Easing.Bounce.Out).onComplete(()=>{if(t.world.hasPointGravityOnPokeball=!1,n.rapierBody){n.rapierBody.setBodyType(0);let t=new e.Vector3(0,-4,0);n.rapierBody.applyImpulse({x:t.x,y:t.y,z:t.z},!0)}r.traverse(e=>{if(e.rapierBody){let n=e.rapierBody;e.isRapierBound=!1,n.isObjectBound=!1;try{t.world.removeRigidBody(n)}catch(t){console.warn(`[Catch] RigidBody removal failed for `+e.name,t)}t.physicBodies&&=t.physicBodies.filter(e=>e!==n),t.skinnedMeshBodies&&=t.skinnedMeshBodies.filter(e=>e!==n),t.objectControlledBodies&&=t.objectControlledBodies.filter(e=>e!==n),t.physicsControlledObjects&&=t.physicsControlledObjects.filter(t=>t!==e),t.physicObjects&&=t.physicObjects.filter(t=>t!==e),e.rapierBody=null}}),t.physicsControlledObjects&&=t.physicsControlledObjects.filter(e=>e!==r),t.physicObjects&&=t.physicObjects.filter(e=>e!==r),t.remove(r),(r.name===`catBlack`||r.name===`blackCat`)&&(t.isMaxMissing=!0),(r.name===`catWhite`||r.name===`Object_108`)&&(t.isMinMissing=!0),r.visible=!1,s--,s<=0&&(t.isSucking=!1)}),f=new v.Tween(u).to({value:1},1e3).easing(v.Easing.Back.InOut).onStart(()=>{n.rapierBody&&n.rapierBody.setBodyType(1),c.copy(n.position),l.copy(n.rotation),typeof t.shootDroneBeam==`function`&&t.shootDroneBeam(t,``,``,c.clone(),`drone-beam`,!1,null,!0,1/0,!0)}).onUpdate(()=>{let r=new e.Vector3().lerpVectors(c,i,u.value);n.rapierBody&&n.rapierBody.setTranslation({x:r.x,y:r.y,z:r.z},!1);let o=t.getObjectByName(`drone-beam`),s=t.getObjectByName(`drone`);if(o&&o.visible&&s){let i=s.getObjectByName(`Sphere001_0`);if(i){let a=new e.Vector3;i.getWorldPosition(a);let s=a.distanceTo(r);o.position.copy(a),o.lookAt(r),o.children.forEach(e=>{e.scale.z=s}),t.gazeFollower&&t.gazeFollower.lookAtTarget(n)}}let d=l.clone().slerp(a,u.value);n.rapierBody&&n.rapierBody.setRotation({x:d.x,y:d.y,z:d.z,w:d.w},!1)}).onComplete(()=>{let e=t.getObjectByName(`drone-beam`);e&&(e.visible=!1,e.activeRequestID&&cancelAnimationFrame(e.activeRequestID)),o.uniforms.catchPoint.value.copy(i),r.traverse(e=>{e.isMesh&&(e.material=o,e.userData.originalMaterial=o)})}).chain(d);setTimeout(()=>{t.world.hasPointGravityOnPokeball=!0},1e3),setTimeout(()=>{f.start()},3e3)})}function za(e,t={}){let{forcedX:n=null,environmentRatio:r=null,duration:i=1e3,delay:a=0}=t,o=e.getObjectByName(`glassInvi`);if(!o)return;let s=5.4,c=.75,l=o.rapierBody,u=l.translation(),d=u.x,f;f=n===null?o.slideDirection?o.slideDirection*-1:1:n<.5?1:-1;let p=(e,t,n)=>e+(t-e)*n,m;m=n===null?f===1?0:1:n;let h=n===null?f===1?s:c:p(s,c,m),g=r===null?m:r,_=e?e.environmentIntensity??1:1,y=p(1,0,g),b=(e,t,n,r,i=null)=>({name:e,properties:[{prop:t,closedVal:n,openVal:r,axis:i}]}),x=[{name:`floor`,properties:[{prop:`envMapRotation`,axis:`x`,closedVal:1.91,openVal:2.07},{prop:`envMapIntensity`,closedVal:.15,openVal:1}]},b(`Object_0003_3`,`envMapIntensity`,.3,1),b(`Object_0003`,`envMapIntensity`,.2,.75),b(`Object_32`,`envMapIntensity`,.5,2.5),{name:`mjolnir_low_mjolnir_hammer_0`,properties:[{prop:`envMapIntensity`,closedVal:1,openVal:5},{prop:`metalness`,closedVal:.6,openVal:1},{prop:`roughness`,closedVal:.2,openVal:1}]},b(`aegis`,`envMapIntensity`,1,5),b(`Object_34001`,`envMapIntensity`,5,10),b(`Object_0003`,`envMapIntensity`,.5,3),b(`shelf`,`envMapIntensity`,.5,1.65),b(`Object_15`,`envMapIntensity`,3,20),b(`Object_15001`,`envMapIntensity`,.5,2),b(`Object_31`,`envMapIntensity`,1,5),b(`Object_0007`,`envMapIntensity`,.1,.8),b(`Object_108`,`envMapIntensity`,.6,1.2)];for(let e=1;e<=38;e++){let t=`book`+String(e).padStart(3,`0`);x.push(b(t,`envMapIntensity`,.5,20))}let S=new Map;x.forEach(t=>{let n=e.getObjectByName(t.name);n&&n.material&&t.properties.forEach(e=>{let r=`${t.name}-${e.prop}`,i=0;e.prop===`envMapRotation`?n.material.envMapRotation&&e.axis===`x`&&(i=n.material.envMapRotation.x):i=n.material[e.prop],S.set(r,i)})});let C={value:0};new v.Tween(C).to({value:1},i).easing(v.Easing.Back.InOut).delay(a).onUpdate(()=>{l.setNextKinematicTranslation({x:d+(h-d)*C.value,y:u.y,z:u.z}),e&&(e.environmentIntensity=p(_,y,C.value),x.forEach(t=>{let n=e.getObjectByName(t.name);if(!n||!n.material)return;let r=n.material;t.properties.forEach(e=>{let n=`${t.name}-${e.prop}`,i=p(S.get(n)??0,p(e.closedVal===void 0?0:e.closedVal,e.openVal===void 0?0:e.openVal,g),C.value);e.prop===`envMapRotation`?r.envMapRotation&&e.axis===`x`&&(r.envMapRotation.x=i):r[e.prop]=i})}))}).onComplete(()=>{o.slideDirection=f;let t=e.globalUniformsHub;if(t&&t.uniforms&&t.uniforms.uWaterIntensity){let e=f===-1?2:.1;new v.Tween(t.uniforms.uWaterIntensity).to({value:e},3e3).easing(v.Easing.Cubic.InOut).start()}}).start()}function Ba(e,t=!0){e.world.hasPointGravityOnBH=t,t&&(e.world.hasPointGravityOnBalls=!1),e.physicBodies.forEach(e=>{e.wakeUp()}),e.allowsResetting=!t}function Va(e,t){return Math.random()*(t-e)+e}function Ha(t,n){if(no)return;no=!0;let r=t.bulb;if(!r||!r.geometry||!r.geometry.isMorphGeo){Wa(t,null,1e3),ki(t,n),no=!1;return}let i=r.geometry,a=r.material,o=r.getObjectByName(`bulbAura`),s=o?o.material:null,c=a.uniforms.uTransformProgress,l=s?s.uniforms.uTransformProgress:null,u={value:0};a.uniforms.uTransformProgress=u,s&&(s.uniforms.uTransformProgress=u),i.setMorphInfo(0,2);let d=new e.Color(`#ffe0b2`),f=new e.Color(`#9cc1f2`),p=`#`+f.getHexString();if(t.bulbLight){let e=t.bulbLight.color;p=Math.abs(e.r-d.r)+Math.abs(e.g-d.g)+Math.abs(e.b-d.b)<.5?`#`+f.getHexString():`#`+d.getHexString()}a.visible=!0,o&&(o.visible=!0),Wa(t,`#ffe0b2`,400),new v.Tween(u).to({value:1},600).easing(v.Easing.Cubic.Out).onComplete(()=>{ki(t,n),setTimeout(()=>{new v.Tween(u).to({value:0},800).easing(v.Easing.Cubic.In).onComplete(()=>{if(a.visible=!0,o&&(o.visible=!0),i.setMorphInfo(0,1),a.uniforms.uTransformProgress=c,s&&l&&(s.uniforms.uTransformProgress=l),t.bulbLight){let e=t.bulbLight.color;a.uniforms.glowColor.value.setRGB(e.r,e.g,e.b)}Wa(t,p,600),no=!1}).start()},300)}).start()}function Ua(t,n,r,i=1e3,a={}){let{easing:o=v.Easing.Cubic.Out,onComplete:s=null,delay:c=0}=a,l=t.bulbLight;if(!l)return;l._activeParamTween&&=(l._activeParamTween.stop(),null);let u=l.intensity,d=l.angle,f={t:0};return l._activeParamTween=new v.Tween(f).to({t:1},i).delay(c).easing(o).onUpdate(()=>{l.intensity=e.MathUtils.lerp(u,n,f.t),l.angle=e.MathUtils.lerp(d,r,f.t)}).onComplete(()=>{l._activeParamTween=null,s&&s()}).start(),l._activeParamTween}function Wa(t,n=null,r=3e3){let i=new e.Color(`#ffe0b2`),a=new e.Color(`#9cc1f2`),o;if(n)o=new e.Color(n);else if(t.bulbLight){let e=t.bulbLight.color;o=Math.abs(e.r-i.r)+Math.abs(e.g-i.g)+Math.abs(e.b-i.b)<.5?a:i}else o=a;if(t.bulbLight&&new v.Tween(t.bulbLight.color).to({r:o.r,g:o.g,b:o.b},r).easing(v.Easing.Cubic.Out).start(),t.bulb&&t.bulb.material&&t.bulb.material.uniforms.glowColor){new v.Tween(t.bulb.material.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(v.Easing.Cubic.Out).start();let e=t.bulb.getObjectByName(`bulbAura`);e&&e.material&&e.material.uniforms.glowColor&&new v.Tween(e.material.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(v.Easing.Cubic.Out).start()}K&&K.uniforms&&(K.uniforms.glowColor&&new v.Tween(K.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(v.Easing.Cubic.Out).start(),K.uniforms.glowIntensity&&new v.Tween(K.uniforms.glowIntensity).to({value:1},r).easing(v.Easing.Cubic.Out).start()),ai&&ai.uniforms&&(ai.uniforms.glowColor&&new v.Tween(ai.uniforms.glowColor.value).to({r:o.r,g:o.g,b:o.b},r).easing(v.Easing.Cubic.Out).start(),ai.uniforms.outerGlowStrength&&new v.Tween(ai.uniforms.outerGlowStrength).to({value:1.5},r).easing(v.Easing.Cubic.Out).start())}function Ga(t,n){if(ro||!n)return;ro=!0;let r=t.bulbLight;r&&t._bulbBaseline===void 0&&(t._bulbBaseline={intensity:r.intensity,angle:r.angle});let i=r?r.color.clone():L.ELECTRIC_CYAN||62463,a=t.getObjectByName(`cFanBulb`)||n,o=new e.Vector3;a.getWorldPosition(o);let s=new e.IcosahedronGeometry(.3,1),c=ds(i);c.uniforms.uOpacity.value=.5,c.uniforms.uBrightness.value=3.5;let l=new e.Mesh(s,c);l.position.copy(o),t.add(l),new v.Tween(l.scale).to({x:3.5,y:3.5,z:3.5},800).easing(v.Easing.Quintic.Out).start();let u=performance.now(),d=e=>{l.parent&&(c.uniforms.iTime.value=(e-u)/1e3,l.rotation.y+=.05,l.rotation.z+=.03,requestAnimationFrame(d))};requestAnimationFrame(d),t.fanAction&&new v.Tween(t.fanAction).to({timeScale:65},800).easing(v.Easing.Exponential.In).start(),Z(`SYNCHRONIZING KINETIC VECTORS...`),r&&t._bulbBaseline&&Ua(t,1e4,.3,800,{easing:v.Easing.Exponential.In,onComplete:()=>{Ua(t,t._bulbBaseline.intensity,t._bulbBaseline.angle,400,{delay:800,easing:v.Easing.Cubic.Out})}}),setTimeout(()=>{ro=!1},2200),setTimeout(()=>{t.remove(l),s.dispose(),c.dispose();let n=Math.abs(o.y- -.55),r=new e.CylinderGeometry(1.5,1.5,n,32,1,!0);r.translate(0,-n/2,0);let a=ds(i);a.uniforms.uOpacity.value=.9,a.uniforms.uBrightness.value=5;let u=new e.Mesh(r,a);u.position.copy(o),t.add(u),u.scale.set(.1,1,.1),new v.Tween(u.scale).to({x:2.2,z:2.2},150).easing(v.Easing.Exponential.Out).onComplete(()=>{new v.Tween(a.uniforms.uOpacity).to({value:0},500).delay(300).start(),setTimeout(()=>{t.remove(u),r.dispose(),a.dispose()},800)}).start();let d=performance.now(),f=e=>{u.parent&&(a.uniforms.iTime.value=(e-d)/1e3,u.rotation.y+=.02,requestAnimationFrame(f))};requestAnimationFrame(f);let p=[];t.bhTargets&&p.push(...t.bhTargets),t.dragonBalls&&p.push(...t.dragonBalls),[...new Set(p)].forEach(t=>{if(!t||!t.rapierBody)return;let n=t.rapierBody,r=new e.Vector3;t.getWorldPosition(r);let i=new e.Vector3(o.x,r.y,o.z),a=new e.Vector3().subVectors(r,i),s=a.length();a.normalize(),a.y=1.35,a.normalize();let c=n.mass(),l=500*c/(Math.max(1,s)+.15);n.applyImpulse({x:a.x*l,y:a.y*l*1.6,z:a.z*l},!0);let u=150*c;n.applyTorqueImpulse({x:(Math.random()-.5)*u,y:(Math.random()-.5)*u,z:(Math.random()-.5)*u},!0)}),Z(`KINETIC DISCHARGE: STABLE`),typeof Ei==`function`&&Ei(t,!0),setTimeout(()=>{typeof Ei==`function`&&Ei(t,!1),t.fanAction&&new v.Tween(t.fanAction).to({timeScale:1},4e3).easing(v.Easing.Cubic.Out).start()},150)},800)}function Ka(e){let t=e.getObjectByName(`Lathe_Center`);return t?t.makeEye?t:(t.userData.initValues={rotation:t.rotation.clone(),scale:t.scale.clone(),nebulaCoreRadius:10,nebulaSwirlSpeed:.25},t.material&&t.material.uniforms&&t.material.uniforms.nebulaCoreRadius&&(t.userData.initValues.nebulaCoreRadius=t.material.uniforms.nebulaCoreRadius.value),e.globalUniformsHub&&e.globalUniformsHub.uNebulaSwirlSpeed&&(t.userData.initValues.nebulaSwirlSpeed=e.globalUniformsHub.uNebulaSwirlSpeed.value),t.makeEye=function(t){this.userData.eyeTweens&&this.userData.eyeTweens.forEach(e=>e.stop()),this.userData.eyeTweens=[];let n=new v.Tween(this.rotation).to({y:-.3},t).easing(v.Easing.Cubic.Out).start(),r=new v.Tween(this.scale).to({x:.675,y:1.5,z:.875},t).easing(v.Easing.Cubic.Out).start();if(this.userData.eyeTweens.push(n,r),this.material&&this.material.uniforms&&this.material.uniforms.nebulaCoreRadius){let e=new v.Tween(this.material.uniforms.nebulaCoreRadius).to({value:15},t).easing(v.Easing.Cubic.Out).start();this.userData.eyeTweens.push(e)}if(e.globalUniformsHub&&e.globalUniformsHub.uNebulaSwirlSpeed){let n=new v.Tween(e.globalUniformsHub.uNebulaSwirlSpeed).to({value:2},t).easing(v.Easing.Cubic.Out).start();this.userData.eyeTweens.push(n)}},t.stopEye=function(t){this.userData.eyeTweens&&this.userData.eyeTweens.forEach(e=>e.stop()),this.userData.eyeTweens=[];let n=this.userData.initValues,r=new v.Tween(this.rotation).to({x:n.rotation.x,y:n.rotation.y,z:n.rotation.z},t).easing(v.Easing.Cubic.Out).start(),i=new v.Tween(this.scale).to({x:n.scale.x,y:n.scale.y,z:n.scale.z},t).easing(v.Easing.Cubic.Out).start();if(this.userData.eyeTweens.push(r,i),this.material&&this.material.uniforms&&this.material.uniforms.nebulaCoreRadius){let e=new v.Tween(this.material.uniforms.nebulaCoreRadius).to({value:n.nebulaCoreRadius},t).easing(v.Easing.Cubic.Out).start();this.userData.eyeTweens.push(e)}if(e.globalUniformsHub&&e.globalUniformsHub.uNebulaSwirlSpeed){let r=new v.Tween(e.globalUniformsHub.uNebulaSwirlSpeed).to({value:n.nebulaSwirlSpeed},t).easing(v.Easing.Cubic.Out).start();this.userData.eyeTweens.push(r)}},t):null}function qa(e,t=3e3){let n=X(e,`wallArea`);if(!n||!n.material)return;let r=n.material.uniforms,i=Ka(e);n.userData.eyeTween&&(n.userData.eyeTween.stop(),n.userData.eyeTween=null),n.userData.latheEyeTweenObj&&(n.userData.latheEyeTweenObj.stop(),n.userData.latheEyeTweenObj=null),r&&r.uEyeActive&&(r.uEyeActive.value=!0),r&&r.uEyeOpenness&&(n.userData.eyeTween=new v.Tween(r.uEyeOpenness).to({value:1},t).easing(v.Easing.Cubic.Out).onStart(()=>{n.material.visible=!0}).start(),i&&i.makeEye(t))}function Ja(e,t=3e3){let n=X(e,`wallArea`);if(!n||!n.material)return;let r=n.material.uniforms,i=Ka(e);n.userData.eyeTween&&(n.userData.eyeTween.stop(),n.userData.eyeTween=null),n.userData.latheEyeTweenObj&&(n.userData.latheEyeTweenObj.stop(),n.userData.latheEyeTweenObj=null),r&&r.uEyeOpenness&&(n.userData.eyeTween=new v.Tween(r.uEyeOpenness).to({value:0},t).easing(v.Easing.Cubic.Out).onComplete(()=>{n.material.visible=!1,r&&r.uEyeActive&&(r.uEyeActive.value=!1)}).start(),i&&i.stopEye(t))}function Ya(t){if(t.isHeroAnimating)return;let n=t.getObjectByName(`a-char`),r=t.getObjectByName(`stool_bound`);if(!n||!r)return;let i=n.position.clone(),a=new e.Vector3,o=new e.Quaternion;r.getWorldPosition(a),r.getWorldQuaternion(o);let s=-9.81,c=R.SYS_SPELL_CHANNELING.en,l=R.SYS_SPELL_CAST.en,u=c[Math.floor(Math.random()*c.length)],d=l[Math.floor(Math.random()*l.length)],f=Er(t,`castSpell`,{autoReturn:!0,speed:.75,onComplete:()=>{t.world&&(t.world.gravity={x:0,y:s,z:0},console.log(`[Spell Ritual] Animation complete. Gravity restored to ${s}.`)),window._cvGravity=.6,window._cvState===`ritual`&&(window._cvState=`falling`),t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`0%`),t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=``);let c=1200;if(new v.Tween(n.position).to({x:i.x,y:i.y,z:i.z},c).easing(v.Easing.Cubic.InOut).onComplete(()=>{Er(t,`typing`,{crossFadeDuration:.5})}).start(),r.rapierBody){let n=r.rapierBody,i=n.translation(),s=n.rotation(),l={t:0};new v.Tween(l).to({t:1},c).easing(v.Easing.Cubic.Out).onUpdate(()=>{let t=new e.Vector3().lerpVectors(i,a,l.t),c=new e.Quaternion().copy(s).slerp(o,l.t);n.setTranslation(t,!0),n.setRotation(c,!0);let u=t.clone();r.parent&&r.parent.worldToLocal(u),r.position.copy(u)}).onComplete(()=>{n.setBodyType(b.RigidBodyType.Fixed),t.isHeroAnimating=!1}).start()}else t.isHeroAnimating=!1;setTimeout(()=>{t.allowsResetting=!0,console.log(`[Spell Ritual] Ritual fully finalized.`)},3e3)}});if(!f)return;t.allowsResetting=!1,t.isHeroAnimating=!0;let p=f.action,m=p.getClip();if(new v.Tween(n.position).to({x:1},800).easing(v.Easing.Cubic.Out).start(),r.rapierBody){r.rapierBody.setBodyType(b.RigidBodyType.KinematicPositionBased);let e=r.rapierBody.translation();new v.Tween(e).to({x:e.x+.5},800).easing(v.Easing.Cubic.Out).onUpdate(()=>{r.rapierBody.setNextKinematicTranslation(e)}).start()}let h=m.duration*.5/.75*1e3;t.world&&(t.world.gravity={x:0,y:0,z:0}),t.physicBodies&&t.physicBodies.forEach(e=>e.wakeUp()),window._cvState=`ritual`,window._cvGravity=0,typeof li==`function`&&li(),typeof fi==`function`&&fi(h);let g={value:0};new v.Tween(g).to({value:100},h).easing(v.Easing.Quadratic.In).onUpdate(()=>{let e=g.value/100*9;t.world&&(t.world.gravity={x:0,y:e,z:0});let n=-(g.value/100)*1.5;window._cvGravity=n,t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`${g.value}%`),t.cursorInformerText&&(t.cursorInformerText.textContent=`${u}... ${Math.floor(g.value)}%`),g.value>=100&&t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=`var(--c-cyan)`)}).onComplete(()=>{t.world&&(t.world.gravity={x:0,y:27,z:0}),window._cvGravity=-6,t.cursorInformerText&&(t.cursorInformerText.textContent=``),t.conversationManager&&t.conversationManager.shout(d,3e3),p.timeScale=1,console.log(`[Spell Ritual] Peak reached: ${d}. Elements pinned to ceiling.`)}).start()}function Xa(t,n){if(io||!n)return;io=!0,n.visible=!1;let r=n.position.clone(),i=r.y+3.5,a=n.rapierBody?n.rapierBody:null;a&&a.setBodyType(1);let o=new e.Group;o.position.copy(r),o.rotation.copy(n.rotation),t.add(o);let s=new e.IcosahedronGeometry(.35,1),c=new e.MeshStandardMaterial({color:`#00F3FF`,emissive:`#00F3FF`,emissiveIntensity:15,transparent:!0,opacity:0,wireframe:!0}),l=new e.Mesh(s,c);o.add(l);let u=[];[{pos:[0,0,.5],rot:[0,0,0],dir:[0,0,1]},{pos:[0,0,-.5],rot:[0,Math.PI,0],dir:[0,0,-1]},{pos:[0,.5,0],rot:[-Math.PI/2,0,0],dir:[0,1,0]},{pos:[0,-.5,0],rot:[Math.PI/2,0,0],dir:[0,-1,0]},{pos:[-.5,0,0],rot:[0,-Math.PI/2,0],dir:[-1,0,0]},{pos:[.5,0,0],rot:[0,Math.PI/2,0],dir:[1,0,0]}].forEach(t=>{let n=ds(`#00F3FF`,0),r=new e.Mesh(new e.PlaneGeometry(.98,.98),n);r.position.set(...t.pos),r.rotation.set(...t.rot),r.userData.dir=new e.Vector3(...t.dir),o.add(r),u.push(r)}),typeof qa==`function`&&(qa(t,800),Z(`SECTOR_7_BREACH: SYNCHRONIZING_CORE`));let d={y:r.y,opacity:0};new v.Tween(d).to({y:i,opacity:1},450).easing(v.Easing.Back.Out).onUpdate(()=>{o.position.y=d.y,o.rotation.y+=.08,u.forEach(e=>{e.material.uniforms?.uOpacity?e.material.uniforms.uOpacity.value=d.opacity:e.material.opacity=d.opacity}),a&&a.setTranslation({x:o.position.x,y:o.position.y,z:o.position.z},!0)}).onComplete(()=>{setTimeout(()=>{let r={unfold:0,corePulse:.1};c.opacity=1,l.scale.setScalar(.1),new v.Tween(r).to({unfold:2.2,corePulse:1.6},1e3).easing(v.Easing.Elastic.Out).onUpdate(()=>{u.forEach(e=>{let t=r.unfold,n=e.userData.dir.clone().multiplyScalar(.5+t);e.position.copy(n),e.material.uniforms?.uOpacity&&(e.material.uniforms.uOpacity.value=.7+Math.random()*.3)}),l.scale.setScalar(r.corePulse+Math.sin(performance.now()*.015)*.15),l.rotation.y+=.07,l.rotation.z+=.04,o.rotation.y+=.01}).onComplete(()=>{Z(`CORE_DECRYPTED: REWARD_STREAM_ACTIVE`);let i=Math.floor(Math.random()*5)+6;for(let n=0;n<i;n++){let n={x:(Math.random()-.5)*15,y:12+Math.random()*8,z:(Math.random()-.5)*15};Fi(t,o.position.clone().add(new e.Vector3(0,.5,0)),n)}new v.Tween(r).to({unfold:0,corePulse:.1},600).easing(v.Easing.Back.In).delay(1200).onUpdate(()=>{u.forEach(e=>{e.position.copy(e.userData.dir.clone().multiplyScalar(.5+r.unfold)),e.material.uniforms?.uOpacity&&(e.material.uniforms.uOpacity.value=.5+r.unfold*.5)}),l.scale.setScalar(Math.max(.01,r.corePulse)),c.opacity=Math.max(0,r.corePulse),o.rotation.z+=.05}).onComplete(()=>{t.remove(o),n.visible=!0,n.position.copy(o.position),n.rotation.copy(o.rotation),a&&(a.setTranslation({x:o.position.x,y:o.position.y,z:o.position.z},!0),a.setRotation({x:n.quaternion.x,y:n.quaternion.y,z:n.quaternion.z,w:n.quaternion.w},!0),a.setBodyType(0),a.applyImpulse({x:0,y:-2,z:0},!0)),io=!1,Z(`SYSTEM_STABLE: CORE_REINTEGRATED`),typeof Ja==`function`&&Ja(t,1e3)}).start()}).start()},250)}).start()}var Za,Qa,$a,J,Y,eo,to,no,ro,io,ao=M((()=>{jn(),Ve(),xn(),Vn(),nr(),ks(),ea(),Dr(),Di(),ci(),mi(),ls(),ke(),Ns(),we(),De(),Na(),gs(),Za=[`floor`,`backWall_rapier`,`rightWall`],Qa=[],$a=(e,t)=>{document.body.style.cursor=`pointer`,wn(e,t),e.gazeFollower&&e.gazeFollower.lookAtTarget(t)},J=e=>{document.body.style.cursor=`auto`,En(e),e.gazeFollower&&e.gazeFollower.lookAtTarget(e.camera)},Y=(e,t,n,r=null)=>{r||=Math.random()*1+2.5,Dn(e,t,n,r)},eo=(t,n,r)=>{let i=n.get(`pokeball`),a=n.get(`pokeball2`),o=n.get(`pokeball3`),s=n.get(`catBlack`),c=n.get(`blackCat`),l=n.get(`catWhite`);n.get(`Object_108`),n.get(`drone`);let u=null,d=0,f=[],p=!1,m=null,h=null,g=null,_=null,y=null,b=(t,n,r)=>{if(console.log(`[Dragon Fortune] Triggered Blessing ritual.`),p){Z(z(`SYS_STORY_VOID_EXHAUSTED`));return}p=!0,Z(z(`SYS_STORY_VOID_RAIN`)),Pi(t);let i=t.globalUniformsHub,a=1;i&&i.uStormSharpness&&(a=i.uStormSharpness.value,new v.Tween(i.uStormSharpness).to({value:0},1500).easing(v.Easing.Cubic.Out).start());let o=t.bulbLight;o&&(t._bulbBaseline===void 0&&(t._bulbBaseline={intensity:o.intensity,angle:o.angle}),Ua(t,t._bulbBaseline.intensity*.04,t._bulbBaseline.angle,1500));let s=t.getObjectByName(`a-char`),c=new e.Vector3;s?s.getWorldPosition(c):c.set(0,1,0),c.y+=.8;for(let s=0;s<54;s++){let l=r&&r.point?r.point.clone():n.position.clone();l.add(new e.Vector3((Math.random()-.5)*.3,(Math.random()-.5)*.3,(Math.random()-.5)*.3));let u=new e.Vector3().subVectors(c,l).normalize();u.x+=(Math.random()-.5)*.15,u.z+=(Math.random()-.5)*.15,u.normalize();let d=28+Math.random()*12,f=u.multiplyScalar(d);f.y=Math.max(f.y,0)+(15+Math.random()*8),setTimeout(()=>{requestAnimationFrame(()=>{Fi(t,l,f,s<53),s===53&&(i&&i.uStormSharpness&&new v.Tween(i.uStormSharpness).to({value:a},2e3).easing(v.Easing.Cubic.InOut).start(),o&&t._bulbBaseline&&Ua(t,t._bulbBaseline.intensity,t._bulbBaseline.angle,2e3,{easing:v.Easing.Cubic.InOut}),setTimeout(()=>{p=!1},1e3))})},s*60)}},x=()=>{u&&cancelAnimationFrame(u),d=performance.now();let e=3e3,n=0,r={value:0};g=new v.Tween(r).to({value:100},e).onUpdate(()=>{t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`${r.value}%`),r.value>=100&&t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=`var(--c-cyan)`)}).onComplete(()=>{g=null}).start();let i=r=>{let a=r-d,o=Math.min(a/e,1),s=Math.max(0,3-Math.floor(a/1e3));if(s>0){let e=a%1e3/1e3,n=`.`;e>.33&&(n=`..`),e>.66&&(n=`...`),t.cursorInformerText&&(t.cursorInformerText.textContent=`Gravity Well in ${s}${n} `)}else if(o>=1){t.cursorInformerText&&(t.cursorInformerText.textContent=`Nom Nom Nom`),Ba(t,!0);let e=t.raycasterWrapper?t.raycasterWrapper.pointer.y:0;typeof di==`function`&&di(-e),u=null;return}let c=1+o*o*20;n+=c,t.cursorInformerIcon&&(t.cursorInformerIcon.style.transform=`rotate(${n}deg)`),u=requestAnimationFrame(i)};u=requestAnimationFrame(i)},S=()=>{u&&=(cancelAnimationFrame(u),null),g&&=(g.stop(),null),t.cursorInformerProgressBar&&(t.cursorInformerProgressBar.style.height=`0%`),t.cursorInformerBox&&(t.cursorInformerBox.style.backgroundColor=``)},C=()=>{t.cursorInformerIcon&&(t.cursorInformerIcon.style.transform=`rotate(0deg)`)},w=0,T=()=>{let e=performance.now();e-w<500||(w=e,S(),t.cursorInformerText&&(t.cursorInformerText.textContent=`Gravity Well ACTIVE`),hi(t,5e3,`pc`),Ba(t,!0),di(-(t.raycasterWrapper?t.raycasterWrapper.pointer.y:0)))},E=()=>{t.pokeballGridUniforms&&(t.pokeballGridUniforms.uWorldGridActive.value=1,t.pokeballGridUniforms.uWorldGridProgress.value=0,new v.Tween(t.pokeballGridUniforms.uWorldGridProgress).to({value:1},600).easing(v.Easing.Quadratic.Out).onComplete(()=>{setTimeout(()=>{new v.Tween(t.pokeballGridUniforms.uWorldGridProgress).to({value:0},500).onComplete(()=>{t.pokeballGridUniforms.uWorldGridActive.value=0}).start()},500)}).start())},D=e=>{let t=X(e,`a-char`);if(!t||e.isHeroAnimating)return;e.isHeroAnimating=!0,e.allowsResetting=!1;let n=X(e,`stool_bound`);t.userData.originalPosX===void 0&&(t.userData.originalPosX=t.position.x);let r=n?.rapierBody,i=n?.userData.originalTranslation;if(r&&!i){let e=r.translation();n.userData.originalTranslation={x:e.x,y:e.y,z:e.z},i=n.userData.originalTranslation}if(r&&i){let e={x:i.x};new v.Tween(e).to({x:.52},200).easing(v.Easing.Quadratic.Out).onUpdate(()=>r.setNextKinematicTranslation({x:e.x,y:i.y,z:i.z})).start()}new v.Tween(t.position).to({x:.4},200).easing(v.Easing.Quadratic.Out).onComplete(()=>{Er(e,`sitToStand`,{autoReturn:!1,onComplete:()=>{if(new v.Tween(t.position).to({x:t.userData.originalPosX},300).easing(v.Easing.Quadratic.InOut).onComplete(()=>{e.isHeroAnimating=!1,e.allowsResetting=!0}).start(),r&&i){let e={x:.52};new v.Tween(e).to({x:i.x},300).easing(v.Easing.Quadratic.InOut).onUpdate(()=>r.setNextKinematicTranslation({x:e.x,y:i.y,z:i.z})).start()}Er(e,`typing`,{crossFadeDuration:.2})}});let n=Q.currentMode===I.POBA?R.SHOUT_STRETCH_LEG_POBA.en:R.SHOUT_STRETCH_LEG_DEV.en;e.conversationManager?.shout(n[Math.floor(Math.random()*n.length)])}).start()},O=(e,t)=>{let r=X(e,`a-char`),i=e.isHeroAnimating||e.allowsResetting===!1;if(y&&=(clearTimeout(y),null),e.heroMenuInterval&&=(clearInterval(e.heroMenuInterval),null),t&&!i){let t=[{label:`DANCE`,icon:Jn,action:()=>pa(e)},{label:`STRETCH`,icon:Yn,action:()=>D(e)},{label:`GOLF`,icon:Jn,action:()=>da(e)},{label:`SPELL`,icon:Un,action:()=>Ya(e)}];e.heroMenuIndex===void 0&&(e.heroMenuIndex=0);let r=()=>{let n=t[e.heroMenuIndex],r=t.map((t,n)=>`<span style="${n===e.heroMenuIndex?`background: var(--c-cyan); color: var(--c-black); padding: 2px 8px; font-weight: 800; border-radius: 2px; text-shadow: none; box-shadow: 0 0 10px var(--c-cyan);`:`opacity: 0.6; padding: 2px 8px;`}">${t.label}</span>`).join(` `);U(e,n.icon,`<div style="display: flex; gap: 4px; align-items: center; font-family: 'Rajdhani', sans-serif; font-size: 13px; letter-spacing: 1px;">${r}</div>`)};r(),e.heroMenuInterval=setInterval(()=>{e.heroMenuIndex=(e.heroMenuIndex+1)%t.length,r()},800);let i=n.get(`hero_hitbox`);if(e.raycastObjects&&f.length===0&&i&&(f=[...e.raycastObjects],e.raycastObjects=[i],e.world&&(e._originalBallGravity=e.world.hasPointGravityOnBalls,e.world.hasPointGravityOnBalls=!1)),e.conversationManager&&!e._hasShoutedHeroMenu){let t=R.UI_HERO_MENU_ENCOURAGEMENT.en,n=t[Math.floor(Math.random()*t.length)];e.conversationManager.shout(n,1e4,{small:!0}),e._hasShoutedHeroMenu=!0}}else{if(r){let t=X(e,`Ch23_Suit`);t?.material&&t.userData.originalToneMapped!==void 0&&(t.material.toneMapped=t.userData.originalToneMapped)}e.conversationManager&&e.conversationManager.hide(),e._hasShoutedHeroMenu=!1,W(e),f.length>0&&(e.raycastObjects=[...f],f=[],e.world&&e._originalBallGravity!==void 0&&(e.world.hasPointGravityOnBalls=e._originalBallGravity,delete e._originalBallGravity))}},k=(e,t,n,r=!0)=>{if(t)if(e.monitorMenuInterval&&=(clearInterval(e.monitorMenuInterval),null),r&&n){t.userData.menuIndex===void 0&&(t.userData.menuIndex=0);let r=()=>{n[t.userData.menuIndex];let r=n.map((e,n)=>`<span style="${n===t.userData.menuIndex?`background: var(--c-cyan); color: var(--c-black); padding: 2px 8px; font-weight: 800; border-radius: 2px; text-shadow: none; box-shadow: 0 0 10px var(--c-cyan);`:`opacity: 0.6; padding: 2px 8px;`}">${e.label}</span>`).join(` `);U(e,tr,`<div style="display: flex; gap: 4px; align-items: center; font-family: 'Rajdhani', sans-serif; font-size: 11px; letter-spacing: 1px;">${r}</div>`)};r(),e.monitorMenuInterval=setInterval(()=>{t.userData.menuIndex=(t.userData.menuIndex+1)%n.length,r()},800)}else W(e)},A=(e,t,n,r=!0)=>{if(t)if(e.wallMenuInterval&&=(clearInterval(e.wallMenuInterval),null),r&&n){t.userData.menuIndex===void 0&&(t.userData.menuIndex=0);let r=()=>{n[t.userData.menuIndex];let r=n.map((e,n)=>`<span style="${n===t.userData.menuIndex?`background: var(--c-cyan); color: var(--c-black); padding: 2px 8px; font-weight: 800; border-radius: 2px; text-shadow: none; box-shadow: 0 0 10px var(--c-cyan);`:`opacity: 0.6; padding: 2px 8px;`}">${e.label}</span>`).join(` `);U(e,Zn,`<div style="display: flex; gap: 4px; align-items: center; font-family: 'Rajdhani', sans-serif; font-size: 13px; letter-spacing: 1px;">${r}</div>`)};r(),e.wallMenuInterval=setInterval(()=>{t.userData.menuIndex=(t.userData.menuIndex+1)%n.length,r()},1e3)}else W(e)};return{hero_hitbox:{onMouseEnter:e=>{try{document.body.style.cursor=`pointer`,t.isHeroAnimating||t.allowsResetting,t.raycasterWrapper?.mouseInContainer,O(t,!0)}catch(e){console.error(`Error in hero_hitbox onMouseEnter:`,e)}},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t),O(t,!1)},onMouseDown:()=>{if(t.isHeroAnimating||t.allowsResetting===!1)return;let e=[()=>pa(t),()=>D(t),()=>da(t),()=>Ya(t)][t.heroMenuIndex||0];e&&(W(t),e())}},catBlack:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&U(t,Yn,e.userData.assignedRole||`MAX - TECH LEAD`),Tn(t,e,kn),c&&Tn(t,c,kn),s&&!s.userData.hasShoutedHover&&(_&&clearTimeout(_),_=setTimeout(()=>{t.conversationManager?.shout(R.SHOUT_CAT_BLACK_HOVER.en[0]),s.userData.hasShoutedHover=!0,_=null},400)))},onMouseLeave:e=>{_&&=(clearTimeout(_),null),document.body.style.cursor=`auto`,J(t),W(t)},onMouseDown:(e,n)=>{if(Y(t,e,n),i&&r){let n=[s];c&&n.push(c),Ia(t,i,n,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}s.userData.hasShoutedClick||(t.conversationManager?.shout(R.SHOUT_CAT_BLACK_CLICK.en[0],4e3,{extraSmall:!0}),s.userData.hasShoutedClick=!0)}},catWhite:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,Tn(t,e,kn),t.raycasterWrapper?.mouseInContainer&&U(t,Yn,e.userData.assignedRole||`MIN - QA ENGINEER`),l&&!l.userData.hasShoutedHover&&(_&&clearTimeout(_),_=setTimeout(()=>{t.conversationManager?.shout(R.SHOUT_CAT_WHITE_HOVER.en[0]),l.userData.hasShoutedHover=!0,_=null},400)))},onMouseLeave:e=>{_&&=(clearTimeout(_),null),document.body.style.cursor=`auto`,J(t),W(t)},onMouseDown:(e,n)=>{Y(t,e,n),i&&r&&Ia(t,i,l,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},pokeball:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,En(t),Tn(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;Y(t,e,n),E();let a=[l,s].filter(e=>e&&e.visible);a.length>0&&Ia(t,i,a,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},pokeball2:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,En(t),Tn(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;Y(t,e,n),E();let i=[l,s].filter(e=>e&&e.visible);i.length>0&&Ia(t,a,i,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},pokeball3:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,En(t),Tn(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;Y(t,e,n),E();let i=[l,s].filter(e=>e&&e.visible);i.length>0&&Ia(t,o,i,r.gravityCenter,r.tgtPos,r.tgtQuat,e)}},Object_2001:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&U(t,Jn,z(`UI_INFORMER_CHAIR`)),$a(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t),J(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&Y(t,e,n)}},Lathe_Center:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&t.integrityBaselineCaptured&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&U(t,Kn,z(`UI_INFORMER_BLACKHOLE`)),t.raycastObjects&&f.length===0&&(f=[...t.raycastObjects],t.raycastObjects=[e]),x())},onMouseLeave:()=>{if(document.body.style.cursor=`auto`,!t.integrityBaselineCaptured)return;S(),C(),f.length>0&&(t.raycastObjects=[...f],f=[]);let e=n.get(`Object_2001`);e&&e.rapierBody.sleep(),Ba(t,!1),W(t),window._cvState===`sucking`&&li()},onMouseDown:()=>{t.raycasterEnabled!==!1&&t.integrityBaselineCaptured&&T()},onMouseHover:()=>{On(t)}},planeSky:{onMouseEnter:()=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&U(t,Un,z(`UI_INFORMER_SKY`)))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t)},onMouseDown:(n,r)=>{if(t.raycasterEnabled===!1)return;let i=r.point.clone(),a=n.worldToLocal(i),o=new e.Vector2(2*a.x,2*a.y),s=t.globalUniformsHub;Nn({scene:t,constantUniform:s?s.uniforms:null,windowLight:t.windowLight},2,o,!1)}},glassInvi:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,U(t,Wn,z(`UI_INFORMER_DOOR`)),$a(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t),J(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&(e.userData.hasClickedOnce?za(t):(za(t,{forcedX:0}),e.userData.hasClickedOnce=!0))}},lamp:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,U(t,Qn,z(`UI_INFORMER_LAMP`)),$a(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t),J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;let r=n.point.clone();e.worldToLocal(r).y>.1?In(t):Y(t,e,n)}},computer:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,U(t,tr,z(`UI_INFORMER_SCREEN`)),$a(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t),J(t)},onMouseDown:(e,r)=>{if(t.raycasterEnabled===!1)return;Pa(t,Q.currentMode,n),t.conversationManager?.shout(`PERSONNEL ROLES REASSIGNED`);let i=t.globalUniformsHub;Ln({constantUniform:i?i.uniforms:null,windowLight:t.windowLight},.96,null,!1)}},questionCube:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,t.raycasterWrapper?.mouseInContainer&&U(t,Jn,z(`UI_INFORMER_CUBE`)),$a(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t),J(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&(console.log(`[Raycast] questionCube clicked! Triggering ritual.`,e.name),Xa(t,e))}},mjolnir_low_mjolnir_hammer_0:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,U(t,Un,z(`UI_INFORMER_MJOLNIR`)),$a(t,e))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t),J(t)},onMouseDown:(e,n)=>{if(t.raycasterEnabled===!1)return;let r=t.globalUniformsHub;Y(t,e,n,8),Nn({scene:t,constantUniform:r?r.uniforms:null,windowLight:t.windowLight},.96,null,!1)}},cFanBulb:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,U(t,Gn,z(`UI_INFORMER_BULB`)))},onMouseLeave:()=>{document.body.style.cursor=`auto`,W(t)},onMouseDown:(e,n)=>{t.raycasterEnabled!==!1&&Ha(t,e)},onMouseHover:()=>{}},cFanBody:{onMouseEnter:e=>{document.body.style.cursor=`pointer`;let n=z(`UI_INFORMER_FAN_BODY`)||`BOOST & BLAST`;U(t,Gn,n),$a(t,e)},onMouseLeave:()=>{W(t),J(t)},onMouseDown:(e,n)=>{Ga(t,e)},onMouseHover:()=>{}},wallArea:{onMouseEnter:e=>{if(t.raycasterEnabled===!1)return;document.body.style.cursor=`pointer`,m&&=(clearTimeout(m),null),qa(t);let n=t.objectMap?t.objectMap.get(`wallArea`):null;t.gazeFollower&&t.gazeFollower.lookAtTarget(n),A(t,e,[{label:`BLESSING`,action:()=>b(t,e)},{label:`WRATH`,action:()=>{let e=t.getObjectByName(`cFanBody`)||(t.objectMap?t.objectMap.get(`cFanBody`):null);e&&Ga(t,e)}}],!0)},onMouseLeave:e=>{document.body.style.cursor=`auto`,t.gazeFollower&&t.gazeFollower.lookAtTarget(t.camera),m=setTimeout(()=>{Ja(t)},4e3),A(t,e,null,!1)},onMouseDown:(e,n)=>{let r=[{label:`BLESSING`,action:()=>b(t,e,n)},{label:`WRATH`,action:()=>{let e=t.getObjectByName(`cFanBody`)||(t.objectMap?t.objectMap.get(`cFanBody`):null);e&&Ga(t,e)}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action()},onMouseHover:()=>{}},shelf:{},caseCover:{onMouseEnter:e=>{if(t.raycasterEnabled===!1)return;document.body.style.cursor=`pointer`,U(t,tr,z(`UI_INFORMER_REBOOT`)),$a(t,e),h&&h.stop();let n=t.globalUniformsHub;!n||!n.uFireHeightOverride||(n.uFireHeightOverride.value<.01&&(n.uFireHeightOverride.value=2.5),h=new v.Tween(n.uFireHeightOverride).to({value:6},4e3).easing(v.Easing.Cubic.Out).start())},onMouseLeave:()=>{W(t),J(t);let e=t.globalUniformsHub;!e||!e.uFireHeightOverride||(h=new v.Tween(e.uFireHeightOverride).to({value:0},1e3).easing(v.Easing.Cubic.In).onComplete(()=>{e.uFireHeightOverride&&(e.uFireHeightOverride.value=0)}).start())},onMouseDown:(e,n)=>{h&&h.stop();let r=t.globalUniformsHub;r&&r.uFireHeightOverride&&(r.uFireHeightOverride.value=0),Y(t,e,n),gi(t,4500),[`screenDisplay001`,`screenDisplay002`,`verticalMonitorDisplay`].forEach(e=>{let n=t.objectMap.get(e);n&&(n.material=G,n.userData.originalMaterial=G)})}},droneRC:{onMouseEnter:()=>{document.body.style.cursor=`pointer`;let n=t.getObjectByName(`drone`);n&&(n.userData.isHovering=!0,Go(t,new e.Vector3(0,-.76,.5).unproject(t.camera),!0))},onMouseLeave:()=>{document.body.style.cursor=`auto`;let e=t.getObjectByName(`drone`);if(e){e.userData.isHovering=!1;let n=t.getObjectByName(`drone-beam`);!(n&&n.visible)&&t.gazeFollower&&(t.gazeFollower.isLocked=!1,Go(t,t.camera,!1))}},onMouseDown:e=>{let n=Q.currentMode===I.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`,r=R[n]?.en||[],i;if(r.length>1){let t=r.filter(t=>t!==e.userData.lastSubtitle);i=t[Math.floor(Math.random()*t.length)]}else i=z(n);e.userData.lastSubtitle=i,ys(i),Ko(t,i)}},Object_34001:{onMouseEnter:e=>{document.body.style.cursor=`pointer`,k(t,e,[{label:`FIREWKS`,action:()=>{e.material=Zr,e.userData.originalMaterial=Zr}},{label:`MOON`,action:()=>{e.material=Qr,e.userData.originalMaterial=Qr}},{label:`SUNSET`,action:()=>{e.material=$r,e.userData.originalMaterial=$r}},{label:`NETFLIX`,action:()=>{e.material=ei,e.userData.originalMaterial=ei,t.globalUniformsHub?.uniforms.iTime&&(ei.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[ri,ii],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}],!0)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1)},onMouseDown:(e,n)=>{let r=[{label:`FIREWKS`,action:()=>{e.material=Zr,e.userData.originalMaterial=Zr}},{label:`MOON`,action:()=>{e.material=Qr,e.userData.originalMaterial=Qr}},{label:`SUNSET`,action:()=>{e.material=$r,e.userData.originalMaterial=$r}},{label:`NETFLIX`,action:()=>{e.material=ei,e.userData.originalMaterial=ei,t.globalUniformsHub?.uniforms.iTime&&(ei.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[ri,ii],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,Y(t,t.objectMap.get(`Object_31`),n,4),k(t,e,r)}},screenDisplay001:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,k(t,e,[{label:`CODE`,action:()=>{e.material=G,e.userData.originalMaterial=G,typeof window.cvReset==`function`&&window.cvReset(1500)}},{label:`NETFLIX`,action:()=>{e.material=ti,e.userData.originalMaterial=ti,li(),t.globalUniformsHub?.uniforms.iTime&&(ti.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[ri,ii],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n,li()}}],!0),G.uniforms.uHoverActive&&(G.uniforms.uHoverActive.value=1))},onMouseHover:(e,t)=>{if(!G.uniforms.uHoverActive)return;let n=t.uv,r=.045;1-r;let i=(n.x-r)/.955-.5,a=.035;.8999999999999999-a;let o=(n.y-a)/.8649999999999999;G.uniforms.uTargetHoverPos.value.set(i,o)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1),G.uniforms.uHoverActive&&(G.uniforms.uHoverActive.value=0)},onMouseDown:(e,n)=>{let r=[{label:`CODE`,action:()=>{e.material=G,e.userData.originalMaterial=G,typeof window.cvReset==`function`&&window.cvReset(1500)}},{label:`NETFLIX`,action:()=>{e.material=ti,e.userData.originalMaterial=ti,li(),t.globalUniformsHub?.uniforms.iTime&&(ti.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[ri,ii],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n,li()}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,Y(t,t.objectMap.get(`screenDisplay`),n,4),k(t,e,r)}},verticalMonitorDisplay:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,k(t,e,[{label:`SPLIT`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(0),t.needsUpdate=!0)}},{label:`FULL`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(1),t.needsUpdate=!0)}}],!0),G.uniforms.uHoverActive&&(G.uniforms.uHoverActive.value=1))},onMouseHover:(e,t)=>{if(!G.uniforms.uHoverActive)return;let n=t.uv,r=.045;1-r;let i=(n.x-r)/.955,a=.035;.8999999999999999-a;let o=(n.y-a)/.8649999999999999;G.uniforms.uTargetHoverPos.value.set(i,o)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1),G.uniforms.uHoverActive&&(G.uniforms.uHoverActive.value=0)},onMouseDown:(e,n)=>{let r=[{label:`SPLIT`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(0),t.needsUpdate=!0)}},{label:`FULL`,action:()=>{let t=e.geometry.attributes.aLayoutMode;t&&(t.array.fill(1),t.needsUpdate=!0)}}];if(e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,n.uv&&G.uniforms.uClickPos){let e=n.uv,r=.045;1-r;let i=(e.x-r)/.955,a=.035;.8999999999999999-a;let o=(e.y-a)/.8649999999999999;G.uniforms.uClickPos.value.set(i,o),t.globalUniformsHub?.uniforms.iTime&&(G.uniforms.uClickTime.value=t.globalUniformsHub.uniforms.iTime.value)}Y(t,t.objectMap.get(`verticalMonitor`),n,4),k(t,e,r)}},screenDisplay002:{onMouseEnter:e=>{t.raycasterEnabled!==!1&&(document.body.style.cursor=`pointer`,k(t,e,[{label:`CODE`,action:()=>{e.material=G,e.userData.originalMaterial=G}},{label:`NETFLIX`,action:()=>{e.material=ti,e.userData.originalMaterial=ti,t.globalUniformsHub?.uniforms.iTime&&(ti.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[ri,ii],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}],!0),G.uniforms.uHoverActive&&(G.uniforms.uHoverActive.value=1))},onMouseHover:(e,t)=>{if(!G.uniforms.uHoverActive)return;let n=t.uv,r=.045;1-r;let i=.54+(n.x-r)/.955,a=.035;.8999999999999999-a;let o=(n.y-a)/.8649999999999999;G.uniforms.uTargetHoverPos.value.set(i,o)},onMouseLeave:e=>{document.body.style.cursor=`auto`,k(t,e,null,!1),G.uniforms.uHoverActive&&(G.uniforms.uHoverActive.value=0)},onMouseDown:(e,n)=>{let r=[{label:`CODE`,action:()=>{e.material=G,e.userData.originalMaterial=G}},{label:`NETFLIX`,action:()=>{e.material=ti,e.userData.originalMaterial=ti,t.globalUniformsHub?.uniforms.iTime&&(ti.uniforms.uNetflixStartTime.value=t.globalUniformsHub.uniforms.iTime.value)}},{label:`DOTA`,action:()=>{let t=[ri,ii],n=t[Math.floor(Math.random()*t.length)];e.material=n,e.userData.originalMaterial=n}}];e.userData.menuIndex===void 0&&(e.userData.menuIndex=0),r[e.userData.menuIndex].action(),e.userData.menuIndex=(e.userData.menuIndex+1)%r.length,Y(t,t.objectMap.get(`screenDisplay2`),n,4),k(t,e,r)}},aegis:{onMouseEnter:e=>{$a(t,e),U(t,tr,z(`UI_INFORMER_AEGIS`)),hs(t,e)},onMouseLeave:e=>{J(t),W(t),ms(t)},onMouseDown:(e,n)=>{let r=t.objectMap.get(`screenDisplay001`),i=t.objectMap.get(`Object_34001`),a=[{screen:r,pool:[ri,ii]},{screen:i,pool:[ri,ii]}],o=a[Math.floor(Math.random()*a.length)];if(o.screen&&o.pool.length>0){let e=o.pool[Math.floor(Math.random()*o.pool.length)];o.screen.material=e,o.screen.userData.originalMaterial=e,Z(z(`SYS_STORY_DOTA_LIFE`))}Y(t,e,n)}},aegis2:{onMouseEnter:e=>{$a(t,e),U(t,tr,z(`UI_INFORMER_AEGIS`)),hs(t,e)},onMouseLeave:e=>{J(t),W(t),ms(t)},onMouseDown:(e,n)=>{let r=t.objectMap.get(`screenDisplay001`),i=t.objectMap.get(`Object_34001`),a=[{screen:r,pool:[ri,ii]},{screen:i,pool:[ri,ii]}],o=a[Math.floor(Math.random()*a.length)];if(o.screen&&o.pool.length>0){let e=o.pool[Math.floor(Math.random()*o.pool.length)];o.screen.material=e,o.screen.userData.originalMaterial=e,Z(`PICK ME!!`)}Y(t,e,n)}}}},to=e=>{W(e),document.body.style.cursor=`auto`},no=!1,ro=!1,io=!1}));function oo(e){return function(t){let n=e*1.525;return(t*=2)<1?.5*(t*t*((n+1)*t-n)):.5*((t-=2)*t*((n+1)*t+n)+2)}}function so(e){return function(t){let n=e;return--t*t*((n+1)*t+n)+1}}var co,lo,uo=M((()=>{co=oo(.4),lo=so(.04)})),fo,po=M((()=>{fo={isUnlocked:!0,init:e=>{let t=e.HUD;!t||!t.navButtons||t.navButtons.forEach(e=>{e.hide(0),e.setActive(!1)})},onHudOpen:e=>{let t=e.HUD;if(!t||!t.navButtons)return;t.navButtons.forEach((e,t)=>{t!==0&&e.hide(0)});let n=t.navButtons[0];n.show(1200,1),n.setActive(!1)},onMorphToAbout:e=>{let t=e.HUD;if(!t||!t.navButtons)return;let n=1e3,r=t.navButtons[3];r.setText(`ABOUT`),r.show(n,2),r.setActive(!0),setTimeout(()=>{let e=t.navButtons[2];e.setText(`LAB`),e.show(n,1.8),e.setActive(!1)},150),setTimeout(()=>{let e=t.navButtons[1];e.setText(`WORK`),e.show(n,2.2),e.setActive(!1)},300)},onRoomAssemble:e=>{let t=e.HUD;if(!t||!t.navButtons)return;fo.isUnlocked=!0,t.navButtons[0].show(1500,1);let n=t.navButtons[2];n.setText(`LAB`),n.show(1500,1.8),n.setActive(!0);let r=t.navButtons[1];r.setText(`WORK`),r.show(1500,2.2),r.setActive(!1);let i=t.navButtons[3];i.setText(`ABOUT`),i.show(1500,2),i.setActive(!1)}}}));function mo(e){if(!e||!e.renderer)return;let t=(window.devicePixelRatio||1)*.2,n=e.renderer.getPixelRatio();Math.abs(n-t)>.01&&(e.renderer.setPixelRatio(t),e.pointsApp&&typeof e.pointsApp.onWindowResize==`function`&&e.pointsApp.onWindowResize())}async function ho(e,t,n,r=800){if(!e||!e.renderer)return;let i=window.devicePixelRatio||1,a=[.35,.5,n];for(let n of a)n<=t||(await No(r),e.renderer&&(e.renderer.setPixelRatio(i*n),e.pointsApp&&typeof e.pointsApp.onWindowResize==`function`&&e.pointsApp.onWindowResize()))}async function go(e,t=800,n=!1){performance.now(),e.isTransitioning=!0,e.HUD&&typeof e.HUD.stopBreathing==`function`&&e.HUD.stopBreathing(),e.renderer&&(e.renderer.shadowMap.autoUpdate=!1,mo(e));let r=X(e,`roomGLBModel`);r&&(r.visible=!0,r.scale.set(1,1,1),r.position.set(0,0,0),e.physicObjects&&e.physicObjects.forEach(e=>{e.visible=!0}),[`rightWall-cover`,`floor`,`planeSky`].forEach(t=>{let n=X(e,t);n&&(n.visible=!0)}));let i=e.isLowPowerMode,a=n?0:i?600:1050;[`floor`,`planeSky`,`rightWall-cover`].forEach(n=>{let r=X(e,n);r&&(r.visible=!0,wo({obj:r,duration:t*(i?.1:.2),delay:a,easing:so(.25)}))});let o=X(e,`a-char`);o&&(o.visible=!0,o.scale.setScalar(1e-4),o.userData.originalPos&&o.position.copy(o.userData.originalPos),o.userData.originalRot&&o.rotation.copy(o.userData.originalRot),o.updateMatrix());let s=X(e,`stool`);s&&(s.visible=!0,s.scale.setScalar(1e-4),s.userData.originalPos&&s.position.copy(s.userData.originalPos),s.userData.originalRot&&s.rotation.copy(s.userData.originalRot),s.updateMatrix());let c=X(e,`stool_bound`);c&&(c.visible=!1,c.userData.originalPos&&c.position.copy(c.userData.originalPos),c.userData.originalScale&&c.scale.copy(c.userData.originalScale),c.userData.originalRot&&c.rotation.copy(c.userData.originalRot),c.updateMatrix()),e.points.material.uniforms.uPixelRatio.value,e.points.material.uniforms.uSize.value;let l=n?0:i?900:1500,u=.15,d=.05,f=l*(1-u-d),p=be[1].toneMappingExposure,m=t=>new v.Tween(e.points.material.uniforms.uPixelRatio).to({value:t},f).easing(v.Easing.Exponential.In),h=t=>new v.Tween(e.points.material.uniforms.uSize).to({value:t},f).easing(v.Easing.Exponential.In),g=t=>new v.Tween(e.renderer).to({toneMappingExposure:t},f).easing(v.Easing.Linear.None);if(n)o&&(o.visible=!0,wo({obj:o,duration:100})),s&&(s.visible=!0,wo({obj:s,duration:100})),Yo(e,0);else{let t=new v.Tween(e.points.bloomPass).to({strength:0},l*u).delay(l*d).easing(v.Easing.Back.InOut).onComplete(async()=>{let t=X(e,`rightWall-cover`);t&&(t.visible=!0),window.showSectionPoint&&window.showSectionPoint()});new v.Tween(e.points.bloomPass).to({strength:5},f).easing(v.Easing.Quadratic.In).onComplete(async()=>{o&&o.scale.copy(o.userData.originalScale),s&&s.scale.copy(s.userData.originalScale),c&&(c.visible=!0,c.userData.originalPos&&c.position.copy(c.userData.originalPos),c.userData.originalRot&&c.rotation.copy(c.userData.originalRot),c.scale.copy(c.userData.originalScale),c.updateMatrix()),e.pointsApp&&e.pointsApp.points&&(e.pointsApp.points.visible=!1),t.start()}).start(),m(0).start(),h(0).start(),setTimeout(()=>{Yo(e)},f*.1)}g(p).start()}async function _o(e,t){let n=To(e);n.forEach((e,t)=>{}),e.loadedModel&&e.loadedModel.model&&e.loadedModel.model.position.set(0,0,0);let r=n.filter(e=>/^book\d+$/.test(e.name)),i=n.filter(e=>!/^book\d+$/.test(e.name)),a=e.isLowPowerMode,o=(e,t,n=1,r=!1,i=null)=>new Promise(a=>{if(e.length===0)return a();let o=0,s=e.length,c=r?v.Easing.Cubic.Out:so(1),l=Math.ceil(s/5),u=0,d=()=>{let f=Math.min(u+l,s);performance.now();for(let l=u;l<f;l++){let u=e[l];u.userData.scenarioTween&&(u.userData.scenarioTween.stop(),u.userData.scenarioTween=null),u.userData.wasMatrixAutoUpdate=u.matrixAutoUpdate,u.matrixAutoUpdate=!1;let d=u.userData,f=(Math.random()-.5)*500,p=Math.max(0,l/s*t*n+f),m=t*(r?1:.7+Math.random()*.7),h={t:0};u.userData.scenarioTween=new v.Tween(h).to({t:1},m).delay(p).easing(c).onUpdate(()=>{let e=h.t;d.originalPos&&d.hidePos&&(u.position.x=d.hidePos.x+(d.originalPos.x-d.hidePos.x)*e,u.position.y=d.hidePos.y+(d.originalPos.y-d.hidePos.y)*e,u.position.z=d.hidePos.z+(d.originalPos.z-d.hidePos.z)*e),d.originalScale&&d.hideScale&&(u.scale.x=d.hideScale.x+(d.originalScale.x-d.hideScale.x)*e,u.scale.y=d.hideScale.y+(d.originalScale.y-d.hideScale.y)*e,u.scale.z=d.hideScale.z+(d.originalScale.z-d.hideScale.z)*e),r&&d.originalRot&&d.hideRot&&(u.rotation.x=d.hideRot.x+(d.originalRot.x-d.hideRot.x)*e,u.rotation.y=d.hideRot.y+(d.originalRot.y-d.hideRot.y)*e,u.rotation.z=d.hideRot.z+(d.originalRot.z-d.hideRot.z)*e),u.matrixAutoUpdate===!1&&u.updateMatrix()}).onComplete(async()=>{u.userData.scenarioTween=null,o++,o===s&&(i&&await i(),a())}).start()}u=f,u<s&&requestAnimationFrame(d)};d()});await o(i,t,a?.3:.5),await No(a?34:68),await o(r,t*.8,a?.3:.4,!0,async()=>{await vo(e,n),qo(e,1),setTimeout(()=>{as(e),e.physicObjects&&e.physicObjects.forEach((e,t)=>{e.rapierBody&&setTimeout(()=>{e.rapierBody&&e.rapierBody.wakeUp()},t*6)})},250),await No(a?300:500)})}function vo(e,t){return new Promise(n=>{let r=0,i=()=>{let a=Math.min(r+20,t.length);for(let e=r;e<a;e++){let n=t[e];n.matrixAutoUpdate=n.userData.wasMatrixAutoUpdate===void 0?!0:n.userData.wasMatrixAutoUpdate,n.updateMatrix()}r=a,r<t.length?requestAnimationFrame(i):(e.loadedModel&&e.loadedModel.model&&e.loadedModel.model.updateMatrixWorld(!0),n())};i()})}async function yo(e,t=!0){e.objectMap.get(`planeSky`),e.objectMap.forEach((e,n)=>{/^dragonBall\d+Stars$/.test(n)&&(e.visible=t)}),t?(e.clock.start(),Z(`Clock Resumed.`)):(e.clock.stop(),Z(`Clock Paused.`)),e.world&&(e.world.isActive=t,Z(t?`Physics Activated.`:`Physics Deactivated.`))}function bo(e){e.userData.originalPos=e.position.clone(),e.userData.originalScale=e.scale.clone(),e.userData.originalRot=e.rotation.clone(),Eo(e,rs,`x`,-1),e.scale.set(0,0,0),e.rotation.z+=.1*Math.PI*2,e.visible=!0}function xo(e,t,n=0){let r=e.objectMap.get(`blackholeScene`);if(!r.userData.originalPos||!r.userData.originalScale||!r.userData.originalRot)return;let i=r.position.clone(),a=r.userData.originalPos,o=r.scale.clone(),s=r.userData.originalScale,c=r.rotation.z,l=r.userData.originalRot.z,u=t*2,d={t:0};new v.Tween(d).to({t:2},u).easing(v.Easing.Linear.None).delay(n).onUpdate(()=>{let t=d.t;if(t<=1){let e=v.Easing.Back.Out(t);r.position.lerpVectors(i,a,e)}else{r.position.copy(a),e.fireflies.material.uniforms.uSizeFactor.value=1;let n=Math.min(t-1,1),i=v.Easing.Back.Out(n);r.scale.lerpVectors(o,s,i);let u=v.Easing.Back.InOut(n);r.rotation.z=c+(l-c)*u}}).onComplete(()=>{r.position.copy(a),r.scale.copy(s),r.rotation.z=l,new v.Tween(e.fireflies.material.uniforms.uKamikazeScale).to({value:1},t).easing(v.Easing.Cubic.In).start()}).start()}function So(e){let t=e.objectMap.get(`planeSky`);t&&(t.visible=!1);let n=e.objectMap.get(`blackholeScene`);n&&bo(n),[`rightWall-cover`,`a-char`,`stool`,`stool_bound`,`floor`,`moon`,`planeSky`].forEach(t=>{let n=e.getObjectByName(t);if(n){Co(n);let e=t===`a-char`||t===`stool`||t===`stool_bound`;t!==`floor`&&t!==`moon`&&!e?(n.position.set(0,-rs,0),n.visible=!1):e?(n.visible=!0,n.scale.setScalar(1e-4)):n.visible=!1}}),To(e).forEach(e=>{/^book\d+$/.test(e.name)?Co(e,{fixedAxis:`x`,fixedDirection:1,enableSpin:!0,ignoreAxisOffset:!1}):Co(e,{fixedAxis:`x`,fixedDirection:-1,ignoreAxisOffset:!1})})}function Co(e,t={}){let{fixedAxis:n=null,fixedDirection:r=null,enableSpin:i=!1,ignoreAxisOffset:a=!1}=t;e.userData.originalPos=e.position.clone(),e.userData.originalScale=e.scale.clone(),e.userData.originalRot=e.rotation.clone();let o=r===null?Math.random()>.5?1:-1:r;if(a?Do(e,rs,n,o):Eo(e,rs,n,o),i){let t=(Math.random()*50+50)*(Math.PI*2),n=Math.random()>.5?1:-1;e.rotation.y+=t*n}e.scale.set(0,0,0),e.visible=!0,e.userData.hidePos=e.position.clone(),e.userData.hideScale=e.scale.clone(),e.userData.hideRot=e.rotation.clone(),e.name}function wo({obj:e,duration:t,delay:n=0,enableSpin:r=!1,easing:i=v.Easing.Cubic.Out}){if(!e.userData.originalPos)return;let a=e.position.clone(),o=e.scale.clone(),s=e.rotation.clone(),c=e.userData.originalPos,l=e.userData.originalScale,u=e.userData.originalRot,d=e.castShadow,f=e.receiveShadow,p=e.matrixAutoUpdate,m=e.frustumCulled;e.castShadow=!1,e.receiveShadow=!1,e.matrixAutoUpdate=!1,e.frustumCulled=!1;let h={t:0};new v.Tween(h).to({t:1},t).delay(n).easing(v.Easing.Linear.None).onUpdate(()=>{let t=h.t,n=i(Math.min(t/.7,1));e.position.lerpVectors(a,c,n);let d=Math.max(0,(t-.2)/.6),f=v.Easing.Back.Out(Math.min(d,1));if(e.scale.lerpVectors(o,l,f),r){let n=Math.max(0,(t-.4)/.6),r=v.Easing.Quadratic.Out(Math.min(n,1));e.rotation.x=s.x+(u.x-s.x)*r,e.rotation.y=s.y+(u.y-s.y)*r,e.rotation.z=s.z+(u.z-s.z)*r}e.updateMatrix()}).onComplete(()=>{e.castShadow=d,e.receiveShadow=f,e.matrixAutoUpdate=p,e.frustumCulled=m,e.position.copy(c),e.scale.copy(l),e.rotation.copy(u),e.updateMatrix(),e.updateMatrixWorld(!0)}).start()}function To(e){if(e.assembleGroups)return e.assembleGroups;let t=e.children.filter(t=>!t.name||t.isCamera||t.isLight||t.isBone||t.name===`roomGLBModel`||t===e||t.name===`HUDFrame`||is.includes(t.name)||/^dragonBall\d+Stars$/.test(t.name)||/^Ch23_/.test(t.name)||/^mixamorig/.test(t.name)||/^BTC_/.test(t.name)||/^ETH_/.test(t.name)?!1:t.isObject3D);return t.sort((e,t)=>{let n=e=>e.material?Array.isArray(e.material)?e.material[0].uuid:e.material.uuid:``;return n(e).localeCompare(n(t))}),e.assembleGroups=t,t}function Eo(e,t,n=null,r=1){let i=[`x`,`y`,`z`],a=n;(!a||!i.includes(a))&&(a=i[Math.floor(Math.random()*3)]),a===`y`&&(r=1),e.position[a]+=t*r}function Do(e,t,n=null,r=1){let i=[`x`,`y`,`z`],a=n;(!a||!i.includes(a))&&(a=i[Math.floor(Math.random()*3)]),a===`y`&&(r=1),e.position[a]+=t*r;let o=t*.5;i.filter(e=>e!==a).forEach(t=>{let n=Math.random()>.5?1:-1;t===`y`&&(n=1),e.position[t]+=o*n})}function X(e,t){if(!t)return null;if(e.objectMap||Ao(e),e.objectMap.has(t))return e.objectMap.get(t);let n=e.getObjectByName(t);return n&&e.objectMap.set(t,n),n}function Oo(e,t){!t||!t.name||(e.objectMap||Ao(e),e.objectMap.set(t.name,t))}function ko(e,t){e.objectMap&&e.objectMap.delete(t)}function Ao(e){let t=new Map;return e.traverse(e=>{e.name&&t.set(e.name,e)}),e.objectMap=t,t}async function jo(){let e=document.getElementById(`progress-text`),t=document.getElementById(`progress-bar`),n=document.getElementById(`cv-container`);e&&(e.innerText=z(`SYS_READY`)),t&&(t.parentElement.style.opacity=`0`),n&&n.classList.add(`collapsed`);let r=document.getElementById(`main-ui`);r&&(r.style.opacity=`0`),await No(200)}async function Mo(){let e=document.getElementById(`loading-container`),t=document.querySelector(`.loader-content`);if(t&&(t.style.transition=`opacity 0.5s ease`,t.style.opacity=`0`),e){await No(100),e.style.transition=`opacity 0.4s ease`,e.style.opacity=`0`,await No(400),e.style.display=`none`;let t=document.getElementById(`main-ui`);t&&(t.style.transition=`opacity 1s ease`,t.style.opacity=`1`)}}function No(e){return new Promise(t=>setTimeout(t,e))}async function Po(t,n={}){let{duration:r=3e3,delay:i=0,onStart:a,onComplete:o}=n,s=t.getObjectByName(`drone`);if(!s){console.error(`Drone not found`);return}return new Promise(n=>{let c=s.position.clone(),l=new e.Vector3(9,1,-1.3),u=new e.Vector3(-1,9,-5);cs=u;let d=new e.CatmullRomCurve3([c,l,u],!1,`centripetal`),f=s.quaternion.clone(),p=new e.Euler(-Math.PI/2,.2,1.25),m=new e.Quaternion().setFromEuler(p),h=new e.Quaternion().setFromAxisAngle(new e.Vector3(1,0,0),Math.PI/2);m.multiply(h);let g={val:0},_=new e.Quaternion;new v.Tween(g).to({val:1},r).delay(i).easing(v.Easing.Quadratic.InOut).onStart(()=>{let e=new He(s);e.init(),t.gazeFollower=e,a&&a()}).onUpdate(()=>{if(t._spawnStopSignal){g.val=1;return}let e=d.getPoint(g.val);s.rapierBody.setNextKinematicTranslation(e),_.copy(f).slerp(m,g.val);let n=t.world;if(n&&!n.isBusy)try{let e=n.isBusy;n.isBusy=!0,s.rapierBody.setRotation({x:_.x,y:_.y,z:_.z,w:_.w},!0),n.isBusy=e}catch(e){console.error(`[Scenario] Rapier failed to set rotation @CurveAnim:`,e.message),e.message.includes(`recursive`)&&console.trace(`[Scenario] Recursive WASM call trace @CurveAnim:`)}}).onComplete(()=>{if(t._spawnStopSignal){n();return}t.world&&!t.world.isBusy&&(s.rapierBody.setTranslation({x:u.x,y:u.y,z:u.z},!0),s.rapierBody.setRotation({x:m.x,y:m.y,z:m.z,w:m.w},!0)),o&&o(),n()}).start()})}function Fo(e){e.globalUniformsHub.uStormSharpness.value=0}function Io(e){e.globalUniformsHub.enableLightning.value=!1,e.globalUniformsHub.uRainHeaviness.value=0,e.globalUniformsHub.glassRainAmount.value=0,e.globalUniformsHub.rainGlassOpacity.value=0}function Lo(e){let t=e.getObjectByName(`floor`),n=e.getObjectByName(`Object_0003_3`),r=e.getObjectByName(`Object_12001`);t?.material&&(t.material.envMapIntensity=.1),n?.material&&(n.material.envMapIntensity=.7),r?.material&&(r.material.envMapIntensity=0),e.environmentIntensity=.4}function Ro(e){Fo(e),Io(e),Lo(e)}function zo(e,t=12e3){let n=e.globalUniformsHub,r=t,i=v.Easing.Linear.None,a={val:0},o=new v.Tween(a).to({val:1},r).easing(i).onUpdate(()=>{e.globalUniformsHub.glassRainAmount.value=a.val,e.globalUniformsHub.rainGlassOpacity.value=a.val}),s=new v.Tween(n.uMoonPosition.value).to({x:`+0.001`,y:`+0.05`},r*2).easing(i),c=new v.Tween(n.uMoonSize).to({value:n.uMoonSize.value*.65},r*2).easing(i),l={t:0};new v.Tween(l).to({t:1},r).easing(i).onUpdate(()=>{e.globalUniformsHub.uStormSharpness.value=l.t,e.globalUniformsHub.uRainHeaviness.value=l.t*.75}).onStart(()=>{setTimeout(()=>{o.start(),s.start(),c.start()},r*.4)}).onComplete(()=>{}).start()}async function Bo(t,n=3e3){let r=t.objectMap.get(`bulb`);if(!r)return;let i=new e.Vector3(1,1,1),a=new e.Vector3(0,9.2,0),o=r.rotation.clone(),s=r.getObjectByName(`bulbLight`);s||(s=t.getObjectByName(`bulbLight`)||t.bulbLight,s&&r&&(r.attach(s),s.position.set(0,0,0),s.target&&(r.add(s.target),s.target.position.set(0,-10,0))));let c=s?s.intensity:0,l=s?s.distance:0,u=new e.Vector3(0,0,0);t.objectMap.get(`Lathe_Center`);let d=new e.Vector3;d.copy(r.position),r.position.copy(d),r.visible=!0,r.scale.setScalar(0),r.material.visible=!0,s&&s.parent!==r&&(r.add(s),s.target&&r.add(s.target),s.position.set(0,0,0),s.target.position.set(0,-10,0));let f=r.getObjectByName(`bulbAura`);f&&(f.visible=!0);let p={t:0},m=t.animations[1],h=t.mixer.clipAction(m);h.reset(),h.play(),new v.Tween(p).to({t:1},n).easing(v.Easing.Back.Out).onStart(()=>{}).onUpdate(()=>{let t=p.t;r.scale.lerpVectors(u,i,t),s&&(s.intensity=e.MathUtils.lerp(c,1e3,t),s.distance=e.MathUtils.lerp(l,25,Math.min(t*5,1))),r.position.lerpVectors(d,a,t);let n=Math.sin(t*Math.PI)*1.5,f=-t*Math.PI*2*4;r.position.y+=Math.cos(f)*n,r.position.z+=Math.sin(f)*n;let m=(1-t)*Math.PI*2*4;r.rotation.set(o.x+m,o.y+m*.5,o.z)}).onComplete(()=>{t.raycasterEnabled=!0,Z(`Scenario Stable. System interactions re-enabled.`),s&&new v.Tween(s).to({intensity:800},3e3).easing(v.Easing.Back.Out).start(),t._spawnStopSignal||(!t.dragonBalls||t.dragonBalls.length===0)&&Vo(t,r)}).start()}function Vo(t,n){t.dragonBalls&&t.dragonBalls.length>0&&t.dragonBalls.forEach(e=>{e.parent&&e.parent.remove(e),t.remove(e)}),t.dragonBalls=[],setTimeout(()=>{Z(`The Dragon Balls descend...`);for(let r=1;r<=7;r++){let i=()=>{if(t._spawnStopSignal)return;if(t.world.isBusy){setTimeout(i,16);return}let a=sr(t,r);if(!a){setTimeout(i,16);return}let o=new e.Vector3;n.getWorldPosition(o),o.y-=.5,o.x+=(Math.random()-.5)*.2,o.z+=(Math.random()-.5)*.2,a.position.copy(o),a.userData.originalPos=a.position.clone(),a.userData.originalScale=a.scale.clone(),a.userData.originalRot=a.rotation.clone(),a.rapierBody&&(a.rapierBody.setTranslation(o,!0),a.rapierBody.wakeUp()),a.userData.oscStrength=2;let s=a.children.find(e=>e.name.startsWith(`Aura`));s&&(s.userData.oscStrength=2);let c=e=>{e.onBeforeRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&(this.userData.prevOsc=i.uniforms.uOscillationStrength.value,i.uniforms.uOscillationStrength.value=this.userData.oscStrength)},e.onAfterRender=function(e,t,n,r,i,a){i.uniforms&&i.uniforms.uOscillationStrength&&(i.uniforms.uOscillationStrength.value=this.userData.prevOsc)}};c(a),s&&c(s);let l=a.scale.clone(),u=.1;if(a.scale.multiplyScalar(u),je(t,a,a.rapierBody,a.rapierShape),a.rapierBody){let e=a.rapierBody.mass(),t=(Math.random()>.5?1:-1)*(.7+Math.random());a.rapierBody.applyImpulse({x:1.6*e,y:0,z:t*e},!0)}let d=.5;a.rapierShape&&a.rapierShape.radius&&l.x>0&&(d=a.rapierShape.radius/l.x),a.rapierCollider.setRadius(a.scale.x*d),setTimeout(()=>{let e=4500,t=l.clone().multiplyScalar(u),n={t:0};new v.Tween(n).to({t:1},e).easing(v.Easing.Cubic.Out).onUpdate(()=>{let e=n.t;if(a.scale.lerpVectors(t,l,e),a.rapierCollider)try{typeof a.rapierCollider.setRadius==`function`&&a.rapierCollider.setRadius(a.scale.x*d)}catch{}}).start();let r={t:0};new v.Tween(r).to({t:1},e).easing(v.Easing.Exponential.In).onUpdate(()=>{let e=2*(1-r.t);a.userData.oscStrength=e,s&&(s.userData.oscStrength=e)}).start()},3e3)};setTimeout(i,r*300)}let r=8*300;setTimeout(()=>{Z(`Point Gravity System Online.`),t.world&&(t.world.hasPointGravityOnBalls=!0)},r+3e3),setTimeout(()=>{let n=t.getObjectByName(`cFanBulb`),r=t.getObjectByName(`bulb`),i=t.getObjectByName(`bulbLight`);if(!n||!r)return;if(i){n.attach(i),i.position.set(0,0,0);let r=new e.Vector3;i.getWorldPosition(r),t.add(i.target),i.target.position.set(r.x,r.y-10,r.z)}let a=new e.Vector3;r.getWorldPosition(a);let o=new e.Vector3;n.getWorldPosition(o),r.scale.x,new v.Tween(r.scale).to({x:.1,y:.1,z:.9},2e3).easing(v.Easing.Cubic.In).start(),new v.Tween(r.position).to(o,2e3).easing(v.Easing.Cubic.In).start().onComplete(()=>{r.visible=!1,K&&K.uniforms&&K.uniforms.glowIntensity&&new v.Tween(K.uniforms.glowIntensity).to({value:1},500).easing(v.Easing.Quadratic.Out).start(),K&&K.uniforms&&K.uniforms.glowPower&&new v.Tween(K.uniforms.glowPower).to({value:.015},500).easing(v.Easing.Quadratic.Out).start(),Z(`Power transferred to ceiling array.`),new v.Tween(r.scale).to({x:.1,y:.1,z:.1},500).easing(v.Easing.Quadratic.Out).onComplete(()=>{r.visible=!1}).start()}).start()},r)},100)}function Ho(t,n={}){let{duration:r=2e3,delay:i=0,onComplete:a}=n,o=new e.Object3D;o.name=`testObj`,t.add(o);let s=t.getObjectByName(`mjolnir_low_mjolnir_hammer_0`);if(!s.isFlying)if(s.isFlying=!0,s&&s.rapierBody){Z(`Boomerang Mjolnir initiated`);let n=s.userData.originalPos,o=s.userData.originalRot;if(!n||!o){console.error(`Mjolnir missing userData.originalPos/Rot`);return}let c=new e.Vector3(-1.5,9,7.3),l=new e.Vector3(-20,15,30);s.rapierBody.setBodyType(b.RigidBodyType.KinematicPositionBased),s.rapierBody.isManualControl=!0,s.rapierBody.wakeUp(),s.rapierBody.setTranslation(l,!0);let u=new e.Quaternion(0,0,0,1),d=new e.Quaternion().setFromAxisAngle(new e.Vector3(0,0,1),Math.PI/2);u.multiply(d),s.rapierBody.setRotation(u,!0);let f=new e.Vector3(7,6,8),p=new e.Vector3(12,4,0),m=t.getObjectByName(`drone`),h=new e.Vector3(m.position.x,m.position.y,m.position.z),g=new e.CatmullRomCurve3([l,f,p,h,c],!1,`centripetal`),_=null;s.rapierBody.numColliders()>0&&(_=s.rapierBody.collider(0),_.setSensor(!0)),s.userData.hitDrone=!1;let y={val:0};new v.Tween(y).to({val:1},r).easing(v.Easing.Cubic.Out).delay(i).onUpdate(()=>{if(t._spawnStopSignal){y.val=1,s.isFlying=!1;return}let n=g.getPoint(y.val);s.rapierBody.setNextKinematicTranslation({x:n.x,y:n.y,z:n.z});let r=y.val*Math.PI*30,i=new e.Vector3(0,1,0),a=new e.Quaternion().setFromAxisAngle(i,r),o=u.clone().multiply(a);if(s.rapierBody.setNextKinematicRotation(o),m&&m.rapierBody&&!s.userData.hitDrone&&g.getPoint(y.val).distanceTo(m.position)<3){let n=m.quaternion.clone(),r=cs.clone();Z(z(Q.currentMode===I.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`)),m.rapierBody.setBodyType(b.RigidBodyType.Dynamic),m.rapierBody.wakeUp(),m.rapierBody.applyImpulse({x:-100,y:75,z:-100},!0),m.rapierBody.applyTorqueImpulse({x:5,y:5,z:5},!0),s.userData.hitDrone=!0,setTimeout(()=>{if(t._spawnStopSignal)return;Z(z(Q.currentMode===I.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`)),m.rapierBody.setBodyType(b.RigidBodyType.KinematicPositionBased);let i=m.position.clone(),a=m.quaternion.clone(),o={val:0};new v.Tween(o).to({val:1},2e3).easing(v.Easing.Back.Out).onUpdate(()=>{let t=new e.Vector3().lerpVectors(i,r,o.val),s=a.clone().slerp(n,o.val);m.rapierBody.setNextKinematicTranslation(t),m.rapierBody.setNextKinematicRotation(s)}).onComplete(async()=>{if(t._spawnStopSignal)return;m.rapierBody.setGravityScale(0),m.rapierBody.setLinvel({x:0,y:0,z:0},!0),m.rapierBody.setAngvel({x:0,y:0,z:0},!0),m.rapierBody.setBodyType(b.RigidBodyType.Fixed);let e=Q.currentMode===I.POBA?`SYS_DRONE_SUBTITLES_POBA`:`SYS_DRONE_SUBTITLES_DEV`;Z(z(e)),yi(t),await Jo(t,`welcome`,{scale:1.65,duration:2500,isAsync:!0}),await No(5500),!t._spawnStopSignal&&(ys(z(e)),t.cursorInformer&&t.cursorInformer.switchToOpacityMode&&t.cursorInformer.switchToOpacityMode())}).start()},2e3)}}).onComplete(()=>{Z(`Mjolnir Returned.`),s.rapierBody.setBodyType(b.RigidBodyType.Dynamic),s.rapierBody.isManualControl=!1,s.userData.originalPos=s.position.clone(),s.userData.originalRot=new e.Euler().setFromQuaternion(s.quaternion),_&&_.setSensor(!1),s.userData.hitDrone=!1,s.rapierBody.wakeUp(),s.isFlying=!1,a&&a()}).start()}else console.warn(`Mjolnir mesh or rapierBody not found`)}function Uo(t,n=`drone-beam`,r=null){let i=new e.Group;i.name=n;let a=r||L.ELECTRIC_CYAN||65535,o=(t,n,r,i)=>{let a=new e.CylinderGeometry(r,r,1,8,1,!0);a.rotateX(Math.PI/2),a.translate(0,0,.5);let o=new e.MeshBasicMaterial({color:n,transparent:!0,opacity:i,blending:e.AdditiveBlending,depthWrite:!1,side:e.DoubleSide}),s=new e.Mesh(a,o);return s.name=t,s};return i.add(o(`beam-core`,16777215,.005,1)),i.add(o(`beam-glow`,a,.015,.6)),i.add(o(`beam-outer`,L.ACCENT_GOLD||16763904,.03,.3)),i.frustumCulled=!1,t.add(i),i}function Wo(t,n,r=null,i=null){let a=new e.Group;a.position.copy(n),t.add(a);let o=new e.Group;r&&o.lookAt(r),a.add(o);let s=new e.IcosahedronGeometry(.1,0),c=[],l=i||[16777215,65535,35071,52479];for(let t=0;t<35;t++){let n=l[t%l.length],r=Rt(n,1.2,2.5),i=new e.Mesh(s,r),a=Lt(n,1,.01,4,e.FrontSide),u=new e.Mesh(s,a);u.scale.setScalar(1.35),i.add(u);let d=Math.random()*Math.PI*2,f=Math.PI*.4*Math.random(),p=new e.Vector3(Math.sin(f)*Math.cos(d),Math.sin(f)*Math.sin(d),Math.cos(f)).multiplyScalar(.08+Math.random()*.12);i.userData.velocity=p,i.lookAt(p.clone().add(i.position)),i.scale.setScalar(.1+Math.random()*.5),o.add(i),c.push(i)}let u=new e.TorusGeometry(1,.015,8,32),d=Lt(l[1]||l[0],2,.01,4,e.DoubleSide),f=new e.Mesh(u,d);f.rotation.x=Math.PI/2,a.add(f);let p=l[0]||16777215,m=Lt(p,1.5,.01,4,e.DoubleSide),h=new e.Mesh(u,m);h.rotation.x=Math.PI/2,h.scale.setScalar(.5),a.add(h);let g=new e.SphereGeometry(.4,16,16),_=Rt(p,1,4),y=new e.Mesh(g,_);a.add(y),new v.Tween({progress:0}).to({progress:1},1e3).easing(v.Easing.Quadratic.Out).onUpdate(e=>{let t=e.progress;c.forEach(e=>{e.position.add(e.userData.velocity);let n=1-t,r=1+t*4;e.scale.set((.3+Math.random()*.4)*n,(.3+Math.random()*.4)*n,(.4+Math.random()*.6)*n*r),e.material.uniforms&&(e.material.uniforms.glowIntensity.value=2.5*n);let i=e.children[0];i&&i.material.uniforms&&(i.material.uniforms.outerGlowStrength.value=1*n)});let n=.1+t*3.5;f.scale.set(n,n,1),f.material.uniforms.outerGlowStrength.value=2*(1-t);let r=.1+t*4.5;h.scale.set(r,r,1),h.material.uniforms.outerGlowStrength.value=1*(1-t);let i=Math.min(t*4,1)<.5?t*8:(1-t)*1.5;y.scale.setScalar(i),y.material.uniforms&&(y.material.uniforms.glowIntensity.value=2.5*(1-t))}).onComplete(()=>{t.remove(a),s.dispose(),u.dispose(),g.dispose(),c.forEach(e=>{e.material.dispose(),e.children[0]&&e.children[0].material.dispose()}),f.material.dispose(),h.material.dispose(),_.dispose()}).start()}function Go(t,n,r=!1,i=!1){let a=X(t,`drone`);if(!a||!t.gazeFollower)return;r&&(t.gazeFollower.isLocked=!0);let o=n;n instanceof e.Vector3&&(a.userData.gazeProxy||(a.userData.gazeProxy=new e.Object3D),a.userData.gazeProxy.position.copy(n),o=a.userData.gazeProxy),o&&(r&&(a.userData.lockTarget=o),t.gazeFollower.lookAtTarget(o,i))}function Ko(t,n,r=``,i=null,a=`drone-beam`,o=!1,s=null,c=!1,l=null,u=!1){let d=X(t,`drone`),f=d?d.getObjectByName(`Sphere001_0`):null;if(!f)return;let p=X(t,a);p||=Uo(t,a,s),p.activeRequestID&&cancelAnimationFrame(p.activeRequestID);let m=t.camera,h=new e.Vector3,g=new e.Vector3,_=i!==null,v=l===1/0,y;if(v)y=1/0;else if(l!==null)y=l;else{let e=_?400:1e3,t=_?600:3e3;y=_?500:Math.min(Math.max(r.length*50,e),t)}let b=performance.now();p.visible=!1;let x=e=>{p.children.forEach((t,n)=>{let r=n===0?1:n===1?.7:.4;t.material.opacity=e*r})},S=(e,t)=>{let n=e.distanceTo(t);p.position.copy(e),p.lookAt(t),p.children.forEach(e=>{e.scale.z=n})},C=()=>{let e=performance.now(),r=e-b,a=Math.min(r/y,1);if(a<1){let r=!1;_?(g.copy(i),r=!0):n&&n.isMesh&&(n.getWorldPosition(g),r=!0),r?(f.getWorldPosition(h),u||(S(h,g),o||Go(t,g,!0)),p.visible=!0,_&&a<.1&&!p.hitTriggered&&!c&&(Wo(t,g,h,s?[16777215,s,s]:null),p.hitTriggered=!0)):p.visible=!1;let l=.7+Math.sin(e*.08)*.3,d;d=v?1:_?a<.2?a*5:1-(a-.5)*2:1-a**2,x(l*Math.max(0,d)),p.activeRequestID=requestAnimationFrame(C)}else p.visible=!1,x(0),p.activeRequestID=null,p.hitTriggered=!1,t.gazeFollower&&!d.userData.isHovering&&(t.gazeFollower.isLocked=!1,t.gazeFollower.lookAtTarget(m))};p.hitTriggered=!1,p.activeRequestID=requestAnimationFrame(C)}function qo(t,n=0){let r=be[n];if(!r){console.error(`Scenario state index ${n} not found`);return}if(t.scenarioState=r,r.ui&&(r.ui.cursorInformer!==void 0&&(t.cursorInformerEnabled=r.ui.cursorInformer,t.cursorInformer&&(r.ui.cursorInformer?t.cursorInformer.show?t.cursorInformer.show():t.cursorInformer.style.display=`block`:t.cursorInformer.hide?t.cursorInformer.hide():t.cursorInformer.style.display=`none`)),r.ui.subtitle===!1&&(Z(``),bs(!0)),r.ui.personaButton3D===!1&&window.boneTracker&&typeof window.boneTracker.forceReset==`function`&&window.boneTracker.forceReset()),r.environment){let n=t.domElement;n&&(r.environment.cssBackground?n.style.background=r.environment.cssBackground:r.environment.background&&(n.style.background=r.environment.background)),r.environment.sceneBackground!==void 0&&(r.environment.sceneBackground===null?t.background=null:t.background=new e.Color(r.environment.sceneBackground))}if(t.renderer){if(!t.isTransitioning){let e=(window.devicePixelRatio||1)*(r.pixelRatioScale===void 0?1:r.pixelRatioScale);t.renderer.setPixelRatio(e),t.points&&typeof t.points.onWindowResize==`function`&&t.points.onWindowResize()}r.toneMappingExposure!==void 0&&(t.renderer.toneMappingExposure=r.toneMappingExposure)}if(t.HUD&&t.HUD.material.uniforms&&r.hudUniforms){let e=3e3,n=v.Easing.Quadratic.Out;for(let[i,a]of Object.entries(r.hudUniforms)){let r=t.HUD.material.uniforms[i];r&&(r._currentTween&&r._currentTween.stop(),a&&a.isColor?r._currentTween=new v.Tween(r.value).to({r:a.r,g:a.g,b:a.b},e).easing(n).start():typeof a==`number`?r._currentTween=new v.Tween(r).to({value:a},e).easing(n).start():r.value=a)}}}function Jo(t,n=`welcome`,r={}){let{scale:i=null,rotation:a=null,position:o=null,duration:s=2e3,isAsync:c=!1,scanline:l=1}=r,u=t.globalUniformsHub&&t.globalUniformsHub.uniforms||t.constantUniform;if(!u||!u.uWelcomeProgress){console.warn(`Welcome Text uniforms not found on scene`);return}i!==null&&u.uWelcomeScale&&(u.uWelcomeScale.value=i),a!==null&&u.uWelcomeRotation&&(u.uWelcomeRotation.value=a),o!==null&&u.uWelcomePosition&&(o instanceof e.Vector2?u.uWelcomePosition.value.copy(o):o.x!==void 0&&o.y!==void 0&&u.uWelcomePosition.value.set(o.x,o.y)),u.uWelcomeScanline&&(u.uWelcomeScanline.value=l),u.uWelcomeOpacity&&(u.uWelcomeOpacity.value=1),u.uWelcomeGlow&&(u.uWelcomeGlow.value=0),u.uWelcomeProgress&&(u.uWelcomeProgress.value=0);let d=new v.Tween(u.uWelcomeProgress).to({value:1},s).easing(v.Easing.Linear.None),f=new v.Tween(u.uWelcomeGlow).to({value:5.2},500).repeat(3).yoyo(!0).easing(v.Easing.Quadratic.InOut),p=new v.Tween(u.uWelcomeOpacity).to({value:0},1e3).delay(4e3).easing(v.Easing.Quadratic.In).onComplete(()=>{u.uWelcomeProgress.value=0,u.uWelcomeGlow.value=0});return d.chain(f),f.chain(p),d.start(),c?new Promise(e=>d.onComplete(e)):d}async function Yo(t,n=800){let r=t.isLowPowerMode,i=r?n*.6:n;zi(t),t._spawnStopSignal=!1,t._assembleCount===void 0&&(t._assembleCount=0),t._assembleCount++,t.renderer&&(t.renderer.shadowMap&&(t.renderer.shadowMap.autoUpdate=!1),mo(t)),t.isTransitioning=!0,t.raycasterEnabled=!1,t.world&&(t.world.isActive=!1),os(t);try{t._assembleCount<=1?(PerformanceLogger.start(`Tween Blackhole`),xo(t,i),PerformanceLogger.end(`Tween Blackhole`)):setTimeout(()=>{xo(t,i)},400),t.HUD&&typeof t.HUD.tweenGardenMode==`function`&&t.HUD.tweenGardenMode(!0,i),PerformanceLogger.start(`Tween Remaining Objects`),await _o(t,i),PerformanceLogger.end(`Tween Remaining Objects`),t.points&&t.points.bloomPass&&new v.Tween(t.points.bloomPass).to({strength:r?.8:1,threshold:.21,radius:.4},i).easing(v.Easing.Cubic.Out).start(),t.HUD&&t.HUD.material.uniforms.uIsGardenFlower&&(t.HUD.material.uniforms.uIsGardenFlower.value=1),t.renderer&&(t.renderer.toneMappingExposure=.25),t.points&&t.points.bloomPass&&(t.points.bloomPass.threshold=.21,t.points.bloomPass.strength=1),t.background=new e.Color(0),await No(200),Bo(t),setTimeout(async()=>{await ho(t,.2,.625,800),t.isTransitioning=!1,await No(4e3),t.windowLight&&(t.windowLight.intensity=1e7,await No(40),t.windowLight.intensity=0)},800)}finally{}Z(z(`ENV_ATMOS_INIT`)),zo(t,ns*.6),PerformanceLogger.start(`Sync Bodies`),t.rapierWorldWrapper&&t.rapierWorldWrapper.syncBodiesToMeshes&&t.rapierWorldWrapper.syncBodiesToMeshes(),PerformanceLogger.end(`Sync Bodies`),Z(z(`SYS_PHYSICS_INIT`)),Z(z(`SYS_DRONE_START`)),Po(t,{duration:r?2e3:3e3,delay:r?1500:2500,onStart:()=>{},onComplete:()=>{Ho(t,{duration:r?2e3:4e3,onComplete:()=>{_i(t);let e=t.getObjectByName(`wallArea`);e&&e.material&&e.material.uniforms&&e.material.uniforms.uEyeActive&&(e.material.uniforms.uEyeActive.value=!0,qa(t),setTimeout(()=>{e&&e.material&&e.material.uniforms&&Ja(t)},3e3)),t.HUD&&typeof t.HUD.runTweenShowIsland==`function`&&t.HUD.runTweenShowIsland(r?2500:3e3),fo.onRoomAssemble(t),window.cvReset&&window.cvReset(1500),t.HUD&&typeof t.HUD.runTweenShowDecos==`function`&&t.HUD.runTweenShowDecos()}});let e=t.getObjectByName(`planeSky`);e&&(e.visible=!0),setTimeout(()=>{za(t,{forcedX:.65,environmentRatio:1,delay:0})},600)}}),await No(r?1e3:2e3),t.renderer&&setTimeout(()=>{},500),setTimeout(()=>{t.raycasterEnabled=!0,t.targetAnimHz=51},r?5500:9e3),t.globalUniformsHub.enableLightning.value=!0,t.renderer&&(window.devicePixelRatio||1)*(be[1].pixelRatioScale||.625)}async function Xo(e,t=1500){bi(e),ts(e),e._spawnStopSignal=!0,Z(``),bs(!0),e.gazeFollower&&typeof e.gazeFollower.stop==`function`&&e.gazeFollower.stop(),e.world&&(e.world.isActive=!1,e.world.hasPointGravityOnBalls=!1),e.windowLight&&(e.windowLight.intensity=0),window.boneTracker&&typeof window.boneTracker.forceReset==`function`&&window.boneTracker.forceReset(),Zo(e,t),qo(e,0),e.renderer,e.pointsApp&&(e.pointsApp.points.visible=!0)}function Zo(e,t=1500){let n=e.getObjectByName(`roomGLBModel`);if(!n)return;let r=Array.from(n.children),i=r.length,a=0,o=()=>{let e=Math.min(a+20,i);for(let n=a;n<e;n++){let e=r[n];if(e.userData.scenarioTween&&(e.userData.scenarioTween.stop(),e.userData.scenarioTween=null),e.userData.originalPos){let n=t+Math.random()*500;new v.Tween(e.position).to({x:e.userData.hidePos?.x||0,y:e.userData.hidePos?.y||-rs,z:e.userData.hidePos?.z||0},n).easing(v.Easing.Cubic.In).onComplete(()=>{e.visible=!1}).start()}else e.visible=!1}a=e,a<i&&requestAnimationFrame(o)};requestAnimationFrame(o),new v.Tween(n.scale).to({x:0,y:0,z:0},t).easing(v.Easing.Cubic.In).onComplete(()=>{n.visible=!1}).start(),[`rightWall-cover`,`a-char`,`stool`,`floor`,`planeSky`].forEach(n=>{let r=e.getObjectByName(n);if(r){let e=r.userData.hidePos||{x:0,y:-rs,z:0};new v.Tween(r.position).to(e,t).easing(v.Easing.Cubic.In).onComplete(()=>{r.visible=!1}).start(),new v.Tween(r.scale).to({x:0,y:0,z:0},t).easing(v.Easing.Cubic.In).start()}}),e.physicObjects&&e.physicObjects.forEach(e=>{e.userData.scenarioTween&&(e.userData.scenarioTween.stop(),e.userData.scenarioTween=null);let n=e.userData;if(n.hidePos){let r=t+Math.random()*500;e.userData.scenarioTween=new v.Tween(e.position).to({x:n.hidePos.x,y:n.hidePos.y,z:n.hidePos.z},r).easing(v.Easing.Cubic.In).onComplete(()=>{e.visible=!1,e.userData.scenarioTween=null}).start()}else e.visible=!1;e.userData.originalScale&&new v.Tween(e.scale).to({x:0,y:0,z:0},t).start()}),e.points&&e.points.bloomPass&&new v.Tween(e.points.bloomPass).to({strength:1.5,radius:.4,threshold:.85},t).easing(v.Easing.Quadratic.Out).start()}function Qo(e){yi(e),e.world.isActive=!0,go(e,1500,!0)}async function $o(t,n=500){t.globalUniformsHub.enableLightning.value=!1,bi(t),window.cvReset&&window.cvReset(1500),ss(t),Ri(t);let r=[];t.children.forEach(e=>{e.userData.hidePos&&(r.includes(e)||es(e,n))});let i=t.getObjectByName(`roomGLBModel`);if(i&&(i.children.forEach(e=>{es(e,n)}),new v.Tween(i.scale).to({x:0,y:0,z:0},n).easing(v.Easing.Cubic.In).onComplete(()=>{i.visible=!1}).start()),t.camera&&t.orbitControls){let r={x:61.56,y:2.97,z:30},i=new e.Vector3(0,0,0);new v.Tween(t.camera.position).to(r,n*3).easing(v.Easing.Cubic.Out).onUpdate(()=>{t.camera.lookAt(i),t.orbitControls.target.copy(i)}).start(),new v.Tween(t.orbitControls.target).to({x:0,y:0,z:0},n*3).easing(v.Easing.Cubic.Out).start()}let a=new v.Tween(t.fireflies.material.uniforms.uKamikazeScale).to({value:1},n).easing(v.Easing.Cubic.In);new v.Tween(t.fireflies.material.uniforms.uSizeFactor).to({value:0},n).easing(v.Easing.Cubic.In).chain(a).onComplete(o).start();function o(){new v.Tween(t.points.bloomPass).to({strength:1.5,threshold:.85,radius:.4},800).easing(v.Easing.Quadratic.Out),new v.Tween(t.points.bloomPass).to({strength:12,threshold:0,radius:1},400).easing(v.Easing.Quadratic.In).onComplete(()=>{ts(t),qo(t,0),t.isTransitioning=!1,t.pointsApp&&(t.pointsApp.points.visible=!0,typeof t.pointsApp.setScrollLock==`function`&&t.pointsApp.setScrollLock(!0),typeof t.pointsApp.triggerStep==`function`&&t.pointsApp.triggerStep(1,1500,!0),typeof t.HUD.tweenGardenMode==`function`&&t.HUD.tweenGardenMode(!1,1500),typeof t.HUD.runTweenShowDecos==`function`&&t.HUD.runTweenShowDecos(1500));let e=document.getElementById(`board`);e&&(e.style.display=``,e.classList.remove(`mode-room`),window.fitBoardTexts&&(window.__boardScale=1,window.__boardSubProgress=0,window.fitBoardTexts(1,0)));let n=document.querySelectorAll(`.nav-modules .nav-item`);n.forEach(e=>e.classList.remove(`active`));let r=Array.from(n).find(e=>e.getAttribute(`data-target`)===`cv-header`);r&&r.classList.add(`active`),new v.Tween(t.points.bloomPass).to({strength:1.5,threshold:.85,radius:.5},1200).easing(v.Easing.Cubic.Out).onComplete(()=>{t.isTransitioning=!1,t.points&&t.points.bloomPass&&(t.points.bloomPass.threshold=.85,t.points.bloomPass.strength=1.5)}).start()}).start()}}function es(e,t,n){if(e.userData.hidePos){let r=t+Math.random()*500;new v.Tween(e.position).to({x:e.userData.hidePos.x,y:e.userData.hidePos.y,z:e.userData.hidePos.z},r).easing(v.Easing.Cubic.In).onComplete(()=>{e.visible=!1,n&&n()}).start(),e.userData.hideRot&&new v.Tween(e.rotation).to({x:e.userData.hideRot.x,y:e.userData.hideRot.y,z:e.userData.hideRot.z},r).easing(v.Easing.Cubic.In).start(),e.userData.hideScale&&new v.Tween(e.scale).to({x:e.userData.hideScale.x,y:e.userData.hideScale.y,z:e.userData.hideScale.z},r).easing(v.Easing.Cubic.In).start()}}function ts(e){let t=e.getObjectByName(`drone`);t&&t.userData.hidePos&&(t.position.copy(t.userData.hidePos),t.visible=!1);let n=e.getObjectByName(`mjolnir_low_mjolnir_hammer_0`);n&&(n.userData.hidePos&&(n.position.copy(n.userData.hidePos),n.visible=!1),n.isFlying=!1),e.dragonBalls&&(e.dragonBalls.forEach(t=>{if(t.rapierBody&&e.world&&e.world.physics&&e.world.physics.removeRigidBody(t.rapierBody),t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose()),[e.physicObjects,e.physicsControlledObjects,e.bhTargets].forEach(e=>{if(e){let n=e.indexOf(t);n!==-1&&e.splice(n,1)}}),e.physicBodies&&t.rapierBody){let n=e.physicBodies.indexOf(t.rapierBody);n!==-1&&e.physicBodies.splice(n,1)}t.parent&&t.parent.remove(t)}),e.dragonBalls=[],e.world&&(e.world.ballBodies=[]));let r=e.getObjectByName(`bulb`)||e.bulb;r&&(r.visible=!1,r.traverse(e=>{e.visible=!1,e.isLight&&(e.intensity=0)}));let i=e.getObjectByName(`bulbLight`)||e.bulbLight;i&&(i.intensity=.001,i.distance=0,i.visible=!0);let a=e.getObjectByName(`Object_120`);if(a&&a.material&&a.material.uniforms){let e=a.material;e.uniforms.glowPower&&(e.uniforms.glowPower.value=0),e.uniforms.glowIntensity&&(e.uniforms.glowIntensity.value=0)}e.background=null,e._spawnStopSignal=!0,zi(e),typeof bs==`function`&&bs(),e.conversationManager&&typeof e.conversationManager.clear==`function`&&e.conversationManager.clear(),e.children.forEach(e=>{e&&e.name&&(e.name.toLowerCase().includes(`beam`)||e.name.toLowerCase().includes(`aura`))&&(e.visible=!1,e.activeRequestID&&=(cancelAnimationFrame(e.activeRequestID),null))});let o=e.getObjectByName(`a-char`);o&&o.traverse(e=>{e&&e.name&&e.name.toLowerCase().includes(`beam`)&&(e.visible=!1,e.activeRequestID&&=(cancelAnimationFrame(e.activeRequestID),null))}),e.targetAnimHz=30}var ns,rs,is,as,os,ss,cs,ls=M((()=>{Ve(),Ue(),ao(),ks(),ke(),Ns(),we(),br(),Di(),uo(),xn(),po(),ci(),ea(),ns=15e3,rs=100,is=[`planeSky`,`blackholeScene`,`PointsCloud`,`bulb`,`bulbLight`,`a-char`,`stool`,`stool_bound`,`rightWall-cover`,`floor`],as=e=>yo(e,!0),os=e=>yo(e,!1),ss=e=>yo(e,!1)}));function us(t,n,r){let i=new e.Group;i.name=n;let a=r||65535,o=(t,n,r,i)=>{let a=new e.CylinderGeometry(n,n,1,6,1,!0);a.rotateX(Math.PI/2),a.translate(0,0,.5);let o=new e.MeshBasicMaterial({color:i,transparent:!0,opacity:r,blending:e.AdditiveBlending,depthWrite:!1,side:e.DoubleSide}),s=new e.Mesh(a,o);return s.name=t,s};return i.add(o(`beam-core`,.002,1,16777215)),i.add(o(`beam-glow`,.006,.5,a)),i.frustumCulled=!1,i}function ds(t){return new e.ShaderMaterial({uniforms:{iTime:{value:0},uColor:{value:new e.Color(t)},uOpacity:{value:.15},uBrightness:{value:1}},vertexShader:`
            varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`}));async function Cc(t,n){if(n&&B(window.loadingProgress||0,z(`SYS_PHYSICS_CALC`)),!t.world&&(console.warn(`Physics world not ready, waiting...`),await new Promise(e=>setTimeout(e,100)),!t.world))throw Error(`Physics World not initialized`);t.bhTargets||=[];let r=new Map;t.traverse(e=>{e.name&&r.set(e.name,e)});async function i(e,n,i={}){let a=Array.isArray(e)?e:[e],o=0,s=performance.now();for(let e of a){let c=r.get(e);if(!c)continue;i.isBhTarget&&t.bhTargets.push(c),c.visible=!1,(i.isConvexHull||performance.now()-s>1)&&(await Ur(),s=performance.now());let l=n(t,c,i);je(t,c,l.body,l.shape,i),o++,a.length>5&&Ke(`physics-binding`,.1+o/a.length*.7)}}await i([`backWall_rapier`,`rightWall`,`leftWall`,`glass2`,`frontWall`,``,`Object_15`,`Object_15001`,`Cube004`,`Cube019_3`,`Cube019_5`,`Object_1001_1`,`Object_8001`,`leftWallFoot001`,`Object_38001`],Ne,{bodyType:`fixed`,restitution:.4,friction:.4}),await i([`bedMain`,`bedStand`],Ne,{bodyType:`fixed`,restitution:.1,friction:.4,isConvexHull:!0}),Ke(`physics-binding`,.2,z(`SYS_MAPPING_BOUNDARIES`));let a=r.get(`a-char`);if(a){Ke(`physics-binding`,.3,z(`SYS_CHAR_COLLISION`)),new e.Quaternion().setFromAxisAngle(new e.Vector3(1,0,0),Math.PI/2);let n=b.ColliderDesc.capsule(.48,.66).setTranslation(0,.1,0);Me(t,a,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:`mixamorigSpine1`,offset:new e.Vector3(0,0,0),restitution:.5,friction:.4,softKinematic:.7}),Ke(`physics-binding`,.4,z(`SYS_BINDING_ARMATURES`)),[{bone:`mixamorigLeftArm`,shapeType:`capsule`,radius:.2,height:.4,offset:new e.Vector3(0,.35,0)},{bone:`mixamorigRightArm`,shapeType:`capsule`,radius:.2,height:.4,offset:new e.Vector3(0,.35,0)},{bone:`mixamorigLeftForeArm`,shapeType:`capsule`,radius:.2,height:.3,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigRightForeArm`,shapeType:`capsule`,radius:.2,height:.3,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigLeftUpLeg`,shapeType:`capsule`,radius:.3,height:.4,offset:new e.Vector3(0,1,0)},{bone:`mixamorigRightUpLeg`,shapeType:`capsule`,radius:.3,height:.4,offset:new e.Vector3(0,1,0)},{bone:`mixamorigRightLeg`,shapeType:`capsule`,radius:.3,height:.4,offset:new e.Vector3(0,1,0)},{bone:`mixamorigLeftFoot`,shapeType:`capsule`,radius:.24,height:.15,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigRightFoot`,shapeType:`capsule`,radius:.24,height:.15,offset:new e.Vector3(0,.5,0)},{bone:`mixamorigHead`,shapeType:`ball`,radius:.43,offset:new e.Vector3(0,.35,0)}].forEach(e=>{let n;n=e.shapeType===`ball`?b.ColliderDesc.ball(e.radius):b.ColliderDesc.capsule(e.height,e.radius),e.offset&&n.setTranslation(e.offset.x,e.offset.y,e.offset.z),e.rotation&&n.setRotation(e.rotation),Me(t,a,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:e.bone,restitution:.5,friction:.4,softKinematic:.7})})}else console.warn(`bindPhysics: Character 'a-char' not found.`);Ke(`physics-binding`,.5,z(`SYS_ANCHORING_ROTORS`));for(let e of[`cFanBody`]){let n=r.get(e);if(n){let{body:e,shape:r}=Ne(t,n,{bodyType:`kinematicPosition`});Me(t,n,e,r,{restitution:.2,friction:.9,softKinematic:.7})}}await i(`glassInvi`,Ne,{bodyType:`kinematicPosition`}),await i(`stool_bound`,Ne,{bodyType:`kinematicPosition`,isIntegrityResetTarget:!0,isIntegrityCheckTarget:!0,isConvexHull:!0,restitution:.7,friction:.2}),Ke(`physics-binding`,.6,z(`SYS_DYNAMIC_RIGIDBODIES`)),await i(`Object_31`,Ne,{bodyType:`dynamic`,restitution:.2,mass:10,pullingDampness:.25,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityCheckTarget:!0}),await i(`pictureLionFrame`,Ne,{bodyType:`dynamic`,mass:1,pullingDampness:.0025,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityCheckTarget:!1,isIntegrityResetTarget:!0}),await i(`Model_0001`,Ne,{bodyType:`dynamic`,mass:1.5,restitution:.01,friction:.995,pullingDampness:.0025,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityResetTarget:!0,isIntegrityCheckTarget:!1}),await i(`blackCat`,Pe,{bodyType:`fixed`,scale:new e.Vector3(1,1,.5),offset:new e.Vector3(0,.5,0)}),Ke(`physics-binding`,.7,z(`SYS_BONE_HIERARCHIES`));let o=r.get(`GLTF_created_0001`);if(o){let n=b.ColliderDesc.capsule(.2,.15).setTranslation(0,0,0);Me(t,o,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:`Root_M_2_6_11`,offset:new e.Vector3(0,0,0),restitution:.2,friction:.9,softKinematic:.7}),[{bone:`HipFix_R_3_7_12`,shapeType:`ball`,radius:.1,offset:new e.Vector3(0,0,0)},{bone:`HipFix_L_85_89_94`,shapeType:`ball`,radius:.1,offset:new e.Vector3(0,0,0)},{bone:`RootPart1_M_16_20_25`,shapeType:`capsule`,radius:.4,height:.3,offset:new e.Vector3(0,.2,.2)},{bone:`Tail0_M_10_14_19`,shapeType:`capsule`,radius:.05,height:.2,offset:new e.Vector3(0,0,0)},{bone:`Tail20_M_15_19_24`,shapeType:`capsule`,radius:.05,height:.2,offset:new e.Vector3(0,0,0)},{bone:`Head_M_26_30_35`,shapeType:`ball`,radius:.3,offset:new e.Vector3(0,0,0)}].forEach(e=>{let n;n=e.shapeType===`ball`?b.ColliderDesc.ball(e.radius):b.ColliderDesc.capsule(e.height,e.radius),e.offset&&n.setTranslation(e.offset.x,e.offset.y,e.offset.z),Me(t,o,t.world.createRigidBody(b.RigidBodyDesc.kinematicPositionBased()),n,{trackBoneName:e.bone,restitution:.2,friction:.9,softKinematic:.7})})}await i(`Object_2001`,Ne,{bodyType:`dynamic`,mass:80,restitution:.6,canSleep:!0,isBhTarget:!0,isConvexHull:!0,offset:new e.Vector3(0,0,0),pullingDampness:.45,isIntegrityCheckTarget:!0}),await i(`mjolnir_low_mjolnir_hammer_0`,Ne,{bodyType:`dynamic`,mass:10,restitution:0,canSleep:!0,isBhTarget:!0,pullingDampness:.9075,isConvexHull:!0,isIntegrityResetTarget:!0}),await i(`questionCube`,Pe,{bodyType:`dynamic`,mass:20,isBhTarget:!0,isIntegrityResetTarget:!0}),await i(`shelf`,Ne,{bodyType:`dynamic`,mass:400,restitution:.3,canSleep:!0,isBhTarget:!0,pullingDampness:.25,isIntegrityCheckTarget:!1,isIntegrityResetTarget:!0});let s=[];for(let e=0;e<=38;e++){let t=`book`+String(e).padStart(3,`0`);s.push(t)}await i(s,Pe,{bodyType:`dynamic`,isBhTarget:!0,mass:2,restitution:.05,canSleep:!0,pullingDampness:.25,isIntegrityCheckTarget:!1,isIntegrityResetTarget:!0}),await i([`pokeball`,`pokeball2`],Fe,{bodyType:`dynamic`,mass:27,scale:.425,restitution:.9,isBhTarget:!0,isIntegrityResetTarget:!0}),await i(`drone`,Pe,{bodyType:`kinematicPosition`,mass:2.5,isBhTarget:!1,linearDamping:1,angularDamping:1}),Ke(`physics-binding`,.85,z(`SYS_COLLISION_MESHES`));try{await i(`caseCover`,Pe,{bodyType:`dynamic`,mass:100,restitution:.1,isBhTarget:!0,isIntegrityCheckTarget:!0}),await i(`Object_42001`,Pe,{bodyType:`dynamic`,mass:.5,restitution:.93,canSleep:!0,isBhTarget:!0,pullingDampness:-1,isIntegrityResetTarget:!0}),await i(`screenDisplay`,Pe,{bodyType:`dynamic`,mass:200,scale:new e.Vector3(1,1.05,.9),offset:new e.Vector3(0,-.13,0),isBhTarget:!0,pullingDampness:.5,isIntegrityCheckTarget:!0}),await i(`screenDisplay2`,Pe,{bodyType:`dynamic`,mass:20,scale:new e.Vector3(1,1.05,.9),offset:new e.Vector3(0,-.13,0),isBhTarget:!0,pullingDampness:.15,restitution:.3,isIntegrityCheckTarget:!0}),await i(`verticalMonitor`,Pe,{bodyType:`dynamic`,mass:150,friction:.9,scale:new e.Vector3(1,1,1),offset:new e.Vector3(0,1.75,0),isBhTarget:!0,pullingDampness:.25,isIntegrityCheckTarget:!0}),await i([`aegis`,`aegis2`],Ne,{bodyType:`dynamic`,mass:1.1,restitution:.01,canSleep:!0,isBhTarget:!0,isConvexHull:!0,isIntegrityResetTarget:!0}),await i([`pillow-small-1`,`pillow-small-2`,`pillow-big-1`,`pillow-big-2`],Ne,{bodyType:`dynamic`,mass:100.3,restitution:0,friction:.9,canSleep:!0,pullingDampness:.64,isBhTarget:!0,isConvexHull:!0,isIntegrityResetTarget:!0})}catch(e){throw e}}var wc=M((()=>{Ve(),ft(),Wr(),ke()})),Tc=M((()=>{xn(),It(),ir()}));function Ec(t,n){if(!t||!n)return console.error(`initConversationBox: Missing model or scene`),null;let r=null;if(t.traverse(e=>{e.isBone&&e.name===`mixamorigSpine2`&&(r=e)}),r||t.traverse(e=>{e.isBone&&e.name===`mixamorigSpine`&&(r=e)}),r||t.traverse(e=>{e.isBone&&e.name===`mixamorigHips`&&(r=e)}),r||=t.getObjectByName(`Ch23_Hair`),!r)return console.warn(`initConversationBox: No head found.`),null;let i=null,a=0,o=0,s=null;new e.Vector2;function c(){if(document.getElementById(`scifi-shout-box`))return;i=document.createElement(`div`),i.id=`scifi-shout-box`,Object.assign(i.style,{position:`absolute`,top:`0`,left:`0`,pointerEvents:`none`,zIndex:`5000`,padding:`10px 20px`,color:`#ffffff`,fontFamily:`"Rajdhani", sans-serif`,fontWeight:`600`,fontSize:`18px`,textAlign:`center`,display:`flex`,alignItems:`center`,justifyContent:`center`,lineHeight:`1.4`,backgroundColor:`rgba(5, 10, 25, 0.85)`,backdropFilter:`blur(10px)`,border:`1.5px solid #00F0FF`,boxShadow:`0 0 30px rgba(0, 240, 255, 0.25)`,opacity:`0`,whiteSpace:`pre-wrap`,transform:`translate(-50%, -100%) scale(0.8)`,transition:`opacity 0.3s ease, transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.25)`,letterSpacing:`1px`,textTransform:`none`,borderRadius:`2px`,clipPath:`none`});let e=document.createElement(`div`);Object.assign(e.style,{position:`absolute`,bottom:`-7.5px`,left:`50%`,width:`12px`,height:`12px`,backgroundColor:`rgba(5, 10, 25, 0.95)`,borderLeft:`1.5px solid #00F0FF`,borderBottom:`1.5px solid #00F0FF`,transform:`translateX(-50%) rotate(-45deg)`,zIndex:`1`}),i.appendChild(e);let t=document.createElement(`div`);Object.assign(t.style,{position:`absolute`,bottom:`4px`,right:`4px`,width:`8px`,height:`8px`,borderRight:`2px solid #00F0FF`,borderBottom:`2px solid #00F0FF`}),i.appendChild(t),document.getElementById(`experience-container`).appendChild(i)}function l(e,t={}){i||c();let n=e;Array.isArray(e)&&(n=e[Math.floor(Math.random()*e.length)]);let r=i.querySelector(`.text-content`);r||(r=document.createElement(`span`),r.className=`text-content`,i.insertBefore(r,i.firstChild)),r.innerText=n;let a=1;t.extraSmall?a=.56:t.small&&(a=.65),i.style.fontSize=`${18*a}px`,i.style.minWidth=n.length>20?`160px`:`95px`}c();let u={update:t=>{if(i){if(Math.abs(o-a)>.01){let e=3*t;o=o<a?Math.min(o+e,a):Math.max(o-e,a),i.style.opacity=o,i.style.display=o>.01?`block`:`none`}else i.style.opacity=a,i.style.display=a>.01?`block`:`none`;if(a>.01&&r&&n.camera&&n.renderer){let t=new e.Vector3;r.getWorldPosition(t),t.y+=2,t.project(n.camera);let a=n.renderer.domElement,s=a.clientWidth/2,c=a.clientHeight/2,l=t.x*s+s,u=-(t.y*c)+c,d=.8+.2*o;i.style.transform=`translate(-50%, -100%) translate(${l}px, ${u}px) scale(${d})`}}},updateText:(e,t={})=>{l(e,t)},show:()=>{a=1,i&&(i.style.display=`block`)},hide:()=>{a=0},shout:(e,t=3e3,n={})=>(s&&clearTimeout(s),l(e,n),u.show(),s=setTimeout(()=>{u.hide(),s=null},t),s),clear:()=>{s&&=(clearTimeout(s),null),a=0,o=0,i&&(i.style.opacity=`0`,i.style.display=`none`)}};return u}var Dc=M((()=>{}));function Oc(t){let n=t.getObjectByName(`Blackhole`);if(!n)return;n.position.y=-500,n.scale.setScalar(2),n.traverse(t=>{t.isMesh&&t.material&&(t.material.roughness=.95,t.material.metalness=0,t.material.side=e.FrontSide,t.castShadow=!1)});function r(e,t,r){let i=n.getObjectByName(e);i?.material&&i.material[t]!==void 0&&(i.material[t]=r)}r(`Lathe_L_Blackhole_03_0`,`roughness`,.4),r(`Lathe_S_Blackhole_01_0`,`metalness`,.6);let i=n.getObjectByName(`Lathe_Center`);if(i){let n=t.globalUniformsHub;n&&n.core,i.material=new e.ShaderMaterial({vertexShader:Zt,fragmentShader:an,transparent:!0,uniforms:{...n.uniforms,nebulaCoreRadius:{value:20},nebulaTwistFactor:{value:0},alpha:{value:1}},blending:e.AdditiveBlending,name:`nebulaMat`})}}function kc(t){let n=t.globalUniformsHub,r=n?n.uniforms:{},i=Gr(t,on,{side:e.BackSide,uniforms:{...n.core,isStriking:r.isStriking||{value:!1},normalizedStrikePos:r.normalizedStrikePos||{value:new e.Vector2(-2,-2)},uRainHeaviness:r.uRainHeaviness||{value:2},uStormSharpness:r.uStormSharpness||{value:0},uMoonPosition:r.uMoonPosition||{value:new e.Vector2(.58,.705)},uMoonSize:r.uMoonSize||{value:.006},uMoonBrightness:r.uMoonBrightness||{value:2.5},uMoonBlur:r.uMoonBlur||{value:0},uCraterScale:r.uCraterScale||{value:.555},uCraterIntensity:r.uCraterIntensity||{value:.28},uFarMountainOffset:r.uFarMountainOffset||{value:0},uNearMountainOffset:r.uNearMountainOffset||{value:-.5}}}),a=new e.Mesh(rr.plane,i);t.add(a),a.position.set(-55,-20,30),a.scale.setScalar(150),a.name=`planeSky`,a.visible=!1}function Ac(t){let n=t.globalUniformsHub,r=n?n.uniforms:{},i=Gr(t,sn,{transparent:!0,uniforms:{rainGlassOpacity:r.rainGlassOpacity||{value:1},glassRainAmount:r.glassRainAmount||{value:1},uRimCenter:r.uRimCenter||{value:new e.Vector2(-.5,.5)},uRainOffset:r.uRainOffset||{value:0},uWaterIntensity:n&&n.uWaterIntensity||{value:.2},hasRimOnGlass:{value:!0}},blending:e.AdditiveBlending,side:e.FrontSide}),a={vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,uniforms:i.uniforms};Nr(a,i.uniforms),i.vertexShader=a.vertexShader,i.fragmentShader=a.fragmentShader;let o=t.getObjectByName(`glass1`),s=t.getObjectByName(`glass2`);o&&(o.material=i),s&&(s.material=i)}var jc,Mc=M((()=>{ft(),pt(),ir(),It(),sc(),Vn(),gc(),xn(),Sc(),Ve(),ao(),ci(),wc(),mc(),Tc(),Br(),ls(),Dc(),Wr(),ke(),Lt(`#dcd0ba`,.85,.03,6.5),Rt(`#dcd0ba`,1,1),jc=class{constructor(e,t,n,r){this.scene=e,this.camera=t,this.renderer=n,this.model=null,this.mixer=null,this.constantUniform=Ft,this.resources=r}async init(t,n,r={}){return new Promise(async(n,r)=>{let i=this.resources.roomModel;if(!i){let e=`Resources: Room Model not loaded.`;console.error(e),t&&B(window.loadingProgress||0,z(`SYS_ERROR`)),r(e);return}try{t&&B(window.loadingProgress||0,z(`SYS_INIT_SCENE`)),Ke(`model-assembly`,.1),this.model=i.scene,this.model.name=`roomGLBModel`,this.model.visible=!1,this.scene.add(this.model),this.scene.room=this.model,this.scene.animations=i.animations,this.boxUpdater=Ec(this.model,this.scene),this.scene.conversationManager=this.boxUpdater;let a=[`leftWallFoot001`,`Cube004`,`shelf`,`glass1`,`Object_17`,`Object_1001_1`,`Object_8001`,`glass1`,`pillow-big-2`,`pillow-small-2`,`pillow-small-1`,`pillow-big-1`,`bedMain`,`Ch23_Hair`,`Ch23_Suit`,`Object_15`],o=[`Object_1001_1`,`Object_8001`,`Object_17`,`leftWallFoot001`];this.model.getObjectByName(`inviMesh`).material.visible=!1;let s=[this.model],c=0,l=performance.now();for(;s.length>0;){let t=s.pop();if(t.isMesh&&(t.material.side=e.FrontSide,a.includes(t.name)&&(t.receiveShadow=!0),o.includes(t.name)||t.name.startsWith(`book`)?t.castShadow=!1:t.castShadow=!0),t.children)for(let e=t.children.length-1;e>=0;e--)s.push(t.children[e]);c++,c%50==0&&performance.now()-l>4&&(await Ur(),l=performance.now())}if(this.mixer=i.mixer,this.scene.mixer=i.mixer,this.scene.heroClips=i.heroClips,this.scene.activeAction=i.activeAction,this.mixer&&this.scene.animations){let t=e.AnimationClip.findByName(this.scene.animations,`3|PlaneAction`);t&&(this.scene.fanAction=this.mixer.clipAction(t),this.scene.fanAction.play())}V.start(`Helpers Setup`),rc(this.scene),Oc(this.scene),kc(this.scene),Ac(this.scene),Pn(this.scene),hc(this.scene);let u=_c(this.scene);this.scene.getObjectByName(`blackholeScene`).attach(u),V.end(`Helpers Setup`),V.start(`Adjust Objects`),Kr(this.scene,t).then(()=>(V.end(`Adjust Objects`),V.start(`Bind Physics`),Cc(this.scene,t))).then(async()=>(V.end(`Bind Physics`),Ke(`physics-binding`,.9),await qr(this.scene),Ke(`physics-binding`,1),Fa(this.scene),this.scene.constantUniform=Ft,t&&B(window.loadingProgress||0,z(`SYS_FINALIZE`)),Promise.resolve())).then(()=>{B(100),clearInterval(void 0),this.model&&this.model.position.set(0,-5e4,0),n()}).catch(e=>{console.error(`Critical error in async chain:`,e),r(e)})}catch(e){console.error(`Critical error during scene initialisation:`,e),r(e)}finally{window.completeTask&&(completeTask(`model-assembly`),completeTask(`physics-binding`))}})}updateAnimationMixer(e){this.mixer&&this.mixer.update(e),this.boxUpdater&&this.boxUpdater.update(e)}}}));async function Nc({scene:e,camera:t,orbitControl:n,clock:r,pointsApp:i}){e.targetAnimHz=30,qo(e,0),Ro(e,Pc*.05),Z(z(`SYS_INIT`)),Z(z(`ENV_CALIBRATION`)),await jo(),Z(z(`SYS_PILOT_ENTRY_WAIT`)),await Mo(),await No(200),e.isTransitioning=!0,e.HUD&&typeof e.HUD.breathe==`function`&&e.HUD.breathe(L.ELECTRIC_CYAN);let a=Q.currentMode;e.fpsStats&&e.fpsStats.avg<45&&(e.isLowPowerMode=!0),Z(`Protocol ${a.toUpperCase()} verified.`);let o=document.getElementById(`cv-container`);o&&o.classList.contains(`collapsed`)&&(o.classList.remove(`collapsed`),window.dispatchEvent(new CustomEvent(`cvToggle`,{detail:{collapsed:!1}})),await No(500)),e.HUD&&typeof e.HUD.runTweenOpen==`function`&&(await e.HUD.runTweenOpen(1500,{isIncludedIsland:!1,isIncludedDecos:!1}),e.HUD.runTweenShowIsland(2500),fo.onHudOpen(e),e.HUD.runTweenShowDecos(1e3)),i&&(i.playIntro(),i.activateScrollInteractions(),i.triggerStep&&i.triggerStep(0,1500,!0)),Z(z(`SYS_BUILD_START`)),setTimeout(()=>{e.isTransitioning=!1},1e3)}var Pc,Fc=M((()=>{ls(),Ns(),ks(),ke(),br(),ao(),we(),po(),Pc=ns}));function Ic(t,n){if(!t)return console.warn(`[knowhere] Parent not found. Skipping.`),null;let r=new e.PlaneGeometry(1,1),i=Gr(n,Rc,{transparent:!0,blending:e.NormalBlending,side:e.DoubleSide,depthTest:!0,depthWrite:!1,vs:Lc});i.uniforms&&(i.uniforms.uScaleFactor={value:0},i.uniforms.uHudOffset={value:new e.Vector2(0,1.2)},i.uniforms.uStarScreenPos={value:new e.Vector2(0,0)});let a=new e.Mesh(r,i);return a.name=`knowhere`,a.scale.set(10,10,1),a.frustumCulled=!1,t.add(a),n.knowhere=a,a}var Lc,Rc,zc=M((()=>{ci(),It(),Lc=`
    varying vec2 vUv;
